var Le=Object.defineProperty;var Zt=t=>{throw TypeError(t)};var Oe=(t,e,a)=>e in t?Le(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var b=(t,e,a)=>Oe(t,typeof e!="symbol"?e+"":e,a),Gt=(t,e,a)=>e.has(t)||Zt("Cannot "+a);var i=(t,e,a)=>(Gt(t,e,"read from private field"),a?a.call(t):e.get(t)),y=(t,e,a)=>e.has(t)?Zt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),v=(t,e,a,n)=>(Gt(t,e,"write to private field"),n?n.call(t,a):e.set(t,a),a),g=(t,e,a)=>(Gt(t,e,"access private method"),a);var te=(t,e,a,n)=>({set _(r){v(t,e,r,a)},get _(){return i(t,e,n)}});var ee=(t,e,a)=>(n,r)=>{let s=-1;return o(0);async function o(l){if(l<=s)throw new Error("next() called multiple times");s=l;let c,d=!1,p;if(t[l]?(p=t[l][0][0],n.req.routeIndex=l):p=l===t.length&&r||void 0,p)try{c=await p(n,()=>o(l+1))}catch(u){if(u instanceof Error&&e)n.error=u,c=await e(u,n),d=!0;else throw u}else n.finalized===!1&&a&&(c=await a(n));return c&&(n.finalized===!1||d)&&(n.res=c),n}},Re=Symbol(),Me=async(t,e=Object.create(null))=>{const{all:a=!1,dot:n=!1}=e,s=(t instanceof fe?t.raw.headers:t.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?je(t,{all:a,dot:n}):{}};async function je(t,e){const a=await t.formData();return a?qe(a,e):{}}function qe(t,e){const a=Object.create(null);return t.forEach((n,r)=>{e.all||r.endsWith("[]")?He(a,r,n):a[r]=n}),e.dot&&Object.entries(a).forEach(([n,r])=>{n.includes(".")&&(ze(a,n,r),delete a[n])}),a}var He=(t,e,a)=>{t[e]!==void 0?Array.isArray(t[e])?t[e].push(a):t[e]=[t[e],a]:e.endsWith("[]")?t[e]=[a]:t[e]=a},ze=(t,e,a)=>{if(/(?:^|\.)__proto__\./.test(e))return;let n=t;const r=e.split(".");r.forEach((s,o)=>{o===r.length-1?n[s]=a:((!n[s]||typeof n[s]!="object"||Array.isArray(n[s])||n[s]instanceof File)&&(n[s]=Object.create(null)),n=n[s])})},ue=t=>{const e=t.split("/");return e[0]===""&&e.shift(),e},Fe=t=>{const{groups:e,path:a}=Ke(t),n=ue(a);return Ue(n,e)},Ke=t=>{const e=[];return t=t.replace(/\{[^}]+\}/g,(a,n)=>{const r=`@${n}`;return e.push([r,a]),r}),{groups:e,path:t}},Ue=(t,e)=>{for(let a=e.length-1;a>=0;a--){const[n]=e[a];for(let r=t.length-1;r>=0;r--)if(t[r].includes(n)){t[r]=t[r].replace(n,e[a][1]);break}}return t},Rt={},Ge=(t,e)=>{if(t==="*")return"*";const a=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const n=`${t}#${e}`;return Rt[n]||(a[2]?Rt[n]=e&&e[0]!==":"&&e[0]!=="*"?[n,a[1],new RegExp(`^${a[2]}(?=/${e})`)]:[t,a[1],new RegExp(`^${a[2]}$`)]:Rt[n]=[t,a[1],!0]),Rt[n]}return null},Xt=(t,e)=>{try{return e(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return e(a)}catch{return a}})}},Ve=t=>Xt(t,decodeURI),me=t=>{const e=t.url,a=e.indexOf("/",e.indexOf(":")+4);let n=a;for(;n<e.length;n++){const r=e.charCodeAt(n);if(r===37){const s=e.indexOf("?",n),o=e.indexOf("#",n),l=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),c=e.slice(a,l);return Ve(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(r===63||r===35)break}return e.slice(a,n)},$e=t=>{const e=me(t);return e.length>1&&e.at(-1)==="/"?e.slice(0,-1):e},pt=(t,e,...a)=>(a.length&&(e=pt(e,...a)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${e==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(e==null?void 0:e[0])==="/"?e.slice(1):e}`}`),ve=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const e=t.split("/"),a=[];let n="";return e.forEach(r=>{if(r!==""&&!/\:/.test(r))n+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){a.length===0&&n===""?a.push("/"):a.push(n);const s=r.replace("?","");n+="/"+s,a.push(n)}else n+="/"+r}),a.filter((r,s,o)=>o.indexOf(r)===s)},Vt=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?Xt(t,ye):t):t,be=(t,e,a)=>{let n;if(!a&&e&&!/[%+]/.test(e)){let o=t.indexOf("?",8);if(o===-1)return;for(t.startsWith(e,o+1)||(o=t.indexOf(`&${e}`,o+1));o!==-1;){const l=t.charCodeAt(o+e.length+1);if(l===61){const c=o+e.length+2,d=t.indexOf("&",c);return Vt(t.slice(c,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";o=t.indexOf(`&${e}`,o+1)}if(n=/[%+]/.test(t),!n)return}const r={};n??(n=/[%+]/.test(t));let s=t.indexOf("?",8);for(;s!==-1;){const o=t.indexOf("&",s+1);let l=t.indexOf("=",s);l>o&&o!==-1&&(l=-1);let c=t.slice(s+1,l===-1?o===-1?void 0:o:l);if(n&&(c=Vt(c)),s=o,c==="")continue;let d;l===-1?d="":(d=t.slice(l+1,o===-1?void 0:o),n&&(d=Vt(d))),a?(r[c]&&Array.isArray(r[c])||(r[c]=[]),r[c].push(d)):r[c]??(r[c]=d)}return e?r[e]:r},Qe=be,Ye=(t,e)=>be(t,e,!0),ye=decodeURIComponent,ae=t=>Xt(t,ye),vt,N,K,he,ge,Qt,G,oe,fe=(oe=class{constructor(t,e="/",a=[[]]){y(this,K);b(this,"raw");y(this,vt);y(this,N);b(this,"routeIndex",0);b(this,"path");b(this,"bodyCache",{});y(this,G,t=>{const{bodyCache:e,raw:a}=this,n=e[t];if(n)return n;const r=Object.keys(e)[0];return r?e[r].then(s=>(r==="json"&&(s=JSON.stringify(s)),new Response(s)[t]())):e[t]=a[t]()});this.raw=t,this.path=e,v(this,N,a),v(this,vt,{})}param(t){return t?g(this,K,he).call(this,t):g(this,K,ge).call(this)}query(t){return Qe(this.url,t)}queries(t){return Ye(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const e={};return this.raw.headers.forEach((a,n)=>{e[n]=a}),e}async parseBody(t){return Me(this,t)}json(){return i(this,G).call(this,"text").then(t=>JSON.parse(t))}text(){return i(this,G).call(this,"text")}arrayBuffer(){return i(this,G).call(this,"arrayBuffer")}blob(){return i(this,G).call(this,"blob")}formData(){return i(this,G).call(this,"formData")}addValidatedData(t,e){i(this,vt)[t]=e}valid(t){return i(this,vt)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[Re](){return i(this,N)}get matchedRoutes(){return i(this,N)[0].map(([[,t]])=>t)}get routePath(){return i(this,N)[0].map(([[,t]])=>t)[this.routeIndex].path}},vt=new WeakMap,N=new WeakMap,K=new WeakSet,he=function(t){const e=i(this,N)[0][this.routeIndex][1][t],a=g(this,K,Qt).call(this,e);return a&&/\%/.test(a)?ae(a):a},ge=function(){const t={},e=Object.keys(i(this,N)[0][this.routeIndex][1]);for(const a of e){const n=g(this,K,Qt).call(this,i(this,N)[0][this.routeIndex][1][a]);n!==void 0&&(t[a]=/\%/.test(n)?ae(n):n)}return t},Qt=function(t){return i(this,N)[1]?i(this,N)[1][t]:t},G=new WeakMap,oe),Xe={Stringify:1},xe=async(t,e,a,n,r)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const s=t.callbacks;return s!=null&&s.length?(r?r[0]+=t:r=[t],Promise.all(s.map(l=>l({phase:e,buffer:r,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(c=>xe(c,e,!1,n,r))).then(()=>r[0]))):Promise.resolve(t)},We="text/plain; charset=UTF-8",$t=(t,e)=>({"Content-Type":t,...e}),Et=(t,e)=>new Response(t,e),Ct,At,q,bt,H,C,Nt,yt,ft,tt,_t,Dt,V,ut,ie,Je=(ie=class{constructor(t,e){y(this,V);y(this,Ct);y(this,At);b(this,"env",{});y(this,q);b(this,"finalized",!1);b(this,"error");y(this,bt);y(this,H);y(this,C);y(this,Nt);y(this,yt);y(this,ft);y(this,tt);y(this,_t);y(this,Dt);b(this,"render",(...t)=>(i(this,yt)??v(this,yt,e=>this.html(e)),i(this,yt).call(this,...t)));b(this,"setLayout",t=>v(this,Nt,t));b(this,"getLayout",()=>i(this,Nt));b(this,"setRenderer",t=>{v(this,yt,t)});b(this,"header",(t,e,a)=>{this.finalized&&v(this,C,Et(i(this,C).body,i(this,C)));const n=i(this,C)?i(this,C).headers:i(this,tt)??v(this,tt,new Headers);e===void 0?n.delete(t):a!=null&&a.append?n.append(t,e):n.set(t,e)});b(this,"status",t=>{v(this,bt,t)});b(this,"set",(t,e)=>{i(this,q)??v(this,q,new Map),i(this,q).set(t,e)});b(this,"get",t=>i(this,q)?i(this,q).get(t):void 0);b(this,"newResponse",(...t)=>g(this,V,ut).call(this,...t));b(this,"body",(t,e,a)=>g(this,V,ut).call(this,t,e,a));b(this,"text",(t,e,a)=>!i(this,tt)&&!i(this,bt)&&!e&&!a&&!this.finalized?new Response(t):g(this,V,ut).call(this,t,e,$t(We,a)));b(this,"json",(t,e,a)=>g(this,V,ut).call(this,JSON.stringify(t),e,$t("application/json",a)));b(this,"html",(t,e,a)=>{const n=r=>g(this,V,ut).call(this,r,e,$t("text/html; charset=UTF-8",a));return typeof t=="object"?xe(t,Xe.Stringify,!1,{}).then(n):n(t)});b(this,"redirect",(t,e)=>{const a=String(t);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,e??302)});b(this,"notFound",()=>(i(this,ft)??v(this,ft,()=>Et()),i(this,ft).call(this,this)));v(this,Ct,t),e&&(v(this,H,e.executionCtx),this.env=e.env,v(this,ft,e.notFoundHandler),v(this,Dt,e.path),v(this,_t,e.matchResult))}get req(){return i(this,At)??v(this,At,new fe(i(this,Ct),i(this,Dt),i(this,_t))),i(this,At)}get event(){if(i(this,H)&&"respondWith"in i(this,H))return i(this,H);throw Error("This context has no FetchEvent")}get executionCtx(){if(i(this,H))return i(this,H);throw Error("This context has no ExecutionContext")}get res(){return i(this,C)||v(this,C,Et(null,{headers:i(this,tt)??v(this,tt,new Headers)}))}set res(t){if(i(this,C)&&t){t=Et(t.body,t);for(const[e,a]of i(this,C).headers.entries())if(e!=="content-type")if(e==="set-cookie"){const n=i(this,C).headers.getSetCookie();t.headers.delete("set-cookie");for(const r of n)t.headers.append("set-cookie",r)}else t.headers.set(e,a)}v(this,C,t),this.finalized=!0}get var(){return i(this,q)?Object.fromEntries(i(this,q)):{}}},Ct=new WeakMap,At=new WeakMap,q=new WeakMap,bt=new WeakMap,H=new WeakMap,C=new WeakMap,Nt=new WeakMap,yt=new WeakMap,ft=new WeakMap,tt=new WeakMap,_t=new WeakMap,Dt=new WeakMap,V=new WeakSet,ut=function(t,e,a){const n=i(this,C)?new Headers(i(this,C).headers):i(this,tt)??new Headers;if(typeof e=="object"&&"headers"in e){const s=e.headers instanceof Headers?e.headers:new Headers(e.headers);for(const[o,l]of s)o.toLowerCase()==="set-cookie"?n.append(o,l):n.set(o,l)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")n.set(s,o);else{n.delete(s);for(const l of o)n.append(s,l)}const r=typeof e=="number"?e:(e==null?void 0:e.status)??i(this,bt);return Et(t,{status:r,headers:n})},ie),I="ALL",Ze="all",ta=["get","post","put","delete","options","patch"],we="Can not add a route since the matcher is already built.",ke=class extends Error{},ea="__COMPOSED_HANDLER",aa=t=>t.text("404 Not Found",404),ne=(t,e)=>{if("getResponse"in t){const a=t.getResponse();return e.newResponse(a.body,a)}return console.error(t),e.text("Internal Server Error",500)},D,S,Pe,L,J,Mt,jt,ht,na=(ht=class{constructor(e={}){y(this,S);b(this,"get");b(this,"post");b(this,"put");b(this,"delete");b(this,"options");b(this,"patch");b(this,"all");b(this,"on");b(this,"use");b(this,"router");b(this,"getPath");b(this,"_basePath","/");y(this,D,"/");b(this,"routes",[]);y(this,L,aa);b(this,"errorHandler",ne);b(this,"onError",e=>(this.errorHandler=e,this));b(this,"notFound",e=>(v(this,L,e),this));b(this,"fetch",(e,...a)=>g(this,S,jt).call(this,e,a[1],a[0],e.method));b(this,"request",(e,a,n,r)=>e instanceof Request?this.fetch(a?new Request(e,a):e,n,r):(e=e.toString(),this.fetch(new Request(/^https?:\/\//.test(e)?e:`http://localhost${pt("/",e)}`,a),n,r)));b(this,"fire",()=>{addEventListener("fetch",e=>{e.respondWith(g(this,S,jt).call(this,e.request,e,void 0,e.request.method))})});[...ta,Ze].forEach(s=>{this[s]=(o,...l)=>(typeof o=="string"?v(this,D,o):g(this,S,J).call(this,s,i(this,D),o),l.forEach(c=>{g(this,S,J).call(this,s,i(this,D),c)}),this)}),this.on=(s,o,...l)=>{for(const c of[o].flat()){v(this,D,c);for(const d of[s].flat())l.map(p=>{g(this,S,J).call(this,d.toUpperCase(),i(this,D),p)})}return this},this.use=(s,...o)=>(typeof s=="string"?v(this,D,s):(v(this,D,"*"),o.unshift(s)),o.forEach(l=>{g(this,S,J).call(this,I,i(this,D),l)}),this);const{strict:n,...r}=e;Object.assign(this,r),this.getPath=n??!0?e.getPath??me:$e}route(e,a){const n=this.basePath(e);return a.routes.map(r=>{var o;let s;a.errorHandler===ne?s=r.handler:(s=async(l,c)=>(await ee([],a.errorHandler)(l,()=>r.handler(l,c))).res,s[ea]=r.handler),g(o=n,S,J).call(o,r.method,r.path,s)}),this}basePath(e){const a=g(this,S,Pe).call(this);return a._basePath=pt(this._basePath,e),a}mount(e,a,n){let r,s;n&&(typeof n=="function"?s=n:(s=n.optionHandler,n.replaceRequest===!1?r=c=>c:r=n.replaceRequest));const o=s?c=>{const d=s(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};r||(r=(()=>{const c=pt(this._basePath,e),d=c==="/"?0:c.length;return p=>{const u=new URL(p.url);return u.pathname=u.pathname.slice(d)||"/",new Request(u,p)}})());const l=async(c,d)=>{const p=await a(r(c.req.raw),...o(c));if(p)return p;await d()};return g(this,S,J).call(this,I,pt(e,"*"),l),this}},D=new WeakMap,S=new WeakSet,Pe=function(){const e=new ht({router:this.router,getPath:this.getPath});return e.errorHandler=this.errorHandler,v(e,L,i(this,L)),e.routes=this.routes,e},L=new WeakMap,J=function(e,a,n){e=e.toUpperCase(),a=pt(this._basePath,a);const r={basePath:this._basePath,path:a,method:e,handler:n};this.router.add(e,a,[n,r]),this.routes.push(r)},Mt=function(e,a){if(e instanceof Error)return this.errorHandler(e,a);throw e},jt=function(e,a,n,r){if(r==="HEAD")return(async()=>new Response(null,await g(this,S,jt).call(this,e,a,n,"GET")))();const s=this.getPath(e,{env:n}),o=this.router.match(r,s),l=new Je(e,{path:s,matchResult:o,env:n,executionCtx:a,notFoundHandler:i(this,L)});if(o[0].length===1){let d;try{d=o[0][0][0][0](l,async()=>{l.res=await i(this,L).call(this,l)})}catch(p){return g(this,S,Mt).call(this,p,l)}return d instanceof Promise?d.then(p=>p||(l.finalized?l.res:i(this,L).call(this,l))).catch(p=>g(this,S,Mt).call(this,p,l)):d??i(this,L).call(this,l)}const c=ee(o[0],this.errorHandler,i(this,L));return(async()=>{try{const d=await c(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return g(this,S,Mt).call(this,d,l)}})()},ht),Ee=[];function sa(t,e){const a=this.buildAllMatchers(),n=((r,s)=>{const o=a[r]||a[I],l=o[2][s];if(l)return l;const c=s.match(o[0]);if(!c)return[[],Ee];const d=c.indexOf("",1);return[o[1][d],c]});return this.match=n,n(t,e)}var Ht="[^/]+",St=".*",Bt="(?:|/.*)",mt=Symbol(),ra=new Set(".\\+*[^]$()");function oa(t,e){return t.length===1?e.length===1?t<e?-1:1:-1:e.length===1||t===St||t===Bt?1:e===St||e===Bt?-1:t===Ht?1:e===Ht?-1:t.length===e.length?t<e?-1:1:e.length-t.length}var et,at,O,rt,ia=(rt=class{constructor(){y(this,et);y(this,at);y(this,O,Object.create(null))}insert(e,a,n,r,s){if(e.length===0){if(i(this,et)!==void 0)throw mt;if(s)return;v(this,et,a);return}const[o,...l]=e,c=o==="*"?l.length===0?["","",St]:["","",Ht]:o==="/*"?["","",Bt]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const p=c[1];let u=c[2]||Ht;if(p&&c[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw mt;if(d=i(this,O)[u],!d){if(Object.keys(i(this,O)).some(h=>h!==St&&h!==Bt))throw mt;if(s)return;d=i(this,O)[u]=new rt,p!==""&&v(d,at,r.varIndex++)}!s&&p!==""&&n.push([p,i(d,at)])}else if(d=i(this,O)[o],!d){if(Object.keys(i(this,O)).some(p=>p.length>1&&p!==St&&p!==Bt))throw mt;if(s)return;d=i(this,O)[o]=new rt}d.insert(l,a,n,r,s)}buildRegExpStr(){const a=Object.keys(i(this,O)).sort(oa).map(n=>{const r=i(this,O)[n];return(typeof i(r,at)=="number"?`(${n})@${i(r,at)}`:ra.has(n)?`\\${n}`:n)+r.buildRegExpStr()});return typeof i(this,et)=="number"&&a.unshift(`#${i(this,et)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},et=new WeakMap,at=new WeakMap,O=new WeakMap,rt),zt,Lt,de,da=(de=class{constructor(){y(this,zt,{varIndex:0});y(this,Lt,new ia)}insert(t,e,a){const n=[],r=[];for(let o=0;;){let l=!1;if(t=t.replace(/\{[^}]+\}/g,c=>{const d=`@\\${o}`;return r[o]=[d,c],o++,l=!0,d}),!l)break}const s=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=r.length-1;o>=0;o--){const[l]=r[o];for(let c=s.length-1;c>=0;c--)if(s[c].indexOf(l)!==-1){s[c]=s[c].replace(l,r[o][1]);break}}return i(this,Lt).insert(s,e,n,i(this,zt),a),n}buildRegExp(){let t=i(this,Lt).buildRegExpStr();if(t==="")return[/^$/,[],[]];let e=0;const a=[],n=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,s,o)=>s!==void 0?(a[++e]=Number(s),"$()"):(o!==void 0&&(n[Number(o)]=++e),"")),[new RegExp(`^${t}`),a,n]}},zt=new WeakMap,Lt=new WeakMap,de),la=[/^$/,[],Object.create(null)],qt=Object.create(null);function Ie(t){return qt[t]??(qt[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(e,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function ca(){qt=Object.create(null)}function pa(t){var d;const e=new da,a=[];if(t.length===0)return la;const n=t.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,u],[h,w])=>p?1:h?-1:u.length-w.length),r=Object.create(null);for(let p=0,u=-1,h=n.length;p<h;p++){const[w,P,A]=n[p];w?r[P]=[A.map(([R])=>[R,Object.create(null)]),Ee]:u++;let _;try{_=e.insert(P,u,w)}catch(R){throw R===mt?new ke(P):R}w||(a[u]=A.map(([R,E])=>{const M=Object.create(null);for(E-=1;E>=0;E--){const[wt,Kt]=_[E];M[wt]=Kt}return[R,M]}))}const[s,o,l]=e.buildRegExp();for(let p=0,u=a.length;p<u;p++)for(let h=0,w=a[p].length;h<w;h++){const P=(d=a[p][h])==null?void 0:d[1];if(!P)continue;const A=Object.keys(P);for(let _=0,R=A.length;_<R;_++)P[A[_]]=l[P[A[_]]]}const c=[];for(const p in o)c[p]=a[o[p]];return[s,c,r]}function lt(t,e){if(t){for(const a of Object.keys(t).sort((n,r)=>r.length-n.length))if(Ie(a).test(e))return[...t[a]]}}var $,Q,Ft,Se,le,ua=(le=class{constructor(){y(this,Ft);b(this,"name","RegExpRouter");y(this,$);y(this,Q);b(this,"match",sa);v(this,$,{[I]:Object.create(null)}),v(this,Q,{[I]:Object.create(null)})}add(t,e,a){var l;const n=i(this,$),r=i(this,Q);if(!n||!r)throw new Error(we);n[t]||[n,r].forEach(c=>{c[t]=Object.create(null),Object.keys(c[I]).forEach(d=>{c[t][d]=[...c[I][d]]})}),e==="/*"&&(e="*");const s=(e.match(/\/:/g)||[]).length;if(/\*$/.test(e)){const c=Ie(e);t===I?Object.keys(n).forEach(d=>{var p;(p=n[d])[e]||(p[e]=lt(n[d],e)||lt(n[I],e)||[])}):(l=n[t])[e]||(l[e]=lt(n[t],e)||lt(n[I],e)||[]),Object.keys(n).forEach(d=>{(t===I||t===d)&&Object.keys(n[d]).forEach(p=>{c.test(p)&&n[d][p].push([a,s])})}),Object.keys(r).forEach(d=>{(t===I||t===d)&&Object.keys(r[d]).forEach(p=>c.test(p)&&r[d][p].push([a,s]))});return}const o=ve(e)||[e];for(let c=0,d=o.length;c<d;c++){const p=o[c];Object.keys(r).forEach(u=>{var h;(t===I||t===u)&&((h=r[u])[p]||(h[p]=[...lt(n[u],p)||lt(n[I],p)||[]]),r[u][p].push([a,s-d+c+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(i(this,Q)).concat(Object.keys(i(this,$))).forEach(e=>{t[e]||(t[e]=g(this,Ft,Se).call(this,e))}),v(this,$,v(this,Q,void 0)),ca(),t}},$=new WeakMap,Q=new WeakMap,Ft=new WeakSet,Se=function(t){const e=[];let a=t===I;return[i(this,$),i(this,Q)].forEach(n=>{const r=n[t]?Object.keys(n[t]).map(s=>[s,n[t][s]]):[];r.length!==0?(a||(a=!0),e.push(...r)):t!==I&&e.push(...Object.keys(n[I]).map(s=>[s,n[I][s]]))}),a?pa(e):null},le),Y,z,ce,ma=(ce=class{constructor(t){b(this,"name","SmartRouter");y(this,Y,[]);y(this,z,[]);v(this,Y,t.routers)}add(t,e,a){if(!i(this,z))throw new Error(we);i(this,z).push([t,e,a])}match(t,e){if(!i(this,z))throw new Error("Fatal error");const a=i(this,Y),n=i(this,z),r=a.length;let s=0,o;for(;s<r;s++){const l=a[s];try{for(let c=0,d=n.length;c<d;c++)l.add(...n[c]);o=l.match(t,e)}catch(c){if(c instanceof ke)continue;throw c}this.match=l.match.bind(l),v(this,Y,[l]),v(this,z,void 0);break}if(s===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(i(this,z)||i(this,Y).length!==1)throw new Error("No active router has been determined yet.");return i(this,Y)[0]}},Y=new WeakMap,z=new WeakMap,ce),It=Object.create(null),va=t=>{for(const e in t)return!0;return!1},X,T,nt,gt,B,F,Z,xt,ba=(xt=class{constructor(e,a,n){y(this,F);y(this,X);y(this,T);y(this,nt);y(this,gt,0);y(this,B,It);if(v(this,T,n||Object.create(null)),v(this,X,[]),e&&a){const r=Object.create(null);r[e]={handler:a,possibleKeys:[],score:0},v(this,X,[r])}v(this,nt,[])}insert(e,a,n){v(this,gt,++te(this,gt)._);let r=this;const s=Fe(a),o=[];for(let l=0,c=s.length;l<c;l++){const d=s[l],p=s[l+1],u=Ge(d,p),h=Array.isArray(u)?u[0]:d;if(h in i(r,T)){r=i(r,T)[h],u&&o.push(u[1]);continue}i(r,T)[h]=new xt,u&&(i(r,nt).push(u),o.push(u[1])),r=i(r,T)[h]}return i(r,X).push({[e]:{handler:n,possibleKeys:o.filter((l,c,d)=>d.indexOf(l)===c),score:i(this,gt)}}),r}search(e,a){var p;const n=[];v(this,B,It);let s=[this];const o=ue(a),l=[],c=o.length;let d=null;for(let u=0;u<c;u++){const h=o[u],w=u===c-1,P=[];for(let _=0,R=s.length;_<R;_++){const E=s[_],M=i(E,T)[h];M&&(v(M,B,i(E,B)),w?(i(M,T)["*"]&&g(this,F,Z).call(this,n,i(M,T)["*"],e,i(E,B)),g(this,F,Z).call(this,n,M,e,i(E,B))):P.push(M));for(let wt=0,Kt=i(E,nt).length;wt<Kt;wt++){const Wt=i(E,nt)[wt],U=i(E,B)===It?{}:{...i(E,B)};if(Wt==="*"){const it=i(E,T)["*"];it&&(g(this,F,Z).call(this,n,it,e,i(E,B)),v(it,B,U),P.push(it));continue}const[De,Jt,kt]=Wt;if(!h&&!(kt instanceof RegExp))continue;const j=i(E,T)[De];if(kt instanceof RegExp){if(d===null){d=new Array(c);let dt=a[0]==="/"?1:0;for(let Pt=0;Pt<c;Pt++)d[Pt]=dt,dt+=o[Pt].length+1}const it=a.substring(d[u]),Ut=kt.exec(it);if(Ut){if(U[Jt]=Ut[0],g(this,F,Z).call(this,n,j,e,i(E,B),U),va(i(j,T))){v(j,B,U);const dt=((p=Ut[0].match(/\//))==null?void 0:p.length)??0;(l[dt]||(l[dt]=[])).push(j)}continue}}(kt===!0||kt.test(h))&&(U[Jt]=h,w?(g(this,F,Z).call(this,n,j,e,U,i(E,B)),i(j,T)["*"]&&g(this,F,Z).call(this,n,i(j,T)["*"],e,U,i(E,B))):(v(j,B,U),P.push(j)))}}const A=l.shift();s=A?P.concat(A):P}return n.length>1&&n.sort((u,h)=>u.score-h.score),[n.map(({handler:u,params:h})=>[u,h])]}},X=new WeakMap,T=new WeakMap,nt=new WeakMap,gt=new WeakMap,B=new WeakMap,F=new WeakSet,Z=function(e,a,n,r,s){for(let o=0,l=i(a,X).length;o<l;o++){const c=i(a,X)[o],d=c[n]||c[I],p={};if(d!==void 0&&(d.params=Object.create(null),e.push(d),r!==It||s&&s!==It))for(let u=0,h=d.possibleKeys.length;u<h;u++){const w=d.possibleKeys[u],P=p[d.score];d.params[w]=s!=null&&s[w]&&!P?s[w]:r[w]??(s==null?void 0:s[w]),p[d.score]=!0}}},xt),st,pe,ya=(pe=class{constructor(){b(this,"name","TrieRouter");y(this,st);v(this,st,new ba)}add(t,e,a){const n=ve(e);if(n){for(let r=0,s=n.length;r<s;r++)i(this,st).insert(t,n[r],a);return}i(this,st).insert(t,e,a)}match(t,e){return i(this,st).search(t,e)}},st=new WeakMap,pe),Be=class extends na{constructor(t={}){super(t),this.router=t.router??new ma({routers:[new ua,new ya]})}};const m=new Be;let Te="1234";const Ce="4321",Ae="2028-12-31";function W(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function ct(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function ot(t,e){if(!t.DATA_STORE)return[];let a;const n=[];do{const o=await t.DATA_STORE.list({prefix:e,cursor:a,limit:1e3});n.push(...o.keys.map(l=>l.name)),a=o.list_complete?void 0:o.cursor}while(a);const r=await Promise.all(n.map(o=>t.DATA_STORE.get(o))),s=[];for(let o=0;o<n.length;o++)if(r[o])try{s.push({_key:n[o],...JSON.parse(r[o])})}catch{}return s}function f(t){return new Response(t,{headers:{"content-type":"text/html;charset=UTF-8","Cache-Control":"no-store, no-cache, must-revalidate, proxy-revalidate",Pragma:"no-cache",Expires:"0"}})}m.post("/login",async t=>{var o;const e=await t.req.formData(),a=e.get("pin"),n=await((o=t.env.DATA_STORE)==null?void 0:o.get("APP_PIN"))||Te,r=(e.get("username")||"").trim(),s=await ot(t.env,"user:");if(s.length>0&&r){const l=s.find(c=>c.username===r&&c.password===a&&c.active!==!1);if(l){const c=encodeURIComponent(JSON.stringify({auth:1,userId:l._key,username:l.username,role:l.role,name:l.name}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${c}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Tt("Invalid credentials",s.length>0))}if(a===n){const l=encodeURIComponent(JSON.stringify({auth:1,userId:"admin",username:"admin",role:"admin",name:"Administrator"}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${l}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Tt("Wrong PIN",s.length>0))});m.get("/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"session=; Path=/; HttpOnly; Max-Age=0; SameSite=Strict",Location:"/login","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache","Clear-Site-Data":'"cache"'}}));function x(t){const a=(t.req.header("Cookie")||"").match(/session=([^;]+)/);if(!a)return null;try{return JSON.parse(decodeURIComponent(a[1]))}catch{return null}}m.use("*",async(t,e)=>{const a=new URL(t.req.url).pathname;if(a==="/login"&&t.req.method==="GET"){const d=await ot(t.env,"user:");return f(Tt("",d.length>0))}if(a==="/api/company-settings"&&t.req.method==="GET"){await e();return}if(!(new URL(t.req.url).searchParams.get("master")===Ce)){const d=new Date().toISOString().slice(0,10);if(d>Ae)return f(se());if(t.env.DATA_STORE){const p=await t.env.DATA_STORE.get("APP_LICENSE");if(p&&d>p)return f(se())}}if(a.startsWith("/sp-portal")){const p=(t.req.header("Cookie")||"").match(/sp_session=([^;]+)/);if(a==="/sp-portal/login"&&t.req.method==="GET"||!p&&a!=="/sp-portal/login")return f(Yt(""));await e();return}const s=x(t);if(!(s!=null&&s.auth)&&a!=="/login")return f(Tt("",!1));const o={admin:[],manager:["/users","/admin"],entry:["/users","/admin","/reports","/profit-loss","/balance-sheet","/trial-balance","/stock","/receivable-payable","/salesperson","/expense-ledger","/approvals","/company-settings"],viewer:["/inventory","/parties","/purchases","/sales","/payments","/expenses","/orders","/users","/admin","/salesperson","/approvals","/company-settings"]},l=(s==null?void 0:s.role)||"admin";if((o[l]||[]).includes(a))return f(k(`<div class="card"><div class="empty" style="padding:40px"><h3>Access Denied</h3><p class="text-muted">You don't have permission to access this page.</p><a href="/" class="btn btn-primary" style="margin-top:12px">Go to Dashboard</a></div></div>`,"dashboard",s));await e()});m.get("/api/license-info",async t=>{const a=(t.env.DATA_STORE?await t.env.DATA_STORE.get("APP_LICENSE"):null)||Ae,n=Math.floor((new Date(a).getTime()-Date.now())/864e5);return t.json({expiry:a,days:n,status:n<0?"Expired":"Active"})});m.post("/api/set-license",async t=>{if(new URL(t.req.url).searchParams.get("master")!==Ce)return t.json({success:!1,error:"Unauthorized"},403);const a=await t.req.json();return t.env.DATA_STORE?(await t.env.DATA_STORE.put("APP_LICENSE",String((a==null?void 0:a.date)||"")),t.json({success:!0})):t.json({success:!1,error:"KV not configured"},500)});m.post("/api/list",async t=>{const e=await t.req.json();return t.json(await ot(t.env,(e==null?void 0:e.prefix)||""))});const Ne=["product:","party:","sale:","purchase:","payment:","expense:","bank:","order:","salesperson:"];m.post("/api/save",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=await t.req.json(),a=(e==null?void 0:e.prefix)||"",n=e==null?void 0:e.id,r=e==null?void 0:e.key,s=(e==null?void 0:e.data)||{},o=(e==null?void 0:e.logAction)||"",l=(e==null?void 0:e.logDetail)||"",c=(e==null?void 0:e.skipApproval)===!0;let d=r;d||(n?d=n.startsWith(a)?n:a+n:d=a+W());const p=x(t),u=(p==null?void 0:p.role)==="entry",h=!!(r||n),w=Ne.some(P=>a&&a===P||d&&d.startsWith(P));if(u&&h&&w&&!c){const P="approval:"+W(),A=await t.env.DATA_STORE.get(d);return await t.env.DATA_STORE.put(P,JSON.stringify({type:"edit",targetKey:d,prefix:a,newData:s,oldData:A?JSON.parse(A):null,detail:l||"Edit: "+d,requestedBy:(p==null?void 0:p.name)||(p==null?void 0:p.username)||"Unknown",requestedAt:new Date().toISOString(),status:"pending"})),t.json({success:!0,key:d,pending:!0,message:"Your edit has been submitted for approval"})}if(await t.env.DATA_STORE.put(d,JSON.stringify(s)),o){const P="modlog:"+W();await t.env.DATA_STORE.put(P,JSON.stringify({action:o,detail:l,key:d,prefix:a,user:(p==null?void 0:p.name)||(p==null?void 0:p.username)||"System",timestamp:new Date().toISOString()}))}return t.json({success:!0,key:d})});m.post("/api/get",async t=>{if(!t.env.DATA_STORE)return t.json(null);const{key:e}=await t.req.json(),a=await t.env.DATA_STORE.get(e);return t.json(a?JSON.parse(a):null)});m.post("/api/delete",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=await t.req.json(),a=e==null?void 0:e.key,n=(e==null?void 0:e.logDetail)||"",r=(e==null?void 0:e.skipApproval)===!0;if(!a)return t.json({success:!1,error:"Key is required"},400);const s=x(t),o=(s==null?void 0:s.role)==="entry",l=Ne.some(p=>a.startsWith(p));if(o&&l&&!r){const p=await t.env.DATA_STORE.get(a),u="approval:"+W();return await t.env.DATA_STORE.put(u,JSON.stringify({type:"delete",targetKey:a,prefix:a.split(":")[0]+":",newData:null,oldData:p?JSON.parse(p):null,detail:n||"Delete: "+a,requestedBy:(s==null?void 0:s.name)||(s==null?void 0:s.username)||"Unknown",requestedAt:new Date().toISOString(),status:"pending"})),t.json({success:!0,pending:!0,message:"Your delete request has been submitted for approval"})}const c=await t.env.DATA_STORE.get(a);await t.env.DATA_STORE.delete(a);const d="modlog:"+W();return await t.env.DATA_STORE.put(d,JSON.stringify({action:"delete",detail:n||"Deleted key: "+a,key:a,oldData:c?c.substring(0,500):"",user:(s==null?void 0:s.name)||(s==null?void 0:s.username)||"System",timestamp:new Date().toISOString()})),t.json({success:!0})});m.post("/api/approval-list",async t=>t.json(await ot(t.env,"approval:")));m.post("/api/approval-action",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=x(t),a=(e==null?void 0:e.role)||"";if(a!=="admin"&&a!=="manager")return t.json({success:!1,error:"Only admin/manager can approve"},403);const{approvalKey:n,action:r}=await t.req.json();if(!n)return t.json({success:!1,error:"Approval key required"},400);const s=await t.env.DATA_STORE.get(n);if(!s)return t.json({success:!1,error:"Approval not found"},404);const o=JSON.parse(s);if(o.status!=="pending")return t.json({success:!1,error:"Already processed"},400);if(r==="approve"){if(o.type==="edit"&&o.targetKey&&o.newData){await t.env.DATA_STORE.put(o.targetKey,JSON.stringify(o.newData));const l="modlog:"+W();await t.env.DATA_STORE.put(l,JSON.stringify({action:"edit",detail:"Approved edit by "+o.requestedBy+": "+o.detail,key:o.targetKey,prefix:o.prefix,user:(e==null?void 0:e.name)||(e==null?void 0:e.username)||"System",timestamp:new Date().toISOString()}))}else if(o.type==="delete"&&o.targetKey){await t.env.DATA_STORE.delete(o.targetKey);const l="modlog:"+W();await t.env.DATA_STORE.put(l,JSON.stringify({action:"delete",detail:"Approved delete by "+o.requestedBy+": "+o.detail,key:o.targetKey,prefix:o.prefix,user:(e==null?void 0:e.name)||(e==null?void 0:e.username)||"System",timestamp:new Date().toISOString()}))}o.status="approved"}else o.status="rejected";return o.processedBy=(e==null?void 0:e.name)||(e==null?void 0:e.username)||"System",o.processedAt=new Date().toISOString(),await t.env.DATA_STORE.put(n,JSON.stringify(o)),t.json({success:!0,status:o.status})});m.get("/api/company-settings",async t=>{if(!t.env.DATA_STORE)return t.json({companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"});const e=await t.env.DATA_STORE.get("COMPANY_SETTINGS");return e?t.json(JSON.parse(e)):t.json({companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"})});m.post("/api/company-settings",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=x(t);if((e==null?void 0:e.role)!=="admin")return t.json({success:!1,error:"Only admin can change company settings"},403);const a=await t.req.json();return await t.env.DATA_STORE.put("COMPANY_SETTINGS",JSON.stringify(a)),t.json({success:!0})});m.post("/api/export-all",async t=>{const e=["product:","party:","sale:","purchase:","payment:","expense:","exphead:","expsubhead:","bank:","cb:","user:","order:","salesperson:","creditlimit:","prodgroup:","modlog:","approval:","companysettings:"],a={};for(const n of e)a[n]=await ot(t.env,n);return t.json(a)});m.post("/api/import-all",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=await t.req.json();let a=0;for(const[n,r]of Object.entries(e))if(Array.isArray(r))for(const s of r){const o=s._key||n+W(),l={...s};delete l._key,await t.env.DATA_STORE.put(o,JSON.stringify(l)),a++}return t.json({success:!0,count:a})});m.post("/api/change-pin",async t=>{var r;const{oldPin:e,newPin:a}=await t.req.json(),n=await((r=t.env.DATA_STORE)==null?void 0:r.get("APP_PIN"))||Te;return e!==n?t.json({success:!1,error:"Wrong current PIN"}):!a||a.length<4?t.json({success:!1,error:"PIN must be at least 4 characters"}):(await t.env.DATA_STORE.put("APP_PIN",a),t.json({success:!0}))});m.post("/api/kv-keys",async t=>{const{prefix:e}=await t.req.json();if(!t.env.DATA_STORE)return t.json([]);const a=await t.env.DATA_STORE.list({prefix:e||"",limit:100});return t.json(a.keys.map(n=>n.name))});m.post("/api/kv-get",async t=>{const{key:e}=await t.req.json();if(!t.env.DATA_STORE)return t.json({value:null});const a=await t.env.DATA_STORE.get(e);return t.json({value:a})});m.post("/api/kv-delete",async t=>{const{key:e}=await t.req.json();return t.env.DATA_STORE?(await t.env.DATA_STORE.delete(e),t.json({success:!0})):t.json({success:!1})});m.post("/sp-portal/login",async t=>{const e=await t.req.formData(),a=e.get("code"),n=e.get("pin"),s=(await ot(t.env,"salesperson:")).find(o=>o.code===a&&o.pin===n&&o.active!==!1);if(s){const o=encodeURIComponent(JSON.stringify({spId:s._key,spName:s.name,spCode:s.code}));return new Response(null,{status:302,headers:{"Set-Cookie":`sp_session=${o}; Path=/; HttpOnly; SameSite=Strict`,Location:"/sp-portal"}})}return f(Yt("Invalid credentials"))});m.get("/sp-portal/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"sp_session=; Path=/; HttpOnly; Max-Age=0",Location:"/sp-portal/login"}}));m.get("/",t=>f(k(ha(),"dashboard",x(t))));m.get("/inventory",t=>f(k(ga(),"inventory",x(t))));m.get("/stock-check",t=>f(k(xa(),"stockcheck",x(t))));m.get("/parties",t=>f(k(wa(),"parties",x(t))));m.get("/purchases",t=>f(k(ka(),"purchases",x(t))));m.get("/sales",t=>f(k(Pa(),"sales",x(t))));m.get("/payments",t=>f(k(Ea(),"payments",x(t))));m.get("/expenses",t=>f(k(Ia(),"expenses",x(t))));m.get("/ledger",t=>f(k(Sa(),"ledger",x(t))));m.get("/expense-ledger",t=>f(k(Ba(),"expledger",x(t))));m.get("/profit-loss",t=>f(k(Ta(),"profitloss",x(t))));m.get("/balance-sheet",t=>f(k(Ca(),"balancesheet",x(t))));m.get("/trial-balance",t=>f(k(Aa(),"trialbalance",x(t))));m.get("/stock",t=>f(k(Na(),"stock",x(t))));m.get("/receivable-payable",t=>f(k(_a(),"recpay",x(t))));m.get("/day-details",t=>f(k(Da(),"daydetails",x(t))));m.get("/reports",t=>f(k(La(),"reports",x(t))));m.get("/salesperson",t=>f(k(Oa(),"salesperson",x(t))));m.get("/orders",t=>f(k(Ra(),"orders",x(t))));m.get("/users",t=>f(k(Ma(),"users",x(t))));m.get("/admin",t=>f(k(ja(),"admin",x(t))));m.get("/mod-log",t=>f(k(qa(),"modlog",x(t))));m.get("/approvals",t=>f(k(Ha(),"approvals",x(t))));m.get("/company-settings",t=>f(k(za(),"companysettings",x(t))));m.get("/sp-portal",t=>f(fa(t)));m.get("/login",async t=>{const e=await ot(t.env,"user:");return f(Tt("",e.length>0))});function Ot(){return`<style>
...
<nav class="bottom-nav" id="bottomNav">
  <a href="/" class="bnav-item${e==="dashboard"?" active":""}"><span class="material-symbols-outlined bnav-icon">grid_view</span><span class="bnav-label">Home</span></a>
  <a href="/sales" class="bnav-item${e==="sales"?" active":""}"><span class="material-symbols-outlined bnav-icon">receipt_long</span><span class="bnav-label">Sales</span></a>
  <a href="/purchases" class="bnav-item${e==="purchases"?" active":""}"><span class="material-symbols-outlined bnav-icon">shopping_cart</span><span class="bnav-label">Purchase</span></a>
  <a href="/payments" class="bnav-item${e==="payments"?" active":""}"><span class="material-symbols-outlined bnav-icon">account_balance_wallet</span><span class="bnav-label">Accounts</span></a>
  <button class="bnav-item bnav-more" id="bnavMoreBtn" onclick="toggleBnavMore()"><span class="material-symbols-outlined bnav-icon">more_horiz</span><span class="bnav-label">More</span>
    <div class="bnav-more-menu" id="bnavMoreMenu">
      ${(function(){const d=[{group:"Main",items:[{p:"/day-details",i:"calendar_today",l:"Day Details",id:"daydetails"},{p:"/orders",i:"assignment",l:"Orders",id:"orders"},{p:"/stock-check",i:"checklist",l:"Stock Check",id:"stockcheck"}]},{group:"Inventory",items:[{p:"/inventory",i:"inventory_2",l:"Inventory",id:"inventory"},{p:"/parties",i:"groups",l:"Customers & Suppliers",id:"parties"}]},{group:"Finance",items:[{p:"/expenses",i:"payments",l:"Expenses",id:"expenses"}]},{group:"Reports",items:[{p:"/reports",i:"assessment",l:"Reports",id:"reports"},{p:"/ledger",i:"menu_book",l:"Ledger",id:"ledger"},{p:"/expense-ledger",i:"receipt",l:"Expense Ledger",id:"expledger"},{p:"/receivable-payable",i:"swap_horiz",l:"Receivable/Payable",id:"recpay"},{p:"/profit-loss",i:"trending_up",l:"Profit & Loss",id:"profitloss"},{p:"/balance-sheet",i:"account_balance",l:"Balance Sheet",id:"balancesheet"},{p:"/trial-balance",i:"balance",l:"Trial Balance",id:"trialbalance"},{p:"/stock",i:"warehouse",l:"Stock & Valuation",id:"stock"}]},{group:"System",items:[{p:"/users",i:"manage_accounts",l:"Users & Access",id:"users"},{p:"/salesperson",i:"badge",l:"Salesperson",id:"salesperson"},{p:"/approvals",i:"task_alt",l:"Approvals",id:"approvals"},{p:"/company-settings",i:"domain",l:"Company Settings",id:"companysettings"},{p:"/admin",i:"settings",l:"Admin",id:"admin"},{p:"/mod-log",i:"history",l:"Mod Log",id:"modlog"}]}];let p="";for(const u of d){const h=u.items.filter(w=>o.includes(w.id));if(h.length){p+='<div class="bnav-menu-group">'+u.group+"</div>";for(const w of h)p+='<a href="'+w.p+'"'+(e===w.id?' style="color:var(--primary);font-weight:700"':"")+'><span class="material-symbols-outlined">'+w.i+"</span>"+w.l+"</a>"}}return p+='<div class="bnav-menu-group">Other</div><a href="/sp-portal" target="_blank"><span class="material-symbols-outlined">storefront</span>SP Portal</a><a href="/logout" style="color:var(--danger)"><span class="material-symbols-outlined">logout</span>Logout</a>',p})()}
    </div>
  </button>
</nav>
...
(function(){
  ...
  if(mhTitle&&titleMap['${e}'])mhTitle.textContent=titleMap['${e}'];
})();
...
<\/script>
</body></html>`}function Tt(t,e=!1){return`<!doctype html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,viewport-fit=cover">
...
<div><h2 style="margin:0">Salesperson Portal</h2><p class="text-muted" style="margin:4px 0 0">Welcome, <b>${ct(s)}</b> (${ct(o)})</p></div>
...
<\/script></body></html>`}function ha(){var t=new Date().toISOString().slice(0,10),e=t.slice(0,7);return`
...
var receivables=0;customers.forEach(function(c){var cs=sales.filter(function(s){return s.customerId===c._key});var cr=payments.filter(function(p){return(p.party===c.name)&&p.type==='receipt'&&p.status==='done'&&!p._autoInvoice&&!(p.billKeys&&p.billKeys.length)});var td=cs.reduce(function(s,x){return s+(x.total||0)},0);var tr=cs.reduce(function(s,x){return s+(x.paid||0)},0)+cr.reduce(function(s,x){return s+(x.amount||0)},0);receivables+=Math.max(0,td-tr)});
var payables=0;suppliers.forEach(function(s){var sp=purchases.filter(function(p){return p.supplierId===s._key});var py=payments.filter(function(p){return p.party===s.name&&p.type==='payment'&&p.status==='done'&&!p._autoInvoice&&!(p.billKeys&&p.billKeys.length)});var td=sp.reduce(function(a,x){return a+(x.total||0)},0);var tp=sp.reduce(function(a,x){return a+(x.paid||0)},0)+py.reduce(function(a,x){return a+(x.amount||0)},0);payables+=Math.max(0,td-tp)});
...
var receivables=0;parties.filter(function(p){return p.type==='customer'}).forEach(function(c){var cs=sales.filter(function(s){return s.customerId===c._key});var cr=payments.filter(function(p){return p.party===c.name&&p.type==='receipt'&&p.status==='done'&&!p._autoInvoice&&!(p.billKeys&&p.billKeys.length)});var td=cs.reduce(function(s,x){return s+(x.total||0)},0);var tr=cs.reduce(function(s,x){return s+(x.paid||0)},0)+cr.reduce(function(s,x){return s+(x.amount||0)},0);receivables+=Math.max(0,td-tr)});
var bankBal=banks.reduce(function(s,b){return s+(b.balance||b.openingBalance||0)},0);
...
var payables=0;parties.filter(function(p){return p.type==='supplier'}).forEach(function(s){var sp=purchases.filter(function(p){return p.supplierId===s._key});var py=payments.filter(function(p){return p.party===s.name&&p.type==='payment'&&p.status==='done'&&!p._autoInvoice&&!(p.billKeys&&p.billKeys.length)});var td=sp.reduce(function(a,x){return a+(x.total||0)},0);var tp=sp.reduce(function(a,x){return a+(x.paid||0)},0)+py.reduce(function(a,x){return a+(x.amount||0)},0);payables+=Math.max(0,td-tp)});
...
var receivables=0;parties.filter(function(p){return p.type==='customer'}).forEach(function(c){var cs=sales.filter(function(s){return s.customerId===c._key});var cr=payments.filter(function(p){return p.party===c.name&&p.type==='receipt'&&p.status==='done'&&!p._autoInvoice&&!(p.billKeys&&p.billKeys.length)});var td=cs.reduce(function(s,x){return s+(x.total||0)},0);var tr=cs.reduce(function(s,x){return s+(x.paid||0)},0)+cr.reduce(function(s,x){return s+(x.amount||0)},0);receivables+=Math.max(0,td-tr)});accounts.push({name:'Accounts Receivable',debit:receivables,credit:0});
var payables=0;parties.filter(function(p){return p.type==='supplier'}).forEach(function(s){var sp=purchases.filter(function(p){return p.supplierId===s._key});var py=payments.filter(function(p){return p.party===s.name&&p.type==='payment'&&p.status==='done'&&!p._autoInvoice&&!(p.billKeys&&p.billKeys.length)});var td=sp.reduce(function(a,x){return a+(x.total||0)},0);var tp=sp.reduce(function(a,x){return a+(x.paid||0)},0)+py.reduce(function(a,x){return a+(x.amount||0)},0);payables+=Math.max(0,td-tp)});accounts.push({name:'Accounts Payable',debit:0,credit:payables});
...
loadCS();
<\/script>`}const re=new Be,Fa=Object.assign({"/src/index.tsx":m});let _e=!1;for(const[,t]of Object.entries(Fa))t&&(re.all("*",e=>{let a;try{a=e.executionCtx}catch{}return t.fetch(e.req.raw,e.env,a)}),re.notFound(e=>{let a;try{a=e.executionCtx}catch{}return t.fetch(e.req.raw,e.env,a)}),_e=!0);if(!_e)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{re as default};

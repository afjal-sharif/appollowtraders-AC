var te=Object.defineProperty;var dt=a=>{throw TypeError(a)};var ee=(a,t,e)=>t in a?te(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var v=(a,t,e)=>ee(a,typeof t!="symbol"?t+"":t,e),Ya=(a,t,e)=>t.has(a)||dt("Cannot "+e);var c=(a,t,e)=>(Ya(a,t,"read from private field"),e?e.call(a):t.get(a)),b=(a,t,e)=>t.has(a)?dt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(Ya(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),k=(a,t,e)=>(Ya(a,t,"access private method"),e);var ct=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return c(a,t,r)}});var pt=(a,t,e)=>(r,i)=>{let n=-1;return s(0);async function s(l){if(l<=n)throw new Error("next() called multiple times");n=l;let o,d=!1,p;if(a[l]?(p=a[l][0][0],r.req.routeIndex=l):p=l===a.length&&i||void 0,p)try{o=await p(r,()=>s(l+1))}catch(u){if(u instanceof Error&&t)r.error=u,o=await t(u,r),d=!0;else throw u}else r.finalized===!1&&e&&(o=await e(r));return o&&(r.finalized===!1||d)&&(r.res=o),r}},re=Symbol(),ne=async(a,t=Object.create(null))=>{const{all:e=!1,dot:r=!1}=t,n=(a instanceof It?a.raw.headers:a.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?ie(a,{all:e,dot:r}):{}};async function ie(a,t){const e=await a.formData();return e?se(e,t):{}}function se(a,t){const e=Object.create(null);return a.forEach((r,i)=>{t.all||i.endsWith("[]")?oe(e,i,r):e[i]=r}),t.dot&&Object.entries(e).forEach(([r,i])=>{r.includes(".")&&(le(e,r,i),delete e[r])}),e}var oe=(a,t,e)=>{a[t]!==void 0?Array.isArray(a[t])?a[t].push(e):a[t]=[a[t],e]:t.endsWith("[]")?a[t]=[e]:a[t]=e},le=(a,t,e)=>{if(/(?:^|\.)__proto__\./.test(t))return;let r=a;const i=t.split(".");i.forEach((n,s)=>{s===i.length-1?r[n]=e:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},St=a=>{const t=a.split("/");return t[0]===""&&t.shift(),t},de=a=>{const{groups:t,path:e}=ce(a),r=St(e);return pe(r,t)},ce=a=>{const t=[];return a=a.replace(/\{[^}]+\}/g,(e,r)=>{const i=`@${r}`;return t.push([i,e]),i}),{groups:t,path:a}},pe=(a,t)=>{for(let e=t.length-1;e>=0;e--){const[r]=t[e];for(let i=a.length-1;i>=0;i--)if(a[i].includes(r)){a[i]=a[i].replace(r,t[e][1]);break}}return a},za={},ue=(a,t)=>{if(a==="*")return"*";const e=a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(e){const r=`${a}#${t}`;return za[r]||(e[2]?za[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,e[1],new RegExp(`^${e[2]}(?=/${t})`)]:[a,e[1],new RegExp(`^${e[2]}$`)]:za[r]=[a,e[1],!0]),za[r]}return null},et=(a,t)=>{try{return t(a)}catch{return a.replace(/(?:%[0-9A-Fa-f]{2})+/g,e=>{try{return t(e)}catch{return e}})}},he=a=>et(a,decodeURI),wt=a=>{const t=a.url,e=t.indexOf("/",t.indexOf(":")+4);let r=e;for(;r<t.length;r++){const i=t.charCodeAt(r);if(i===37){const n=t.indexOf("?",r),s=t.indexOf("#",r),l=n===-1?s===-1?void 0:s:s===-1?n:Math.min(n,s),o=t.slice(e,l);return he(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(i===63||i===35)break}return t.slice(e,r)},me=a=>{const t=wt(a);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ua=(a,t,...e)=>(e.length&&(t=ua(t,...e)),`${(a==null?void 0:a[0])==="/"?"":"/"}${a}${t==="/"?"":`${(a==null?void 0:a.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Bt=a=>{if(a.charCodeAt(a.length-1)!==63||!a.includes(":"))return null;const t=a.split("/"),e=[];let r="";return t.forEach(i=>{if(i!==""&&!/\:/.test(i))r+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){e.length===0&&r===""?e.push("/"):e.push(r);const n=i.replace("?","");r+="/"+n,e.push(r)}else r+="/"+i}),e.filter((i,n,s)=>s.indexOf(i)===n)},Wa=a=>/[%+]/.test(a)?(a.indexOf("+")!==-1&&(a=a.replace(/\+/g," ")),a.indexOf("%")!==-1?et(a,Pt):a):a,Ct=(a,t,e)=>{let r;if(!e&&t&&!/[%+]/.test(t)){let s=a.indexOf("?",8);if(s===-1)return;for(a.startsWith(t,s+1)||(s=a.indexOf(`&${t}`,s+1));s!==-1;){const l=a.charCodeAt(s+t.length+1);if(l===61){const o=s+t.length+2,d=a.indexOf("&",o);return Wa(a.slice(o,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";s=a.indexOf(`&${t}`,s+1)}if(r=/[%+]/.test(a),!r)return}const i={};r??(r=/[%+]/.test(a));let n=a.indexOf("?",8);for(;n!==-1;){const s=a.indexOf("&",n+1);let l=a.indexOf("=",n);l>s&&s!==-1&&(l=-1);let o=a.slice(n+1,l===-1?s===-1?void 0:s:l);if(r&&(o=Wa(o)),n=s,o==="")continue;let d;l===-1?d="":(d=a.slice(l+1,s===-1?void 0:s),r&&(d=Wa(d))),e?(i[o]&&Array.isArray(i[o])||(i[o]=[]),i[o].push(d)):i[o]??(i[o]=d)}return t?i[t]:i},ge=Ct,ve=(a,t)=>Ct(a,t,!0),Pt=decodeURIComponent,ut=a=>et(a,Pt),ga,M,J,Et,Tt,at,U,vt,It=(vt=class{constructor(a,t="/",e=[[]]){b(this,J);v(this,"raw");b(this,ga);b(this,M);v(this,"routeIndex",0);v(this,"path");v(this,"bodyCache",{});b(this,U,a=>{const{bodyCache:t,raw:e}=this,r=t[a];if(r)return r;const i=Object.keys(t)[0];return i?t[i].then(n=>(i==="json"&&(n=JSON.stringify(n)),new Response(n)[a]())):t[a]=e[a]()});this.raw=a,this.path=t,m(this,M,e),m(this,ga,{})}param(a){return a?k(this,J,Et).call(this,a):k(this,J,Tt).call(this)}query(a){return ge(this.url,a)}queries(a){return ve(this.url,a)}header(a){if(a)return this.raw.headers.get(a)??void 0;const t={};return this.raw.headers.forEach((e,r)=>{t[r]=e}),t}async parseBody(a){return ne(this,a)}json(){return c(this,U).call(this,"text").then(a=>JSON.parse(a))}text(){return c(this,U).call(this,"text")}arrayBuffer(){return c(this,U).call(this,"arrayBuffer")}blob(){return c(this,U).call(this,"blob")}formData(){return c(this,U).call(this,"formData")}addValidatedData(a,t){c(this,ga)[a]=t}valid(a){return c(this,ga)[a]}get url(){return this.raw.url}get method(){return this.raw.method}get[re](){return c(this,M)}get matchedRoutes(){return c(this,M)[0].map(([[,a]])=>a)}get routePath(){return c(this,M)[0].map(([[,a]])=>a)[this.routeIndex].path}},ga=new WeakMap,M=new WeakMap,J=new WeakSet,Et=function(a){const t=c(this,M)[0][this.routeIndex][1][a],e=k(this,J,at).call(this,t);return e&&/\%/.test(e)?ut(e):e},Tt=function(){const a={},t=Object.keys(c(this,M)[0][this.routeIndex][1]);for(const e of t){const r=k(this,J,at).call(this,c(this,M)[0][this.routeIndex][1][e]);r!==void 0&&(a[e]=/\%/.test(r)?ut(r):r)}return a},at=function(a){return c(this,M)[1]?c(this,M)[1][a]:a},U=new WeakMap,vt),be={Stringify:1},Dt=async(a,t,e,r,i)=>{typeof a=="object"&&!(a instanceof String)&&(a instanceof Promise||(a=a.toString()),a instanceof Promise&&(a=await a));const n=a.callbacks;return n!=null&&n.length?(i?i[0]+=a:i=[a],Promise.all(n.map(l=>l({phase:t,buffer:i,context:r}))).then(l=>Promise.all(l.filter(Boolean).map(o=>Dt(o,t,!1,r,i))).then(()=>i[0]))):Promise.resolve(a)},fe="text/plain; charset=UTF-8",Za=(a,t)=>({"Content-Type":a,...t}),Pa=(a,t)=>new Response(a,t),Ra,Ma,z,va,H,N,Aa,ba,fa,aa,_a,La,V,ha,bt,ye=(bt=class{constructor(a,t){b(this,V);b(this,Ra);b(this,Ma);v(this,"env",{});b(this,z);v(this,"finalized",!1);v(this,"error");b(this,va);b(this,H);b(this,N);b(this,Aa);b(this,ba);b(this,fa);b(this,aa);b(this,_a);b(this,La);v(this,"render",(...a)=>(c(this,ba)??m(this,ba,t=>this.html(t)),c(this,ba).call(this,...a)));v(this,"setLayout",a=>m(this,Aa,a));v(this,"getLayout",()=>c(this,Aa));v(this,"setRenderer",a=>{m(this,ba,a)});v(this,"header",(a,t,e)=>{this.finalized&&m(this,N,Pa(c(this,N).body,c(this,N)));const r=c(this,N)?c(this,N).headers:c(this,aa)??m(this,aa,new Headers);t===void 0?r.delete(a):e!=null&&e.append?r.append(a,t):r.set(a,t)});v(this,"status",a=>{m(this,va,a)});v(this,"set",(a,t)=>{c(this,z)??m(this,z,new Map),c(this,z).set(a,t)});v(this,"get",a=>c(this,z)?c(this,z).get(a):void 0);v(this,"newResponse",(...a)=>k(this,V,ha).call(this,...a));v(this,"body",(a,t,e)=>k(this,V,ha).call(this,a,t,e));v(this,"text",(a,t,e)=>!c(this,aa)&&!c(this,va)&&!t&&!e&&!this.finalized?new Response(a):k(this,V,ha).call(this,a,t,Za(fe,e)));v(this,"json",(a,t,e)=>k(this,V,ha).call(this,JSON.stringify(a),t,Za("application/json",e)));v(this,"html",(a,t,e)=>{const r=i=>k(this,V,ha).call(this,i,t,Za("text/html; charset=UTF-8",e));return typeof a=="object"?Dt(a,be.Stringify,!1,{}).then(r):r(a)});v(this,"redirect",(a,t)=>{const e=String(a);return this.header("Location",/[^\x00-\xFF]/.test(e)?encodeURI(e):e),this.newResponse(null,t??302)});v(this,"notFound",()=>(c(this,fa)??m(this,fa,()=>Pa()),c(this,fa).call(this,this)));m(this,Ra,a),t&&(m(this,H,t.executionCtx),this.env=t.env,m(this,fa,t.notFoundHandler),m(this,La,t.path),m(this,_a,t.matchResult))}get req(){return c(this,Ma)??m(this,Ma,new It(c(this,Ra),c(this,La),c(this,_a))),c(this,Ma)}get event(){if(c(this,H)&&"respondWith"in c(this,H))return c(this,H);throw Error("This context has no FetchEvent")}get executionCtx(){if(c(this,H))return c(this,H);throw Error("This context has no ExecutionContext")}get res(){return c(this,N)||m(this,N,Pa(null,{headers:c(this,aa)??m(this,aa,new Headers)}))}set res(a){if(c(this,N)&&a){a=Pa(a.body,a);for(const[t,e]of c(this,N).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=c(this,N).headers.getSetCookie();a.headers.delete("set-cookie");for(const i of r)a.headers.append("set-cookie",i)}else a.headers.set(t,e)}m(this,N,a),this.finalized=!0}get var(){return c(this,z)?Object.fromEntries(c(this,z)):{}}},Ra=new WeakMap,Ma=new WeakMap,z=new WeakMap,va=new WeakMap,H=new WeakMap,N=new WeakMap,Aa=new WeakMap,ba=new WeakMap,fa=new WeakMap,aa=new WeakMap,_a=new WeakMap,La=new WeakMap,V=new WeakSet,ha=function(a,t,e){const r=c(this,N)?new Headers(c(this,N).headers):c(this,aa)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[s,l]of n)s.toLowerCase()==="set-cookie"?r.append(s,l):r.set(s,l)}if(e)for(const[n,s]of Object.entries(e))if(typeof s=="string")r.set(n,s);else{r.delete(n);for(const l of s)r.append(n,l)}const i=typeof t=="number"?t:(t==null?void 0:t.status)??c(this,va);return Pa(a,{status:i,headers:r})},bt),I="ALL",xe="all",ke=["get","post","put","delete","options","patch"],jt="Can not add a route since the matcher is already built.",Nt=class extends Error{},Se="__COMPOSED_HANDLER",we=a=>a.text("404 Not Found",404),ht=(a,t)=>{if("getResponse"in a){const e=a.getResponse();return t.newResponse(e.body,e)}return console.error(a),t.text("Internal Server Error",500)},A,E,Rt,_,W,Ha,Ga,ya,Be=(ya=class{constructor(t={}){b(this,E);v(this,"get");v(this,"post");v(this,"put");v(this,"delete");v(this,"options");v(this,"patch");v(this,"all");v(this,"on");v(this,"use");v(this,"router");v(this,"getPath");v(this,"_basePath","/");b(this,A,"/");v(this,"routes",[]);b(this,_,we);v(this,"errorHandler",ht);v(this,"onError",t=>(this.errorHandler=t,this));v(this,"notFound",t=>(m(this,_,t),this));v(this,"fetch",(t,...e)=>k(this,E,Ga).call(this,t,e[1],e[0],t.method));v(this,"request",(t,e,r,i)=>t instanceof Request?this.fetch(e?new Request(t,e):t,r,i):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ua("/",t)}`,e),r,i)));v(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(k(this,E,Ga).call(this,t.request,t,void 0,t.request.method))})});[...ke,xe].forEach(n=>{this[n]=(s,...l)=>(typeof s=="string"?m(this,A,s):k(this,E,W).call(this,n,c(this,A),s),l.forEach(o=>{k(this,E,W).call(this,n,c(this,A),o)}),this)}),this.on=(n,s,...l)=>{for(const o of[s].flat()){m(this,A,o);for(const d of[n].flat())l.map(p=>{k(this,E,W).call(this,d.toUpperCase(),c(this,A),p)})}return this},this.use=(n,...s)=>(typeof n=="string"?m(this,A,n):(m(this,A,"*"),s.unshift(n)),s.forEach(l=>{k(this,E,W).call(this,I,c(this,A),l)}),this);const{strict:r,...i}=t;Object.assign(this,i),this.getPath=r??!0?t.getPath??wt:me}route(t,e){const r=this.basePath(t);return e.routes.map(i=>{var s;let n;e.errorHandler===ht?n=i.handler:(n=async(l,o)=>(await pt([],e.errorHandler)(l,()=>i.handler(l,o))).res,n[Se]=i.handler),k(s=r,E,W).call(s,i.method,i.path,n)}),this}basePath(t){const e=k(this,E,Rt).call(this);return e._basePath=ua(this._basePath,t),e}mount(t,e,r){let i,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?i=o=>o:i=r.replaceRequest));const s=n?o=>{const d=n(o);return Array.isArray(d)?d:[d]}:o=>{let d;try{d=o.executionCtx}catch{}return[o.env,d]};i||(i=(()=>{const o=ua(this._basePath,t),d=o==="/"?0:o.length;return p=>{const u=new URL(p.url);return u.pathname=u.pathname.slice(d)||"/",new Request(u,p)}})());const l=async(o,d)=>{const p=await e(i(o.req.raw),...s(o));if(p)return p;await d()};return k(this,E,W).call(this,I,ua(t,"*"),l),this}},A=new WeakMap,E=new WeakSet,Rt=function(){const t=new ya({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,m(t,_,c(this,_)),t.routes=this.routes,t},_=new WeakMap,W=function(t,e,r){t=t.toUpperCase(),e=ua(this._basePath,e);const i={basePath:this._basePath,path:e,method:t,handler:r};this.router.add(t,e,[r,i]),this.routes.push(i)},Ha=function(t,e){if(t instanceof Error)return this.errorHandler(t,e);throw t},Ga=function(t,e,r,i){if(i==="HEAD")return(async()=>new Response(null,await k(this,E,Ga).call(this,t,e,r,"GET")))();const n=this.getPath(t,{env:r}),s=this.router.match(i,n),l=new ye(t,{path:n,matchResult:s,env:r,executionCtx:e,notFoundHandler:c(this,_)});if(s[0].length===1){let d;try{d=s[0][0][0][0](l,async()=>{l.res=await c(this,_).call(this,l)})}catch(p){return k(this,E,Ha).call(this,p,l)}return d instanceof Promise?d.then(p=>p||(l.finalized?l.res:c(this,_).call(this,l))).catch(p=>k(this,E,Ha).call(this,p,l)):d??c(this,_).call(this,l)}const o=pt(s[0],this.errorHandler,c(this,_));return(async()=>{try{const d=await o(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return k(this,E,Ha).call(this,d,l)}})()},ya),Mt=[];function Ce(a,t){const e=this.buildAllMatchers(),r=((i,n)=>{const s=e[i]||e[I],l=s[2][n];if(l)return l;const o=n.match(s[0]);if(!o)return[[],Mt];const d=o.indexOf("",1);return[s[1][d],o]});return this.match=r,r(a,t)}var Ja="[^/]+",Ea=".*",Ta="(?:|/.*)",ma=Symbol(),Pe=new Set(".\\+*[^]$()");function Ie(a,t){return a.length===1?t.length===1?a<t?-1:1:-1:t.length===1||a===Ea||a===Ta?1:t===Ea||t===Ta?-1:a===Ja?1:t===Ja?-1:a.length===t.length?a<t?-1:1:t.length-a.length}var ta,ea,L,ia,Ee=(ia=class{constructor(){b(this,ta);b(this,ea);b(this,L,Object.create(null))}insert(t,e,r,i,n){if(t.length===0){if(c(this,ta)!==void 0)throw ma;if(n)return;m(this,ta,e);return}const[s,...l]=t,o=s==="*"?l.length===0?["","",Ea]:["","",Ja]:s==="/*"?["","",Ta]:s.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(o){const p=o[1];let u=o[2]||Ja;if(p&&o[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ma;if(d=c(this,L)[u],!d){if(Object.keys(c(this,L)).some(g=>g!==Ea&&g!==Ta))throw ma;if(n)return;d=c(this,L)[u]=new ia,p!==""&&m(d,ea,i.varIndex++)}!n&&p!==""&&r.push([p,c(d,ea)])}else if(d=c(this,L)[s],!d){if(Object.keys(c(this,L)).some(p=>p.length>1&&p!==Ea&&p!==Ta))throw ma;if(n)return;d=c(this,L)[s]=new ia}d.insert(l,e,r,i,n)}buildRegExpStr(){const e=Object.keys(c(this,L)).sort(Ie).map(r=>{const i=c(this,L)[r];return(typeof c(i,ea)=="number"?`(${r})@${c(i,ea)}`:Pe.has(r)?`\\${r}`:r)+i.buildRegExpStr()});return typeof c(this,ta)=="number"&&e.unshift(`#${c(this,ta)}`),e.length===0?"":e.length===1?e[0]:"(?:"+e.join("|")+")"}},ta=new WeakMap,ea=new WeakMap,L=new WeakMap,ia),Va,Ka,ft,Te=(ft=class{constructor(){b(this,Va,{varIndex:0});b(this,Ka,new Ee)}insert(a,t,e){const r=[],i=[];for(let s=0;;){let l=!1;if(a=a.replace(/\{[^}]+\}/g,o=>{const d=`@\\${s}`;return i[s]=[d,o],s++,l=!0,d}),!l)break}const n=a.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let s=i.length-1;s>=0;s--){const[l]=i[s];for(let o=n.length-1;o>=0;o--)if(n[o].indexOf(l)!==-1){n[o]=n[o].replace(l,i[s][1]);break}}return c(this,Ka).insert(n,t,r,c(this,Va),e),r}buildRegExp(){let a=c(this,Ka).buildRegExpStr();if(a==="")return[/^$/,[],[]];let t=0;const e=[],r=[];return a=a.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,n,s)=>n!==void 0?(e[++t]=Number(n),"$()"):(s!==void 0&&(r[Number(s)]=++t),"")),[new RegExp(`^${a}`),e,r]}},Va=new WeakMap,Ka=new WeakMap,ft),De=[/^$/,[],Object.create(null)],qa=Object.create(null);function At(a){return qa[a]??(qa[a]=new RegExp(a==="*"?"":`^${a.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,e)=>e?`\\${e}`:"(?:|/.*)")}$`))}function je(){qa=Object.create(null)}function Ne(a){var d;const t=new Te,e=[];if(a.length===0)return De;const r=a.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,u],[g,y])=>p?1:g?-1:u.length-y.length),i=Object.create(null);for(let p=0,u=-1,g=r.length;p<g;p++){const[y,S,P]=r[p];y?i[S]=[P.map(([w])=>[w,Object.create(null)]),Mt]:u++;let T;try{T=t.insert(S,u,y)}catch(w){throw w===ma?new Nt(S):w}y||(e[u]=P.map(([w,C])=>{const R=Object.create(null);for(C-=1;C>=0;C--){const[F,wa]=T[C];R[F]=wa}return[w,R]}))}const[n,s,l]=t.buildRegExp();for(let p=0,u=e.length;p<u;p++)for(let g=0,y=e[p].length;g<y;g++){const S=(d=e[p][g])==null?void 0:d[1];if(!S)continue;const P=Object.keys(S);for(let T=0,w=P.length;T<w;T++)S[P[T]]=l[S[P[T]]]}const o=[];for(const p in s)o[p]=e[s[p]];return[n,o,i]}function ca(a,t){if(a){for(const e of Object.keys(a).sort((r,i)=>i.length-r.length))if(At(e).test(t))return[...a[e]]}}var X,$,Xa,_t,yt,Re=(yt=class{constructor(){b(this,Xa);v(this,"name","RegExpRouter");b(this,X);b(this,$);v(this,"match",Ce);m(this,X,{[I]:Object.create(null)}),m(this,$,{[I]:Object.create(null)})}add(a,t,e){var l;const r=c(this,X),i=c(this,$);if(!r||!i)throw new Error(jt);r[a]||[r,i].forEach(o=>{o[a]=Object.create(null),Object.keys(o[I]).forEach(d=>{o[a][d]=[...o[I][d]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=At(t);a===I?Object.keys(r).forEach(d=>{var p;(p=r[d])[t]||(p[t]=ca(r[d],t)||ca(r[I],t)||[])}):(l=r[a])[t]||(l[t]=ca(r[a],t)||ca(r[I],t)||[]),Object.keys(r).forEach(d=>{(a===I||a===d)&&Object.keys(r[d]).forEach(p=>{o.test(p)&&r[d][p].push([e,n])})}),Object.keys(i).forEach(d=>{(a===I||a===d)&&Object.keys(i[d]).forEach(p=>o.test(p)&&i[d][p].push([e,n]))});return}const s=Bt(t)||[t];for(let o=0,d=s.length;o<d;o++){const p=s[o];Object.keys(i).forEach(u=>{var g;(a===I||a===u)&&((g=i[u])[p]||(g[p]=[...ca(r[u],p)||ca(r[I],p)||[]]),i[u][p].push([e,n-d+o+1]))})}}buildAllMatchers(){const a=Object.create(null);return Object.keys(c(this,$)).concat(Object.keys(c(this,X))).forEach(t=>{a[t]||(a[t]=k(this,Xa,_t).call(this,t))}),m(this,X,m(this,$,void 0)),je(),a}},X=new WeakMap,$=new WeakMap,Xa=new WeakSet,_t=function(a){const t=[];let e=a===I;return[c(this,X),c(this,$)].forEach(r=>{const i=r[a]?Object.keys(r[a]).map(n=>[n,r[a][n]]):[];i.length!==0?(e||(e=!0),t.push(...i)):a!==I&&t.push(...Object.keys(r[I]).map(n=>[n,r[I][n]]))}),e?Ne(t):null},yt),Q,G,xt,Me=(xt=class{constructor(a){v(this,"name","SmartRouter");b(this,Q,[]);b(this,G,[]);m(this,Q,a.routers)}add(a,t,e){if(!c(this,G))throw new Error(jt);c(this,G).push([a,t,e])}match(a,t){if(!c(this,G))throw new Error("Fatal error");const e=c(this,Q),r=c(this,G),i=e.length;let n=0,s;for(;n<i;n++){const l=e[n];try{for(let o=0,d=r.length;o<d;o++)l.add(...r[o]);s=l.match(a,t)}catch(o){if(o instanceof Nt)continue;throw o}this.match=l.match.bind(l),m(this,Q,[l]),m(this,G,void 0);break}if(n===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,s}get activeRouter(){if(c(this,G)||c(this,Q).length!==1)throw new Error("No active router has been determined yet.");return c(this,Q)[0]}},Q=new WeakMap,G=new WeakMap,xt),Ia=Object.create(null),Ae=a=>{for(const t in a)return!0;return!1},Y,j,ra,xa,D,q,Z,ka,_e=(ka=class{constructor(t,e,r){b(this,q);b(this,Y);b(this,j);b(this,ra);b(this,xa,0);b(this,D,Ia);if(m(this,j,r||Object.create(null)),m(this,Y,[]),t&&e){const i=Object.create(null);i[t]={handler:e,possibleKeys:[],score:0},m(this,Y,[i])}m(this,ra,[])}insert(t,e,r){m(this,xa,++ct(this,xa)._);let i=this;const n=de(e),s=[];for(let l=0,o=n.length;l<o;l++){const d=n[l],p=n[l+1],u=ue(d,p),g=Array.isArray(u)?u[0]:d;if(g in c(i,j)){i=c(i,j)[g],u&&s.push(u[1]);continue}c(i,j)[g]=new ka,u&&(c(i,ra).push(u),s.push(u[1])),i=c(i,j)[g]}return c(i,Y).push({[t]:{handler:r,possibleKeys:s.filter((l,o,d)=>d.indexOf(l)===o),score:c(this,xa)}}),i}search(t,e){var p;const r=[];m(this,D,Ia);let n=[this];const s=St(e),l=[],o=s.length;let d=null;for(let u=0;u<o;u++){const g=s[u],y=u===o-1,S=[];for(let T=0,w=n.length;T<w;T++){const C=n[T],R=c(C,j)[g];R&&(m(R,D,c(C,D)),y?(c(R,j)["*"]&&k(this,q,Z).call(this,r,c(R,j)["*"],t,c(C,D)),k(this,q,Z).call(this,r,R,t,c(C,D))):S.push(R));for(let F=0,wa=c(C,ra).length;F<wa;F++){const Oa=c(C,ra)[F],K=c(C,D)===Ia?{}:{...c(C,D)};if(Oa==="*"){const la=c(C,j)["*"];la&&(k(this,q,Z).call(this,r,la,t,c(C,D)),m(la,D,K),S.push(la));continue}const[oa,lt,Ba]=Oa;if(!g&&!(Ba instanceof RegExp))continue;const O=c(C,j)[oa];if(Ba instanceof RegExp){if(d===null){d=new Array(o);let da=e[0]==="/"?1:0;for(let Ca=0;Ca<o;Ca++)d[Ca]=da,da+=s[Ca].length+1}const la=e.substring(d[u]),Qa=Ba.exec(la);if(Qa){if(K[lt]=Qa[0],k(this,q,Z).call(this,r,O,t,c(C,D),K),Ae(c(O,j))){m(O,D,K);const da=((p=Qa[0].match(/\//))==null?void 0:p.length)??0;(l[da]||(l[da]=[])).push(O)}continue}}(Ba===!0||Ba.test(g))&&(K[lt]=g,y?(k(this,q,Z).call(this,r,O,t,K,c(C,D)),c(O,j)["*"]&&k(this,q,Z).call(this,r,c(O,j)["*"],t,K,c(C,D))):(m(O,D,K),S.push(O)))}}const P=l.shift();n=P?S.concat(P):S}return r.length>1&&r.sort((u,g)=>u.score-g.score),[r.map(({handler:u,params:g})=>[u,g])]}},Y=new WeakMap,j=new WeakMap,ra=new WeakMap,xa=new WeakMap,D=new WeakMap,q=new WeakSet,Z=function(t,e,r,i,n){for(let s=0,l=c(e,Y).length;s<l;s++){const o=c(e,Y)[s],d=o[r]||o[I],p={};if(d!==void 0&&(d.params=Object.create(null),t.push(d),i!==Ia||n&&n!==Ia))for(let u=0,g=d.possibleKeys.length;u<g;u++){const y=d.possibleKeys[u],S=p[d.score];d.params[y]=n!=null&&n[y]&&!S?n[y]:i[y]??(n==null?void 0:n[y]),p[d.score]=!0}}},ka),na,kt,Le=(kt=class{constructor(){v(this,"name","TrieRouter");b(this,na);m(this,na,new _e)}add(a,t,e){const r=Bt(t);if(r){for(let i=0,n=r.length;i<n;i++)c(this,na).insert(a,r[i],e);return}c(this,na).insert(a,t,e)}match(a,t){return c(this,na).search(a,t)}},na=new WeakMap,kt),Lt=class extends Be{constructor(a={}){super(a),this.router=a.router??new Me({routers:[new Re,new Le]})}};const sa={"product:":"products","party:":"parties","sale:":"sales","purchase:":"purchases","payment:":"payments","expense:":"expenses","exphead:":"exp_heads","expsubhead:":"exp_subheads","bank:":"banks","cb:":"cb","user:":"users","order:":"orders","salesperson:":"salespersons","creditlimit:":"credit_limits","prodgroup:":"prod_groups","prodbrand:":"prod_brands","modlog:":"mod_logs","approval:":"approvals","thanafare:":"thana_fares"},rt={sales:"sale_items",purchases:"purchase_items",orders:"order_items"},Kt={products:{purchasePrice:"purchase_price",salePrice:"sale_price",extraData:"extra_data"},parties:{postOffice:"post_office",openingBalance:"opening_balance",creditLimit:"credit_limit",salespersonId:"salesperson_id",salespersonName:"salesperson_name",extraData:"extra_data"},sales:{invoiceNo:"invoice_no",customerId:"customer_id",customerName:"customer_name",salespersonId:"salesperson_id",salespersonName:"salesperson_name",bankName:"bank_name",discountType:"discount_type",vatType:"vat_type",vatAmount:"vat_amount",aitType:"ait_type",aitAmount:"ait_amount",truckFare:"truck_fare",customerThana:"customer_thana",createdBy:"created_by",extraData:"extra_data"},purchases:{purchaseNo:"purchase_no",supplierId:"supplier_id",supplierName:"supplier_name",bankName:"bank_name",vatType:"vat_type",extraData:"extra_data"},payments:{bankName:"bank_name",chequeNo:"cheque_no",fromAcc:"from_acc",toAcc:"to_acc",autoInvoice:"auto_invoice",isTruckFare:"is_truck_fare",billKeys:"bill_keys",extraData:"extra_data",_autoInvoice:"auto_invoice",_isTruckFare:"is_truck_fare"},expenses:{expenseNo:"expense_no",headName:"head_name",subHeadName:"sub_head_name",bankName:"bank_name",isTruckFare:"is_truck_fare",_isTruckFare:"is_truck_fare",extraData:"extra_data"},orders:{orderNo:"order_no",customerId:"customer_id",customerName:"customer_name",spId:"sp_id",spName:"sp_name",spCode:"sp_code",convertedInvoice:"converted_invoice",extraData:"extra_data"},salespersons:{extraData:"extra_data"},banks:{accountNo:"account_no",openingBalance:"opening_balance",extraData:"extra_data"},users:{extraData:"extra_data"},approvals:{targetKey:"target_key",newData:"new_data",oldData:"old_data",requestedBy:"requested_by",requestedAt:"requested_at",processedBy:"processed_by",processedAt:"processed_at",extraData:"extra_data"},mod_logs:{oldData:"old_data",extraData:"extra_data"},exp_heads:{},exp_subheads:{headId:"head_id",headName:"head_name"},credit_limits:{partyId:"party_id",partyName:"party_name",extraData:"extra_data"},thana_fares:{maxFare:"max_fare",extraData:"extra_data"},cb:{openingBalance:"opening_balance",extraData:"extra_data"},prod_groups:{},prod_brands:{}},Ft={sale_items:{saleId:"sale_id",productId:"product_id",productName:"product_name",extraData:"extra_data"},purchase_items:{purchaseId:"purchase_id",productId:"product_id",productName:"product_name",extraData:"extra_data"},order_items:{orderId:"order_id",productKey:"product_key",productName:"product_name",extraData:"extra_data"}};function Ot(a){return{products:["id","name","sku","unit",'"group"',"brand","purchase_price","sale_price","stock","extra_data","created_at","updated_at"],parties:["id","name","type","phone","address","division","district","thana","post_office","postcode","opening_balance","credit_limit","salesperson_id","salesperson_name","extra_data","created_at","updated_at"],salespersons:["id","name","code","pin","phone","active","extra_data","created_at","updated_at"],banks:["id","name","account_no","opening_balance","balance","extra_data","created_at","updated_at"],sales:["id","invoice_no","date","customer_id","customer_name","salesperson_id","salesperson_name","method","bank_name","discount","discount_type","extra","vat","vat_type","vat_amount","ait","ait_type","ait_amount","truck_fare","total","paid","note","customer_thana","created_by","extra_data","created_at","updated_at"],sale_items:["sale_id","product_id","product_name","qty","rate","amount","extra_data"],purchases:["id","purchase_no","date","supplier_id","supplier_name","method","bank_name","discount","extra","vat","vat_type","total","paid","note","extra_data","created_at","updated_at"],purchase_items:["purchase_id","product_id","product_name","qty","rate","amount","extra_data"],payments:["id",'"no"',"date","type","party","method","bank_name","amount","note","cheque_no","status","from_acc","to_acc","auto_invoice","is_truck_fare","bill_keys","extra_data","created_at","updated_at"],expenses:["id","expense_no","date","head_name","sub_head_name","method","bank_name","amount","description","is_truck_fare","extra_data","created_at","updated_at"],exp_heads:["id","name","created_at"],exp_subheads:["id","name","head_id","head_name","created_at"],orders:["id","order_no","date","customer_id","customer_name","sp_id","sp_name","sp_code","total","status","converted_invoice","note","extra_data","created_at","updated_at"],order_items:["order_id","product_key","product_name","qty","rate","amount","extra_data"],users:["id","username","password","name","role","active","extra_data","created_at","updated_at"],approvals:["id","type","target_key","prefix","new_data","old_data","detail","requested_by","requested_at","status","processed_by","processed_at","extra_data","created_at"],mod_logs:["id","action","detail","key","prefix","old_data",'"user"',"timestamp","extra_data"],credit_limits:["id","party_id","party_name","amount","extra_data","created_at"],thana_fares:["id","thana","district","division","max_fare","extra_data","created_at","updated_at"],cb:["id","opening_balance","extra_data","created_at"],prod_groups:["id","name","created_at","updated_at"],prod_brands:["id","name","created_at","updated_at"]}[a]||[]}function nt(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function Ke(a,t){const e=Kt[a];return e&&e[t]?e[t]:t}function Fe(a,t){const e=Ft[a];return e&&e[t]?e[t]:t}function Oe(a,t){const r=Ot(a).map(s=>s.replace(/"/g,"")),i={},n={};for(const[s,l]of Object.entries(t)){if(s==="_key"||s==="_items")continue;const o=Ke(a,s);r.includes(o)?typeof l=="object"&&l!==null?i[o]=JSON.stringify(l):i[o]=l:n[s]=l}if(Object.keys(n).length>0){let s={};if(i.extra_data&&typeof i.extra_data=="string")try{s=JSON.parse(i.extra_data)}catch{}i.extra_data=JSON.stringify({...s,...n})}return i}function ze(a,t,e){const i=Ot(a).map(l=>l.replace(/"/g,"")),n={},s={};a==="sale_items"?n.sale_id=e:a==="purchase_items"?n.purchase_id=e:a==="order_items"&&(n.order_id=e);for(const[l,o]of Object.entries(t)){if(l==="_key")continue;const d=Fe(a,l);i.includes(d)?typeof o=="object"&&o!==null?n[d]=JSON.stringify(o):n[d]=o:s[l]=o}return Object.keys(s).length>0&&(n.extra_data=JSON.stringify(s)),n}function zt(a,t,e){const r=t.id,i={_key:e+r},n={},s=Kt[a]||{};for(const[l,o]of Object.entries(s))n[o]=l;for(const[l,o]of Object.entries(t)){if(l==="id"||l==="created_at"||l==="updated_at")continue;const d=n[l]||l;if(l==="extra_data"&&typeof o=="string"&&o!=="{}"){try{const p=JSON.parse(o);Object.assign(i,p)}catch{}continue}if(l==="bill_keys"&&typeof o=="string"){try{i[d]=JSON.parse(o)}catch{i[d]=o}continue}if(l==="new_data"||l==="old_data"){if(typeof o=="string")try{i[d]=JSON.parse(o)}catch{i[d]=o}else i[d]=o;continue}i[d]=o}return i}function He(a){const t=Ft[a]||{},e={};for(const[r,i]of Object.entries(t))e[i]=r;return e}function Ht(a,t){const e=t?He(t):{};return a.map(r=>{const i={};for(const[n,s]of Object.entries(r)){if(n==="id"||n==="extra_data"||n==="sale_id"||n==="purchase_id"||n==="order_id")continue;const l=e[n]||n;i[l]=s}if(r.extra_data&&typeof r.extra_data=="string"&&r.extra_data!=="{}")try{Object.assign(i,JSON.parse(r.extra_data))}catch{}return i})}async function Gt(a,t){const e=sa[t];if(!e)return[];const r=a.prepare(`SELECT * FROM ${e} ORDER BY created_at DESC`),{results:i}=await r.all(),n=i.map(l=>zt(e,l,t)),s=rt[e];if(s&&i.length>0){const l=i.map(y=>y.id),o=l.map(()=>"?").join(","),d=s==="sale_items"?"sale_id":s==="purchase_items"?"purchase_id":"order_id",p=a.prepare(`SELECT * FROM ${s} WHERE ${d} IN (${o})`).bind(...l),{results:u}=await p.all(),g={};for(const y of u){const S=y[d];g[S]||(g[S]=[]),g[S].push(y)}for(const y of n){const P=y._key.replace(t,""),T=g[P]||[];T.length>0&&(y.items=Ht(T,s))}}return n}async function Da(a,t){const e=t.indexOf(":");if(e===-1)return null;const r=t.substring(0,e+1),i=t.substring(e+1),n=sa[r];if(!n)return null;const l=await a.prepare(`SELECT * FROM ${n} WHERE id = ?`).bind(i).first();if(!l)return null;const o=zt(n,l,r),d=rt[n];if(d){const p=d==="sale_items"?"sale_id":d==="purchase_items"?"purchase_id":"order_id",u=a.prepare(`SELECT * FROM ${d} WHERE ${p} = ?`).bind(i),{results:g}=await u.all();g.length>0&&(o.items=Ht(g,d))}return delete o._key,o}async function it(a,t,e,r){const i=sa[t];if(!i)throw new Error(`Unknown prefix: ${t}`);let n;r?n=r.startsWith(t)?r.substring(t.length):r:n=nt();const s=new Date().toISOString(),l=Oe(i,e);l.id=n,l.updated_at=s,r||(l.created_at=s);const o=Object.keys(l),d=o.map(w=>w==="group"?'"group"':w==="no"?'"no"':w==="user"?'"user"':w),p=o.map(()=>"?").join(", "),u=o.filter(w=>w!=="id"&&w!=="created_at").map(w=>{const C=w==="group"?'"group"':w==="no"?'"no"':w==="user"?'"user"':w;return`${C} = excluded.${C}`}).join(", "),g=`INSERT INTO ${i} (${d.join(", ")}) VALUES (${p})
    ON CONFLICT(id) DO UPDATE SET ${u}`,y=o.map(w=>l[w]??null),S=[a.prepare(g).bind(...y)],P=rt[i],T=e.items||e._items;if(P&&Array.isArray(T)){const w=P==="sale_items"?"sale_id":P==="purchase_items"?"purchase_id":"order_id";S.push(a.prepare(`DELETE FROM ${P} WHERE ${w} = ?`).bind(n));for(const C of T){const R=ze(P,C,n),F=Object.keys(R),wa=F.map(oa=>oa==="no"?'"no"':oa),Oa=F.map(()=>"?").join(", "),K=F.map(oa=>R[oa]??null);S.push(a.prepare(`INSERT INTO ${P} (${wa.join(", ")}) VALUES (${Oa})`).bind(...K))}}return await a.batch(S),t+n}async function st(a,t){const e=t.indexOf(":");if(e===-1)return;const r=t.substring(0,e+1),i=t.substring(e+1),n=sa[r];n&&await a.prepare(`DELETE FROM ${n} WHERE id = ?`).bind(i).run()}async function Ua(a,t,e,r,i,n,s){const l=nt(),o=new Date().toISOString();await a.prepare('INSERT INTO mod_logs (id, action, detail, key, prefix, old_data, "user", timestamp) VALUES (?, ?, ?, ?, ?, ?, ?, ?)').bind(l,t,e,r,i,s||"",n,o).run()}async function qt(a,t,e,r,i,n,s,l){const o=nt(),d=new Date().toISOString();return await a.prepare("INSERT INTO approvals (id, type, target_key, prefix, new_data, old_data, detail, requested_by, requested_at, status, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending', ?)").bind(o,t,e,r,JSON.stringify(i),JSON.stringify(n),s,l,d,d).run(),"approval:"+o}async function Ge(a,t,e,r){const i=t.startsWith("approval:")?t.substring(9):t,n=await a.prepare("SELECT * FROM approvals WHERE id = ?").bind(i).first();if(!n)return{success:!1,error:"Approval not found"};if(n.status!=="pending")return{success:!1,error:"Already processed"};const s=new Date().toISOString(),l=e==="approve"?"approved":"rejected";if(e==="approve"){const o=n.target_key,d=n.prefix,p=n.type,u=n.requested_by;if(p==="edit"&&n.new_data){const g=typeof n.new_data=="string"?JSON.parse(n.new_data):n.new_data;await it(a,d,g,o),await Ua(a,"edit",`Approved edit by ${u}: ${n.detail}`,o,d,r)}else p==="delete"&&(await st(a,o),await Ua(a,"delete",`Approved delete by ${u}: ${n.detail}`,o,d,r))}return await a.prepare("UPDATE approvals SET status = ?, processed_by = ?, processed_at = ? WHERE id = ?").bind(l,r,s,i).run(),{success:!0,status:l}}async function qe(a){const t={};for(const[e]of Object.entries(sa))t[e]=await Gt(a,e);return t}async function Je(a,t){let e=0;for(const[r,i]of Object.entries(t))if(!(!Array.isArray(i)||!sa[r]))for(const s of i){const l=s._key,o={...s};delete o._key,await it(a,r,o,l),e++}return e}async function Ue(a,t,e=100){const r=sa[t];if(!r)return[];const{results:i}=await a.prepare(`SELECT id FROM ${r} ORDER BY created_at DESC LIMIT ?`).bind(e).all();return i.map(n=>t+n.id)}const Ve={"product:":300,"party:":300,"prodgroup:":600,"prodbrand:":600,"salesperson:":300,"bank:":300,"exphead:":600,"expsubhead:":600,"thanafare:":600,"creditlimit:":300,"cb:":300,"user:":120,"sale:":60,"purchase:":60,"payment:":60,"expense:":60,"order:":60,"modlog:":120,"approval:":30},$a="cache:",Xe=2*1024*1024;async function $e(a,t){if(!a)return null;try{const e=$a+t,r=await a.get(e);return r?JSON.parse(r):null}catch{return null}}async function Qe(a,t,e){if(a)try{const r=JSON.stringify(e);if(r.length>Xe)return;const i=Ve[t]||60;await a.put($a+t,r,{expirationTtl:i})}catch{}}async function ja(a,...t){if(a)try{await Promise.all(t.map(e=>a.delete($a+e)))}catch{}}async function Jt(a){if(a)try{let t;const e=[];do{const r=await a.list({prefix:$a,cursor:t,limit:1e3});e.push(...r.keys.map(i=>i.name)),t=r.list_complete?void 0:r.cursor}while(t);await Promise.all(e.map(r=>a.delete(r)))}catch{}}async function Ut(a){return a?a.get("APP_LICENSE"):null}async function Ye(a,t){a&&await a.put("APP_LICENSE",t)}async function Vt(a){return a?a.get("APP_PIN"):null}async function We(a,t){a&&await a.put("APP_PIN",t)}async function Xt(a){if(!a)return null;const t=await a.get("COMPANY_SETTINGS");if(!t)return null;try{return JSON.parse(t)}catch{return null}}async function $t(a,t){a&&await a.put("COMPANY_SETTINGS",JSON.stringify(t))}async function Ze(a,t,e){const r=await $e(a,e);if(r!==null)return r;const i=await t(e);return await Qe(a,e,i),i}function ot(a){return{"sale:":["sale:","product:"],"purchase:":["purchase:","product:"],"payment:":["payment:"],"expense:":["expense:"],"order:":["order:"],"product:":["product:"],"party:":["party:"]}[a]||[a]}const h=new Lt;let Qt="1234";const Yt="4321",Wt="2028-12-31";function ar(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function pa(a){return String(a).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function Sa(a,t){return a.DB?Ze(a.DATA_STORE,e=>Gt(a.DB,e),t):[]}function f(a){return new Response(a,{headers:{"content-type":"text/html;charset=UTF-8","Cache-Control":"no-store, no-cache, must-revalidate, proxy-revalidate",Pragma:"no-cache",Expires:"0"}})}h.post("/login",async a=>{const t=await a.req.formData(),e=t.get("pin"),r=await Vt(a.env.DATA_STORE)||Qt,i=(t.get("username")||"").trim(),n=await Sa(a.env,"user:");if(n.length>0&&i){const s=n.find(l=>l.username===i&&l.password===e&&l.active!==!1);if(s){const l=encodeURIComponent(JSON.stringify({auth:1,userId:s._key,username:s.username,role:s.role,name:s.name}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${l}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Na("Invalid credentials",n.length>0))}if(e===r){const s=encodeURIComponent(JSON.stringify({auth:1,userId:"admin",username:"admin",role:"admin",name:"Administrator"}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${s}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Na("Wrong PIN",n.length>0))});h.get("/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"session=; Path=/; HttpOnly; Max-Age=0; SameSite=Strict",Location:"/login","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache","Clear-Site-Data":'"cache"'}}));function x(a){const e=(a.req.header("Cookie")||"").match(/session=([^;]+)/);if(!e)return null;try{return JSON.parse(decodeURIComponent(e[1]))}catch{return null}}h.use("*",async(a,t)=>{const e=new URL(a.req.url).pathname;if(e==="/login"&&a.req.method==="GET"){const d=await Sa(a.env,"user:");return f(Na("",d.length>0))}if(e==="/api/company-settings"&&a.req.method==="GET"){await t();return}if(!(new URL(a.req.url).searchParams.get("master")===Yt)){const d=new Date().toISOString().slice(0,10);if(d>Wt)return f(mt());{const p=await Ut(a.env.DATA_STORE);if(p&&d>p)return f(mt())}}if(e.startsWith("/sp-portal")){const p=(a.req.header("Cookie")||"").match(/sp_session=([^;]+)/);if(e==="/sp-portal/login"&&a.req.method==="GET"||!p&&e!=="/sp-portal/login")return f(tt(""));await t();return}const n=x(a);if(!(n!=null&&n.auth)&&e!=="/login")return f(Na("",!1));const s={admin:[],manager:["/users","/admin"],entry:["/users","/admin","/profit-loss","/balance-sheet","/trial-balance","/stock","/receivable-payable","/salesperson","/expense-ledger","/approvals","/company-settings"],viewer:["/inventory","/parties","/purchases","/sales","/payments","/expenses","/orders","/users","/admin","/salesperson","/approvals","/company-settings"]},l=(n==null?void 0:n.role)||"admin";if((s[l]||[]).includes(e))return f(B(`<div class="card"><div class="empty" style="padding:40px"><h3>Access Denied</h3><p class="text-muted">You don't have permission to access this page.</p><a href="/" class="btn btn-primary" style="margin-top:12px">Go to Dashboard</a></div></div>`,"dashboard",n));await t()});h.get("/api/license-info",async a=>{const e=await Ut(a.env.DATA_STORE)||Wt,r=Math.floor((new Date(e).getTime()-Date.now())/864e5);return a.json({expiry:e,days:r,status:r<0?"Expired":"Active"})});h.post("/api/set-license",async a=>{if(new URL(a.req.url).searchParams.get("master")!==Yt)return a.json({success:!1,error:"Unauthorized"},403);const e=await a.req.json();return await Ye(a.env.DATA_STORE,String((e==null?void 0:e.date)||"")),a.json({success:!0})});h.post("/api/list",async a=>{const t=await a.req.json();return a.json(await Sa(a.env,(t==null?void 0:t.prefix)||""))});const Zt=["product:","party:","sale:","purchase:","payment:","expense:","bank:","order:","salesperson:"];h.post("/api/save",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json();let e=(t==null?void 0:t.prefix)||"";const r=t==null?void 0:t.id,i=t==null?void 0:t.key,n=(t==null?void 0:t.data)||{},s=(t==null?void 0:t.logAction)||"",l=(t==null?void 0:t.logDetail)||"",o=(t==null?void 0:t.skipApproval)===!0;let d=i;d||(r?d=r.startsWith(e)?r:e+r:d=e+ar()),!e&&d&&d.includes(":")&&(e=d.substring(0,d.indexOf(":")+1));const p=x(a),u=(p==null?void 0:p.role)==="entry",g=!!(i||r),y=Zt.some(P=>e&&e===P||d&&d.startsWith(P));if(u&&g&&y&&!o){const P=await Da(a.env.DB,d);return await qt(a.env.DB,"edit",d,e,n,P,l||"Edit: "+d,(p==null?void 0:p.name)||(p==null?void 0:p.username)||"Unknown"),await ja(a.env.DATA_STORE,"approval:"),a.json({success:!0,key:d,pending:!0,message:"Your edit has been submitted for approval"})}const S=await it(a.env.DB,e,n,d);return s&&await Ua(a.env.DB,s,l,S,e,(p==null?void 0:p.name)||(p==null?void 0:p.username)||"System"),await ja(a.env.DATA_STORE,...ot(e)),a.json({success:!0,key:S})});h.post("/api/get",async a=>{if(!a.env.DB)return a.json(null);const{key:t}=await a.req.json(),e=await Da(a.env.DB,t);return a.json(e)});h.post("/api/delete",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json(),e=t==null?void 0:t.key,r=(t==null?void 0:t.logDetail)||"",i=(t==null?void 0:t.skipApproval)===!0;if(!e)return a.json({success:!1,error:"Key is required"},400);const n=e.split(":")[0]+":",s=x(a),l=(s==null?void 0:s.role)==="entry",o=Zt.some(p=>e.startsWith(p));if(l&&o&&!i){const p=await Da(a.env.DB,e);return await qt(a.env.DB,"delete",e,n,null,p,r||"Delete: "+e,(s==null?void 0:s.name)||(s==null?void 0:s.username)||"Unknown"),await ja(a.env.DATA_STORE,"approval:"),a.json({success:!0,pending:!0,message:"Your delete request has been submitted for approval"})}const d=await Da(a.env.DB,e);return await st(a.env.DB,e),await Ua(a.env.DB,"delete",r||"Deleted key: "+e,e,n,(s==null?void 0:s.name)||(s==null?void 0:s.username)||"System",d?JSON.stringify(d).substring(0,500):""),await ja(a.env.DATA_STORE,...ot(n)),a.json({success:!0})});h.post("/api/approval-list",async a=>a.json(await Sa(a.env,"approval:")));h.post("/api/approval-action",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=x(a),e=(t==null?void 0:t.role)||"";if(e!=="admin"&&e!=="manager")return a.json({success:!1,error:"Only admin/manager can approve"},403);const{approvalKey:r,action:i}=await a.req.json();if(!r)return a.json({success:!1,error:"Approval key required"},400);const n=await Ge(a.env.DB,r,i,(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System");return n.success?(await Jt(a.env.DATA_STORE),a.json({success:!0,status:n.status})):a.json(n,400)});h.get("/api/company-settings",async a=>{const t={companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"},e=await Xt(a.env.DATA_STORE);return a.json(e||t)});h.post("/api/company-settings",async a=>{const t=x(a);if((t==null?void 0:t.role)!=="admin")return a.json({success:!1,error:"Only admin can change company settings"},403);const e=await a.req.json();return await $t(a.env.DATA_STORE,e),a.json({success:!0})});h.post("/api/export-all",async a=>{if(!a.env.DB)return a.json({});const t=await qe(a.env.DB),e=await Xt(a.env.DATA_STORE);return e&&(t["companysettings:"]=[e]),a.json(t)});h.post("/api/import-all",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json();t["companysettings:"]&&Array.isArray(t["companysettings:"])&&t["companysettings:"].length>0&&(await $t(a.env.DATA_STORE,t["companysettings:"][0]),delete t["companysettings:"]);const e=await Je(a.env.DB,t);return await Jt(a.env.DATA_STORE),a.json({success:!0,count:e})});h.post("/api/change-pin",async a=>{const{oldPin:t,newPin:e}=await a.req.json(),r=await Vt(a.env.DATA_STORE)||Qt;return t!==r?a.json({success:!1,error:"Wrong current PIN"}):!e||e.length<4?a.json({success:!1,error:"PIN must be at least 4 characters"}):(await We(a.env.DATA_STORE,e),a.json({success:!0}))});h.post("/api/kv-keys",async a=>{if(!a.env.DB)return a.json([]);const{prefix:t}=await a.req.json();return a.json(await Ue(a.env.DB,t||"",100))});h.post("/api/kv-get",async a=>{if(!a.env.DB)return a.json({value:null});const{key:t}=await a.req.json(),e=await Da(a.env.DB,t);return a.json({value:e?JSON.stringify(e):null})});h.post("/api/kv-delete",async a=>{if(!a.env.DB)return a.json({success:!1});const{key:t}=await a.req.json();await st(a.env.DB,t);const e=t.split(":")[0]+":";return await ja(a.env.DATA_STORE,...ot(e)),a.json({success:!0})});h.post("/sp-portal/login",async a=>{const t=await a.req.formData(),e=t.get("code"),r=t.get("pin"),n=(await Sa(a.env,"salesperson:")).find(s=>s.code===e&&s.pin===r&&s.active!==!1);if(n){const s=encodeURIComponent(JSON.stringify({spId:n._key,spName:n.name,spCode:n.code}));return new Response(null,{status:302,headers:{"Set-Cookie":`sp_session=${s}; Path=/; HttpOnly; SameSite=Strict`,Location:"/sp-portal"}})}return f(tt("Invalid credentials"))});h.get("/sp-portal/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"sp_session=; Path=/; HttpOnly; Max-Age=0",Location:"/sp-portal/login"}}));h.get("/",a=>f(B(nr(),"dashboard",x(a))));h.get("/inventory",a=>f(B(ir(),"inventory",x(a))));h.get("/stock-check",a=>f(B(sr(),"stockcheck",x(a))));h.get("/parties",a=>f(B(or(),"parties",x(a))));h.get("/purchases",a=>f(B(lr(),"purchases",x(a))));h.get("/sales",a=>f(B(dr(),"sales",x(a))));h.get("/payments",a=>f(B(cr(),"payments",x(a))));h.get("/expenses",a=>f(B(pr(),"expenses",x(a))));h.get("/ledger",a=>f(B(ur(),"ledger",x(a))));h.get("/expense-ledger",a=>f(B(hr(),"expledger",x(a))));h.get("/profit-loss",a=>f(B(mr(),"profitloss",x(a))));h.get("/balance-sheet",a=>f(B(gr(),"balancesheet",x(a))));h.get("/trial-balance",a=>f(B(vr(),"trialbalance",x(a))));h.get("/stock",a=>f(B(br(),"stock",x(a))));h.get("/receivable-payable",a=>f(B(fr(),"recpay",x(a))));h.get("/day-details",a=>f(B(yr(),"daydetails",x(a))));h.get("/reports",a=>f(B(xr(),"reports",x(a))));h.get("/salesperson",a=>f(B(kr(),"salesperson",x(a))));h.get("/orders",a=>f(B(Sr(),"orders",x(a))));h.get("/users",a=>f(B(wr(),"users",x(a))));h.get("/admin",a=>f(B(Br(),"admin",x(a))));h.get("/mod-log",a=>f(B(Cr(),"modlog",x(a))));h.get("/approvals",a=>f(B(Pr(),"approvals",x(a))));h.get("/company-settings",a=>f(B(Ir(),"companysettings",x(a))));h.get("/truck-fare-report",a=>f(B(er(),"truckfarereport",x(a))));h.get("/truck-fare-settings",a=>f(B(tr(),"truckfaresettings",x(a))));h.get("/sp-portal",a=>f(rr(a)));h.get("/login",async a=>{const t=await Sa(a.env,"user:");return f(Na("",t.length>0))});function tr(){return`

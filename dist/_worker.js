var Le=Object.defineProperty;var Zt=t=>{throw TypeError(t)};var Oe=(t,e,a)=>e in t?Le(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var y=(t,e,a)=>Oe(t,typeof e!="symbol"?e+"":e,a),Ut=(t,e,a)=>e.has(t)||Zt("Cannot "+a);var i=(t,e,a)=>(Ut(t,e,"read from private field"),a?a.call(t):e.get(t)),b=(t,e,a)=>e.has(t)?Zt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),v=(t,e,a,n)=>(Ut(t,e,"write to private field"),n?n.call(t,a):e.set(t,a),a),g=(t,e,a)=>(Ut(t,e,"access private method"),a);var te=(t,e,a,n)=>({set _(r){v(t,e,r,a)},get _(){return i(t,e,n)}});var ee=(t,e,a)=>(n,r)=>{let s=-1;return o(0);async function o(d){if(d<=s)throw new Error("next() called multiple times");s=d;let c,l=!1,p;if(t[d]?(p=t[d][0][0],n.req.routeIndex=d):p=d===t.length&&r||void 0,p)try{c=await p(n,()=>o(d+1))}catch(u){if(u instanceof Error&&e)n.error=u,c=await e(u,n),l=!0;else throw u}else n.finalized===!1&&a&&(c=await a(n));return c&&(n.finalized===!1||l)&&(n.res=c),n}},Re=Symbol(),Me=async(t,e=Object.create(null))=>{const{all:a=!1,dot:n=!1}=e,s=(t instanceof fe?t.raw.headers:t.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?je(t,{all:a,dot:n}):{}};async function je(t,e){const a=await t.formData();return a?qe(a,e):{}}function qe(t,e){const a=Object.create(null);return t.forEach((n,r)=>{e.all||r.endsWith("[]")?He(a,r,n):a[r]=n}),e.dot&&Object.entries(a).forEach(([n,r])=>{n.includes(".")&&(ze(a,n,r),delete a[n])}),a}var He=(t,e,a)=>{t[e]!==void 0?Array.isArray(t[e])?t[e].push(a):t[e]=[t[e],a]:e.endsWith("[]")?t[e]=[a]:t[e]=a},ze=(t,e,a)=>{if(/(?:^|\.)__proto__\./.test(e))return;let n=t;const r=e.split(".");r.forEach((s,o)=>{o===r.length-1?n[s]=a:((!n[s]||typeof n[s]!="object"||Array.isArray(n[s])||n[s]instanceof File)&&(n[s]=Object.create(null)),n=n[s])})},ue=t=>{const e=t.split("/");return e[0]===""&&e.shift(),e},Fe=t=>{const{groups:e,path:a}=Ke(t),n=ue(a);return Ge(n,e)},Ke=t=>{const e=[];return t=t.replace(/\{[^}]+\}/g,(a,n)=>{const r=`@${n}`;return e.push([r,a]),r}),{groups:e,path:t}},Ge=(t,e)=>{for(let a=e.length-1;a>=0;a--){const[n]=e[a];for(let r=t.length-1;r>=0;r--)if(t[r].includes(n)){t[r]=t[r].replace(n,e[a][1]);break}}return t},Rt={},Ue=(t,e)=>{if(t==="*")return"*";const a=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const n=`${t}#${e}`;return Rt[n]||(a[2]?Rt[n]=e&&e[0]!==":"&&e[0]!=="*"?[n,a[1],new RegExp(`^${a[2]}(?=/${e})`)]:[t,a[1],new RegExp(`^${a[2]}$`)]:Rt[n]=[t,a[1],!0]),Rt[n]}return null},Wt=(t,e)=>{try{return e(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return e(a)}catch{return a}})}},Ve=t=>Wt(t,decodeURI),me=t=>{const e=t.url,a=e.indexOf("/",e.indexOf(":")+4);let n=a;for(;n<e.length;n++){const r=e.charCodeAt(n);if(r===37){const s=e.indexOf("?",n),o=e.indexOf("#",n),d=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),c=e.slice(a,d);return Ve(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(r===63||r===35)break}return e.slice(a,n)},$e=t=>{const e=me(t);return e.length>1&&e.at(-1)==="/"?e.slice(0,-1):e},pt=(t,e,...a)=>(a.length&&(e=pt(e,...a)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${e==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(e==null?void 0:e[0])==="/"?e.slice(1):e}`}`),ve=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const e=t.split("/"),a=[];let n="";return e.forEach(r=>{if(r!==""&&!/\:/.test(r))n+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){a.length===0&&n===""?a.push("/"):a.push(n);const s=r.replace("?","");n+="/"+s,a.push(n)}else n+="/"+r}),a.filter((r,s,o)=>o.indexOf(r)===s)},Vt=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?Wt(t,be):t):t,ye=(t,e,a)=>{let n;if(!a&&e&&!/[%+]/.test(e)){let o=t.indexOf("?",8);if(o===-1)return;for(t.startsWith(e,o+1)||(o=t.indexOf(`&${e}`,o+1));o!==-1;){const d=t.charCodeAt(o+e.length+1);if(d===61){const c=o+e.length+2,l=t.indexOf("&",c);return Vt(t.slice(c,l===-1?void 0:l))}else if(d==38||isNaN(d))return"";o=t.indexOf(`&${e}`,o+1)}if(n=/[%+]/.test(t),!n)return}const r={};n??(n=/[%+]/.test(t));let s=t.indexOf("?",8);for(;s!==-1;){const o=t.indexOf("&",s+1);let d=t.indexOf("=",s);d>o&&o!==-1&&(d=-1);let c=t.slice(s+1,d===-1?o===-1?void 0:o:d);if(n&&(c=Vt(c)),s=o,c==="")continue;let l;d===-1?l="":(l=t.slice(d+1,o===-1?void 0:o),n&&(l=Vt(l))),a?(r[c]&&Array.isArray(r[c])||(r[c]=[]),r[c].push(l)):r[c]??(r[c]=l)}return e?r[e]:r},Qe=ye,Ye=(t,e)=>ye(t,e,!0),be=decodeURIComponent,ae=t=>Wt(t,be),vt,A,K,he,ge,Qt,U,oe,fe=(oe=class{constructor(t,e="/",a=[[]]){b(this,K);y(this,"raw");b(this,vt);b(this,A);y(this,"routeIndex",0);y(this,"path");y(this,"bodyCache",{});b(this,U,t=>{const{bodyCache:e,raw:a}=this,n=e[t];if(n)return n;const r=Object.keys(e)[0];return r?e[r].then(s=>(r==="json"&&(s=JSON.stringify(s)),new Response(s)[t]())):e[t]=a[t]()});this.raw=t,this.path=e,v(this,A,a),v(this,vt,{})}param(t){return t?g(this,K,he).call(this,t):g(this,K,ge).call(this)}query(t){return Qe(this.url,t)}queries(t){return Ye(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const e={};return this.raw.headers.forEach((a,n)=>{e[n]=a}),e}async parseBody(t){return Me(this,t)}json(){return i(this,U).call(this,"text").then(t=>JSON.parse(t))}text(){return i(this,U).call(this,"text")}arrayBuffer(){return i(this,U).call(this,"arrayBuffer")}blob(){return i(this,U).call(this,"blob")}formData(){return i(this,U).call(this,"formData")}addValidatedData(t,e){i(this,vt)[t]=e}valid(t){return i(this,vt)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[Re](){return i(this,A)}get matchedRoutes(){return i(this,A)[0].map(([[,t]])=>t)}get routePath(){return i(this,A)[0].map(([[,t]])=>t)[this.routeIndex].path}},vt=new WeakMap,A=new WeakMap,K=new WeakSet,he=function(t){const e=i(this,A)[0][this.routeIndex][1][t],a=g(this,K,Qt).call(this,e);return a&&/\%/.test(a)?ae(a):a},ge=function(){const t={},e=Object.keys(i(this,A)[0][this.routeIndex][1]);for(const a of e){const n=g(this,K,Qt).call(this,i(this,A)[0][this.routeIndex][1][a]);n!==void 0&&(t[a]=/\%/.test(n)?ae(n):n)}return t},Qt=function(t){return i(this,A)[1]?i(this,A)[1][t]:t},U=new WeakMap,oe),We={Stringify:1},xe=async(t,e,a,n,r)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const s=t.callbacks;return s!=null&&s.length?(r?r[0]+=t:r=[t],Promise.all(s.map(d=>d({phase:e,buffer:r,context:n}))).then(d=>Promise.all(d.filter(Boolean).map(c=>xe(c,e,!1,n,r))).then(()=>r[0]))):Promise.resolve(t)},Xe="text/plain; charset=UTF-8",$t=(t,e)=>({"Content-Type":t,...e}),Et=(t,e)=>new Response(t,e),Ct,Nt,q,yt,H,C,At,bt,ft,tt,Dt,_t,V,ut,ie,Je=(ie=class{constructor(t,e){b(this,V);b(this,Ct);b(this,Nt);y(this,"env",{});b(this,q);y(this,"finalized",!1);y(this,"error");b(this,yt);b(this,H);b(this,C);b(this,At);b(this,bt);b(this,ft);b(this,tt);b(this,Dt);b(this,_t);y(this,"render",(...t)=>(i(this,bt)??v(this,bt,e=>this.html(e)),i(this,bt).call(this,...t)));y(this,"setLayout",t=>v(this,At,t));y(this,"getLayout",()=>i(this,At));y(this,"setRenderer",t=>{v(this,bt,t)});y(this,"header",(t,e,a)=>{this.finalized&&v(this,C,Et(i(this,C).body,i(this,C)));const n=i(this,C)?i(this,C).headers:i(this,tt)??v(this,tt,new Headers);e===void 0?n.delete(t):a!=null&&a.append?n.append(t,e):n.set(t,e)});y(this,"status",t=>{v(this,yt,t)});y(this,"set",(t,e)=>{i(this,q)??v(this,q,new Map),i(this,q).set(t,e)});y(this,"get",t=>i(this,q)?i(this,q).get(t):void 0);y(this,"newResponse",(...t)=>g(this,V,ut).call(this,...t));y(this,"body",(t,e,a)=>g(this,V,ut).call(this,t,e,a));y(this,"text",(t,e,a)=>!i(this,tt)&&!i(this,yt)&&!e&&!a&&!this.finalized?new Response(t):g(this,V,ut).call(this,t,e,$t(Xe,a)));y(this,"json",(t,e,a)=>g(this,V,ut).call(this,JSON.stringify(t),e,$t("application/json",a)));y(this,"html",(t,e,a)=>{const n=r=>g(this,V,ut).call(this,r,e,$t("text/html; charset=UTF-8",a));return typeof t=="object"?xe(t,We.Stringify,!1,{}).then(n):n(t)});y(this,"redirect",(t,e)=>{const a=String(t);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,e??302)});y(this,"notFound",()=>(i(this,ft)??v(this,ft,()=>Et()),i(this,ft).call(this,this)));v(this,Ct,t),e&&(v(this,H,e.executionCtx),this.env=e.env,v(this,ft,e.notFoundHandler),v(this,_t,e.path),v(this,Dt,e.matchResult))}get req(){return i(this,Nt)??v(this,Nt,new fe(i(this,Ct),i(this,_t),i(this,Dt))),i(this,Nt)}get event(){if(i(this,H)&&"respondWith"in i(this,H))return i(this,H);throw Error("This context has no FetchEvent")}get executionCtx(){if(i(this,H))return i(this,H);throw Error("This context has no ExecutionContext")}get res(){return i(this,C)||v(this,C,Et(null,{headers:i(this,tt)??v(this,tt,new Headers)}))}set res(t){if(i(this,C)&&t){t=Et(t.body,t);for(const[e,a]of i(this,C).headers.entries())if(e!=="content-type")if(e==="set-cookie"){const n=i(this,C).headers.getSetCookie();t.headers.delete("set-cookie");for(const r of n)t.headers.append("set-cookie",r)}else t.headers.set(e,a)}v(this,C,t),this.finalized=!0}get var(){return i(this,q)?Object.fromEntries(i(this,q)):{}}},Ct=new WeakMap,Nt=new WeakMap,q=new WeakMap,yt=new WeakMap,H=new WeakMap,C=new WeakMap,At=new WeakMap,bt=new WeakMap,ft=new WeakMap,tt=new WeakMap,Dt=new WeakMap,_t=new WeakMap,V=new WeakSet,ut=function(t,e,a){const n=i(this,C)?new Headers(i(this,C).headers):i(this,tt)??new Headers;if(typeof e=="object"&&"headers"in e){const s=e.headers instanceof Headers?e.headers:new Headers(e.headers);for(const[o,d]of s)o.toLowerCase()==="set-cookie"?n.append(o,d):n.set(o,d)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")n.set(s,o);else{n.delete(s);for(const d of o)n.append(s,d)}const r=typeof e=="number"?e:(e==null?void 0:e.status)??i(this,yt);return Et(t,{status:r,headers:n})},ie),E="ALL",Ze="all",ta=["get","post","put","delete","options","patch"],we="Can not add a route since the matcher is already built.",ke=class extends Error{},ea="__COMPOSED_HANDLER",aa=t=>t.text("404 Not Found",404),ne=(t,e)=>{if("getResponse"in t){const a=t.getResponse();return e.newResponse(a.body,a)}return console.error(t),e.text("Internal Server Error",500)},_,I,Pe,L,J,Mt,jt,ht,na=(ht=class{constructor(e={}){b(this,I);y(this,"get");y(this,"post");y(this,"put");y(this,"delete");y(this,"options");y(this,"patch");y(this,"all");y(this,"on");y(this,"use");y(this,"router");y(this,"getPath");y(this,"_basePath","/");b(this,_,"/");y(this,"routes",[]);b(this,L,aa);y(this,"errorHandler",ne);y(this,"onError",e=>(this.errorHandler=e,this));y(this,"notFound",e=>(v(this,L,e),this));y(this,"fetch",(e,...a)=>g(this,I,jt).call(this,e,a[1],a[0],e.method));y(this,"request",(e,a,n,r)=>e instanceof Request?this.fetch(a?new Request(e,a):e,n,r):(e=e.toString(),this.fetch(new Request(/^https?:\/\//.test(e)?e:`http://localhost${pt("/",e)}`,a),n,r)));y(this,"fire",()=>{addEventListener("fetch",e=>{e.respondWith(g(this,I,jt).call(this,e.request,e,void 0,e.request.method))})});[...ta,Ze].forEach(s=>{this[s]=(o,...d)=>(typeof o=="string"?v(this,_,o):g(this,I,J).call(this,s,i(this,_),o),d.forEach(c=>{g(this,I,J).call(this,s,i(this,_),c)}),this)}),this.on=(s,o,...d)=>{for(const c of[o].flat()){v(this,_,c);for(const l of[s].flat())d.map(p=>{g(this,I,J).call(this,l.toUpperCase(),i(this,_),p)})}return this},this.use=(s,...o)=>(typeof s=="string"?v(this,_,s):(v(this,_,"*"),o.unshift(s)),o.forEach(d=>{g(this,I,J).call(this,E,i(this,_),d)}),this);const{strict:n,...r}=e;Object.assign(this,r),this.getPath=n??!0?e.getPath??me:$e}route(e,a){const n=this.basePath(e);return a.routes.map(r=>{var o;let s;a.errorHandler===ne?s=r.handler:(s=async(d,c)=>(await ee([],a.errorHandler)(d,()=>r.handler(d,c))).res,s[ea]=r.handler),g(o=n,I,J).call(o,r.method,r.path,s)}),this}basePath(e){const a=g(this,I,Pe).call(this);return a._basePath=pt(this._basePath,e),a}mount(e,a,n){let r,s;n&&(typeof n=="function"?s=n:(s=n.optionHandler,n.replaceRequest===!1?r=c=>c:r=n.replaceRequest));const o=s?c=>{const l=s(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};r||(r=(()=>{const c=pt(this._basePath,e),l=c==="/"?0:c.length;return p=>{const u=new URL(p.url);return u.pathname=u.pathname.slice(l)||"/",new Request(u,p)}})());const d=async(c,l)=>{const p=await a(r(c.req.raw),...o(c));if(p)return p;await l()};return g(this,I,J).call(this,E,pt(e,"*"),d),this}},_=new WeakMap,I=new WeakSet,Pe=function(){const e=new ht({router:this.router,getPath:this.getPath});return e.errorHandler=this.errorHandler,v(e,L,i(this,L)),e.routes=this.routes,e},L=new WeakMap,J=function(e,a,n){e=e.toUpperCase(),a=pt(this._basePath,a);const r={basePath:this._basePath,path:a,method:e,handler:n};this.router.add(e,a,[n,r]),this.routes.push(r)},Mt=function(e,a){if(e instanceof Error)return this.errorHandler(e,a);throw e},jt=function(e,a,n,r){if(r==="HEAD")return(async()=>new Response(null,await g(this,I,jt).call(this,e,a,n,"GET")))();const s=this.getPath(e,{env:n}),o=this.router.match(r,s),d=new Je(e,{path:s,matchResult:o,env:n,executionCtx:a,notFoundHandler:i(this,L)});if(o[0].length===1){let l;try{l=o[0][0][0][0](d,async()=>{d.res=await i(this,L).call(this,d)})}catch(p){return g(this,I,Mt).call(this,p,d)}return l instanceof Promise?l.then(p=>p||(d.finalized?d.res:i(this,L).call(this,d))).catch(p=>g(this,I,Mt).call(this,p,d)):l??i(this,L).call(this,d)}const c=ee(o[0],this.errorHandler,i(this,L));return(async()=>{try{const l=await c(d);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return g(this,I,Mt).call(this,l,d)}})()},ht),Ee=[];function sa(t,e){const a=this.buildAllMatchers(),n=((r,s)=>{const o=a[r]||a[E],d=o[2][s];if(d)return d;const c=s.match(o[0]);if(!c)return[[],Ee];const l=c.indexOf("",1);return[o[1][l],c]});return this.match=n,n(t,e)}var Ht="[^/]+",St=".*",Bt="(?:|/.*)",mt=Symbol(),ra=new Set(".\\+*[^]$()");function oa(t,e){return t.length===1?e.length===1?t<e?-1:1:-1:e.length===1||t===St||t===Bt?1:e===St||e===Bt?-1:t===Ht?1:e===Ht?-1:t.length===e.length?t<e?-1:1:e.length-t.length}var et,at,O,rt,ia=(rt=class{constructor(){b(this,et);b(this,at);b(this,O,Object.create(null))}insert(e,a,n,r,s){if(e.length===0){if(i(this,et)!==void 0)throw mt;if(s)return;v(this,et,a);return}const[o,...d]=e,c=o==="*"?d.length===0?["","",St]:["","",Ht]:o==="/*"?["","",Bt]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const p=c[1];let u=c[2]||Ht;if(p&&c[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw mt;if(l=i(this,O)[u],!l){if(Object.keys(i(this,O)).some(h=>h!==St&&h!==Bt))throw mt;if(s)return;l=i(this,O)[u]=new rt,p!==""&&v(l,at,r.varIndex++)}!s&&p!==""&&n.push([p,i(l,at)])}else if(l=i(this,O)[o],!l){if(Object.keys(i(this,O)).some(p=>p.length>1&&p!==St&&p!==Bt))throw mt;if(s)return;l=i(this,O)[o]=new rt}l.insert(d,a,n,r,s)}buildRegExpStr(){const a=Object.keys(i(this,O)).sort(oa).map(n=>{const r=i(this,O)[n];return(typeof i(r,at)=="number"?`(${n})@${i(r,at)}`:ra.has(n)?`\\${n}`:n)+r.buildRegExpStr()});return typeof i(this,et)=="number"&&a.unshift(`#${i(this,et)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},et=new WeakMap,at=new WeakMap,O=new WeakMap,rt),zt,Lt,de,da=(de=class{constructor(){b(this,zt,{varIndex:0});b(this,Lt,new ia)}insert(t,e,a){const n=[],r=[];for(let o=0;;){let d=!1;if(t=t.replace(/\{[^}]+\}/g,c=>{const l=`@\\${o}`;return r[o]=[l,c],o++,d=!0,l}),!d)break}const s=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=r.length-1;o>=0;o--){const[d]=r[o];for(let c=s.length-1;c>=0;c--)if(s[c].indexOf(d)!==-1){s[c]=s[c].replace(d,r[o][1]);break}}return i(this,Lt).insert(s,e,n,i(this,zt),a),n}buildRegExp(){let t=i(this,Lt).buildRegExpStr();if(t==="")return[/^$/,[],[]];let e=0;const a=[],n=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,s,o)=>s!==void 0?(a[++e]=Number(s),"$()"):(o!==void 0&&(n[Number(o)]=++e),"")),[new RegExp(`^${t}`),a,n]}},zt=new WeakMap,Lt=new WeakMap,de),la=[/^$/,[],Object.create(null)],qt=Object.create(null);function Ie(t){return qt[t]??(qt[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(e,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function ca(){qt=Object.create(null)}function pa(t){var l;const e=new da,a=[];if(t.length===0)return la;const n=t.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,u],[h,S])=>p?1:h?-1:u.length-S.length),r=Object.create(null);for(let p=0,u=-1,h=n.length;p<h;p++){const[S,k,N]=n[p];S?r[k]=[N.map(([R])=>[R,Object.create(null)]),Ee]:u++;let D;try{D=e.insert(k,u,S)}catch(R){throw R===mt?new ke(k):R}S||(a[u]=N.map(([R,P])=>{const M=Object.create(null);for(P-=1;P>=0;P--){const[wt,Kt]=D[P];M[wt]=Kt}return[R,M]}))}const[s,o,d]=e.buildRegExp();for(let p=0,u=a.length;p<u;p++)for(let h=0,S=a[p].length;h<S;h++){const k=(l=a[p][h])==null?void 0:l[1];if(!k)continue;const N=Object.keys(k);for(let D=0,R=N.length;D<R;D++)k[N[D]]=d[k[N[D]]]}const c=[];for(const p in o)c[p]=a[o[p]];return[s,c,r]}function lt(t,e){if(t){for(const a of Object.keys(t).sort((n,r)=>r.length-n.length))if(Ie(a).test(e))return[...t[a]]}}var $,Q,Ft,Se,le,ua=(le=class{constructor(){b(this,Ft);y(this,"name","RegExpRouter");b(this,$);b(this,Q);y(this,"match",sa);v(this,$,{[E]:Object.create(null)}),v(this,Q,{[E]:Object.create(null)})}add(t,e,a){var d;const n=i(this,$),r=i(this,Q);if(!n||!r)throw new Error(we);n[t]||[n,r].forEach(c=>{c[t]=Object.create(null),Object.keys(c[E]).forEach(l=>{c[t][l]=[...c[E][l]]})}),e==="/*"&&(e="*");const s=(e.match(/\/:/g)||[]).length;if(/\*$/.test(e)){const c=Ie(e);t===E?Object.keys(n).forEach(l=>{var p;(p=n[l])[e]||(p[e]=lt(n[l],e)||lt(n[E],e)||[])}):(d=n[t])[e]||(d[e]=lt(n[t],e)||lt(n[E],e)||[]),Object.keys(n).forEach(l=>{(t===E||t===l)&&Object.keys(n[l]).forEach(p=>{c.test(p)&&n[l][p].push([a,s])})}),Object.keys(r).forEach(l=>{(t===E||t===l)&&Object.keys(r[l]).forEach(p=>c.test(p)&&r[l][p].push([a,s]))});return}const o=ve(e)||[e];for(let c=0,l=o.length;c<l;c++){const p=o[c];Object.keys(r).forEach(u=>{var h;(t===E||t===u)&&((h=r[u])[p]||(h[p]=[...lt(n[u],p)||lt(n[E],p)||[]]),r[u][p].push([a,s-l+c+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(i(this,Q)).concat(Object.keys(i(this,$))).forEach(e=>{t[e]||(t[e]=g(this,Ft,Se).call(this,e))}),v(this,$,v(this,Q,void 0)),ca(),t}},$=new WeakMap,Q=new WeakMap,Ft=new WeakSet,Se=function(t){const e=[];let a=t===E;return[i(this,$),i(this,Q)].forEach(n=>{const r=n[t]?Object.keys(n[t]).map(s=>[s,n[t][s]]):[];r.length!==0?(a||(a=!0),e.push(...r)):t!==E&&e.push(...Object.keys(n[E]).map(s=>[s,n[E][s]]))}),a?pa(e):null},le),Y,z,ce,ma=(ce=class{constructor(t){y(this,"name","SmartRouter");b(this,Y,[]);b(this,z,[]);v(this,Y,t.routers)}add(t,e,a){if(!i(this,z))throw new Error(we);i(this,z).push([t,e,a])}match(t,e){if(!i(this,z))throw new Error("Fatal error");const a=i(this,Y),n=i(this,z),r=a.length;let s=0,o;for(;s<r;s++){const d=a[s];try{for(let c=0,l=n.length;c<l;c++)d.add(...n[c]);o=d.match(t,e)}catch(c){if(c instanceof ke)continue;throw c}this.match=d.match.bind(d),v(this,Y,[d]),v(this,z,void 0);break}if(s===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(i(this,z)||i(this,Y).length!==1)throw new Error("No active router has been determined yet.");return i(this,Y)[0]}},Y=new WeakMap,z=new WeakMap,ce),It=Object.create(null),va=t=>{for(const e in t)return!0;return!1},W,T,nt,gt,B,F,Z,xt,ya=(xt=class{constructor(e,a,n){b(this,F);b(this,W);b(this,T);b(this,nt);b(this,gt,0);b(this,B,It);if(v(this,T,n||Object.create(null)),v(this,W,[]),e&&a){const r=Object.create(null);r[e]={handler:a,possibleKeys:[],score:0},v(this,W,[r])}v(this,nt,[])}insert(e,a,n){v(this,gt,++te(this,gt)._);let r=this;const s=Fe(a),o=[];for(let d=0,c=s.length;d<c;d++){const l=s[d],p=s[d+1],u=Ue(l,p),h=Array.isArray(u)?u[0]:l;if(h in i(r,T)){r=i(r,T)[h],u&&o.push(u[1]);continue}i(r,T)[h]=new xt,u&&(i(r,nt).push(u),o.push(u[1])),r=i(r,T)[h]}return i(r,W).push({[e]:{handler:n,possibleKeys:o.filter((d,c,l)=>l.indexOf(d)===c),score:i(this,gt)}}),r}search(e,a){var p;const n=[];v(this,B,It);let s=[this];const o=ue(a),d=[],c=o.length;let l=null;for(let u=0;u<c;u++){const h=o[u],S=u===c-1,k=[];for(let D=0,R=s.length;D<R;D++){const P=s[D],M=i(P,T)[h];M&&(v(M,B,i(P,B)),S?(i(M,T)["*"]&&g(this,F,Z).call(this,n,i(M,T)["*"],e,i(P,B)),g(this,F,Z).call(this,n,M,e,i(P,B))):k.push(M));for(let wt=0,Kt=i(P,nt).length;wt<Kt;wt++){const Xt=i(P,nt)[wt],G=i(P,B)===It?{}:{...i(P,B)};if(Xt==="*"){const it=i(P,T)["*"];it&&(g(this,F,Z).call(this,n,it,e,i(P,B)),v(it,B,G),k.push(it));continue}const[_e,Jt,kt]=Xt;if(!h&&!(kt instanceof RegExp))continue;const j=i(P,T)[_e];if(kt instanceof RegExp){if(l===null){l=new Array(c);let dt=a[0]==="/"?1:0;for(let Pt=0;Pt<c;Pt++)l[Pt]=dt,dt+=o[Pt].length+1}const it=a.substring(l[u]),Gt=kt.exec(it);if(Gt){if(G[Jt]=Gt[0],g(this,F,Z).call(this,n,j,e,i(P,B),G),va(i(j,T))){v(j,B,G);const dt=((p=Gt[0].match(/\//))==null?void 0:p.length)??0;(d[dt]||(d[dt]=[])).push(j)}continue}}(kt===!0||kt.test(h))&&(G[Jt]=h,S?(g(this,F,Z).call(this,n,j,e,G,i(P,B)),i(j,T)["*"]&&g(this,F,Z).call(this,n,i(j,T)["*"],e,G,i(P,B))):(v(j,B,G),k.push(j)))}}const N=d.shift();s=N?k.concat(N):k}return n.length>1&&n.sort((u,h)=>u.score-h.score),[n.map(({handler:u,params:h})=>[u,h])]}},W=new WeakMap,T=new WeakMap,nt=new WeakMap,gt=new WeakMap,B=new WeakMap,F=new WeakSet,Z=function(e,a,n,r,s){for(let o=0,d=i(a,W).length;o<d;o++){const c=i(a,W)[o],l=c[n]||c[E],p={};if(l!==void 0&&(l.params=Object.create(null),e.push(l),r!==It||s&&s!==It))for(let u=0,h=l.possibleKeys.length;u<h;u++){const S=l.possibleKeys[u],k=p[l.score];l.params[S]=s!=null&&s[S]&&!k?s[S]:r[S]??(s==null?void 0:s[S]),p[l.score]=!0}}},xt),st,pe,ba=(pe=class{constructor(){y(this,"name","TrieRouter");b(this,st);v(this,st,new ya)}add(t,e,a){const n=ve(e);if(n){for(let r=0,s=n.length;r<s;r++)i(this,st).insert(t,n[r],a);return}i(this,st).insert(t,e,a)}match(t,e){return i(this,st).search(t,e)}},st=new WeakMap,pe),Be=class extends na{constructor(t={}){super(t),this.router=t.router??new ma({routers:[new ua,new ba]})}};const m=new Be;let Te="1234";const Ce="4321",Ne="2028-12-31";function X(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function ct(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function ot(t,e){if(!t.DATA_STORE)return[];let a;const n=[];do{const o=await t.DATA_STORE.list({prefix:e,cursor:a,limit:1e3});n.push(...o.keys.map(d=>d.name)),a=o.list_complete?void 0:o.cursor}while(a);const r=await Promise.all(n.map(o=>t.DATA_STORE.get(o))),s=[];for(let o=0;o<n.length;o++)if(r[o])try{s.push({_key:n[o],...JSON.parse(r[o])})}catch{}return s}function f(t){return new Response(t,{headers:{"content-type":"text/html;charset=UTF-8","Cache-Control":"no-store, no-cache, must-revalidate, proxy-revalidate",Pragma:"no-cache",Expires:"0"}})}m.post("/login",async t=>{var o;const e=await t.req.formData(),a=e.get("pin"),n=await((o=t.env.DATA_STORE)==null?void 0:o.get("APP_PIN"))||Te,r=(e.get("username")||"").trim(),s=await ot(t.env,"user:");if(s.length>0&&r){const d=s.find(c=>c.username===r&&c.password===a&&c.active!==!1);if(d){const c=encodeURIComponent(JSON.stringify({auth:1,userId:d._key,username:d.username,role:d.role,name:d.name}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${c}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Tt("Invalid credentials",s.length>0))}if(a===n){const d=encodeURIComponent(JSON.stringify({auth:1,userId:"admin",username:"admin",role:"admin",name:"Administrator"}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${d}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Tt("Wrong PIN",s.length>0))});m.get("/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"session=; Path=/; HttpOnly; Max-Age=0; SameSite=Strict",Location:"/login","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache","Clear-Site-Data":'"cache"'}}));function x(t){const a=(t.req.header("Cookie")||"").match(/session=([^;]+)/);if(!a)return null;try{return JSON.parse(decodeURIComponent(a[1]))}catch{return null}}m.use("*",async(t,e)=>{const a=new URL(t.req.url).pathname;if(a==="/login"&&t.req.method==="GET"){const l=await ot(t.env,"user:");return f(Tt("",l.length>0))}if(a==="/api/company-settings"&&t.req.method==="GET"){await e();return}if(!(new URL(t.req.url).searchParams.get("master")===Ce)){const l=new Date().toISOString().slice(0,10);if(l>Ne)return f(se());if(t.env.DATA_STORE){const p=await t.env.DATA_STORE.get("APP_LICENSE");if(p&&l>p)return f(se())}}if(a.startsWith("/sp-portal")){const p=(t.req.header("Cookie")||"").match(/sp_session=([^;]+)/);if(a==="/sp-portal/login"&&t.req.method==="GET"||!p&&a!=="/sp-portal/login")return f(Yt(""));await e();return}const s=x(t);if(!(s!=null&&s.auth)&&a!=="/login")return f(Tt("",!1));const o={admin:[],manager:["/users","/admin"],entry:["/users","/admin","/reports","/profit-loss","/balance-sheet","/trial-balance","/stock","/receivable-payable","/salesperson","/expense-ledger","/approvals","/company-settings"],viewer:["/inventory","/parties","/purchases","/sales","/payments","/expenses","/orders","/users","/admin","/salesperson","/approvals","/company-settings"]},d=(s==null?void 0:s.role)||"admin";if((o[d]||[]).includes(a))return f(w(`<div class="card"><div class="empty" style="padding:40px"><h3>Access Denied</h3><p class="text-muted">You don't have permission to access this page.</p><a href="/" class="btn btn-primary" style="margin-top:12px">Go to Dashboard</a></div></div>`,"dashboard",s));await e()});m.get("/api/license-info",async t=>{const a=(t.env.DATA_STORE?await t.env.DATA_STORE.get("APP_LICENSE"):null)||Ne,n=Math.floor((new Date(a).getTime()-Date.now())/864e5);return t.json({expiry:a,days:n,status:n<0?"Expired":"Active"})});m.post("/api/set-license",async t=>{if(new URL(t.req.url).searchParams.get("master")!==Ce)return t.json({success:!1,error:"Unauthorized"},403);const a=await t.req.json();return t.env.DATA_STORE?(await t.env.DATA_STORE.put("APP_LICENSE",String((a==null?void 0:a.date)||"")),t.json({success:!0})):t.json({success:!1,error:"KV not configured"},500)});m.post("/api/list",async t=>{const e=await t.req.json();return t.json(await ot(t.env,(e==null?void 0:e.prefix)||""))});const Ae=["product:","party:","sale:","purchase:","payment:","expense:","bank:","order:","salesperson:"];m.post("/api/save",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=await t.req.json(),a=(e==null?void 0:e.prefix)||"",n=e==null?void 0:e.id,r=e==null?void 0:e.key,s=(e==null?void 0:e.data)||{},o=(e==null?void 0:e.logAction)||"",d=(e==null?void 0:e.logDetail)||"",c=(e==null?void 0:e.skipApproval)===!0;let l=r;l||(n?l=n.startsWith(a)?n:a+n:l=a+X());const p=x(t),u=(p==null?void 0:p.role)==="entry",h=!!(r||n),S=Ae.some(k=>a&&a===k||l&&l.startsWith(k));if(u&&h&&S&&!c){const k="approval:"+X(),N=await t.env.DATA_STORE.get(l);return await t.env.DATA_STORE.put(k,JSON.stringify({type:"edit",targetKey:l,prefix:a,newData:s,oldData:N?JSON.parse(N):null,detail:d||"Edit: "+l,requestedBy:(p==null?void 0:p.name)||(p==null?void 0:p.username)||"Unknown",requestedAt:new Date().toISOString(),status:"pending"})),t.json({success:!0,key:l,pending:!0,message:"Your edit has been submitted for approval"})}if(await t.env.DATA_STORE.put(l,JSON.stringify(s)),o){const k="modlog:"+X();await t.env.DATA_STORE.put(k,JSON.stringify({action:o,detail:d,key:l,prefix:a,user:(p==null?void 0:p.name)||(p==null?void 0:p.username)||"System",timestamp:new Date().toISOString()}))}return t.json({success:!0,key:l})});m.post("/api/get",async t=>{if(!t.env.DATA_STORE)return t.json(null);const{key:e}=await t.req.json(),a=await t.env.DATA_STORE.get(e);return t.json(a?JSON.parse(a):null)});m.post("/api/delete",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=await t.req.json(),a=e==null?void 0:e.key,n=(e==null?void 0:e.logDetail)||"",r=(e==null?void 0:e.skipApproval)===!0;if(!a)return t.json({success:!1,error:"Key is required"},400);const s=x(t),o=(s==null?void 0:s.role)==="entry",d=Ae.some(p=>a.startsWith(p));if(o&&d&&!r){const p=await t.env.DATA_STORE.get(a),u="approval:"+X();return await t.env.DATA_STORE.put(u,JSON.stringify({type:"delete",targetKey:a,prefix:a.split(":")[0]+":",newData:null,oldData:p?JSON.parse(p):null,detail:n||"Delete: "+a,requestedBy:(s==null?void 0:s.name)||(s==null?void 0:s.username)||"Unknown",requestedAt:new Date().toISOString(),status:"pending"})),t.json({success:!0,pending:!0,message:"Your delete request has been submitted for approval"})}const c=await t.env.DATA_STORE.get(a);await t.env.DATA_STORE.delete(a);const l="modlog:"+X();return await t.env.DATA_STORE.put(l,JSON.stringify({action:"delete",detail:n||"Deleted key: "+a,key:a,oldData:c?c.substring(0,500):"",user:(s==null?void 0:s.name)||(s==null?void 0:s.username)||"System",timestamp:new Date().toISOString()})),t.json({success:!0})});m.post("/api/approval-list",async t=>t.json(await ot(t.env,"approval:")));m.post("/api/approval-action",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=x(t),a=(e==null?void 0:e.role)||"";if(a!=="admin"&&a!=="manager")return t.json({success:!1,error:"Only admin/manager can approve"},403);const{approvalKey:n,action:r}=await t.req.json();if(!n)return t.json({success:!1,error:"Approval key required"},400);const s=await t.env.DATA_STORE.get(n);if(!s)return t.json({success:!1,error:"Approval not found"},404);const o=JSON.parse(s);if(o.status!=="pending")return t.json({success:!1,error:"Already processed"},400);if(r==="approve"){if(o.type==="edit"&&o.targetKey&&o.newData){await t.env.DATA_STORE.put(o.targetKey,JSON.stringify(o.newData));const d="modlog:"+X();await t.env.DATA_STORE.put(d,JSON.stringify({action:"edit",detail:"Approved edit by "+o.requestedBy+": "+o.detail,key:o.targetKey,prefix:o.prefix,user:(e==null?void 0:e.name)||(e==null?void 0:e.username)||"System",timestamp:new Date().toISOString()}))}else if(o.type==="delete"&&o.targetKey){await t.env.DATA_STORE.delete(o.targetKey);const d="modlog:"+X();await t.env.DATA_STORE.put(d,JSON.stringify({action:"delete",detail:"Approved delete by "+o.requestedBy+": "+o.detail,key:o.targetKey,prefix:o.prefix,user:(e==null?void 0:e.name)||(e==null?void 0:e.username)||"System",timestamp:new Date().toISOString()}))}o.status="approved"}else o.status="rejected";return o.processedBy=(e==null?void 0:e.name)||(e==null?void 0:e.username)||"System",o.processedAt=new Date().toISOString(),await t.env.DATA_STORE.put(n,JSON.stringify(o)),t.json({success:!0,status:o.status})});m.get("/api/company-settings",async t=>{if(!t.env.DATA_STORE)return t.json({companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"});const e=await t.env.DATA_STORE.get("COMPANY_SETTINGS");return e?t.json(JSON.parse(e)):t.json({companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"})});m.post("/api/company-settings",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=x(t);if((e==null?void 0:e.role)!=="admin")return t.json({success:!1,error:"Only admin can change company settings"},403);const a=await t.req.json();return await t.env.DATA_STORE.put("COMPANY_SETTINGS",JSON.stringify(a)),t.json({success:!0})});m.post("/api/export-all",async t=>{const e=["product:","party:","sale:","purchase:","payment:","expense:","exphead:","expsubhead:","bank:","cb:","user:","order:","salesperson:","creditlimit:","prodgroup:","modlog:","approval:","companysettings:"],a={};for(const n of e)a[n]=await ot(t.env,n);return t.json(a)});m.post("/api/import-all",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=await t.req.json();let a=0;for(const[n,r]of Object.entries(e))if(Array.isArray(r))for(const s of r){const o=s._key||n+X(),d={...s};delete d._key,await t.env.DATA_STORE.put(o,JSON.stringify(d)),a++}return t.json({success:!0,count:a})});m.post("/api/change-pin",async t=>{var r;const{oldPin:e,newPin:a}=await t.req.json(),n=await((r=t.env.DATA_STORE)==null?void 0:r.get("APP_PIN"))||Te;return e!==n?t.json({success:!1,error:"Wrong current PIN"}):!a||a.length<4?t.json({success:!1,error:"PIN must be at least 4 characters"}):(await t.env.DATA_STORE.put("APP_PIN",a),t.json({success:!0}))});m.post("/api/kv-keys",async t=>{const{prefix:e}=await t.req.json();if(!t.env.DATA_STORE)return t.json([]);const a=await t.env.DATA_STORE.list({prefix:e||"",limit:100});return t.json(a.keys.map(n=>n.name))});m.post("/api/kv-get",async t=>{const{key:e}=await t.req.json();if(!t.env.DATA_STORE)return t.json({value:null});const a=await t.env.DATA_STORE.get(e);return t.json({value:a})});m.post("/api/kv-delete",async t=>{const{key:e}=await t.req.json();return t.env.DATA_STORE?(await t.env.DATA_STORE.delete(e),t.json({success:!0})):t.json({success:!1})});m.post("/sp-portal/login",async t=>{const e=await t.req.formData(),a=e.get("code"),n=e.get("pin"),s=(await ot(t.env,"salesperson:")).find(o=>o.code===a&&o.pin===n&&o.active!==!1);if(s){const o=encodeURIComponent(JSON.stringify({spId:s._key,spName:s.name,spCode:s.code}));return new Response(null,{status:302,headers:{"Set-Cookie":`sp_session=${o}; Path=/; HttpOnly; SameSite=Strict`,Location:"/sp-portal"}})}return f(Yt("Invalid credentials"))});m.get("/sp-portal/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"sp_session=; Path=/; HttpOnly; Max-Age=0",Location:"/sp-portal/login"}}));m.get("/",t=>f(w(ha(),"dashboard",x(t))));m.get("/inventory",t=>f(w(ga(),"inventory",x(t))));m.get("/stock-check",t=>f(w(xa(),"stockcheck",x(t))));m.get("/parties",t=>f(w(wa(),"parties",x(t))));m.get("/purchases",t=>f(w(ka(),"purchases",x(t))));m.get("/sales",t=>f(w(Pa(),"sales",x(t))));m.get("/payments",t=>f(w(Ea(),"payments",x(t))));m.get("/expenses",t=>f(w(Ia(),"expenses",x(t))));m.get("/ledger",t=>f(w(Sa(),"ledger",x(t))));m.get("/expense-ledger",t=>f(w(Ba(),"expledger",x(t))));m.get("/profit-loss",t=>f(w(Ta(),"profitloss",x(t))));m.get("/balance-sheet",t=>f(w(Ca(),"balancesheet",x(t))));m.get("/trial-balance",t=>f(w(Na(),"trialbalance",x(t))));m.get("/stock",t=>f(w(Aa(),"stock",x(t))));m.get("/receivable-payable",t=>f(w(Da(),"recpay",x(t))));m.get("/day-details",t=>f(w(_a(),"daydetails",x(t))));m.get("/reports",t=>f(w(La(),"reports",x(t))));m.get("/salesperson",t=>f(w(Oa(),"salesperson",x(t))));m.get("/orders",t=>f(w(Ra(),"orders",x(t))));m.get("/users",t=>f(w(Ma(),"users",x(t))));m.get("/admin",t=>f(w(ja(),"admin",x(t))));m.get("/mod-log",t=>f(w(qa(),"modlog",x(t))));m.get("/approvals",t=>f(w(Ha(),"approvals",x(t))));m.get("/company-settings",t=>f(w(za(),"companysettings",x(t))));m.get("/sp-portal",t=>f(fa(t)));m.get("/login",async t=>{const e=await ot(t.env,"user:");return f(Tt("",e.length>0))});function Ot(){return`<style>
...
</body></html>`}function Tt(t,e=!1){return`<!doctype html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">

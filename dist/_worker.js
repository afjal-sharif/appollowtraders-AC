var Mt=Object.defineProperty;var Za=a=>{throw TypeError(a)};var At=(a,t,e)=>t in a?Mt(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var g=(a,t,e)=>At(a,typeof t!="symbol"?t+"":t,e),Ja=(a,t,e)=>t.has(a)||Za("Cannot "+e);var o=(a,t,e)=>(Ja(a,t,"read from private field"),e?e.call(a):t.get(a)),v=(a,t,e)=>t.has(a)?Za("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(Ja(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),x=(a,t,e)=>(Ja(a,t,"access private method"),e);var at=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return o(a,t,r)}});var tt=(a,t,e)=>(r,i)=>{let n=-1;return s(0);async function s(d){if(d<=n)throw new Error("next() called multiple times");n=d;let c,l=!1,p;if(a[d]?(p=a[d][0][0],r.req.routeIndex=d):p=d===a.length&&i||void 0,p)try{c=await p(r,()=>s(d+1))}catch(u){if(u instanceof Error&&t)r.error=u,c=await t(u,r),l=!0;else throw u}else r.finalized===!1&&e&&(c=await e(r));return c&&(r.finalized===!1||l)&&(r.res=c),r}},Lt=Symbol(),Kt=async(a,t=Object.create(null))=>{const{all:e=!1,dot:r=!1}=t,n=(a instanceof bt?a.raw.headers:a.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?_t(a,{all:e,dot:r}):{}};async function _t(a,t){const e=await a.formData();return e?Ft(e,t):{}}function Ft(a,t){const e=Object.create(null);return a.forEach((r,i)=>{t.all||i.endsWith("[]")?Ot(e,i,r):e[i]=r}),t.dot&&Object.entries(e).forEach(([r,i])=>{r.includes(".")&&(zt(e,r,i),delete e[r])}),e}var Ot=(a,t,e)=>{a[t]!==void 0?Array.isArray(a[t])?a[t].push(e):a[t]=[a[t],e]:t.endsWith("[]")?a[t]=[e]:a[t]=e},zt=(a,t,e)=>{if(/(?:^|\.)__proto__\./.test(t))return;let r=a;const i=t.split(".");i.forEach((n,s)=>{s===i.length-1?r[n]=e:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},ut=a=>{const t=a.split("/");return t[0]===""&&t.shift(),t},Ht=a=>{const{groups:t,path:e}=Gt(a),r=ut(e);return qt(r,t)},Gt=a=>{const t=[];return a=a.replace(/\{[^}]+\}/g,(e,r)=>{const i=`@${r}`;return t.push([i,e]),i}),{groups:t,path:a}},qt=(a,t)=>{for(let e=t.length-1;e>=0;e--){const[r]=t[e];for(let i=a.length-1;i>=0;i--)if(a[i].includes(r)){a[i]=a[i].replace(r,t[e][1]);break}}return a},La={},Jt=(a,t)=>{if(a==="*")return"*";const e=a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(e){const r=`${a}#${t}`;return La[r]||(e[2]?La[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,e[1],new RegExp(`^${e[2]}(?=/${t})`)]:[a,e[1],new RegExp(`^${e[2]}$`)]:La[r]=[a,e[1],!0]),La[r]}return null},$a=(a,t)=>{try{return t(a)}catch{return a.replace(/(?:%[0-9A-Fa-f]{2})+/g,e=>{try{return t(e)}catch{return e}})}},Ut=a=>$a(a,decodeURI),ht=a=>{const t=a.url,e=t.indexOf("/",t.indexOf(":")+4);let r=e;for(;r<t.length;r++){const i=t.charCodeAt(r);if(i===37){const n=t.indexOf("?",r),s=t.indexOf("#",r),d=n===-1?s===-1?void 0:s:s===-1?n:Math.min(n,s),c=t.slice(e,d);return Ut(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(i===63||i===35)break}return t.slice(e,r)},Vt=a=>{const t=ht(a);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},pa=(a,t,...e)=>(e.length&&(t=pa(t,...e)),`${(a==null?void 0:a[0])==="/"?"":"/"}${a}${t==="/"?"":`${(a==null?void 0:a.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),mt=a=>{if(a.charCodeAt(a.length-1)!==63||!a.includes(":"))return null;const t=a.split("/"),e=[];let r="";return t.forEach(i=>{if(i!==""&&!/\:/.test(i))r+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){e.length===0&&r===""?e.push("/"):e.push(r);const n=i.replace("?","");r+="/"+n,e.push(r)}else r+="/"+i}),e.filter((i,n,s)=>s.indexOf(i)===n)},Ua=a=>/[%+]/.test(a)?(a.indexOf("+")!==-1&&(a=a.replace(/\+/g," ")),a.indexOf("%")!==-1?$a(a,vt):a):a,gt=(a,t,e)=>{let r;if(!e&&t&&!/[%+]/.test(t)){let s=a.indexOf("?",8);if(s===-1)return;for(a.startsWith(t,s+1)||(s=a.indexOf(`&${t}`,s+1));s!==-1;){const d=a.charCodeAt(s+t.length+1);if(d===61){const c=s+t.length+2,l=a.indexOf("&",c);return Ua(a.slice(c,l===-1?void 0:l))}else if(d==38||isNaN(d))return"";s=a.indexOf(`&${t}`,s+1)}if(r=/[%+]/.test(a),!r)return}const i={};r??(r=/[%+]/.test(a));let n=a.indexOf("?",8);for(;n!==-1;){const s=a.indexOf("&",n+1);let d=a.indexOf("=",n);d>s&&s!==-1&&(d=-1);let c=a.slice(n+1,d===-1?s===-1?void 0:s:d);if(r&&(c=Ua(c)),n=s,c==="")continue;let l;d===-1?l="":(l=a.slice(d+1,s===-1?void 0:s),r&&(l=Ua(l))),e?(i[c]&&Array.isArray(i[c])||(i[c]=[]),i[c].push(l)):i[c]??(i[c]=l)}return t?i[t]:i},Xt=gt,Qt=(a,t)=>gt(a,t,!0),vt=decodeURIComponent,et=a=>$a(a,vt),ma,j,G,ft,yt,Xa,J,st,bt=(st=class{constructor(a,t="/",e=[[]]){v(this,G);g(this,"raw");v(this,ma);v(this,j);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});v(this,J,a=>{const{bodyCache:t,raw:e}=this,r=t[a];if(r)return r;const i=Object.keys(t)[0];return i?t[i].then(n=>(i==="json"&&(n=JSON.stringify(n)),new Response(n)[a]())):t[a]=e[a]()});this.raw=a,this.path=t,m(this,j,e),m(this,ma,{})}param(a){return a?x(this,G,ft).call(this,a):x(this,G,yt).call(this)}query(a){return Xt(this.url,a)}queries(a){return Qt(this.url,a)}header(a){if(a)return this.raw.headers.get(a)??void 0;const t={};return this.raw.headers.forEach((e,r)=>{t[r]=e}),t}async parseBody(a){return Kt(this,a)}json(){return o(this,J).call(this,"text").then(a=>JSON.parse(a))}text(){return o(this,J).call(this,"text")}arrayBuffer(){return o(this,J).call(this,"arrayBuffer")}blob(){return o(this,J).call(this,"blob")}formData(){return o(this,J).call(this,"formData")}addValidatedData(a,t){o(this,ma)[a]=t}valid(a){return o(this,ma)[a]}get url(){return this.raw.url}get method(){return this.raw.method}get[Lt](){return o(this,j)}get matchedRoutes(){return o(this,j)[0].map(([[,a]])=>a)}get routePath(){return o(this,j)[0].map(([[,a]])=>a)[this.routeIndex].path}},ma=new WeakMap,j=new WeakMap,G=new WeakSet,ft=function(a){const t=o(this,j)[0][this.routeIndex][1][a],e=x(this,G,Xa).call(this,t);return e&&/\%/.test(e)?et(e):e},yt=function(){const a={},t=Object.keys(o(this,j)[0][this.routeIndex][1]);for(const e of t){const r=x(this,G,Xa).call(this,o(this,j)[0][this.routeIndex][1][e]);r!==void 0&&(a[e]=/\%/.test(r)?et(r):r)}return a},Xa=function(a){return o(this,j)[1]?o(this,j)[1][a]:a},J=new WeakMap,st),$t={Stringify:1},xt=async(a,t,e,r,i)=>{typeof a=="object"&&!(a instanceof String)&&(a instanceof Promise||(a=a.toString()),a instanceof Promise&&(a=await a));const n=a.callbacks;return n!=null&&n.length?(i?i[0]+=a:i=[a],Promise.all(n.map(d=>d({phase:t,buffer:i,context:r}))).then(d=>Promise.all(d.filter(Boolean).map(c=>xt(c,t,!1,r,i))).then(()=>i[0]))):Promise.resolve(a)},Yt="text/plain; charset=UTF-8",Va=(a,t)=>({"Content-Type":a,...t}),Ba=(a,t)=>new Response(a,t),Ea,Da,F,ga,O,E,ja,va,ba,aa,Na,Ra,U,ua,ot,Wt=(ot=class{constructor(a,t){v(this,U);v(this,Ea);v(this,Da);g(this,"env",{});v(this,F);g(this,"finalized",!1);g(this,"error");v(this,ga);v(this,O);v(this,E);v(this,ja);v(this,va);v(this,ba);v(this,aa);v(this,Na);v(this,Ra);g(this,"render",(...a)=>(o(this,va)??m(this,va,t=>this.html(t)),o(this,va).call(this,...a)));g(this,"setLayout",a=>m(this,ja,a));g(this,"getLayout",()=>o(this,ja));g(this,"setRenderer",a=>{m(this,va,a)});g(this,"header",(a,t,e)=>{this.finalized&&m(this,E,Ba(o(this,E).body,o(this,E)));const r=o(this,E)?o(this,E).headers:o(this,aa)??m(this,aa,new Headers);t===void 0?r.delete(a):e!=null&&e.append?r.append(a,t):r.set(a,t)});g(this,"status",a=>{m(this,ga,a)});g(this,"set",(a,t)=>{o(this,F)??m(this,F,new Map),o(this,F).set(a,t)});g(this,"get",a=>o(this,F)?o(this,F).get(a):void 0);g(this,"newResponse",(...a)=>x(this,U,ua).call(this,...a));g(this,"body",(a,t,e)=>x(this,U,ua).call(this,a,t,e));g(this,"text",(a,t,e)=>!o(this,aa)&&!o(this,ga)&&!t&&!e&&!this.finalized?new Response(a):x(this,U,ua).call(this,a,t,Va(Yt,e)));g(this,"json",(a,t,e)=>x(this,U,ua).call(this,JSON.stringify(a),t,Va("application/json",e)));g(this,"html",(a,t,e)=>{const r=i=>x(this,U,ua).call(this,i,t,Va("text/html; charset=UTF-8",e));return typeof a=="object"?xt(a,$t.Stringify,!1,{}).then(r):r(a)});g(this,"redirect",(a,t)=>{const e=String(a);return this.header("Location",/[^\x00-\xFF]/.test(e)?encodeURI(e):e),this.newResponse(null,t??302)});g(this,"notFound",()=>(o(this,ba)??m(this,ba,()=>Ba()),o(this,ba).call(this,this)));m(this,Ea,a),t&&(m(this,O,t.executionCtx),this.env=t.env,m(this,ba,t.notFoundHandler),m(this,Ra,t.path),m(this,Na,t.matchResult))}get req(){return o(this,Da)??m(this,Da,new bt(o(this,Ea),o(this,Ra),o(this,Na))),o(this,Da)}get event(){if(o(this,O)&&"respondWith"in o(this,O))return o(this,O);throw Error("This context has no FetchEvent")}get executionCtx(){if(o(this,O))return o(this,O);throw Error("This context has no ExecutionContext")}get res(){return o(this,E)||m(this,E,Ba(null,{headers:o(this,aa)??m(this,aa,new Headers)}))}set res(a){if(o(this,E)&&a){a=Ba(a.body,a);for(const[t,e]of o(this,E).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=o(this,E).headers.getSetCookie();a.headers.delete("set-cookie");for(const i of r)a.headers.append("set-cookie",i)}else a.headers.set(t,e)}m(this,E,a),this.finalized=!0}get var(){return o(this,F)?Object.fromEntries(o(this,F)):{}}},Ea=new WeakMap,Da=new WeakMap,F=new WeakMap,ga=new WeakMap,O=new WeakMap,E=new WeakMap,ja=new WeakMap,va=new WeakMap,ba=new WeakMap,aa=new WeakMap,Na=new WeakMap,Ra=new WeakMap,U=new WeakSet,ua=function(a,t,e){const r=o(this,E)?new Headers(o(this,E).headers):o(this,aa)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[s,d]of n)s.toLowerCase()==="set-cookie"?r.append(s,d):r.set(s,d)}if(e)for(const[n,s]of Object.entries(e))if(typeof s=="string")r.set(n,s);else{r.delete(n);for(const d of s)r.append(n,d)}const i=typeof t=="number"?t:(t==null?void 0:t.status)??o(this,ga);return Ba(a,{status:i,headers:r})},ot),C="ALL",Zt="all",ae=["get","post","put","delete","options","patch"],kt="Can not add a route since the matcher is already built.",St=class extends Error{},te="__COMPOSED_HANDLER",ee=a=>a.text("404 Not Found",404),rt=(a,t)=>{if("getResponse"in a){const e=a.getResponse();return t.newResponse(e.body,e)}return console.error(a),t.text("Internal Server Error",500)},R,P,wt,M,W,Ka,_a,fa,re=(fa=class{constructor(t={}){v(this,P);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");v(this,R,"/");g(this,"routes",[]);v(this,M,ee);g(this,"errorHandler",rt);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(m(this,M,t),this));g(this,"fetch",(t,...e)=>x(this,P,_a).call(this,t,e[1],e[0],t.method));g(this,"request",(t,e,r,i)=>t instanceof Request?this.fetch(e?new Request(t,e):t,r,i):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${pa("/",t)}`,e),r,i)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(x(this,P,_a).call(this,t.request,t,void 0,t.request.method))})});[...ae,Zt].forEach(n=>{this[n]=(s,...d)=>(typeof s=="string"?m(this,R,s):x(this,P,W).call(this,n,o(this,R),s),d.forEach(c=>{x(this,P,W).call(this,n,o(this,R),c)}),this)}),this.on=(n,s,...d)=>{for(const c of[s].flat()){m(this,R,c);for(const l of[n].flat())d.map(p=>{x(this,P,W).call(this,l.toUpperCase(),o(this,R),p)})}return this},this.use=(n,...s)=>(typeof n=="string"?m(this,R,n):(m(this,R,"*"),s.unshift(n)),s.forEach(d=>{x(this,P,W).call(this,C,o(this,R),d)}),this);const{strict:r,...i}=t;Object.assign(this,i),this.getPath=r??!0?t.getPath??ht:Vt}route(t,e){const r=this.basePath(t);return e.routes.map(i=>{var s;let n;e.errorHandler===rt?n=i.handler:(n=async(d,c)=>(await tt([],e.errorHandler)(d,()=>i.handler(d,c))).res,n[te]=i.handler),x(s=r,P,W).call(s,i.method,i.path,n)}),this}basePath(t){const e=x(this,P,wt).call(this);return e._basePath=pa(this._basePath,t),e}mount(t,e,r){let i,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?i=c=>c:i=r.replaceRequest));const s=n?c=>{const l=n(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};i||(i=(()=>{const c=pa(this._basePath,t),l=c==="/"?0:c.length;return p=>{const u=new URL(p.url);return u.pathname=u.pathname.slice(l)||"/",new Request(u,p)}})());const d=async(c,l)=>{const p=await e(i(c.req.raw),...s(c));if(p)return p;await l()};return x(this,P,W).call(this,C,pa(t,"*"),d),this}},R=new WeakMap,P=new WeakSet,wt=function(){const t=new fa({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,m(t,M,o(this,M)),t.routes=this.routes,t},M=new WeakMap,W=function(t,e,r){t=t.toUpperCase(),e=pa(this._basePath,e);const i={basePath:this._basePath,path:e,method:t,handler:r};this.router.add(t,e,[r,i]),this.routes.push(i)},Ka=function(t,e){if(t instanceof Error)return this.errorHandler(t,e);throw t},_a=function(t,e,r,i){if(i==="HEAD")return(async()=>new Response(null,await x(this,P,_a).call(this,t,e,r,"GET")))();const n=this.getPath(t,{env:r}),s=this.router.match(i,n),d=new Wt(t,{path:n,matchResult:s,env:r,executionCtx:e,notFoundHandler:o(this,M)});if(s[0].length===1){let l;try{l=s[0][0][0][0](d,async()=>{d.res=await o(this,M).call(this,d)})}catch(p){return x(this,P,Ka).call(this,p,d)}return l instanceof Promise?l.then(p=>p||(d.finalized?d.res:o(this,M).call(this,d))).catch(p=>x(this,P,Ka).call(this,p,d)):l??o(this,M).call(this,d)}const c=tt(s[0],this.errorHandler,o(this,M));return(async()=>{try{const l=await c(d);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return x(this,P,Ka).call(this,l,d)}})()},fa),Bt=[];function ne(a,t){const e=this.buildAllMatchers(),r=((i,n)=>{const s=e[i]||e[C],d=s[2][n];if(d)return d;const c=n.match(s[0]);if(!c)return[[],Bt];const l=c.indexOf("",1);return[s[1][l],c]});return this.match=r,r(a,t)}var Oa="[^/]+",Pa=".*",Ia="(?:|/.*)",ha=Symbol(),ie=new Set(".\\+*[^]$()");function se(a,t){return a.length===1?t.length===1?a<t?-1:1:-1:t.length===1||a===Pa||a===Ia?1:t===Pa||t===Ia?-1:a===Oa?1:t===Oa?-1:a.length===t.length?a<t?-1:1:t.length-a.length}var ta,ea,A,ia,oe=(ia=class{constructor(){v(this,ta);v(this,ea);v(this,A,Object.create(null))}insert(t,e,r,i,n){if(t.length===0){if(o(this,ta)!==void 0)throw ha;if(n)return;m(this,ta,e);return}const[s,...d]=t,c=s==="*"?d.length===0?["","",Pa]:["","",Oa]:s==="/*"?["","",Ia]:s.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const p=c[1];let u=c[2]||Oa;if(p&&c[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ha;if(l=o(this,A)[u],!l){if(Object.keys(o(this,A)).some(f=>f!==Pa&&f!==Ia))throw ha;if(n)return;l=o(this,A)[u]=new ia,p!==""&&m(l,ea,i.varIndex++)}!n&&p!==""&&r.push([p,o(l,ea)])}else if(l=o(this,A)[s],!l){if(Object.keys(o(this,A)).some(p=>p.length>1&&p!==Pa&&p!==Ia))throw ha;if(n)return;l=o(this,A)[s]=new ia}l.insert(d,e,r,i,n)}buildRegExpStr(){const e=Object.keys(o(this,A)).sort(se).map(r=>{const i=o(this,A)[r];return(typeof o(i,ea)=="number"?`(${r})@${o(i,ea)}`:ie.has(r)?`\\${r}`:r)+i.buildRegExpStr()});return typeof o(this,ta)=="number"&&e.unshift(`#${o(this,ta)}`),e.length===0?"":e.length===1?e[0]:"(?:"+e.join("|")+")"}},ta=new WeakMap,ea=new WeakMap,A=new WeakMap,ia),za,Ma,lt,le=(lt=class{constructor(){v(this,za,{varIndex:0});v(this,Ma,new oe)}insert(a,t,e){const r=[],i=[];for(let s=0;;){let d=!1;if(a=a.replace(/\{[^}]+\}/g,c=>{const l=`@\\${s}`;return i[s]=[l,c],s++,d=!0,l}),!d)break}const n=a.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let s=i.length-1;s>=0;s--){const[d]=i[s];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(d)!==-1){n[c]=n[c].replace(d,i[s][1]);break}}return o(this,Ma).insert(n,t,r,o(this,za),e),r}buildRegExp(){let a=o(this,Ma).buildRegExpStr();if(a==="")return[/^$/,[],[]];let t=0;const e=[],r=[];return a=a.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,n,s)=>n!==void 0?(e[++t]=Number(n),"$()"):(s!==void 0&&(r[Number(s)]=++t),"")),[new RegExp(`^${a}`),e,r]}},za=new WeakMap,Ma=new WeakMap,lt),de=[/^$/,[],Object.create(null)],Fa=Object.create(null);function Ct(a){return Fa[a]??(Fa[a]=new RegExp(a==="*"?"":`^${a.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,e)=>e?`\\${e}`:"(?:|/.*)")}$`))}function ce(){Fa=Object.create(null)}function pe(a){var l;const t=new le,e=[];if(a.length===0)return de;const r=a.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,u],[f,S])=>p?1:f?-1:u.length-S.length),i=Object.create(null);for(let p=0,u=-1,f=r.length;p<f;p++){const[S,w,D]=r[p];S?i[w]=[D.map(([L])=>[L,Object.create(null)]),Bt]:u++;let N;try{N=t.insert(w,u,S)}catch(L){throw L===ha?new St(w):L}S||(e[u]=D.map(([L,B])=>{const K=Object.create(null);for(B-=1;B>=0;B--){const[ka,Ga]=N[B];K[ka]=Ga}return[L,K]}))}const[n,s,d]=t.buildRegExp();for(let p=0,u=e.length;p<u;p++)for(let f=0,S=e[p].length;f<S;f++){const w=(l=e[p][f])==null?void 0:l[1];if(!w)continue;const D=Object.keys(w);for(let N=0,L=D.length;N<L;N++)w[D[N]]=d[w[D[N]]]}const c=[];for(const p in s)c[p]=e[s[p]];return[n,c,i]}function da(a,t){if(a){for(const e of Object.keys(a).sort((r,i)=>i.length-r.length))if(Ct(e).test(t))return[...a[e]]}}var V,X,Ha,Pt,dt,ue=(dt=class{constructor(){v(this,Ha);g(this,"name","RegExpRouter");v(this,V);v(this,X);g(this,"match",ne);m(this,V,{[C]:Object.create(null)}),m(this,X,{[C]:Object.create(null)})}add(a,t,e){var d;const r=o(this,V),i=o(this,X);if(!r||!i)throw new Error(kt);r[a]||[r,i].forEach(c=>{c[a]=Object.create(null),Object.keys(c[C]).forEach(l=>{c[a][l]=[...c[C][l]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=Ct(t);a===C?Object.keys(r).forEach(l=>{var p;(p=r[l])[t]||(p[t]=da(r[l],t)||da(r[C],t)||[])}):(d=r[a])[t]||(d[t]=da(r[a],t)||da(r[C],t)||[]),Object.keys(r).forEach(l=>{(a===C||a===l)&&Object.keys(r[l]).forEach(p=>{c.test(p)&&r[l][p].push([e,n])})}),Object.keys(i).forEach(l=>{(a===C||a===l)&&Object.keys(i[l]).forEach(p=>c.test(p)&&i[l][p].push([e,n]))});return}const s=mt(t)||[t];for(let c=0,l=s.length;c<l;c++){const p=s[c];Object.keys(i).forEach(u=>{var f;(a===C||a===u)&&((f=i[u])[p]||(f[p]=[...da(r[u],p)||da(r[C],p)||[]]),i[u][p].push([e,n-l+c+1]))})}}buildAllMatchers(){const a=Object.create(null);return Object.keys(o(this,X)).concat(Object.keys(o(this,V))).forEach(t=>{a[t]||(a[t]=x(this,Ha,Pt).call(this,t))}),m(this,V,m(this,X,void 0)),ce(),a}},V=new WeakMap,X=new WeakMap,Ha=new WeakSet,Pt=function(a){const t=[];let e=a===C;return[o(this,V),o(this,X)].forEach(r=>{const i=r[a]?Object.keys(r[a]).map(n=>[n,r[a][n]]):[];i.length!==0?(e||(e=!0),t.push(...i)):a!==C&&t.push(...Object.keys(r[C]).map(n=>[n,r[C][n]]))}),e?pe(t):null},dt),Q,z,ct,he=(ct=class{constructor(a){g(this,"name","SmartRouter");v(this,Q,[]);v(this,z,[]);m(this,Q,a.routers)}add(a,t,e){if(!o(this,z))throw new Error(kt);o(this,z).push([a,t,e])}match(a,t){if(!o(this,z))throw new Error("Fatal error");const e=o(this,Q),r=o(this,z),i=e.length;let n=0,s;for(;n<i;n++){const d=e[n];try{for(let c=0,l=r.length;c<l;c++)d.add(...r[c]);s=d.match(a,t)}catch(c){if(c instanceof St)continue;throw c}this.match=d.match.bind(d),m(this,Q,[d]),m(this,z,void 0);break}if(n===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,s}get activeRouter(){if(o(this,z)||o(this,Q).length!==1)throw new Error("No active router has been determined yet.");return o(this,Q)[0]}},Q=new WeakMap,z=new WeakMap,ct),Ca=Object.create(null),me=a=>{for(const t in a)return!0;return!1},$,T,ra,ya,I,H,Z,xa,ge=(xa=class{constructor(t,e,r){v(this,H);v(this,$);v(this,T);v(this,ra);v(this,ya,0);v(this,I,Ca);if(m(this,T,r||Object.create(null)),m(this,$,[]),t&&e){const i=Object.create(null);i[t]={handler:e,possibleKeys:[],score:0},m(this,$,[i])}m(this,ra,[])}insert(t,e,r){m(this,ya,++at(this,ya)._);let i=this;const n=Ht(e),s=[];for(let d=0,c=n.length;d<c;d++){const l=n[d],p=n[d+1],u=Jt(l,p),f=Array.isArray(u)?u[0]:l;if(f in o(i,T)){i=o(i,T)[f],u&&s.push(u[1]);continue}o(i,T)[f]=new xa,u&&(o(i,ra).push(u),s.push(u[1])),i=o(i,T)[f]}return o(i,$).push({[t]:{handler:r,possibleKeys:s.filter((d,c,l)=>l.indexOf(d)===c),score:o(this,ya)}}),i}search(t,e){var p;const r=[];m(this,I,Ca);let n=[this];const s=ut(e),d=[],c=s.length;let l=null;for(let u=0;u<c;u++){const f=s[u],S=u===c-1,w=[];for(let N=0,L=n.length;N<L;N++){const B=n[N],K=o(B,T)[f];K&&(m(K,I,o(B,I)),S?(o(K,T)["*"]&&x(this,H,Z).call(this,r,o(K,T)["*"],t,o(B,I)),x(this,H,Z).call(this,r,K,t,o(B,I))):w.push(K));for(let ka=0,Ga=o(B,ra).length;ka<Ga;ka++){const Ya=o(B,ra)[ka],q=o(B,I)===Ca?{}:{...o(B,I)};if(Ya==="*"){const oa=o(B,T)["*"];oa&&(x(this,H,Z).call(this,r,oa,t,o(B,I)),m(oa,I,q),w.push(oa));continue}const[Rt,Wa,Sa]=Ya;if(!f&&!(Sa instanceof RegExp))continue;const _=o(B,T)[Rt];if(Sa instanceof RegExp){if(l===null){l=new Array(c);let la=e[0]==="/"?1:0;for(let wa=0;wa<c;wa++)l[wa]=la,la+=s[wa].length+1}const oa=e.substring(l[u]),qa=Sa.exec(oa);if(qa){if(q[Wa]=qa[0],x(this,H,Z).call(this,r,_,t,o(B,I),q),me(o(_,T))){m(_,I,q);const la=((p=qa[0].match(/\//))==null?void 0:p.length)??0;(d[la]||(d[la]=[])).push(_)}continue}}(Sa===!0||Sa.test(f))&&(q[Wa]=f,S?(x(this,H,Z).call(this,r,_,t,q,o(B,I)),o(_,T)["*"]&&x(this,H,Z).call(this,r,o(_,T)["*"],t,q,o(B,I))):(m(_,I,q),w.push(_)))}}const D=d.shift();n=D?w.concat(D):w}return r.length>1&&r.sort((u,f)=>u.score-f.score),[r.map(({handler:u,params:f})=>[u,f])]}},$=new WeakMap,T=new WeakMap,ra=new WeakMap,ya=new WeakMap,I=new WeakMap,H=new WeakSet,Z=function(t,e,r,i,n){for(let s=0,d=o(e,$).length;s<d;s++){const c=o(e,$)[s],l=c[r]||c[C],p={};if(l!==void 0&&(l.params=Object.create(null),t.push(l),i!==Ca||n&&n!==Ca))for(let u=0,f=l.possibleKeys.length;u<f;u++){const S=l.possibleKeys[u],w=p[l.score];l.params[S]=n!=null&&n[S]&&!w?n[S]:i[S]??(n==null?void 0:n[S]),p[l.score]=!0}}},xa),na,pt,ve=(pt=class{constructor(){g(this,"name","TrieRouter");v(this,na);m(this,na,new ge)}add(a,t,e){const r=mt(t);if(r){for(let i=0,n=r.length;i<n;i++)o(this,na).insert(a,r[i],e);return}o(this,na).insert(a,t,e)}match(a,t){return o(this,na).search(a,t)}},na=new WeakMap,pt),It=class extends re{constructor(a={}){super(a),this.router=a.router??new he({routers:[new ue,new ve]})}};const h=new It;let Tt="1234";const Et="4321",Dt="2028-12-31";function Y(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function ca(a){return String(a).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function sa(a,t){if(!a.DATA_STORE)return[];let e;const r=[];do{const s=await a.DATA_STORE.list({prefix:t,cursor:e,limit:1e3});r.push(...s.keys.map(d=>d.name)),e=s.list_complete?void 0:s.cursor}while(e);const i=await Promise.all(r.map(s=>a.DATA_STORE.get(s))),n=[];for(let s=0;s<r.length;s++)if(i[s])try{n.push({_key:r[s],...JSON.parse(i[s])})}catch{}return n}function b(a){return new Response(a,{headers:{"content-type":"text/html;charset=UTF-8","Cache-Control":"no-store, no-cache, must-revalidate, proxy-revalidate",Pragma:"no-cache",Expires:"0"}})}h.post("/login",async a=>{var s;const t=await a.req.formData(),e=t.get("pin"),r=await((s=a.env.DATA_STORE)==null?void 0:s.get("APP_PIN"))||Tt,i=(t.get("username")||"").trim(),n=await sa(a.env,"user:");if(n.length>0&&i){const d=n.find(c=>c.username===i&&c.password===e&&c.active!==!1);if(d){const c=encodeURIComponent(JSON.stringify({auth:1,userId:d._key,username:d.username,role:d.role,name:d.name}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${c}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return b(Ta("Invalid credentials",n.length>0))}if(e===r){const d=encodeURIComponent(JSON.stringify({auth:1,userId:"admin",username:"admin",role:"admin",name:"Administrator"}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${d}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return b(Ta("Wrong PIN",n.length>0))});h.get("/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"session=; Path=/; HttpOnly; Max-Age=0; SameSite=Strict",Location:"/login","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache","Clear-Site-Data":'"cache"'}}));function y(a){const e=(a.req.header("Cookie")||"").match(/session=([^;]+)/);if(!e)return null;try{return JSON.parse(decodeURIComponent(e[1]))}catch{return null}}h.use("*",async(a,t)=>{const e=new URL(a.req.url).pathname;if(e==="/login"&&a.req.method==="GET"){const l=await sa(a.env,"user:");return b(Ta("",l.length>0))}if(e==="/api/company-settings"&&a.req.method==="GET"){await t();return}if(!(new URL(a.req.url).searchParams.get("master")===Et)){const l=new Date().toISOString().slice(0,10);if(l>Dt)return b(nt());if(a.env.DATA_STORE){const p=await a.env.DATA_STORE.get("APP_LICENSE");if(p&&l>p)return b(nt())}}if(e.startsWith("/sp-portal")){const p=(a.req.header("Cookie")||"").match(/sp_session=([^;]+)/);if(e==="/sp-portal/login"&&a.req.method==="GET"||!p&&e!=="/sp-portal/login")return b(Qa(""));await t();return}const n=y(a);if(!(n!=null&&n.auth)&&e!=="/login")return b(Ta("",!1));const s={admin:[],manager:["/users","/admin"],entry:["/users","/admin","/profit-loss","/balance-sheet","/trial-balance","/stock","/receivable-payable","/salesperson","/expense-ledger","/approvals","/company-settings"],viewer:["/inventory","/parties","/purchases","/sales","/payments","/expenses","/orders","/users","/admin","/salesperson","/approvals","/company-settings"]},d=(n==null?void 0:n.role)||"admin";if((s[d]||[]).includes(e))return b(k(`<div class="card"><div class="empty" style="padding:40px"><h3>Access Denied</h3><p class="text-muted">You don't have permission to access this page.</p><a href="/" class="btn btn-primary" style="margin-top:12px">Go to Dashboard</a></div></div>`,"dashboard",n));await t()});h.get("/api/license-info",async a=>{const e=(a.env.DATA_STORE?await a.env.DATA_STORE.get("APP_LICENSE"):null)||Dt,r=Math.floor((new Date(e).getTime()-Date.now())/864e5);return a.json({expiry:e,days:r,status:r<0?"Expired":"Active"})});h.post("/api/set-license",async a=>{if(new URL(a.req.url).searchParams.get("master")!==Et)return a.json({success:!1,error:"Unauthorized"},403);const e=await a.req.json();return a.env.DATA_STORE?(await a.env.DATA_STORE.put("APP_LICENSE",String((e==null?void 0:e.date)||"")),a.json({success:!0})):a.json({success:!1,error:"KV not configured"},500)});h.post("/api/list",async a=>{const t=await a.req.json();return a.json(await sa(a.env,(t==null?void 0:t.prefix)||""))});const jt=["product:","party:","sale:","purchase:","payment:","expense:","bank:","order:","salesperson:"];h.post("/api/save",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=await a.req.json(),e=(t==null?void 0:t.prefix)||"",r=t==null?void 0:t.id,i=t==null?void 0:t.key,n=(t==null?void 0:t.data)||{},s=(t==null?void 0:t.logAction)||"",d=(t==null?void 0:t.logDetail)||"",c=(t==null?void 0:t.skipApproval)===!0;let l=i;l||(r?l=r.startsWith(e)?r:e+r:l=e+Y());const p=y(a),u=(p==null?void 0:p.role)==="entry",f=!!(i||r),S=jt.some(w=>e&&e===w||l&&l.startsWith(w));if(u&&f&&S&&!c){const w="approval:"+Y(),D=await a.env.DATA_STORE.get(l);return await a.env.DATA_STORE.put(w,JSON.stringify({type:"edit",targetKey:l,prefix:e,newData:n,oldData:D?JSON.parse(D):null,detail:d||"Edit: "+l,requestedBy:(p==null?void 0:p.name)||(p==null?void 0:p.username)||"Unknown",requestedAt:new Date().toISOString(),status:"pending"})),a.json({success:!0,key:l,pending:!0,message:"Your edit has been submitted for approval"})}if(await a.env.DATA_STORE.put(l,JSON.stringify(n)),s){const w="modlog:"+Y();await a.env.DATA_STORE.put(w,JSON.stringify({action:s,detail:d,key:l,prefix:e,user:(p==null?void 0:p.name)||(p==null?void 0:p.username)||"System",timestamp:new Date().toISOString()}))}return a.json({success:!0,key:l})});h.post("/api/get",async a=>{if(!a.env.DATA_STORE)return a.json(null);const{key:t}=await a.req.json(),e=await a.env.DATA_STORE.get(t);return a.json(e?JSON.parse(e):null)});h.post("/api/delete",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=await a.req.json(),e=t==null?void 0:t.key,r=(t==null?void 0:t.logDetail)||"",i=(t==null?void 0:t.skipApproval)===!0;if(!e)return a.json({success:!1,error:"Key is required"},400);const n=y(a),s=(n==null?void 0:n.role)==="entry",d=jt.some(p=>e.startsWith(p));if(s&&d&&!i){const p=await a.env.DATA_STORE.get(e),u="approval:"+Y();return await a.env.DATA_STORE.put(u,JSON.stringify({type:"delete",targetKey:e,prefix:e.split(":")[0]+":",newData:null,oldData:p?JSON.parse(p):null,detail:r||"Delete: "+e,requestedBy:(n==null?void 0:n.name)||(n==null?void 0:n.username)||"Unknown",requestedAt:new Date().toISOString(),status:"pending"})),a.json({success:!0,pending:!0,message:"Your delete request has been submitted for approval"})}const c=await a.env.DATA_STORE.get(e);await a.env.DATA_STORE.delete(e);const l="modlog:"+Y();return await a.env.DATA_STORE.put(l,JSON.stringify({action:"delete",detail:r||"Deleted key: "+e,key:e,oldData:c?c.substring(0,500):"",user:(n==null?void 0:n.name)||(n==null?void 0:n.username)||"System",timestamp:new Date().toISOString()})),a.json({success:!0})});h.post("/api/approval-list",async a=>a.json(await sa(a.env,"approval:")));h.post("/api/approval-action",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=y(a),e=(t==null?void 0:t.role)||"";if(e!=="admin"&&e!=="manager")return a.json({success:!1,error:"Only admin/manager can approve"},403);const{approvalKey:r,action:i}=await a.req.json();if(!r)return a.json({success:!1,error:"Approval key required"},400);const n=await a.env.DATA_STORE.get(r);if(!n)return a.json({success:!1,error:"Approval not found"},404);const s=JSON.parse(n);if(s.status!=="pending")return a.json({success:!1,error:"Already processed"},400);if(i==="approve"){if(s.type==="edit"&&s.targetKey&&s.newData){await a.env.DATA_STORE.put(s.targetKey,JSON.stringify(s.newData));const d="modlog:"+Y();await a.env.DATA_STORE.put(d,JSON.stringify({action:"edit",detail:"Approved edit by "+s.requestedBy+": "+s.detail,key:s.targetKey,prefix:s.prefix,user:(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System",timestamp:new Date().toISOString()}))}else if(s.type==="delete"&&s.targetKey){await a.env.DATA_STORE.delete(s.targetKey);const d="modlog:"+Y();await a.env.DATA_STORE.put(d,JSON.stringify({action:"delete",detail:"Approved delete by "+s.requestedBy+": "+s.detail,key:s.targetKey,prefix:s.prefix,user:(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System",timestamp:new Date().toISOString()}))}s.status="approved"}else s.status="rejected";return s.processedBy=(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System",s.processedAt=new Date().toISOString(),await a.env.DATA_STORE.put(r,JSON.stringify(s)),a.json({success:!0,status:s.status})});h.get("/api/company-settings",async a=>{if(!a.env.DATA_STORE)return a.json({companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"});const t=await a.env.DATA_STORE.get("COMPANY_SETTINGS");return t?a.json(JSON.parse(t)):a.json({companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"})});h.post("/api/company-settings",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=y(a);if((t==null?void 0:t.role)!=="admin")return a.json({success:!1,error:"Only admin can change company settings"},403);const e=await a.req.json();return await a.env.DATA_STORE.put("COMPANY_SETTINGS",JSON.stringify(e)),a.json({success:!0})});h.post("/api/export-all",async a=>{const t=["product:","party:","sale:","purchase:","payment:","expense:","exphead:","expsubhead:","bank:","cb:","user:","order:","salesperson:","creditlimit:","prodgroup:","modlog:","approval:","companysettings:"],e={};for(const r of t)e[r]=await sa(a.env,r);return a.json(e)});h.post("/api/import-all",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=await a.req.json();let e=0;for(const[r,i]of Object.entries(t))if(Array.isArray(i))for(const n of i){const s=n._key||r+Y(),d={...n};delete d._key,await a.env.DATA_STORE.put(s,JSON.stringify(d)),e++}return a.json({success:!0,count:e})});h.post("/api/change-pin",async a=>{var i;const{oldPin:t,newPin:e}=await a.req.json(),r=await((i=a.env.DATA_STORE)==null?void 0:i.get("APP_PIN"))||Tt;return t!==r?a.json({success:!1,error:"Wrong current PIN"}):!e||e.length<4?a.json({success:!1,error:"PIN must be at least 4 characters"}):(await a.env.DATA_STORE.put("APP_PIN",e),a.json({success:!0}))});h.post("/api/kv-keys",async a=>{const{prefix:t}=await a.req.json();if(!a.env.DATA_STORE)return a.json([]);const e=await a.env.DATA_STORE.list({prefix:t||"",limit:100});return a.json(e.keys.map(r=>r.name))});h.post("/api/kv-get",async a=>{const{key:t}=await a.req.json();if(!a.env.DATA_STORE)return a.json({value:null});const e=await a.env.DATA_STORE.get(t);return a.json({value:e})});h.post("/api/kv-delete",async a=>{const{key:t}=await a.req.json();return a.env.DATA_STORE?(await a.env.DATA_STORE.delete(t),a.json({success:!0})):a.json({success:!1})});h.post("/sp-portal/login",async a=>{const t=await a.req.formData(),e=t.get("code"),r=t.get("pin"),n=(await sa(a.env,"salesperson:")).find(s=>s.code===e&&s.pin===r&&s.active!==!1);if(n){const s=encodeURIComponent(JSON.stringify({spId:n._key,spName:n.name,spCode:n.code}));return new Response(null,{status:302,headers:{"Set-Cookie":`sp_session=${s}; Path=/; HttpOnly; SameSite=Strict`,Location:"/sp-portal"}})}return b(Qa("Invalid credentials"))});h.get("/sp-portal/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"sp_session=; Path=/; HttpOnly; Max-Age=0",Location:"/sp-portal/login"}}));h.get("/",a=>b(k(xe(),"dashboard",y(a))));h.get("/inventory",a=>b(k(ke(),"inventory",y(a))));h.get("/stock-check",a=>b(k(Se(),"stockcheck",y(a))));h.get("/parties",a=>b(k(we(),"parties",y(a))));h.get("/purchases",a=>b(k(Be(),"purchases",y(a))));h.get("/sales",a=>b(k(Ce(),"sales",y(a))));h.get("/payments",a=>b(k(Pe(),"payments",y(a))));h.get("/expenses",a=>b(k(Ie(),"expenses",y(a))));h.get("/ledger",a=>b(k(Te(),"ledger",y(a))));h.get("/expense-ledger",a=>b(k(Ee(),"expledger",y(a))));h.get("/profit-loss",a=>b(k(De(),"profitloss",y(a))));h.get("/balance-sheet",a=>b(k(je(),"balancesheet",y(a))));h.get("/trial-balance",a=>b(k(Ne(),"trialbalance",y(a))));h.get("/stock",a=>b(k(Re(),"stock",y(a))));h.get("/receivable-payable",a=>b(k(Me(),"recpay",y(a))));h.get("/day-details",a=>b(k(Ae(),"daydetails",y(a))));h.get("/reports",a=>b(k(Le(),"reports",y(a))));h.get("/salesperson",a=>b(k(Ke(),"salesperson",y(a))));h.get("/orders",a=>b(k(_e(),"orders",y(a))));h.get("/users",a=>b(k(Fe(),"users",y(a))));h.get("/admin",a=>b(k(Oe(),"admin",y(a))));h.get("/mod-log",a=>b(k(ze(),"modlog",y(a))));h.get("/approvals",a=>b(k(He(),"approvals",y(a))));h.get("/company-settings",a=>b(k(Ge(),"companysettings",y(a))));h.get("/truck-fare-report",a=>b(k(fe(),"truckfarereport",y(a))));h.get("/truck-fare-settings",a=>b(k(be(),"truckfaresettings",y(a))));h.get("/sp-portal",a=>b(ye(a)));h.get("/login",async a=>{const t=await sa(a.env,"user:");return b(Ta("",t.length>0))});function be(){return`
...
<\/script>
</body></html>`}function Ta(a,t=!1){return`<!doctype html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,viewport-fit=cover">
...
<div><h2><span class="material-symbols-outlined" style="font-size:20px;vertical-align:middle;margin-right:4px">storefront</span>SP Portal</h2><div class="sp-user">Welcome, <b>${ca(n)}</b> (${ca(s)})</div></div>
...
<\/script></body></html>`}function xe(){var a=new Date().toISOString().slice(0,10),t=a.slice(0,7);return`

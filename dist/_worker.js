var ee=Object.defineProperty;var dt=a=>{throw TypeError(a)};var ne=(a,t,e)=>t in a?ee(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var g=(a,t,e)=>ne(a,typeof t!="symbol"?t+"":t,e),Ya=(a,t,e)=>t.has(a)||dt("Cannot "+e);var c=(a,t,e)=>(Ya(a,t,"read from private field"),e?e.call(a):t.get(a)),b=(a,t,e)=>t.has(a)?dt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,n)=>(Ya(a,t,"write to private field"),n?n.call(a,e):t.set(a,e),e),B=(a,t,e)=>(Ya(a,t,"access private method"),e);var ct=(a,t,e,n)=>({set _(i){m(a,t,i,e)},get _(){return c(a,t,n)}});var pt=(a,t,e)=>(n,i)=>{let r=-1;return s(0);async function s(l){if(l<=r)throw new Error("next() called multiple times");r=l;let o,d=!1,p;if(a[l]?(p=a[l][0][0],n.req.routeIndex=l):p=l===a.length&&i||void 0,p)try{o=await p(n,()=>s(l+1))}catch(u){if(u instanceof Error&&t)n.error=u,o=await t(u,n),d=!0;else throw u}else n.finalized===!1&&e&&(o=await e(n));return o&&(n.finalized===!1||d)&&(n.res=o),n}},re=Symbol(),ie=async(a,t=Object.create(null))=>{const{all:e=!1,dot:n=!1}=t,r=(a instanceof It?a.raw.headers:a.headers).get("Content-Type");return r!=null&&r.startsWith("multipart/form-data")||r!=null&&r.startsWith("application/x-www-form-urlencoded")?se(a,{all:e,dot:n}):{}};async function se(a,t){const e=await a.formData();return e?oe(e,t):{}}function oe(a,t){const e=Object.create(null);return a.forEach((n,i)=>{t.all||i.endsWith("[]")?le(e,i,n):e[i]=n}),t.dot&&Object.entries(e).forEach(([n,i])=>{n.includes(".")&&(de(e,n,i),delete e[n])}),e}var le=(a,t,e)=>{a[t]!==void 0?Array.isArray(a[t])?a[t].push(e):a[t]=[a[t],e]:t.endsWith("[]")?a[t]=[e]:a[t]=e},de=(a,t,e)=>{if(/(?:^|\.)__proto__\./.test(t))return;let n=a;const i=t.split(".");i.forEach((r,s)=>{s===i.length-1?n[r]=e:((!n[r]||typeof n[r]!="object"||Array.isArray(n[r])||n[r]instanceof File)&&(n[r]=Object.create(null)),n=n[r])})},St=a=>{const t=a.split("/");return t[0]===""&&t.shift(),t},ce=a=>{const{groups:t,path:e}=pe(a),n=St(e);return ue(n,t)},pe=a=>{const t=[];return a=a.replace(/\{[^}]+\}/g,(e,n)=>{const i=`@${n}`;return t.push([i,e]),i}),{groups:t,path:a}},ue=(a,t)=>{for(let e=t.length-1;e>=0;e--){const[n]=t[e];for(let i=a.length-1;i>=0;i--)if(a[i].includes(n)){a[i]=a[i].replace(n,t[e][1]);break}}return a},za={},he=(a,t)=>{if(a==="*")return"*";const e=a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(e){const n=`${a}#${t}`;return za[n]||(e[2]?za[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,e[1],new RegExp(`^${e[2]}(?=/${t})`)]:[a,e[1],new RegExp(`^${e[2]}$`)]:za[n]=[a,e[1],!0]),za[n]}return null},et=(a,t)=>{try{return t(a)}catch{return a.replace(/(?:%[0-9A-Fa-f]{2})+/g,e=>{try{return t(e)}catch{return e}})}},me=a=>et(a,decodeURI),Bt=a=>{const t=a.url,e=t.indexOf("/",t.indexOf(":")+4);let n=e;for(;n<t.length;n++){const i=t.charCodeAt(n);if(i===37){const r=t.indexOf("?",n),s=t.indexOf("#",n),l=r===-1?s===-1?void 0:s:s===-1?r:Math.min(r,s),o=t.slice(e,l);return me(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(i===63||i===35)break}return t.slice(e,n)},ge=a=>{const t=Bt(a);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ua=(a,t,...e)=>(e.length&&(t=ua(t,...e)),`${(a==null?void 0:a[0])==="/"?"":"/"}${a}${t==="/"?"":`${(a==null?void 0:a.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),wt=a=>{if(a.charCodeAt(a.length-1)!==63||!a.includes(":"))return null;const t=a.split("/"),e=[];let n="";return t.forEach(i=>{if(i!==""&&!/\:/.test(i))n+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){e.length===0&&n===""?e.push("/"):e.push(n);const r=i.replace("?","");n+="/"+r,e.push(n)}else n+="/"+i}),e.filter((i,r,s)=>s.indexOf(i)===r)},Wa=a=>/[%+]/.test(a)?(a.indexOf("+")!==-1&&(a=a.replace(/\+/g," ")),a.indexOf("%")!==-1?et(a,Pt):a):a,Ct=(a,t,e)=>{let n;if(!e&&t&&!/[%+]/.test(t)){let s=a.indexOf("?",8);if(s===-1)return;for(a.startsWith(t,s+1)||(s=a.indexOf(`&${t}`,s+1));s!==-1;){const l=a.charCodeAt(s+t.length+1);if(l===61){const o=s+t.length+2,d=a.indexOf("&",o);return Wa(a.slice(o,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";s=a.indexOf(`&${t}`,s+1)}if(n=/[%+]/.test(a),!n)return}const i={};n??(n=/[%+]/.test(a));let r=a.indexOf("?",8);for(;r!==-1;){const s=a.indexOf("&",r+1);let l=a.indexOf("=",r);l>s&&s!==-1&&(l=-1);let o=a.slice(r+1,l===-1?s===-1?void 0:s:l);if(n&&(o=Wa(o)),r=s,o==="")continue;let d;l===-1?d="":(d=a.slice(l+1,s===-1?void 0:s),n&&(d=Wa(d))),e?(i[o]&&Array.isArray(i[o])||(i[o]=[]),i[o].push(d)):i[o]??(i[o]=d)}return t?i[t]:i},ve=Ct,be=(a,t)=>Ct(a,t,!0),Pt=decodeURIComponent,ut=a=>et(a,Pt),ga,R,J,Et,Tt,at,U,vt,It=(vt=class{constructor(a,t="/",e=[[]]){b(this,J);g(this,"raw");b(this,ga);b(this,R);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});b(this,U,a=>{const{bodyCache:t,raw:e}=this,n=t[a];if(n)return n;const i=Object.keys(t)[0];return i?t[i].then(r=>(i==="json"&&(r=JSON.stringify(r)),new Response(r)[a]())):t[a]=e[a]()});this.raw=a,this.path=t,m(this,R,e),m(this,ga,{})}param(a){return a?B(this,J,Et).call(this,a):B(this,J,Tt).call(this)}query(a){return ve(this.url,a)}queries(a){return be(this.url,a)}header(a){if(a)return this.raw.headers.get(a)??void 0;const t={};return this.raw.headers.forEach((e,n)=>{t[n]=e}),t}async parseBody(a){return ie(this,a)}json(){return c(this,U).call(this,"text").then(a=>JSON.parse(a))}text(){return c(this,U).call(this,"text")}arrayBuffer(){return c(this,U).call(this,"arrayBuffer")}blob(){return c(this,U).call(this,"blob")}formData(){return c(this,U).call(this,"formData")}addValidatedData(a,t){c(this,ga)[a]=t}valid(a){return c(this,ga)[a]}get url(){return this.raw.url}get method(){return this.raw.method}get[re](){return c(this,R)}get matchedRoutes(){return c(this,R)[0].map(([[,a]])=>a)}get routePath(){return c(this,R)[0].map(([[,a]])=>a)[this.routeIndex].path}},ga=new WeakMap,R=new WeakMap,J=new WeakSet,Et=function(a){const t=c(this,R)[0][this.routeIndex][1][a],e=B(this,J,at).call(this,t);return e&&/\%/.test(e)?ut(e):e},Tt=function(){const a={},t=Object.keys(c(this,R)[0][this.routeIndex][1]);for(const e of t){const n=B(this,J,at).call(this,c(this,R)[0][this.routeIndex][1][e]);n!==void 0&&(a[e]=/\%/.test(n)?ut(n):n)}return a},at=function(a){return c(this,R)[1]?c(this,R)[1][a]:a},U=new WeakMap,vt),fe={Stringify:1},Dt=async(a,t,e,n,i)=>{typeof a=="object"&&!(a instanceof String)&&(a instanceof Promise||(a=a.toString()),a instanceof Promise&&(a=await a));const r=a.callbacks;return r!=null&&r.length?(i?i[0]+=a:i=[a],Promise.all(r.map(l=>l({phase:t,buffer:i,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(o=>Dt(o,t,!1,n,i))).then(()=>i[0]))):Promise.resolve(a)},ye="text/plain; charset=UTF-8",Za=(a,t)=>({"Content-Type":a,...t}),Pa=(a,t)=>new Response(a,t),Aa,Ra,z,va,H,N,Ma,ba,fa,aa,_a,La,V,ha,bt,ke=(bt=class{constructor(a,t){b(this,V);b(this,Aa);b(this,Ra);g(this,"env",{});b(this,z);g(this,"finalized",!1);g(this,"error");b(this,va);b(this,H);b(this,N);b(this,Ma);b(this,ba);b(this,fa);b(this,aa);b(this,_a);b(this,La);g(this,"render",(...a)=>(c(this,ba)??m(this,ba,t=>this.html(t)),c(this,ba).call(this,...a)));g(this,"setLayout",a=>m(this,Ma,a));g(this,"getLayout",()=>c(this,Ma));g(this,"setRenderer",a=>{m(this,ba,a)});g(this,"header",(a,t,e)=>{this.finalized&&m(this,N,Pa(c(this,N).body,c(this,N)));const n=c(this,N)?c(this,N).headers:c(this,aa)??m(this,aa,new Headers);t===void 0?n.delete(a):e!=null&&e.append?n.append(a,t):n.set(a,t)});g(this,"status",a=>{m(this,va,a)});g(this,"set",(a,t)=>{c(this,z)??m(this,z,new Map),c(this,z).set(a,t)});g(this,"get",a=>c(this,z)?c(this,z).get(a):void 0);g(this,"newResponse",(...a)=>B(this,V,ha).call(this,...a));g(this,"body",(a,t,e)=>B(this,V,ha).call(this,a,t,e));g(this,"text",(a,t,e)=>!c(this,aa)&&!c(this,va)&&!t&&!e&&!this.finalized?new Response(a):B(this,V,ha).call(this,a,t,Za(ye,e)));g(this,"json",(a,t,e)=>B(this,V,ha).call(this,JSON.stringify(a),t,Za("application/json",e)));g(this,"html",(a,t,e)=>{const n=i=>B(this,V,ha).call(this,i,t,Za("text/html; charset=UTF-8",e));return typeof a=="object"?Dt(a,fe.Stringify,!1,{}).then(n):n(a)});g(this,"redirect",(a,t)=>{const e=String(a);return this.header("Location",/[^\x00-\xFF]/.test(e)?encodeURI(e):e),this.newResponse(null,t??302)});g(this,"notFound",()=>(c(this,fa)??m(this,fa,()=>Pa()),c(this,fa).call(this,this)));m(this,Aa,a),t&&(m(this,H,t.executionCtx),this.env=t.env,m(this,fa,t.notFoundHandler),m(this,La,t.path),m(this,_a,t.matchResult))}get req(){return c(this,Ra)??m(this,Ra,new It(c(this,Aa),c(this,La),c(this,_a))),c(this,Ra)}get event(){if(c(this,H)&&"respondWith"in c(this,H))return c(this,H);throw Error("This context has no FetchEvent")}get executionCtx(){if(c(this,H))return c(this,H);throw Error("This context has no ExecutionContext")}get res(){return c(this,N)||m(this,N,Pa(null,{headers:c(this,aa)??m(this,aa,new Headers)}))}set res(a){if(c(this,N)&&a){a=Pa(a.body,a);for(const[t,e]of c(this,N).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=c(this,N).headers.getSetCookie();a.headers.delete("set-cookie");for(const i of n)a.headers.append("set-cookie",i)}else a.headers.set(t,e)}m(this,N,a),this.finalized=!0}get var(){return c(this,z)?Object.fromEntries(c(this,z)):{}}},Aa=new WeakMap,Ra=new WeakMap,z=new WeakMap,va=new WeakMap,H=new WeakMap,N=new WeakMap,Ma=new WeakMap,ba=new WeakMap,fa=new WeakMap,aa=new WeakMap,_a=new WeakMap,La=new WeakMap,V=new WeakSet,ha=function(a,t,e){const n=c(this,N)?new Headers(c(this,N).headers):c(this,aa)??new Headers;if(typeof t=="object"&&"headers"in t){const r=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[s,l]of r)s.toLowerCase()==="set-cookie"?n.append(s,l):n.set(s,l)}if(e)for(const[r,s]of Object.entries(e))if(typeof s=="string")n.set(r,s);else{n.delete(r);for(const l of s)n.append(r,l)}const i=typeof t=="number"?t:(t==null?void 0:t.status)??c(this,va);return Pa(a,{status:i,headers:n})},bt),I="ALL",xe="all",Se=["get","post","put","delete","options","patch"],jt="Can not add a route since the matcher is already built.",Nt=class extends Error{},Be="__COMPOSED_HANDLER",we=a=>a.text("404 Not Found",404),ht=(a,t)=>{if("getResponse"in a){const e=a.getResponse();return t.newResponse(e.body,e)}return console.error(a),t.text("Internal Server Error",500)},M,E,At,_,W,Ha,Ga,ya,Ce=(ya=class{constructor(t={}){b(this,E);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");b(this,M,"/");g(this,"routes",[]);b(this,_,we);g(this,"errorHandler",ht);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(m(this,_,t),this));g(this,"fetch",(t,...e)=>B(this,E,Ga).call(this,t,e[1],e[0],t.method));g(this,"request",(t,e,n,i)=>t instanceof Request?this.fetch(e?new Request(t,e):t,n,i):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ua("/",t)}`,e),n,i)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(B(this,E,Ga).call(this,t.request,t,void 0,t.request.method))})});[...Se,xe].forEach(r=>{this[r]=(s,...l)=>(typeof s=="string"?m(this,M,s):B(this,E,W).call(this,r,c(this,M),s),l.forEach(o=>{B(this,E,W).call(this,r,c(this,M),o)}),this)}),this.on=(r,s,...l)=>{for(const o of[s].flat()){m(this,M,o);for(const d of[r].flat())l.map(p=>{B(this,E,W).call(this,d.toUpperCase(),c(this,M),p)})}return this},this.use=(r,...s)=>(typeof r=="string"?m(this,M,r):(m(this,M,"*"),s.unshift(r)),s.forEach(l=>{B(this,E,W).call(this,I,c(this,M),l)}),this);const{strict:n,...i}=t;Object.assign(this,i),this.getPath=n??!0?t.getPath??Bt:ge}route(t,e){const n=this.basePath(t);return e.routes.map(i=>{var s;let r;e.errorHandler===ht?r=i.handler:(r=async(l,o)=>(await pt([],e.errorHandler)(l,()=>i.handler(l,o))).res,r[Be]=i.handler),B(s=n,E,W).call(s,i.method,i.path,r)}),this}basePath(t){const e=B(this,E,At).call(this);return e._basePath=ua(this._basePath,t),e}mount(t,e,n){let i,r;n&&(typeof n=="function"?r=n:(r=n.optionHandler,n.replaceRequest===!1?i=o=>o:i=n.replaceRequest));const s=r?o=>{const d=r(o);return Array.isArray(d)?d:[d]}:o=>{let d;try{d=o.executionCtx}catch{}return[o.env,d]};i||(i=(()=>{const o=ua(this._basePath,t),d=o==="/"?0:o.length;return p=>{const u=new URL(p.url);return u.pathname=u.pathname.slice(d)||"/",new Request(u,p)}})());const l=async(o,d)=>{const p=await e(i(o.req.raw),...s(o));if(p)return p;await d()};return B(this,E,W).call(this,I,ua(t,"*"),l),this}},M=new WeakMap,E=new WeakSet,At=function(){const t=new ya({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,m(t,_,c(this,_)),t.routes=this.routes,t},_=new WeakMap,W=function(t,e,n){t=t.toUpperCase(),e=ua(this._basePath,e);const i={basePath:this._basePath,path:e,method:t,handler:n};this.router.add(t,e,[n,i]),this.routes.push(i)},Ha=function(t,e){if(t instanceof Error)return this.errorHandler(t,e);throw t},Ga=function(t,e,n,i){if(i==="HEAD")return(async()=>new Response(null,await B(this,E,Ga).call(this,t,e,n,"GET")))();const r=this.getPath(t,{env:n}),s=this.router.match(i,r),l=new ke(t,{path:r,matchResult:s,env:n,executionCtx:e,notFoundHandler:c(this,_)});if(s[0].length===1){let d;try{d=s[0][0][0][0](l,async()=>{l.res=await c(this,_).call(this,l)})}catch(p){return B(this,E,Ha).call(this,p,l)}return d instanceof Promise?d.then(p=>p||(l.finalized?l.res:c(this,_).call(this,l))).catch(p=>B(this,E,Ha).call(this,p,l)):d??c(this,_).call(this,l)}const o=pt(s[0],this.errorHandler,c(this,_));return(async()=>{try{const d=await o(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return B(this,E,Ha).call(this,d,l)}})()},ya),Rt=[];function Pe(a,t){const e=this.buildAllMatchers(),n=((i,r)=>{const s=e[i]||e[I],l=s[2][r];if(l)return l;const o=r.match(s[0]);if(!o)return[[],Rt];const d=o.indexOf("",1);return[s[1][d],o]});return this.match=n,n(a,t)}var Ja="[^/]+",Ea=".*",Ta="(?:|/.*)",ma=Symbol(),Ie=new Set(".\\+*[^]$()");function Ee(a,t){return a.length===1?t.length===1?a<t?-1:1:-1:t.length===1||a===Ea||a===Ta?1:t===Ea||t===Ta?-1:a===Ja?1:t===Ja?-1:a.length===t.length?a<t?-1:1:t.length-a.length}var ta,ea,L,ia,Te=(ia=class{constructor(){b(this,ta);b(this,ea);b(this,L,Object.create(null))}insert(t,e,n,i,r){if(t.length===0){if(c(this,ta)!==void 0)throw ma;if(r)return;m(this,ta,e);return}const[s,...l]=t,o=s==="*"?l.length===0?["","",Ea]:["","",Ja]:s==="/*"?["","",Ta]:s.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(o){const p=o[1];let u=o[2]||Ja;if(p&&o[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ma;if(d=c(this,L)[u],!d){if(Object.keys(c(this,L)).some(v=>v!==Ea&&v!==Ta))throw ma;if(r)return;d=c(this,L)[u]=new ia,p!==""&&m(d,ea,i.varIndex++)}!r&&p!==""&&n.push([p,c(d,ea)])}else if(d=c(this,L)[s],!d){if(Object.keys(c(this,L)).some(p=>p.length>1&&p!==Ea&&p!==Ta))throw ma;if(r)return;d=c(this,L)[s]=new ia}d.insert(l,e,n,i,r)}buildRegExpStr(){const e=Object.keys(c(this,L)).sort(Ee).map(n=>{const i=c(this,L)[n];return(typeof c(i,ea)=="number"?`(${n})@${c(i,ea)}`:Ie.has(n)?`\\${n}`:n)+i.buildRegExpStr()});return typeof c(this,ta)=="number"&&e.unshift(`#${c(this,ta)}`),e.length===0?"":e.length===1?e[0]:"(?:"+e.join("|")+")"}},ta=new WeakMap,ea=new WeakMap,L=new WeakMap,ia),Va,Ka,ft,De=(ft=class{constructor(){b(this,Va,{varIndex:0});b(this,Ka,new Te)}insert(a,t,e){const n=[],i=[];for(let s=0;;){let l=!1;if(a=a.replace(/\{[^}]+\}/g,o=>{const d=`@\\${s}`;return i[s]=[d,o],s++,l=!0,d}),!l)break}const r=a.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let s=i.length-1;s>=0;s--){const[l]=i[s];for(let o=r.length-1;o>=0;o--)if(r[o].indexOf(l)!==-1){r[o]=r[o].replace(l,i[s][1]);break}}return c(this,Ka).insert(r,t,n,c(this,Va),e),n}buildRegExp(){let a=c(this,Ka).buildRegExpStr();if(a==="")return[/^$/,[],[]];let t=0;const e=[],n=[];return a=a.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,r,s)=>r!==void 0?(e[++t]=Number(r),"$()"):(s!==void 0&&(n[Number(s)]=++t),"")),[new RegExp(`^${a}`),e,n]}},Va=new WeakMap,Ka=new WeakMap,ft),je=[/^$/,[],Object.create(null)],qa=Object.create(null);function Mt(a){return qa[a]??(qa[a]=new RegExp(a==="*"?"":`^${a.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,e)=>e?`\\${e}`:"(?:|/.*)")}$`))}function Ne(){qa=Object.create(null)}function Ae(a){var d;const t=new De,e=[];if(a.length===0)return je;const n=a.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,u],[v,y])=>p?1:v?-1:u.length-y.length),i=Object.create(null);for(let p=0,u=-1,v=n.length;p<v;p++){const[y,k,C]=n[p];y?i[k]=[C.map(([S])=>[S,Object.create(null)]),Rt]:u++;let D;try{D=t.insert(k,u,y)}catch(S){throw S===ma?new Nt(k):S}y||(e[u]=C.map(([S,P])=>{const A=Object.create(null);for(P-=1;P>=0;P--){const[F,Ba]=D[P];A[F]=Ba}return[S,A]}))}const[r,s,l]=t.buildRegExp();for(let p=0,u=e.length;p<u;p++)for(let v=0,y=e[p].length;v<y;v++){const k=(d=e[p][v])==null?void 0:d[1];if(!k)continue;const C=Object.keys(k);for(let D=0,S=C.length;D<S;D++)k[C[D]]=l[k[C[D]]]}const o=[];for(const p in s)o[p]=e[s[p]];return[r,o,i]}function ca(a,t){if(a){for(const e of Object.keys(a).sort((n,i)=>i.length-n.length))if(Mt(e).test(t))return[...a[e]]}}var Q,X,Qa,_t,yt,Re=(yt=class{constructor(){b(this,Qa);g(this,"name","RegExpRouter");b(this,Q);b(this,X);g(this,"match",Pe);m(this,Q,{[I]:Object.create(null)}),m(this,X,{[I]:Object.create(null)})}add(a,t,e){var l;const n=c(this,Q),i=c(this,X);if(!n||!i)throw new Error(jt);n[a]||[n,i].forEach(o=>{o[a]=Object.create(null),Object.keys(o[I]).forEach(d=>{o[a][d]=[...o[I][d]]})}),t==="/*"&&(t="*");const r=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=Mt(t);a===I?Object.keys(n).forEach(d=>{var p;(p=n[d])[t]||(p[t]=ca(n[d],t)||ca(n[I],t)||[])}):(l=n[a])[t]||(l[t]=ca(n[a],t)||ca(n[I],t)||[]),Object.keys(n).forEach(d=>{(a===I||a===d)&&Object.keys(n[d]).forEach(p=>{o.test(p)&&n[d][p].push([e,r])})}),Object.keys(i).forEach(d=>{(a===I||a===d)&&Object.keys(i[d]).forEach(p=>o.test(p)&&i[d][p].push([e,r]))});return}const s=wt(t)||[t];for(let o=0,d=s.length;o<d;o++){const p=s[o];Object.keys(i).forEach(u=>{var v;(a===I||a===u)&&((v=i[u])[p]||(v[p]=[...ca(n[u],p)||ca(n[I],p)||[]]),i[u][p].push([e,r-d+o+1]))})}}buildAllMatchers(){const a=Object.create(null);return Object.keys(c(this,X)).concat(Object.keys(c(this,Q))).forEach(t=>{a[t]||(a[t]=B(this,Qa,_t).call(this,t))}),m(this,Q,m(this,X,void 0)),Ne(),a}},Q=new WeakMap,X=new WeakMap,Qa=new WeakSet,_t=function(a){const t=[];let e=a===I;return[c(this,Q),c(this,X)].forEach(n=>{const i=n[a]?Object.keys(n[a]).map(r=>[r,n[a][r]]):[];i.length!==0?(e||(e=!0),t.push(...i)):a!==I&&t.push(...Object.keys(n[I]).map(r=>[r,n[I][r]]))}),e?Ae(t):null},yt),$,G,kt,Me=(kt=class{constructor(a){g(this,"name","SmartRouter");b(this,$,[]);b(this,G,[]);m(this,$,a.routers)}add(a,t,e){if(!c(this,G))throw new Error(jt);c(this,G).push([a,t,e])}match(a,t){if(!c(this,G))throw new Error("Fatal error");const e=c(this,$),n=c(this,G),i=e.length;let r=0,s;for(;r<i;r++){const l=e[r];try{for(let o=0,d=n.length;o<d;o++)l.add(...n[o]);s=l.match(a,t)}catch(o){if(o instanceof Nt)continue;throw o}this.match=l.match.bind(l),m(this,$,[l]),m(this,G,void 0);break}if(r===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,s}get activeRouter(){if(c(this,G)||c(this,$).length!==1)throw new Error("No active router has been determined yet.");return c(this,$)[0]}},$=new WeakMap,G=new WeakMap,kt),Ia=Object.create(null),_e=a=>{for(const t in a)return!0;return!1},Y,j,na,ka,T,q,Z,xa,Le=(xa=class{constructor(t,e,n){b(this,q);b(this,Y);b(this,j);b(this,na);b(this,ka,0);b(this,T,Ia);if(m(this,j,n||Object.create(null)),m(this,Y,[]),t&&e){const i=Object.create(null);i[t]={handler:e,possibleKeys:[],score:0},m(this,Y,[i])}m(this,na,[])}insert(t,e,n){m(this,ka,++ct(this,ka)._);let i=this;const r=ce(e),s=[];for(let l=0,o=r.length;l<o;l++){const d=r[l],p=r[l+1],u=he(d,p),v=Array.isArray(u)?u[0]:d;if(v in c(i,j)){i=c(i,j)[v],u&&s.push(u[1]);continue}c(i,j)[v]=new xa,u&&(c(i,na).push(u),s.push(u[1])),i=c(i,j)[v]}return c(i,Y).push({[t]:{handler:n,possibleKeys:s.filter((l,o,d)=>d.indexOf(l)===o),score:c(this,ka)}}),i}search(t,e){var p;const n=[];m(this,T,Ia);let r=[this];const s=St(e),l=[],o=s.length;let d=null;for(let u=0;u<o;u++){const v=s[u],y=u===o-1,k=[];for(let D=0,S=r.length;D<S;D++){const P=r[D],A=c(P,j)[v];A&&(m(A,T,c(P,T)),y?(c(A,j)["*"]&&B(this,q,Z).call(this,n,c(A,j)["*"],t,c(P,T)),B(this,q,Z).call(this,n,A,t,c(P,T))):k.push(A));for(let F=0,Ba=c(P,na).length;F<Ba;F++){const Oa=c(P,na)[F],K=c(P,T)===Ia?{}:{...c(P,T)};if(Oa==="*"){const la=c(P,j)["*"];la&&(B(this,q,Z).call(this,n,la,t,c(P,T)),m(la,T,K),k.push(la));continue}const[oa,lt,wa]=Oa;if(!v&&!(wa instanceof RegExp))continue;const O=c(P,j)[oa];if(wa instanceof RegExp){if(d===null){d=new Array(o);let da=e[0]==="/"?1:0;for(let Ca=0;Ca<o;Ca++)d[Ca]=da,da+=s[Ca].length+1}const la=e.substring(d[u]),$a=wa.exec(la);if($a){if(K[lt]=$a[0],B(this,q,Z).call(this,n,O,t,c(P,T),K),_e(c(O,j))){m(O,T,K);const da=((p=$a[0].match(/\//))==null?void 0:p.length)??0;(l[da]||(l[da]=[])).push(O)}continue}}(wa===!0||wa.test(v))&&(K[lt]=v,y?(B(this,q,Z).call(this,n,O,t,K,c(P,T)),c(O,j)["*"]&&B(this,q,Z).call(this,n,c(O,j)["*"],t,K,c(P,T))):(m(O,T,K),k.push(O)))}}const C=l.shift();r=C?k.concat(C):k}return n.length>1&&n.sort((u,v)=>u.score-v.score),[n.map(({handler:u,params:v})=>[u,v])]}},Y=new WeakMap,j=new WeakMap,na=new WeakMap,ka=new WeakMap,T=new WeakMap,q=new WeakSet,Z=function(t,e,n,i,r){for(let s=0,l=c(e,Y).length;s<l;s++){const o=c(e,Y)[s],d=o[n]||o[I],p={};if(d!==void 0&&(d.params=Object.create(null),t.push(d),i!==Ia||r&&r!==Ia))for(let u=0,v=d.possibleKeys.length;u<v;u++){const y=d.possibleKeys[u],k=p[d.score];d.params[y]=r!=null&&r[y]&&!k?r[y]:i[y]??(r==null?void 0:r[y]),p[d.score]=!0}}},xa),ra,xt,Ke=(xt=class{constructor(){g(this,"name","TrieRouter");b(this,ra);m(this,ra,new Le)}add(a,t,e){const n=wt(t);if(n){for(let i=0,r=n.length;i<r;i++)c(this,ra).insert(a,n[i],e);return}c(this,ra).insert(a,t,e)}match(a,t){return c(this,ra).search(a,t)}},ra=new WeakMap,xt),Lt=class extends Ce{constructor(a={}){super(a),this.router=a.router??new Me({routers:[new Re,new Ke]})}};const sa={"product:":"products","party:":"parties","sale:":"sales","purchase:":"purchases","payment:":"payments","expense:":"expenses","exphead:":"exp_heads","expsubhead:":"exp_subheads","bank:":"banks","cb:":"cb","user:":"users","order:":"orders","salesperson:":"salespersons","creditlimit:":"credit_limits","prodgroup:":"prod_groups","prodbrand:":"prod_brands","modlog:":"mod_logs","approval:":"approvals","thanafare:":"thana_fares"},nt={sales:"sale_items",purchases:"purchase_items",orders:"order_items"},Kt={products:{purchasePrice:"purchase_price",salePrice:"sale_price",extraData:"extra_data"},parties:{postOffice:"post_office",openingBalance:"opening_balance",creditLimit:"credit_limit",salespersonId:"salesperson_id",salespersonName:"salesperson_name",extraData:"extra_data"},sales:{invoiceNo:"invoice_no",customerId:"customer_id",customerName:"customer_name",salespersonId:"salesperson_id",salespersonName:"salesperson_name",bankName:"bank_name",discountType:"discount_type",vatType:"vat_type",vatAmount:"vat_amount",aitType:"ait_type",aitAmount:"ait_amount",truckFare:"truck_fare",customerThana:"customer_thana",createdBy:"created_by",extraData:"extra_data",cashAmount:"cash_amount",bankAmount:"bank_amount",bankMethod:"bank_method",chequeNo:"cheque_no"},purchases:{purchaseNo:"purchase_no",supplierId:"supplier_id",supplierName:"supplier_name",bankName:"bank_name",vatType:"vat_type",extraData:"extra_data",cashAmount:"cash_amount",bankAmount:"bank_amount",bankMethod:"bank_method",chequeNo:"cheque_no"},payments:{bankName:"bank_name",chequeNo:"cheque_no",fromAcc:"from_acc",toAcc:"to_acc",autoInvoice:"auto_invoice",isTruckFare:"is_truck_fare",billKeys:"bill_keys",extraData:"extra_data",_autoInvoice:"auto_invoice",_isTruckFare:"is_truck_fare"},expenses:{expenseNo:"expense_no",headName:"head_name",subHeadName:"sub_head_name",bankName:"bank_name",isTruckFare:"is_truck_fare",_isTruckFare:"is_truck_fare",extraData:"extra_data"},orders:{orderNo:"order_no",customerId:"customer_id",customerName:"customer_name",spId:"sp_id",spName:"sp_name",spCode:"sp_code",convertedInvoice:"converted_invoice",extraData:"extra_data"},salespersons:{extraData:"extra_data"},banks:{accountNo:"account_no",openingBalance:"opening_balance",extraData:"extra_data"},users:{extraData:"extra_data"},approvals:{targetKey:"target_key",newData:"new_data",oldData:"old_data",requestedBy:"requested_by",requestedAt:"requested_at",processedBy:"processed_by",processedAt:"processed_at",extraData:"extra_data"},mod_logs:{oldData:"old_data",extraData:"extra_data"},exp_heads:{},exp_subheads:{headId:"head_id",headName:"head_name"},credit_limits:{partyId:"party_id",partyName:"party_name",extraData:"extra_data"},thana_fares:{maxFare:"max_fare",extraData:"extra_data"},cb:{openingBalance:"opening_balance",extraData:"extra_data"},prod_groups:{},prod_brands:{}},Ft={sale_items:{saleId:"sale_id",productId:"product_id",productName:"product_name",extraData:"extra_data"},purchase_items:{purchaseId:"purchase_id",productId:"product_id",productName:"product_name",extraData:"extra_data"},order_items:{orderId:"order_id",productKey:"product_key",productName:"product_name",extraData:"extra_data"}},Fe=new Set(["exp_heads","exp_subheads","mod_logs","approvals","credit_limits","cb","sale_items","purchase_items","order_items"]),Ot={mod_logs:"timestamp"};function zt(a){return{products:["id","name","sku","unit",'"group"',"brand","purchase_price","sale_price","stock","extra_data","created_at","updated_at"],parties:["id","name","type","phone","address","division","district","thana","post_office","postcode","opening_balance","credit_limit","salesperson_id","salesperson_name","extra_data","created_at","updated_at"],salespersons:["id","name","code","pin","phone","active","extra_data","created_at","updated_at"],banks:["id","name","account_no","opening_balance","balance","extra_data","created_at","updated_at"],sales:["id","invoice_no","date","customer_id","customer_name","salesperson_id","salesperson_name","method","bank_name","discount","discount_type","extra","vat","vat_type","vat_amount","ait","ait_type","ait_amount","truck_fare","total","paid","note","customer_thana","created_by","extra_data","created_at","updated_at","cash_amount","bank_amount","bank_method","cheque_no"],sale_items:["sale_id","product_id","product_name","qty","rate","amount","extra_data"],purchases:["id","purchase_no","date","supplier_id","supplier_name","method","bank_name","discount","extra","vat","vat_type","total","paid","note","extra_data","created_at","updated_at","cash_amount","bank_amount","bank_method","cheque_no"],purchase_items:["purchase_id","product_id","product_name","qty","rate","amount","extra_data"],payments:["id",'"no"',"date","type","party","method","bank_name","amount","note","cheque_no","status","from_acc","to_acc","auto_invoice","is_truck_fare","bill_keys","extra_data","created_at","updated_at"],expenses:["id","expense_no","date","head_name","sub_head_name","method","bank_name","amount","description","is_truck_fare","extra_data","created_at","updated_at"],exp_heads:["id","name","created_at"],exp_subheads:["id","name","head_id","head_name","created_at"],orders:["id","order_no","date","customer_id","customer_name","sp_id","sp_name","sp_code","total","status","converted_invoice","note","extra_data","created_at","updated_at"],order_items:["order_id","product_key","product_name","qty","rate","amount","extra_data"],users:["id","username","password","name","role","active","extra_data","created_at","updated_at"],approvals:["id","type","target_key","prefix","new_data","old_data","detail","requested_by","requested_at","status","processed_by","processed_at","extra_data","created_at"],mod_logs:["id","action","detail","key","prefix","old_data",'"user"',"timestamp","extra_data"],credit_limits:["id","party_id","party_name","amount","extra_data","created_at"],thana_fares:["id","thana","district","division","max_fare","extra_data","created_at","updated_at"],cb:["id","opening_balance","extra_data","created_at"],prod_groups:["id","name","created_at","updated_at"],prod_brands:["id","name","created_at","updated_at"]}[a]||[]}function rt(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function Oe(a,t){const e=Kt[a];return e&&e[t]?e[t]:t}function ze(a,t){const e=Ft[a];return e&&e[t]?e[t]:t}function He(a,t){const n=zt(a).map(s=>s.replace(/"/g,"")),i={},r={};for(const[s,l]of Object.entries(t)){if(s==="_key"||s==="_items")continue;const o=Oe(a,s);n.includes(o)?typeof l=="object"&&l!==null?i[o]=JSON.stringify(l):i[o]=l:r[s]=l}if(Object.keys(r).length>0){let s={};if(i.extra_data&&typeof i.extra_data=="string")try{s=JSON.parse(i.extra_data)}catch{}i.extra_data=JSON.stringify({...s,...r})}return i}function Ge(a,t,e){const i=zt(a).map(l=>l.replace(/"/g,"")),r={},s={};a==="sale_items"?r.sale_id=e:a==="purchase_items"?r.purchase_id=e:a==="order_items"&&(r.order_id=e);for(const[l,o]of Object.entries(t)){if(l==="_key")continue;const d=ze(a,l);i.includes(d)?typeof o=="object"&&o!==null?r[d]=JSON.stringify(o):r[d]=o:s[l]=o}return Object.keys(s).length>0&&(r.extra_data=JSON.stringify(s)),r}function Ht(a,t,e){const n=t.id,i={_key:e+n},r={},s=Kt[a]||{};for(const[l,o]of Object.entries(s))r[o]=l;for(const[l,o]of Object.entries(t)){if(l==="id"||l==="created_at"||l==="updated_at")continue;const d=r[l]||l;if(l==="extra_data"&&typeof o=="string"&&o!=="{}"){try{const p=JSON.parse(o);Object.assign(i,p)}catch{}continue}if(l==="bill_keys"&&typeof o=="string"){try{i[d]=JSON.parse(o)}catch{i[d]=o}continue}if(l==="new_data"||l==="old_data"){if(typeof o=="string")try{i[d]=JSON.parse(o)}catch{i[d]=o}else i[d]=o;continue}i[d]=o}return i}function qe(a){const t=Ft[a]||{},e={};for(const[n,i]of Object.entries(t))e[i]=n;return e}function Gt(a,t){const e=t?qe(t):{};return a.map(n=>{const i={};for(const[r,s]of Object.entries(n)){if(r==="id"||r==="extra_data"||r==="sale_id"||r==="purchase_id"||r==="order_id")continue;const l=e[r]||r;i[l]=s}if(n.extra_data&&typeof n.extra_data=="string"&&n.extra_data!=="{}")try{Object.assign(i,JSON.parse(n.extra_data))}catch{}return i})}async function qt(a,t){const e=sa[t];if(!e)return[];const n=Ot[e]||"created_at",i=a.prepare(`SELECT * FROM ${e} ORDER BY ${n} DESC`),{results:r}=await i.all(),s=r.map(o=>Ht(e,o,t)),l=nt[e];if(l&&r.length>0){const o=r.map(k=>k.id),d=o.map(()=>"?").join(","),p=l==="sale_items"?"sale_id":l==="purchase_items"?"purchase_id":"order_id",u=a.prepare(`SELECT * FROM ${l} WHERE ${p} IN (${d})`).bind(...o),{results:v}=await u.all(),y={};for(const k of v){const C=k[p];y[C]||(y[C]=[]),y[C].push(k)}for(const k of s){const D=k._key.replace(t,""),S=y[D]||[];S.length>0&&(k.items=Gt(S,l))}}return s}async function Da(a,t){const e=t.indexOf(":");if(e===-1)return null;const n=t.substring(0,e+1),i=t.substring(e+1),r=sa[n];if(!r)return null;const l=await a.prepare(`SELECT * FROM ${r} WHERE id = ?`).bind(i).first();if(!l)return null;const o=Ht(r,l,n),d=nt[r];if(d){const p=d==="sale_items"?"sale_id":d==="purchase_items"?"purchase_id":"order_id",u=a.prepare(`SELECT * FROM ${d} WHERE ${p} = ?`).bind(i),{results:v}=await u.all();v.length>0&&(o.items=Gt(v,d))}return delete o._key,o}async function it(a,t,e,n){const i=sa[t];if(!i)throw new Error(`Unknown prefix: ${t}`);let r;n?r=n.startsWith(t)?n.substring(t.length):n:r=rt();const s=new Date().toISOString(),l=He(i,e);l.id=r,Fe.has(i)||(l.updated_at=s),n||(i==="mod_logs"?l.timestamp||(l.timestamp=s):l.created_at=s);const o=Object.keys(l),d=o.map(S=>S==="group"?'"group"':S==="no"?'"no"':S==="user"?'"user"':S),p=o.map(()=>"?").join(", "),u=o.filter(S=>S!=="id"&&S!=="created_at").map(S=>{const P=S==="group"?'"group"':S==="no"?'"no"':S==="user"?'"user"':S;return`${P} = excluded.${P}`}).join(", "),v=`INSERT INTO ${i} (${d.join(", ")}) VALUES (${p})
    ON CONFLICT(id) DO UPDATE SET ${u}`,y=o.map(S=>l[S]??null),k=[a.prepare(v).bind(...y)],C=nt[i],D=e.items||e._items;if(C&&Array.isArray(D)){const S=C==="sale_items"?"sale_id":C==="purchase_items"?"purchase_id":"order_id";k.push(a.prepare(`DELETE FROM ${C} WHERE ${S} = ?`).bind(r));for(const P of D){const A=Ge(C,P,r),F=Object.keys(A),Ba=F.map(oa=>oa==="no"?'"no"':oa),Oa=F.map(()=>"?").join(", "),K=F.map(oa=>A[oa]??null);k.push(a.prepare(`INSERT INTO ${C} (${Ba.join(", ")}) VALUES (${Oa})`).bind(...K))}}return await a.batch(k),t+r}async function st(a,t){const e=t.indexOf(":");if(e===-1)return;const n=t.substring(0,e+1),i=t.substring(e+1),r=sa[n];r&&await a.prepare(`DELETE FROM ${r} WHERE id = ?`).bind(i).run()}async function Ua(a,t,e,n,i,r,s){const l=rt(),o=new Date().toISOString();await a.prepare('INSERT INTO mod_logs (id, action, detail, key, prefix, old_data, "user", timestamp) VALUES (?, ?, ?, ?, ?, ?, ?, ?)').bind(l,t,e,n,i,s||"",r,o).run()}async function Jt(a,t,e,n,i,r,s,l){const o=rt(),d=new Date().toISOString();return await a.prepare("INSERT INTO approvals (id, type, target_key, prefix, new_data, old_data, detail, requested_by, requested_at, status, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending', ?)").bind(o,t,e,n,JSON.stringify(i),JSON.stringify(r),s,l,d,d).run(),"approval:"+o}async function Je(a,t,e,n){const i=t.startsWith("approval:")?t.substring(9):t,r=await a.prepare("SELECT * FROM approvals WHERE id = ?").bind(i).first();if(!r)return{success:!1,error:"Approval not found"};if(r.status!=="pending")return{success:!1,error:"Already processed"};const s=new Date().toISOString(),l=e==="approve"?"approved":"rejected";if(e==="approve"){const o=r.target_key,d=r.prefix,p=r.type,u=r.requested_by;if(p==="edit"&&r.new_data){const v=typeof r.new_data=="string"?JSON.parse(r.new_data):r.new_data;await it(a,d,v,o),await Ua(a,"edit",`Approved edit by ${u}: ${r.detail}`,o,d,n)}else p==="delete"&&(await st(a,o),await Ua(a,"delete",`Approved delete by ${u}: ${r.detail}`,o,d,n))}return await a.prepare("UPDATE approvals SET status = ?, processed_by = ?, processed_at = ? WHERE id = ?").bind(l,n,s,i).run(),{success:!0,status:l}}async function Ue(a){const t={};for(const[e]of Object.entries(sa))t[e]=await qt(a,e);return t}async function Ve(a,t){let e=0;for(const[n,i]of Object.entries(t))if(!(!Array.isArray(i)||!sa[n]))for(const s of i){const l=s._key,o={...s};delete o._key,await it(a,n,o,l),e++}return e}async function Qe(a,t,e=100){const n=sa[t];if(!n)return[];const i=Ot[n]||"created_at",{results:r}=await a.prepare(`SELECT id FROM ${n} ORDER BY ${i} DESC LIMIT ?`).bind(e).all();return r.map(s=>t+s.id)}const Xe={"product:":300,"party:":300,"prodgroup:":600,"prodbrand:":600,"salesperson:":300,"bank:":300,"exphead:":600,"expsubhead:":600,"thanafare:":600,"creditlimit:":300,"cb:":300,"user:":120,"sale:":60,"purchase:":60,"payment:":60,"expense:":60,"order:":60,"modlog:":120,"approval:":30},Xa="cache:",$e=2*1024*1024;async function Ye(a,t){if(!a)return null;try{const e=Xa+t,n=await a.get(e);return n?JSON.parse(n):null}catch{return null}}async function We(a,t,e){if(a)try{const n=JSON.stringify(e);if(n.length>$e)return;const i=Xe[t]||60;await a.put(Xa+t,n,{expirationTtl:i})}catch{}}async function ja(a,...t){if(a)try{await Promise.all(t.map(e=>a.delete(Xa+e)))}catch{}}async function Ut(a){if(a)try{let t;const e=[];do{const n=await a.list({prefix:Xa,cursor:t,limit:1e3});e.push(...n.keys.map(i=>i.name)),t=n.list_complete?void 0:n.cursor}while(t);await Promise.all(e.map(n=>a.delete(n)))}catch{}}async function Vt(a){return a?a.get("APP_LICENSE"):null}async function Ze(a,t){a&&await a.put("APP_LICENSE",t)}async function Qt(a){return a?a.get("APP_PIN"):null}async function an(a,t){a&&await a.put("APP_PIN",t)}async function Xt(a){if(!a)return null;const t=await a.get("COMPANY_SETTINGS");if(!t)return null;try{return JSON.parse(t)}catch{return null}}async function $t(a,t){a&&await a.put("COMPANY_SETTINGS",JSON.stringify(t))}async function tn(a,t,e){const n=await Ye(a,e);if(n!==null)return n;const i=await t(e);return await We(a,e,i),i}function ot(a){return{"sale:":["sale:","product:"],"purchase:":["purchase:","product:"],"payment:":["payment:"],"expense:":["expense:"],"order:":["order:"],"product:":["product:"],"party:":["party:"]}[a]||[a]}const h=new Lt;let Yt="1234";const Wt="4321",Zt="2028-12-31";function en(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function pa(a){return String(a).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function Sa(a,t){return a.DB?tn(a.DATA_STORE,e=>qt(a.DB,e),t):[]}function f(a){return new Response(a,{headers:{"content-type":"text/html;charset=UTF-8","Cache-Control":"no-store, no-cache, must-revalidate, proxy-revalidate",Pragma:"no-cache",Expires:"0"}})}h.post("/login",async a=>{const t=await a.req.formData(),e=t.get("pin"),n=await Qt(a.env.DATA_STORE)||Yt,i=(t.get("username")||"").trim(),r=await Sa(a.env,"user:");if(r.length>0&&i){const s=r.find(l=>l.username===i&&l.password===e&&l.active!==!1);if(s){const l=encodeURIComponent(JSON.stringify({auth:1,userId:s._key,username:s.username,role:s.role,name:s.name}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${l}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Na("Invalid credentials",r.length>0))}if(e===n){const s=encodeURIComponent(JSON.stringify({auth:1,userId:"admin",username:"admin",role:"admin",name:"Administrator"}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${s}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Na("Wrong PIN",r.length>0))});h.get("/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"session=; Path=/; HttpOnly; Max-Age=0; SameSite=Strict",Location:"/login","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache","Clear-Site-Data":'"cache"'}}));function x(a){const e=(a.req.header("Cookie")||"").match(/session=([^;]+)/);if(!e)return null;try{return JSON.parse(decodeURIComponent(e[1]))}catch{return null}}h.use("*",async(a,t)=>{const e=new URL(a.req.url).pathname;if(e==="/login"&&a.req.method==="GET"){const d=await Sa(a.env,"user:");return f(Na("",d.length>0))}if(e==="/api/company-settings"&&a.req.method==="GET"){await t();return}if(!(new URL(a.req.url).searchParams.get("master")===Wt)){const d=new Date().toISOString().slice(0,10);if(d>Zt)return f(mt());{const p=await Vt(a.env.DATA_STORE);if(p&&d>p)return f(mt())}}if(e.startsWith("/sp-portal")){const p=(a.req.header("Cookie")||"").match(/sp_session=([^;]+)/);if(e==="/sp-portal/login"&&a.req.method==="GET"||!p&&e!=="/sp-portal/login")return f(tt(""));await t();return}const r=x(a);if(!(r!=null&&r.auth)&&e!=="/login")return f(Na("",!1));const s={admin:[],manager:["/users","/admin"],entry:["/users","/admin","/profit-loss","/balance-sheet","/trial-balance","/stock","/receivable-payable","/salesperson","/expense-ledger","/approvals","/company-settings"],viewer:["/inventory","/parties","/purchases","/sales","/payments","/expenses","/orders","/users","/admin","/salesperson","/approvals","/company-settings"]},l=(r==null?void 0:r.role)||"admin";if((s[l]||[]).includes(e))return f(w(`<div class="card"><div class="empty" style="padding:40px"><h3>Access Denied</h3><p class="text-muted">You don't have permission to access this page.</p><a href="/" class="btn btn-primary" style="margin-top:12px">Go to Dashboard</a></div></div>`,"dashboard",r));await t()});h.get("/api/license-info",async a=>{const e=await Vt(a.env.DATA_STORE)||Zt,n=Math.floor((new Date(e).getTime()-Date.now())/864e5);return a.json({expiry:e,days:n,status:n<0?"Expired":"Active"})});h.post("/api/set-license",async a=>{if(new URL(a.req.url).searchParams.get("master")!==Wt)return a.json({success:!1,error:"Unauthorized"},403);const e=await a.req.json();return await Ze(a.env.DATA_STORE,String((e==null?void 0:e.date)||"")),a.json({success:!0})});h.post("/api/list",async a=>{const t=await a.req.json();return a.json(await Sa(a.env,(t==null?void 0:t.prefix)||""))});const ae=["product:","party:","sale:","purchase:","payment:","expense:","bank:","order:","salesperson:"];h.post("/api/save",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json();let e=(t==null?void 0:t.prefix)||"";const n=t==null?void 0:t.id,i=t==null?void 0:t.key,r=(t==null?void 0:t.data)||{},s=(t==null?void 0:t.logAction)||"",l=(t==null?void 0:t.logDetail)||"",o=(t==null?void 0:t.skipApproval)===!0;let d=i;d||(n?d=n.startsWith(e)?n:e+n:d=e+en()),!e&&d&&d.includes(":")&&(e=d.substring(0,d.indexOf(":")+1));const p=x(a),u=(p==null?void 0:p.role)==="entry",v=!!(i||n),y=ae.some(C=>e&&e===C||d&&d.startsWith(C));if(u&&v&&y&&!o){const C=await Da(a.env.DB,d);return await Jt(a.env.DB,"edit",d,e,r,C,l||"Edit: "+d,(p==null?void 0:p.name)||(p==null?void 0:p.username)||"Unknown"),await ja(a.env.DATA_STORE,"approval:"),a.json({success:!0,key:d,pending:!0,message:"Your edit has been submitted for approval"})}const k=await it(a.env.DB,e,r,d);return s&&await Ua(a.env.DB,s,l,k,e,(p==null?void 0:p.name)||(p==null?void 0:p.username)||"System"),await ja(a.env.DATA_STORE,...ot(e)),a.json({success:!0,key:k})});h.post("/api/get",async a=>{if(!a.env.DB)return a.json(null);const{key:t}=await a.req.json(),e=await Da(a.env.DB,t);return a.json(e)});h.post("/api/delete",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json(),e=t==null?void 0:t.key,n=(t==null?void 0:t.logDetail)||"",i=(t==null?void 0:t.skipApproval)===!0;if(!e)return a.json({success:!1,error:"Key is required"},400);const r=e.split(":")[0]+":",s=x(a),l=(s==null?void 0:s.role)==="entry",o=ae.some(p=>e.startsWith(p));if(l&&o&&!i){const p=await Da(a.env.DB,e);return await Jt(a.env.DB,"delete",e,r,null,p,n||"Delete: "+e,(s==null?void 0:s.name)||(s==null?void 0:s.username)||"Unknown"),await ja(a.env.DATA_STORE,"approval:"),a.json({success:!0,pending:!0,message:"Your delete request has been submitted for approval"})}const d=await Da(a.env.DB,e);return await st(a.env.DB,e),await Ua(a.env.DB,"delete",n||"Deleted key: "+e,e,r,(s==null?void 0:s.name)||(s==null?void 0:s.username)||"System",d?JSON.stringify(d).substring(0,500):""),await ja(a.env.DATA_STORE,...ot(r)),a.json({success:!0})});h.post("/api/approval-list",async a=>a.json(await Sa(a.env,"approval:")));h.post("/api/approval-action",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=x(a),e=(t==null?void 0:t.role)||"";if(e!=="admin"&&e!=="manager")return a.json({success:!1,error:"Only admin/manager can approve"},403);const{approvalKey:n,action:i}=await a.req.json();if(!n)return a.json({success:!1,error:"Approval key required"},400);const r=await Je(a.env.DB,n,i,(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System");return r.success?(await Ut(a.env.DATA_STORE),a.json({success:!0,status:r.status})):a.json(r,400)});h.get("/api/company-settings",async a=>{const t={companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"},e=await Xt(a.env.DATA_STORE);return a.json(e||t)});h.post("/api/company-settings",async a=>{const t=x(a);if((t==null?void 0:t.role)!=="admin")return a.json({success:!1,error:"Only admin can change company settings"},403);const e=await a.req.json();return await $t(a.env.DATA_STORE,e),a.json({success:!0})});h.post("/api/export-all",async a=>{if(!a.env.DB)return a.json({});const t=await Ue(a.env.DB),e=await Xt(a.env.DATA_STORE);return e&&(t["companysettings:"]=[e]),a.json(t)});h.post("/api/import-all",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json();t["companysettings:"]&&Array.isArray(t["companysettings:"])&&t["companysettings:"].length>0&&(await $t(a.env.DATA_STORE,t["companysettings:"][0]),delete t["companysettings:"]);const e=await Ve(a.env.DB,t);return await Ut(a.env.DATA_STORE),a.json({success:!0,count:e})});h.post("/api/change-pin",async a=>{const{oldPin:t,newPin:e}=await a.req.json(),n=await Qt(a.env.DATA_STORE)||Yt;return t!==n?a.json({success:!1,error:"Wrong current PIN"}):!e||e.length<4?a.json({success:!1,error:"PIN must be at least 4 characters"}):(await an(a.env.DATA_STORE,e),a.json({success:!0}))});h.post("/api/kv-keys",async a=>{if(!a.env.DB)return a.json([]);const{prefix:t}=await a.req.json();return a.json(await Qe(a.env.DB,t||"",100))});h.post("/api/kv-get",async a=>{if(!a.env.DB)return a.json({value:null});const{key:t}=await a.req.json(),e=await Da(a.env.DB,t);return a.json({value:e?JSON.stringify(e):null})});h.post("/api/kv-delete",async a=>{if(!a.env.DB)return a.json({success:!1});const{key:t}=await a.req.json();await st(a.env.DB,t);const e=t.split(":")[0]+":";return await ja(a.env.DATA_STORE,...ot(e)),a.json({success:!0})});h.post("/sp-portal/login",async a=>{const t=await a.req.formData(),e=t.get("code"),n=t.get("pin"),r=(await Sa(a.env,"salesperson:")).find(s=>s.code===e&&s.pin===n&&s.active!==!1);if(r){const s=encodeURIComponent(JSON.stringify({spId:r._key,spName:r.name,spCode:r.code}));return new Response(null,{status:302,headers:{"Set-Cookie":`sp_session=${s}; Path=/; HttpOnly; SameSite=Strict`,Location:"/sp-portal"}})}return f(tt("Invalid credentials"))});h.get("/sp-portal/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"sp_session=; Path=/; HttpOnly; Max-Age=0",Location:"/sp-portal/login"}}));h.get("/",a=>f(w(on(),"dashboard",x(a))));h.get("/inventory",a=>f(w(ln(),"inventory",x(a))));h.get("/stock-check",a=>f(w(dn(),"stockcheck",x(a))));h.get("/parties",a=>f(w(cn(),"parties",x(a))));h.get("/purchases",a=>f(w(pn(),"purchases",x(a))));h.get("/sales",a=>f(w(un(),"sales",x(a))));h.get("/payments",a=>f(w(hn(),"payments",x(a))));h.get("/expenses",a=>f(w(mn(),"expenses",x(a))));h.get("/ledger",a=>f(w(gn(),"ledger",x(a))));h.get("/expense-ledger",a=>f(w(vn(),"expledger",x(a))));h.get("/profit-loss",a=>f(w(bn(),"profitloss",x(a))));h.get("/balance-sheet",a=>f(w(fn(),"balancesheet",x(a))));h.get("/trial-balance",a=>f(w(yn(),"trialbalance",x(a))));h.get("/stock",a=>f(w(kn(),"stock",x(a))));h.get("/receivable-payable",a=>f(w(xn(),"recpay",x(a))));h.get("/day-details",a=>f(w(Sn(),"daydetails",x(a))));h.get("/reports",a=>f(w(Bn(),"reports",x(a))));h.get("/salesperson",a=>f(w(wn(),"salesperson",x(a))));h.get("/orders",a=>f(w(Cn(),"orders",x(a))));h.get("/users",a=>f(w(Pn(),"users",x(a))));h.get("/admin",a=>f(w(In(),"admin",x(a))));h.get("/mod-log",a=>f(w(En(),"modlog",x(a))));h.get("/approvals",a=>f(w(Tn(),"approvals",x(a))));h.get("/company-settings",a=>f(w(Dn(),"companysettings",x(a))));h.get("/truck-fare-report",a=>f(w(rn(),"truckfarereport",x(a))));h.get("/truck-fare-settings",a=>f(w(nn(),"truckfaresettings",x(a))));h.get("/sp-portal",a=>f(sn(a)));h.get("/login",async a=>{const t=await Sa(a.env,"user:");return f(Na("",t.length>0))});function nn(){return`
...
window.buildPurchaseInvoice=function(p){
  ...
  return '<div style="max-width:700px;margin:0 auto">'+getCompanyHeader()+'<div style="display:flex;justify-content:space-between;border-bottom:2px solid #333;padding-bottom:10px;margin-bottom:12px"><div><h2 style="margin:0;font-size:18px">PURCHASE INVOICE</h2><b>No:</b> '+p.purchaseNo+'</div><div style="text-align:right"><b>Date:</b> '+p.date+'<br><b>Supplier:</b> '+p.supplierName+'</div></div><table class="tbl"><thead><tr style="background:#f3f3f3"><th>#</th><th>Item</th><th class="r">Qty</th><th class="r">Rate</th><th class="r">Amount</th></tr></thead><tbody>'+(p.items||[]).map(function(it,i){return'<tr><td>'+(i+1)+'</td><td>'+it.productName+'</td><td class="r">'+it.qty+'</td><td class="r">'+fmt(it.rate)+'</td><td class="r">'+fmt(it.amount)+'</td></tr>';}).join('')+'</tbody></table><div style="display:flex;justify-content:flex-end;margin-top:12px"><div style="width:260px;line-height:1.8;font-size:12px"><div style="display:flex;justify-content:space-between"><span>Subtotal:</span><span>'+fmt(sub)+'</span></div><div style="display:flex;justify-content:space-between;color:#dc2626"><span>Discount:</span><span>-'+fmt(p.discount||0)+'</span></div><div style="display:flex;justify-content:space-between"><span>Extra:</span><span>+'+fmt(p.extra||0)+'</span></div><div style="display:flex;justify-content:space-between"><span>VAT:</span><span>+'+fmt(vatAmt)+'</span></div><div style="display:flex;justify-content:space-between;font-weight:800;font-size:14px;border-top:2px solid #333;margin-top:4px;padding-top:4px"><span>Total:</span><span>'+fmt(p.total)+'</span></div><div style="display:flex;justify-content:space-between;color:#059669"><span>Paid:</span><span>'+fmt(p.paid)+'</span></div>'+(p.cashAmount>0?'<div style="display:flex;justify-content:space-between;color:#059669;font-size:11px"><span>&nbsp;&nbsp;Cash:</span><span>'+fmt(p.cashAmount)+'</span></div>':'')+(p.bankAmount>0?'<div style="display:flex;justify-content:space-between;color:#2563eb;font-size:11px"><span>&nbsp;&nbsp;'+fmtMethod(p.bankMethod||p.method)+(p.bankName?' ('+p.bankName+')':'')+':</span><span>'+fmt(p.bankAmount)+'</span></div>':'')+'<div style="display:flex;justify-content:space-between;border-top:1px dashed #666"><span>Balance:</span><span>'+fmt((p.total||0)-(p.paid||0))+'</span></div></div></div></div>';
};
...
<div><h2><span class="material-symbols-outlined" style="font-size:20px;vertical-align:middle;margin-right:4px">storefront</span>SP Portal</h2><div class="sp-user">Welcome, <b>${pa(r)}</b> (${pa(s)})</div></div>
...
<\/script></body></html>`}function on(){var a=new Date().toISOString().slice(0,10),t=a.slice(0,7);return`
...
<div class="collapsible-section" style="margin-top:12px"><div class="collapsible-toggle" onclick="this.parentElement.classList.toggle('open')" style="display:flex;align-items:center;gap:6px;cursor:pointer;padding:8px 10px;background:var(--bg);border-radius:8px;font-size:12px;font-weight:600;color:var(--text-muted);user-select:none"><span class="material-symbols-outlined" style="font-size:16px;transition:transform .2s">expand_more</span> Discount, VAT & Extra Charges</div><div class="collapsible-body" style="display:none;padding-top:8px"><div class="form-row"><div><label>Discount</label><input type="number" id="purDisc" value="0" oninput="calcPur()"></div><div><label>Extra Charges</label><input type="number" id="purExtra" value="0" oninput="calcPur()"></div></div>
<div class="form-row"><div><label>VAT/Tax</label><div style="display:flex;gap:4px"><input type="number" id="purVat" value="0" oninput="calcPur()"><select id="purVatType" onchange="calcPur()" style="width:80px"><option value="amount">Amt</option><option value="percent">%</option></select></div></div></div></div></div>
<div class="form-row"><div><label>Total</label><input id="purTotal" readonly class="bold"></div></div>
<div class="form-row"><div><label>Paid</label><input type="number" id="purPaid" value="0" oninput="purSplitSync()"></div></div>
...
window.openPurchase=function(){document.getElementById('purEK').value='';document.getElementById('purNo').value=txnNo('PUR');document.getElementById('purDate').value=todayISO();document.getElementById('purSupplier').value='';document.getElementById('purDisc').value=0;document.getElementById('purExtra').value=0;document.getElementById('purVat').value=0;document.getElementById('purPaid').value=0;document.getElementById('purMethod').value='';document.getElementById('purTitle').textContent='New Purchase';togglePurBank();window._purItems=[{pk:'',pn:'',qty:1,rate:0,amt:0}];renderPurItems();openModal('purModal');var csec=document.querySelector('#purModal .collapsible-section');if(csec)csec.classList.remove('open')}
window._purItems=[];
...
if((p.discount||0)>0||(p.extra||0)>0||(p.vat||0)>0){var csec=document.querySelector('#purModal .collapsible-section');if(csec)csec.classList.add('open')}else{var csec2=document.querySelector('#purModal .collapsible-section');if(csec2)csec2.classList.remove('open')}}
...
<div class="collapsible-section" style="margin-top:12px"><div class="collapsible-toggle" onclick="this.parentElement.classList.toggle('open')" style="display:flex;align-items:center;gap:6px;cursor:pointer;padding:8px 10px;background:var(--bg);border-radius:8px;font-size:12px;font-weight:600;color:var(--text-muted);user-select:none"><span class="material-symbols-outlined" style="font-size:16px;transition:transform .2s">expand_more</span> Discount, VAT, AIT & Extra Charges</div><div class="collapsible-body" style="display:none;padding-top:8px"><div class="form-row"><div><label>Discount</label><div style="display:flex;gap:4px"><input type="number" id="salDisc" value="0" oninput="calcSal()"><select id="salDiscType" onchange="calcSal()" style="width:80px"><option value="amount">Amt</option><option value="percent">%</option></select></div></div><div><label>Extra Charges</label><input type="number" id="salExtra" value="0" oninput="calcSal()"></div></div>
<div class="form-row"><div><label>VAT/Tax</label><div style="display:flex;gap:4px"><input type="number" id="salVat" value="0" oninput="calcSal()"><select id="salVatType" onchange="calcSal()" style="width:80px"><option value="amount">Amt</option><option value="percent">%</option></select></div></div><div><label>AIT</label><div style="display:flex;gap:4px"><input type="number" id="salAit" value="0" oninput="calcSal()"><select id="salAitType" onchange="calcSal()" style="width:80px"><option value="amount">Amt</option><option value="percent">%</option></select></div></div></div></div></div>
...
<style>.sr-list.open{display:block}
.collapsible-section .collapsible-body{display:none}
.collapsible-section.open .collapsible-body{display:block}
.collapsible-section.open .collapsible-toggle .material-symbols-outlined{transform:rotate(180deg)}
.collapsible-toggle:hover{background:var(--hover) !important}</style>
<script>
...
window.salFilterCust=function(){var q=(document.getElementById('salCustSearch').value||'').toLowerCase();var list=document.getElementById('salCustList');if(!q){list.innerHTML=customers.map(function(c){return'<div class="sr-item" onmousedown="salPickCust(&#39;'+c._key+'&#39;,&#39;'+c.name.replace(/'/g,"")+'&#39;)">'+c.name+'</div>'}).join('');list.classList.add('open');return}var fl=customers.filter(function(c){return c.name.toLowerCase().includes(q)||(c.phone||'').includes(q)||(c.address||'').toLowerCase().includes(q)||(c.thana||'').toLowerCase().includes(q)||(c.district||'').toLowerCase().includes(q)||(c.division||'').toLowerCase().includes(q)||(c.postcode||'').includes(q)||(c.postOffice||'').toLowerCase().includes(q)});list.innerHTML=fl.length?fl.map(function(c){return'<div class="sr-item" onmousedown="salPickCust(&#39;'+c._key+'&#39;,&#39;'+c.name.replace(/'/g,"")+'&#39;)">'+c.name+(c.phone?' <span style="font-size:10px;color:var(--muted)">'+c.phone+'</span>':'')+(c.thana?' <span style="font-size:9px;color:var(--muted)">['+c.thana+']</span>':'')+'</div>'}).join(''):'<div class="sr-item" style="color:var(--muted)">No match</div>';list.classList.add('open')};
...
if((s.discount||0)>0||(s.extra||0)>0||(s.vat||0)>0||(s.ait||0)>0){var csec=document.querySelector('#salModal .collapsible-section');if(csec)csec.classList.add('open')}else{var csec2=document.querySelector('#salModal .collapsible-section');if(csec2)csec2.classList.remove('open')}}
...
if(ek){
  ...
  if(oldPay&&oldPay.billKeys&&oldPay.billKeys.length){var revRem=oldPay.amount||0;for(var ri=0;ri<oldPay.billKeys.length&&revRem>0;ri++){var rkey=oldPay.billKeys[ri];if(oldPay.type==='receipt'){var rSale=paySales.find(function(x){return x._key===rkey});if(rSale){var ra=Math.min(revRem,rSale.paid||0);rSale.paid=Math.max(0,(rSale.paid||0)-ra);revRem-=ra;
// Reverse method fields on sale
...
if((rSale.cashAmount||0)>0&&(rSale.bankAmount||0)>0){rSale.method='split'}else if((rSale.cashAmount||0)>0){rSale.method='cash'}else if((rSale.bankAmount||0)>0){rSale.method=rSale.bankMethod||'bank_transfer'}else{rSale.method='credit'}
await saveByKey(rkey,cleanForSave(rSale))}}else{var rPur=payPurchases.find(function(x){return x._key===rkey});if(rPur){var ra2=Math.min(revRem,rPur.paid||0);rPur.paid=Math.max(0,(rPur.paid||0)-ra2);revRem-=ra2;
// Reverse method fields on purchase
...
if((rPur.cashAmount||0)>0&&(rPur.bankAmount||0)>0){rPur.method='split'}else if((rPur.cashAmount||0)>0){rPur.method='cash'}else if((rPur.bankAmount||0)>0){rPur.method=rPur.bankMethod||'bank_transfer'}else{rPur.method='credit'}
await saveByKey(rkey,cleanForSave(rPur))}}}}
...
// Update payment method fields on the sale so invoice shows correct method
var oldCash=sale.cashAmount||0;var oldBank=sale.bankAmount||0;
if(data.method==='cash'){sale.cashAmount=(oldCash||0)+apply;sale.method=(sale.bankAmount||0)>0?'split':'cash'}
else{sale.bankAmount=(oldBank||0)+apply;sale.bankMethod=data.method;sale.bankName=data.bankName||sale.bankName||'';sale.chequeNo=data.chequeNo||sale.chequeNo||'';sale.method=(sale.cashAmount||0)>0?'split':data.method}
...
// Update payment method fields on the purchase so invoice shows correct method
var oldCashP=pur.cashAmount||0;var oldBankP=pur.bankAmount||0;
if(data.method==='cash'){pur.cashAmount=(oldCashP||0)+apply2;pur.method=(pur.bankAmount||0)>0?'split':'cash'}
else{pur.bankAmount=(oldBankP||0)+apply2;pur.bankMethod=data.method;pur.bankName=data.bankName||pur.bankName||'';pur.chequeNo=data.chequeNo||pur.chequeNo||'';pur.method=(pur.cashAmount||0)>0?'split':data.method}
...
if((sale.cashAmount||0)>0&&(sale.bankAmount||0)>0){sale.method='split'}else if((sale.cashAmount||0)>0){sale.method='cash'}else if((sale.bankAmount||0)>0){sale.method=sale.bankMethod||'bank_transfer'}else{sale.method='credit'}
await saveByKey(bkey,cleanForSave(sale))}}else{var pur=payPurchases.find(function(x){return x._key===bkey});if(pur){var revAmt2=Math.min(remaining,pur.paid||0);pur.paid=Math.max(0,(pur.paid||0)-revAmt2);remaining-=revAmt2;
// Reverse method fields on purchase
...
if((pur.cashAmount||0)>0&&(pur.bankAmount||0)>0){pur.method='split'}else if((pur.cashAmount||0)>0){pur.method='cash'}else if((pur.bankAmount||0)>0){pur.method=pur.bankMethod||'bank_transfer'}else{pur.method='credit'}
await saveByKey(bkey,cleanForSave(pur))}}}}
...
loadCS();
<\/script>`}const gt=new Lt,jn=Object.assign({"/src/index.tsx":h});let te=!1;for(const[,a]of Object.entries(jn))a&&(gt.all("*",t=>{let e;try{e=t.executionCtx}catch{}return a.fetch(t.req.raw,t.env,e)}),gt.notFound(t=>{let e;try{e=t.executionCtx}catch{}return a.fetch(t.req.raw,t.env,e)}),te=!0);if(!te)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{gt as default};

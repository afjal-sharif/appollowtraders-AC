var _e=Object.defineProperty;var Jt=t=>{throw TypeError(t)};var De=(t,e,a)=>e in t?_e(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var v=(t,e,a)=>De(t,typeof e!="symbol"?e+"":e,a),Ut=(t,e,a)=>e.has(t)||Jt("Cannot "+a);var i=(t,e,a)=>(Ut(t,e,"read from private field"),a?a.call(t):e.get(t)),f=(t,e,a)=>e.has(t)?Jt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),m=(t,e,a,n)=>(Ut(t,e,"write to private field"),n?n.call(t,a):e.set(t,a),a),h=(t,e,a)=>(Ut(t,e,"access private method"),a);var Zt=(t,e,a,n)=>({set _(s){m(t,e,s,a)},get _(){return i(t,e,n)}});var te=(t,e,a)=>(n,s)=>{let r=-1;return d(0);async function d(l){if(l<=r)throw new Error("next() called multiple times");r=l;let o,c=!1,p;if(t[l]?(p=t[l][0][0],n.req.routeIndex=l):p=l===t.length&&s||void 0,p)try{o=await p(n,()=>d(l+1))}catch(u){if(u instanceof Error&&e)n.error=u,o=await e(u,n),c=!0;else throw u}else n.finalized===!1&&a&&(o=await a(n));return o&&(n.finalized===!1||c)&&(n.res=o),n}},Oe=Symbol(),Re=async(t,e=Object.create(null))=>{const{all:a=!1,dot:n=!1}=e,r=(t instanceof fe?t.raw.headers:t.headers).get("Content-Type");return r!=null&&r.startsWith("multipart/form-data")||r!=null&&r.startsWith("application/x-www-form-urlencoded")?Me(t,{all:a,dot:n}):{}};async function Me(t,e){const a=await t.formData();return a?je(a,e):{}}function je(t,e){const a=Object.create(null);return t.forEach((n,s)=>{e.all||s.endsWith("[]")?He(a,s,n):a[s]=n}),e.dot&&Object.entries(a).forEach(([n,s])=>{n.includes(".")&&(qe(a,n,s),delete a[n])}),a}var He=(t,e,a)=>{t[e]!==void 0?Array.isArray(t[e])?t[e].push(a):t[e]=[t[e],a]:e.endsWith("[]")?t[e]=[a]:t[e]=a},qe=(t,e,a)=>{if(/(?:^|\.)__proto__\./.test(e))return;let n=t;const s=e.split(".");s.forEach((r,d)=>{d===s.length-1?n[r]=a:((!n[r]||typeof n[r]!="object"||Array.isArray(n[r])||n[r]instanceof File)&&(n[r]=Object.create(null)),n=n[r])})},pe=t=>{const e=t.split("/");return e[0]===""&&e.shift(),e},ze=t=>{const{groups:e,path:a}=Fe(t),n=pe(a);return Ke(n,e)},Fe=t=>{const e=[];return t=t.replace(/\{[^}]+\}/g,(a,n)=>{const s=`@${n}`;return e.push([s,a]),s}),{groups:e,path:t}},Ke=(t,e)=>{for(let a=e.length-1;a>=0;a--){const[n]=e[a];for(let s=t.length-1;s>=0;s--)if(t[s].includes(n)){t[s]=t[s].replace(n,e[a][1]);break}}return t},Ot={},Ue=(t,e)=>{if(t==="*")return"*";const a=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const n=`${t}#${e}`;return Ot[n]||(a[2]?Ot[n]=e&&e[0]!==":"&&e[0]!=="*"?[n,a[1],new RegExp(`^${a[2]}(?=/${e})`)]:[t,a[1],new RegExp(`^${a[2]}$`)]:Ot[n]=[t,a[1],!0]),Ot[n]}return null},Yt=(t,e)=>{try{return e(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return e(a)}catch{return a}})}},$e=t=>Yt(t,decodeURI),ue=t=>{const e=t.url,a=e.indexOf("/",e.indexOf(":")+4);let n=a;for(;n<e.length;n++){const s=e.charCodeAt(n);if(s===37){const r=e.indexOf("?",n),d=e.indexOf("#",n),l=r===-1?d===-1?void 0:d:d===-1?r:Math.min(r,d),o=e.slice(a,l);return $e(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(s===63||s===35)break}return e.slice(a,n)},Ve=t=>{const e=ue(t);return e.length>1&&e.at(-1)==="/"?e.slice(0,-1):e},lt=(t,e,...a)=>(a.length&&(e=lt(e,...a)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${e==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(e==null?void 0:e[0])==="/"?e.slice(1):e}`}`),me=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const e=t.split("/"),a=[];let n="";return e.forEach(s=>{if(s!==""&&!/\:/.test(s))n+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){a.length===0&&n===""?a.push("/"):a.push(n);const r=s.replace("?","");n+="/"+r,a.push(n)}else n+="/"+s}),a.filter((s,r,d)=>d.indexOf(s)===r)},$t=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?Yt(t,be):t):t,ve=(t,e,a)=>{let n;if(!a&&e&&!/[%+]/.test(e)){let d=t.indexOf("?",8);if(d===-1)return;for(t.startsWith(e,d+1)||(d=t.indexOf(`&${e}`,d+1));d!==-1;){const l=t.charCodeAt(d+e.length+1);if(l===61){const o=d+e.length+2,c=t.indexOf("&",o);return $t(t.slice(o,c===-1?void 0:c))}else if(l==38||isNaN(l))return"";d=t.indexOf(`&${e}`,d+1)}if(n=/[%+]/.test(t),!n)return}const s={};n??(n=/[%+]/.test(t));let r=t.indexOf("?",8);for(;r!==-1;){const d=t.indexOf("&",r+1);let l=t.indexOf("=",r);l>d&&d!==-1&&(l=-1);let o=t.slice(r+1,l===-1?d===-1?void 0:d:l);if(n&&(o=$t(o)),r=d,o==="")continue;let c;l===-1?c="":(c=t.slice(l+1,d===-1?void 0:d),n&&(c=$t(c))),a?(s[o]&&Array.isArray(s[o])||(s[o]=[]),s[o].push(c)):s[o]??(s[o]=c)}return e?s[e]:s},Ge=ve,Qe=(t,e)=>ve(t,e,!0),be=decodeURIComponent,ee=t=>Yt(t,be),ut,N,K,ye,he,Gt,$,re,fe=(re=class{constructor(t,e="/",a=[[]]){f(this,K);v(this,"raw");f(this,ut);f(this,N);v(this,"routeIndex",0);v(this,"path");v(this,"bodyCache",{});f(this,$,t=>{const{bodyCache:e,raw:a}=this,n=e[t];if(n)return n;const s=Object.keys(e)[0];return s?e[s].then(r=>(s==="json"&&(r=JSON.stringify(r)),new Response(r)[t]())):e[t]=a[t]()});this.raw=t,this.path=e,m(this,N,a),m(this,ut,{})}param(t){return t?h(this,K,ye).call(this,t):h(this,K,he).call(this)}query(t){return Ge(this.url,t)}queries(t){return Qe(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const e={};return this.raw.headers.forEach((a,n)=>{e[n]=a}),e}async parseBody(t){return Re(this,t)}json(){return i(this,$).call(this,"text").then(t=>JSON.parse(t))}text(){return i(this,$).call(this,"text")}arrayBuffer(){return i(this,$).call(this,"arrayBuffer")}blob(){return i(this,$).call(this,"blob")}formData(){return i(this,$).call(this,"formData")}addValidatedData(t,e){i(this,ut)[t]=e}valid(t){return i(this,ut)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[Oe](){return i(this,N)}get matchedRoutes(){return i(this,N)[0].map(([[,t]])=>t)}get routePath(){return i(this,N)[0].map(([[,t]])=>t)[this.routeIndex].path}},ut=new WeakMap,N=new WeakMap,K=new WeakSet,ye=function(t){const e=i(this,N)[0][this.routeIndex][1][t],a=h(this,K,Gt).call(this,e);return a&&/\%/.test(a)?ee(a):a},he=function(){const t={},e=Object.keys(i(this,N)[0][this.routeIndex][1]);for(const a of e){const n=h(this,K,Gt).call(this,i(this,N)[0][this.routeIndex][1][a]);n!==void 0&&(t[a]=/\%/.test(n)?ee(n):n)}return t},Gt=function(t){return i(this,N)[1]?i(this,N)[1][t]:t},$=new WeakMap,re),Ye={Stringify:1},ge=async(t,e,a,n,s)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const r=t.callbacks;return r!=null&&r.length?(s?s[0]+=t:s=[t],Promise.all(r.map(l=>l({phase:e,buffer:s,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(o=>ge(o,e,!1,n,s))).then(()=>s[0]))):Promise.resolve(t)},Xe="text/plain; charset=UTF-8",Vt=(t,e)=>({"Content-Type":t,...e}),Pt=(t,e)=>new Response(t,e),Tt,Ct,H,mt,q,C,Nt,vt,bt,Z,Lt,At,V,ct,de,We=(de=class{constructor(t,e){f(this,V);f(this,Tt);f(this,Ct);v(this,"env",{});f(this,H);v(this,"finalized",!1);v(this,"error");f(this,mt);f(this,q);f(this,C);f(this,Nt);f(this,vt);f(this,bt);f(this,Z);f(this,Lt);f(this,At);v(this,"render",(...t)=>(i(this,vt)??m(this,vt,e=>this.html(e)),i(this,vt).call(this,...t)));v(this,"setLayout",t=>m(this,Nt,t));v(this,"getLayout",()=>i(this,Nt));v(this,"setRenderer",t=>{m(this,vt,t)});v(this,"header",(t,e,a)=>{this.finalized&&m(this,C,Pt(i(this,C).body,i(this,C)));const n=i(this,C)?i(this,C).headers:i(this,Z)??m(this,Z,new Headers);e===void 0?n.delete(t):a!=null&&a.append?n.append(t,e):n.set(t,e)});v(this,"status",t=>{m(this,mt,t)});v(this,"set",(t,e)=>{i(this,H)??m(this,H,new Map),i(this,H).set(t,e)});v(this,"get",t=>i(this,H)?i(this,H).get(t):void 0);v(this,"newResponse",(...t)=>h(this,V,ct).call(this,...t));v(this,"body",(t,e,a)=>h(this,V,ct).call(this,t,e,a));v(this,"text",(t,e,a)=>!i(this,Z)&&!i(this,mt)&&!e&&!a&&!this.finalized?new Response(t):h(this,V,ct).call(this,t,e,Vt(Xe,a)));v(this,"json",(t,e,a)=>h(this,V,ct).call(this,JSON.stringify(t),e,Vt("application/json",a)));v(this,"html",(t,e,a)=>{const n=s=>h(this,V,ct).call(this,s,e,Vt("text/html; charset=UTF-8",a));return typeof t=="object"?ge(t,Ye.Stringify,!1,{}).then(n):n(t)});v(this,"redirect",(t,e)=>{const a=String(t);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,e??302)});v(this,"notFound",()=>(i(this,bt)??m(this,bt,()=>Pt()),i(this,bt).call(this,this)));m(this,Tt,t),e&&(m(this,q,e.executionCtx),this.env=e.env,m(this,bt,e.notFoundHandler),m(this,At,e.path),m(this,Lt,e.matchResult))}get req(){return i(this,Ct)??m(this,Ct,new fe(i(this,Tt),i(this,At),i(this,Lt))),i(this,Ct)}get event(){if(i(this,q)&&"respondWith"in i(this,q))return i(this,q);throw Error("This context has no FetchEvent")}get executionCtx(){if(i(this,q))return i(this,q);throw Error("This context has no ExecutionContext")}get res(){return i(this,C)||m(this,C,Pt(null,{headers:i(this,Z)??m(this,Z,new Headers)}))}set res(t){if(i(this,C)&&t){t=Pt(t.body,t);for(const[e,a]of i(this,C).headers.entries())if(e!=="content-type")if(e==="set-cookie"){const n=i(this,C).headers.getSetCookie();t.headers.delete("set-cookie");for(const s of n)t.headers.append("set-cookie",s)}else t.headers.set(e,a)}m(this,C,t),this.finalized=!0}get var(){return i(this,H)?Object.fromEntries(i(this,H)):{}}},Tt=new WeakMap,Ct=new WeakMap,H=new WeakMap,mt=new WeakMap,q=new WeakMap,C=new WeakMap,Nt=new WeakMap,vt=new WeakMap,bt=new WeakMap,Z=new WeakMap,Lt=new WeakMap,At=new WeakMap,V=new WeakSet,ct=function(t,e,a){const n=i(this,C)?new Headers(i(this,C).headers):i(this,Z)??new Headers;if(typeof e=="object"&&"headers"in e){const r=e.headers instanceof Headers?e.headers:new Headers(e.headers);for(const[d,l]of r)d.toLowerCase()==="set-cookie"?n.append(d,l):n.set(d,l)}if(a)for(const[r,d]of Object.entries(a))if(typeof d=="string")n.set(r,d);else{n.delete(r);for(const l of d)n.append(r,l)}const s=typeof e=="number"?e:(e==null?void 0:e.status)??i(this,mt);return Pt(t,{status:s,headers:n})},de),P="ALL",Je="all",Ze=["get","post","put","delete","options","patch"],xe="Can not add a route since the matcher is already built.",we=class extends Error{},ta="__COMPOSED_HANDLER",ea=t=>t.text("404 Not Found",404),ae=(t,e)=>{if("getResponse"in t){const a=t.getResponse();return e.newResponse(a.body,a)}return console.error(t),e.text("Internal Server Error",500)},A,E,ke,_,W,Rt,Mt,ft,aa=(ft=class{constructor(e={}){f(this,E);v(this,"get");v(this,"post");v(this,"put");v(this,"delete");v(this,"options");v(this,"patch");v(this,"all");v(this,"on");v(this,"use");v(this,"router");v(this,"getPath");v(this,"_basePath","/");f(this,A,"/");v(this,"routes",[]);f(this,_,ea);v(this,"errorHandler",ae);v(this,"onError",e=>(this.errorHandler=e,this));v(this,"notFound",e=>(m(this,_,e),this));v(this,"fetch",(e,...a)=>h(this,E,Mt).call(this,e,a[1],a[0],e.method));v(this,"request",(e,a,n,s)=>e instanceof Request?this.fetch(a?new Request(e,a):e,n,s):(e=e.toString(),this.fetch(new Request(/^https?:\/\//.test(e)?e:`http://localhost${lt("/",e)}`,a),n,s)));v(this,"fire",()=>{addEventListener("fetch",e=>{e.respondWith(h(this,E,Mt).call(this,e.request,e,void 0,e.request.method))})});[...Ze,Je].forEach(r=>{this[r]=(d,...l)=>(typeof d=="string"?m(this,A,d):h(this,E,W).call(this,r,i(this,A),d),l.forEach(o=>{h(this,E,W).call(this,r,i(this,A),o)}),this)}),this.on=(r,d,...l)=>{for(const o of[d].flat()){m(this,A,o);for(const c of[r].flat())l.map(p=>{h(this,E,W).call(this,c.toUpperCase(),i(this,A),p)})}return this},this.use=(r,...d)=>(typeof r=="string"?m(this,A,r):(m(this,A,"*"),d.unshift(r)),d.forEach(l=>{h(this,E,W).call(this,P,i(this,A),l)}),this);const{strict:n,...s}=e;Object.assign(this,s),this.getPath=n??!0?e.getPath??ue:Ve}route(e,a){const n=this.basePath(e);return a.routes.map(s=>{var d;let r;a.errorHandler===ae?r=s.handler:(r=async(l,o)=>(await te([],a.errorHandler)(l,()=>s.handler(l,o))).res,r[ta]=s.handler),h(d=n,E,W).call(d,s.method,s.path,r)}),this}basePath(e){const a=h(this,E,ke).call(this);return a._basePath=lt(this._basePath,e),a}mount(e,a,n){let s,r;n&&(typeof n=="function"?r=n:(r=n.optionHandler,n.replaceRequest===!1?s=o=>o:s=n.replaceRequest));const d=r?o=>{const c=r(o);return Array.isArray(c)?c:[c]}:o=>{let c;try{c=o.executionCtx}catch{}return[o.env,c]};s||(s=(()=>{const o=lt(this._basePath,e),c=o==="/"?0:o.length;return p=>{const u=new URL(p.url);return u.pathname=u.pathname.slice(c)||"/",new Request(u,p)}})());const l=async(o,c)=>{const p=await a(s(o.req.raw),...d(o));if(p)return p;await c()};return h(this,E,W).call(this,P,lt(e,"*"),l),this}},A=new WeakMap,E=new WeakSet,ke=function(){const e=new ft({router:this.router,getPath:this.getPath});return e.errorHandler=this.errorHandler,m(e,_,i(this,_)),e.routes=this.routes,e},_=new WeakMap,W=function(e,a,n){e=e.toUpperCase(),a=lt(this._basePath,a);const s={basePath:this._basePath,path:a,method:e,handler:n};this.router.add(e,a,[n,s]),this.routes.push(s)},Rt=function(e,a){if(e instanceof Error)return this.errorHandler(e,a);throw e},Mt=function(e,a,n,s){if(s==="HEAD")return(async()=>new Response(null,await h(this,E,Mt).call(this,e,a,n,"GET")))();const r=this.getPath(e,{env:n}),d=this.router.match(s,r),l=new We(e,{path:r,matchResult:d,env:n,executionCtx:a,notFoundHandler:i(this,_)});if(d[0].length===1){let c;try{c=d[0][0][0][0](l,async()=>{l.res=await i(this,_).call(this,l)})}catch(p){return h(this,E,Rt).call(this,p,l)}return c instanceof Promise?c.then(p=>p||(l.finalized?l.res:i(this,_).call(this,l))).catch(p=>h(this,E,Rt).call(this,p,l)):c??i(this,_).call(this,l)}const o=te(d[0],this.errorHandler,i(this,_));return(async()=>{try{const c=await o(l);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return h(this,E,Rt).call(this,c,l)}})()},ft),Pe=[];function na(t,e){const a=this.buildAllMatchers(),n=((s,r)=>{const d=a[s]||a[P],l=d[2][r];if(l)return l;const o=r.match(d[0]);if(!o)return[[],Pe];const c=o.indexOf("",1);return[d[1][c],o]});return this.match=n,n(t,e)}var Ht="[^/]+",It=".*",St="(?:|/.*)",pt=Symbol(),sa=new Set(".\\+*[^]$()");function ra(t,e){return t.length===1?e.length===1?t<e?-1:1:-1:e.length===1||t===It||t===St?1:e===It||e===St?-1:t===Ht?1:e===Ht?-1:t.length===e.length?t<e?-1:1:e.length-t.length}var tt,et,D,st,da=(st=class{constructor(){f(this,tt);f(this,et);f(this,D,Object.create(null))}insert(e,a,n,s,r){if(e.length===0){if(i(this,tt)!==void 0)throw pt;if(r)return;m(this,tt,a);return}const[d,...l]=e,o=d==="*"?l.length===0?["","",It]:["","",Ht]:d==="/*"?["","",St]:d.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(o){const p=o[1];let u=o[2]||Ht;if(p&&o[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw pt;if(c=i(this,D)[u],!c){if(Object.keys(i(this,D)).some(g=>g!==It&&g!==St))throw pt;if(r)return;c=i(this,D)[u]=new st,p!==""&&m(c,et,s.varIndex++)}!r&&p!==""&&n.push([p,i(c,et)])}else if(c=i(this,D)[d],!c){if(Object.keys(i(this,D)).some(p=>p.length>1&&p!==It&&p!==St))throw pt;if(r)return;c=i(this,D)[d]=new st}c.insert(l,a,n,s,r)}buildRegExpStr(){const a=Object.keys(i(this,D)).sort(ra).map(n=>{const s=i(this,D)[n];return(typeof i(s,et)=="number"?`(${n})@${i(s,et)}`:sa.has(n)?`\\${n}`:n)+s.buildRegExpStr()});return typeof i(this,tt)=="number"&&a.unshift(`#${i(this,tt)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},tt=new WeakMap,et=new WeakMap,D=new WeakMap,st),qt,_t,ie,ia=(ie=class{constructor(){f(this,qt,{varIndex:0});f(this,_t,new da)}insert(t,e,a){const n=[],s=[];for(let d=0;;){let l=!1;if(t=t.replace(/\{[^}]+\}/g,o=>{const c=`@\\${d}`;return s[d]=[c,o],d++,l=!0,c}),!l)break}const r=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let d=s.length-1;d>=0;d--){const[l]=s[d];for(let o=r.length-1;o>=0;o--)if(r[o].indexOf(l)!==-1){r[o]=r[o].replace(l,s[d][1]);break}}return i(this,_t).insert(r,e,n,i(this,qt),a),n}buildRegExp(){let t=i(this,_t).buildRegExpStr();if(t==="")return[/^$/,[],[]];let e=0;const a=[],n=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,r,d)=>r!==void 0?(a[++e]=Number(r),"$()"):(d!==void 0&&(n[Number(d)]=++e),"")),[new RegExp(`^${t}`),a,n]}},qt=new WeakMap,_t=new WeakMap,ie),oa=[/^$/,[],Object.create(null)],jt=Object.create(null);function Ee(t){return jt[t]??(jt[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(e,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function la(){jt=Object.create(null)}function ca(t){var c;const e=new ia,a=[];if(t.length===0)return oa;const n=t.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,u],[g,S])=>p?1:g?-1:u.length-S.length),s=Object.create(null);for(let p=0,u=-1,g=n.length;p<g;p++){const[S,B,R]=n[p];S?s[B]=[R.map(([O])=>[O,Object.create(null)]),Pe]:u++;let L;try{L=e.insert(B,u,S)}catch(O){throw O===pt?new we(B):O}S||(a[u]=R.map(([O,k])=>{const M=Object.create(null);for(k-=1;k>=0;k--){const[xt,Ft]=L[k];M[xt]=Ft}return[O,M]}))}const[r,d,l]=e.buildRegExp();for(let p=0,u=a.length;p<u;p++)for(let g=0,S=a[p].length;g<S;g++){const B=(c=a[p][g])==null?void 0:c[1];if(!B)continue;const R=Object.keys(B);for(let L=0,O=R.length;L<O;L++)B[R[L]]=l[B[R[L]]]}const o=[];for(const p in d)o[p]=a[d[p]];return[r,o,s]}function it(t,e){if(t){for(const a of Object.keys(t).sort((n,s)=>s.length-n.length))if(Ee(a).test(e))return[...t[a]]}}var G,Q,zt,Ie,oe,pa=(oe=class{constructor(){f(this,zt);v(this,"name","RegExpRouter");f(this,G);f(this,Q);v(this,"match",na);m(this,G,{[P]:Object.create(null)}),m(this,Q,{[P]:Object.create(null)})}add(t,e,a){var l;const n=i(this,G),s=i(this,Q);if(!n||!s)throw new Error(xe);n[t]||[n,s].forEach(o=>{o[t]=Object.create(null),Object.keys(o[P]).forEach(c=>{o[t][c]=[...o[P][c]]})}),e==="/*"&&(e="*");const r=(e.match(/\/:/g)||[]).length;if(/\*$/.test(e)){const o=Ee(e);t===P?Object.keys(n).forEach(c=>{var p;(p=n[c])[e]||(p[e]=it(n[c],e)||it(n[P],e)||[])}):(l=n[t])[e]||(l[e]=it(n[t],e)||it(n[P],e)||[]),Object.keys(n).forEach(c=>{(t===P||t===c)&&Object.keys(n[c]).forEach(p=>{o.test(p)&&n[c][p].push([a,r])})}),Object.keys(s).forEach(c=>{(t===P||t===c)&&Object.keys(s[c]).forEach(p=>o.test(p)&&s[c][p].push([a,r]))});return}const d=me(e)||[e];for(let o=0,c=d.length;o<c;o++){const p=d[o];Object.keys(s).forEach(u=>{var g;(t===P||t===u)&&((g=s[u])[p]||(g[p]=[...it(n[u],p)||it(n[P],p)||[]]),s[u][p].push([a,r-c+o+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(i(this,Q)).concat(Object.keys(i(this,G))).forEach(e=>{t[e]||(t[e]=h(this,zt,Ie).call(this,e))}),m(this,G,m(this,Q,void 0)),la(),t}},G=new WeakMap,Q=new WeakMap,zt=new WeakSet,Ie=function(t){const e=[];let a=t===P;return[i(this,G),i(this,Q)].forEach(n=>{const s=n[t]?Object.keys(n[t]).map(r=>[r,n[t][r]]):[];s.length!==0?(a||(a=!0),e.push(...s)):t!==P&&e.push(...Object.keys(n[P]).map(r=>[r,n[P][r]]))}),a?ca(e):null},oe),Y,z,le,ua=(le=class{constructor(t){v(this,"name","SmartRouter");f(this,Y,[]);f(this,z,[]);m(this,Y,t.routers)}add(t,e,a){if(!i(this,z))throw new Error(xe);i(this,z).push([t,e,a])}match(t,e){if(!i(this,z))throw new Error("Fatal error");const a=i(this,Y),n=i(this,z),s=a.length;let r=0,d;for(;r<s;r++){const l=a[r];try{for(let o=0,c=n.length;o<c;o++)l.add(...n[o]);d=l.match(t,e)}catch(o){if(o instanceof we)continue;throw o}this.match=l.match.bind(l),m(this,Y,[l]),m(this,z,void 0);break}if(r===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,d}get activeRouter(){if(i(this,z)||i(this,Y).length!==1)throw new Error("No active router has been determined yet.");return i(this,Y)[0]}},Y=new WeakMap,z=new WeakMap,le),Et=Object.create(null),ma=t=>{for(const e in t)return!0;return!1},X,T,at,yt,I,F,J,ht,va=(ht=class{constructor(e,a,n){f(this,F);f(this,X);f(this,T);f(this,at);f(this,yt,0);f(this,I,Et);if(m(this,T,n||Object.create(null)),m(this,X,[]),e&&a){const s=Object.create(null);s[e]={handler:a,possibleKeys:[],score:0},m(this,X,[s])}m(this,at,[])}insert(e,a,n){m(this,yt,++Zt(this,yt)._);let s=this;const r=ze(a),d=[];for(let l=0,o=r.length;l<o;l++){const c=r[l],p=r[l+1],u=Ue(c,p),g=Array.isArray(u)?u[0]:c;if(g in i(s,T)){s=i(s,T)[g],u&&d.push(u[1]);continue}i(s,T)[g]=new ht,u&&(i(s,at).push(u),d.push(u[1])),s=i(s,T)[g]}return i(s,X).push({[e]:{handler:n,possibleKeys:d.filter((l,o,c)=>c.indexOf(l)===o),score:i(this,yt)}}),s}search(e,a){var p;const n=[];m(this,I,Et);let r=[this];const d=pe(a),l=[],o=d.length;let c=null;for(let u=0;u<o;u++){const g=d[u],S=u===o-1,B=[];for(let L=0,O=r.length;L<O;L++){const k=r[L],M=i(k,T)[g];M&&(m(M,I,i(k,I)),S?(i(M,T)["*"]&&h(this,F,J).call(this,n,i(M,T)["*"],e,i(k,I)),h(this,F,J).call(this,n,M,e,i(k,I))):B.push(M));for(let xt=0,Ft=i(k,at).length;xt<Ft;xt++){const Xt=i(k,at)[xt],U=i(k,I)===Et?{}:{...i(k,I)};if(Xt==="*"){const rt=i(k,T)["*"];rt&&(h(this,F,J).call(this,n,rt,e,i(k,I)),m(rt,I,U),B.push(rt));continue}const[Ae,Wt,wt]=Xt;if(!g&&!(wt instanceof RegExp))continue;const j=i(k,T)[Ae];if(wt instanceof RegExp){if(c===null){c=new Array(o);let dt=a[0]==="/"?1:0;for(let kt=0;kt<o;kt++)c[kt]=dt,dt+=d[kt].length+1}const rt=a.substring(c[u]),Kt=wt.exec(rt);if(Kt){if(U[Wt]=Kt[0],h(this,F,J).call(this,n,j,e,i(k,I),U),ma(i(j,T))){m(j,I,U);const dt=((p=Kt[0].match(/\//))==null?void 0:p.length)??0;(l[dt]||(l[dt]=[])).push(j)}continue}}(wt===!0||wt.test(g))&&(U[Wt]=g,S?(h(this,F,J).call(this,n,j,e,U,i(k,I)),i(j,T)["*"]&&h(this,F,J).call(this,n,i(j,T)["*"],e,U,i(k,I))):(m(j,I,U),B.push(j)))}}const R=l.shift();r=R?B.concat(R):B}return n.length>1&&n.sort((u,g)=>u.score-g.score),[n.map(({handler:u,params:g})=>[u,g])]}},X=new WeakMap,T=new WeakMap,at=new WeakMap,yt=new WeakMap,I=new WeakMap,F=new WeakSet,J=function(e,a,n,s,r){for(let d=0,l=i(a,X).length;d<l;d++){const o=i(a,X)[d],c=o[n]||o[P],p={};if(c!==void 0&&(c.params=Object.create(null),e.push(c),s!==Et||r&&r!==Et))for(let u=0,g=c.possibleKeys.length;u<g;u++){const S=c.possibleKeys[u],B=p[c.score];c.params[S]=r!=null&&r[S]&&!B?r[S]:s[S]??(r==null?void 0:r[S]),p[c.score]=!0}}},ht),nt,ce,ba=(ce=class{constructor(){v(this,"name","TrieRouter");f(this,nt);m(this,nt,new va)}add(t,e,a){const n=me(e);if(n){for(let s=0,r=n.length;s<r;s++)i(this,nt).insert(t,n[s],a);return}i(this,nt).insert(t,e,a)}match(t,e){return i(this,nt).search(t,e)}},nt=new WeakMap,ce),Se=class extends aa{constructor(t={}){super(t),this.router=t.router??new ua({routers:[new pa,new ba]})}};const b=new Se;let Be="1234";const Te="4321",Ce="2028-12-31";function Ne(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function ot(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function gt(t,e){if(!t.DATA_STORE)return[];let a;const n=[];do{const d=await t.DATA_STORE.list({prefix:e,cursor:a,limit:1e3});n.push(...d.keys.map(l=>l.name)),a=d.list_complete?void 0:d.cursor}while(a);const s=await Promise.all(n.map(d=>t.DATA_STORE.get(d))),r=[];for(let d=0;d<n.length;d++)if(s[d])try{r.push({_key:n[d],...JSON.parse(s[d])})}catch{}return r}function y(t){return new Response(t,{headers:{"content-type":"text/html;charset=UTF-8"}})}b.post("/login",async t=>{var d;const e=await t.req.formData(),a=e.get("pin"),n=await((d=t.env.DATA_STORE)==null?void 0:d.get("APP_PIN"))||Be,s=(e.get("username")||"").trim(),r=await gt(t.env,"user:");if(r.length>0&&s){const l=r.find(o=>o.username===s&&o.password===a&&o.active!==!1);if(l){const o=encodeURIComponent(JSON.stringify({auth:1,userId:l._key,username:l.username,role:l.role,name:l.name}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${o}; Path=/; HttpOnly; SameSite=Strict`,Location:"/"}})}return y(Bt("Invalid credentials",r.length>0))}if(a===n){const l=encodeURIComponent(JSON.stringify({auth:1,userId:"admin",username:"admin",role:"admin",name:"Administrator"}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${l}; Path=/; HttpOnly; SameSite=Strict`,Location:"/"}})}return y(Bt("Wrong PIN",r.length>0))});b.get("/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"session=; Path=/; HttpOnly; Max-Age=0",Location:"/login"}}));function x(t){const a=(t.req.header("Cookie")||"").match(/session=([^;]+)/);if(!a)return null;try{return JSON.parse(decodeURIComponent(a[1]))}catch{return null}}b.use("*",async(t,e)=>{const a=new URL(t.req.url).pathname;if(a==="/login"&&t.req.method==="GET"){const c=await gt(t.env,"user:");return y(Bt("",c.length>0))}if(!(new URL(t.req.url).searchParams.get("master")===Te)){const c=new Date().toISOString().slice(0,10);if(c>Ce)return y(ne());if(t.env.DATA_STORE){const p=await t.env.DATA_STORE.get("APP_LICENSE");if(p&&c>p)return y(ne())}}if(a.startsWith("/sp-portal")){const p=(t.req.header("Cookie")||"").match(/sp_session=([^;]+)/);if(a==="/sp-portal/login"&&t.req.method==="GET"||!p&&a!=="/sp-portal/login")return y(Qt(""));await e();return}const r=x(t);if(!(r!=null&&r.auth)&&a!=="/login")return y(Bt("",!1));const d={admin:[],manager:["/users","/admin"],entry:["/users","/admin","/reports","/profit-loss","/balance-sheet","/trial-balance","/stock","/receivable-payable","/salesperson","/expense-ledger"],viewer:["/inventory","/parties","/purchases","/sales","/payments","/expenses","/orders","/users","/admin","/salesperson"]},l=(r==null?void 0:r.role)||"admin";if((d[l]||[]).includes(a))return y(w(`<div class="card"><div class="empty" style="padding:40px"><h3>Access Denied</h3><p class="text-muted">You don't have permission to access this page.</p><a href="/" class="btn btn-primary" style="margin-top:12px">Go to Dashboard</a></div></div>`,"dashboard",r));await e()});b.get("/api/license-info",async t=>{const a=(t.env.DATA_STORE?await t.env.DATA_STORE.get("APP_LICENSE"):null)||Ce,n=Math.floor((new Date(a).getTime()-Date.now())/864e5);return t.json({expiry:a,days:n,status:n<0?"Expired":"Active"})});b.post("/api/set-license",async t=>{if(new URL(t.req.url).searchParams.get("master")!==Te)return t.json({success:!1,error:"Unauthorized"},403);const a=await t.req.json();return t.env.DATA_STORE?(await t.env.DATA_STORE.put("APP_LICENSE",String((a==null?void 0:a.date)||"")),t.json({success:!0})):t.json({success:!1,error:"KV not configured"},500)});b.post("/api/list",async t=>{const e=await t.req.json();return t.json(await gt(t.env,(e==null?void 0:e.prefix)||""))});b.post("/api/save",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=await t.req.json(),a=(e==null?void 0:e.prefix)||"",n=e==null?void 0:e.id,s=e==null?void 0:e.key,r=(e==null?void 0:e.data)||{};let d=s;return d||(n?d=n.startsWith(a)?n:a+n:d=a+Ne()),await t.env.DATA_STORE.put(d,JSON.stringify(r)),t.json({success:!0,key:d})});b.post("/api/get",async t=>{if(!t.env.DATA_STORE)return t.json(null);const{key:e}=await t.req.json(),a=await t.env.DATA_STORE.get(e);return t.json(a?JSON.parse(a):null)});b.post("/api/delete",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const{key:e}=await t.req.json();return e?(await t.env.DATA_STORE.delete(e),t.json({success:!0})):t.json({success:!1,error:"Key is required"},400)});b.post("/api/export-all",async t=>{const e=["product:","party:","sale:","purchase:","payment:","expense:","exphead:","expsubhead:","bank:","cb:","user:","order:","salesperson:","creditlimit:"],a={};for(const n of e)a[n]=await gt(t.env,n);return t.json(a)});b.post("/api/import-all",async t=>{if(!t.env.DATA_STORE)return t.json({success:!1,error:"KV not configured"},500);const e=await t.req.json();let a=0;for(const[n,s]of Object.entries(e))if(Array.isArray(s))for(const r of s){const d=r._key||n+Ne(),l={...r};delete l._key,await t.env.DATA_STORE.put(d,JSON.stringify(l)),a++}return t.json({success:!0,count:a})});b.post("/api/change-pin",async t=>{var s;const{oldPin:e,newPin:a}=await t.req.json(),n=await((s=t.env.DATA_STORE)==null?void 0:s.get("APP_PIN"))||Be;return e!==n?t.json({success:!1,error:"Wrong current PIN"}):!a||a.length<4?t.json({success:!1,error:"PIN must be at least 4 characters"}):(await t.env.DATA_STORE.put("APP_PIN",a),t.json({success:!0}))});b.post("/api/kv-keys",async t=>{const{prefix:e}=await t.req.json();if(!t.env.DATA_STORE)return t.json([]);const a=await t.env.DATA_STORE.list({prefix:e||"",limit:100});return t.json(a.keys.map(n=>n.name))});b.post("/api/kv-get",async t=>{const{key:e}=await t.req.json();if(!t.env.DATA_STORE)return t.json({value:null});const a=await t.env.DATA_STORE.get(e);return t.json({value:a})});b.post("/api/kv-delete",async t=>{const{key:e}=await t.req.json();return t.env.DATA_STORE?(await t.env.DATA_STORE.delete(e),t.json({success:!0})):t.json({success:!1})});b.post("/sp-portal/login",async t=>{const e=await t.req.formData(),a=e.get("code"),n=e.get("pin"),r=(await gt(t.env,"salesperson:")).find(d=>d.code===a&&d.pin===n&&d.active!==!1);if(r){const d=encodeURIComponent(JSON.stringify({spId:r._key,spName:r.name,spCode:r.code}));return new Response(null,{status:302,headers:{"Set-Cookie":`sp_session=${d}; Path=/; HttpOnly; SameSite=Strict`,Location:"/sp-portal"}})}return y(Qt("Invalid credentials"))});b.get("/sp-portal/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"sp_session=; Path=/; HttpOnly; Max-Age=0",Location:"/sp-portal/login"}}));b.get("/",t=>y(w(ya(),"dashboard",x(t))));b.get("/inventory",t=>y(w(ha(),"inventory",x(t))));b.get("/stock-check",t=>y(w(ga(),"stockcheck",x(t))));b.get("/parties",t=>y(w(xa(),"parties",x(t))));b.get("/purchases",t=>y(w(wa(),"purchases",x(t))));b.get("/sales",t=>y(w(ka(),"sales",x(t))));b.get("/payments",t=>y(w(Pa(),"payments",x(t))));b.get("/expenses",t=>y(w(Ea(),"expenses",x(t))));b.get("/ledger",t=>y(w(Ia(),"ledger",x(t))));b.get("/expense-ledger",t=>y(w(Sa(),"expledger",x(t))));b.get("/profit-loss",t=>y(w(Ba(),"profitloss",x(t))));b.get("/balance-sheet",t=>y(w(Ta(),"balancesheet",x(t))));b.get("/trial-balance",t=>y(w(Ca(),"trialbalance",x(t))));b.get("/stock",t=>y(w(Na(),"stock",x(t))));b.get("/receivable-payable",t=>y(w(La(),"recpay",x(t))));b.get("/day-details",t=>y(w(Aa(),"daydetails",x(t))));b.get("/reports",t=>y(w(_a(),"reports",x(t))));b.get("/salesperson",t=>y(w(Da(),"salesperson",x(t))));b.get("/orders",t=>y(w(Oa(),"orders",x(t))));b.get("/users",t=>y(w(Ra(),"users",x(t))));b.get("/admin",t=>y(w(Ma(),"admin",x(t))));b.get("/sp-portal",t=>y(fa(t)));b.get("/login",async t=>{const e=await gt(t.env,"user:");return y(Bt("",e.length>0))});function Dt(){return`<style>
...
<div class="app">
  <aside class="sidebar" id="sidebar">
    ...
    <nav>${o}<div class="nav-group" style="margin-top:12px"></div><a href="/sp-portal" target="_blank"><span class="nav-icon material-symbols-outlined">storefront</span>SP Portal</a><a href="/logout" style="opacity:.6"><span class="nav-icon material-symbols-outlined">logout</span>Logout</a></nav>
    <div class="sidebar-footer">BizManager v3.0 | ${s} (${n})</div>
  </aside>
...
<div><h2 style="margin:0">Salesperson Portal</h2><p class="text-muted" style="margin:4px 0 0">Welcome, <b>${ot(r)}</b> (${ot(d)})</p></div>
...
<\/script></body></html>`}function ya(){return new Date().toISOString().slice(0,10),`
...
<div class="search-wrap" style="max-width:500px;margin-bottom:16px"><span class="icon"><span class="material-symbols-outlined" style="font-size:16px">search</span></span><input id="sckSearch" placeholder="Search product name..." oninput="filterSck(this.value)" style="padding:12px 12px 12px 36px;font-size:15px"></div>
<div id="sckPrint"><div class="card" style="padding:0"><div class="table-wrap"><table class="tbl" id="sckTbl"><thead><tr><th style="width:60%">Product Name</th><th class="r" style="width:40%">Available Qty</th></tr></thead><tbody id="sckBody"></tbody></table></div></div></div>
<script>
var sckProds=[];
async function loadSck(){sckProds=await loadList('product:');sckProds.sort(function(a,b){return(a.name||'').localeCompare(b.name||'')});renderSck(sckProds)}
function renderSck(list){document.getElementById('sckBody').innerHTML=!list.length?'<tr><td colspan="2" class="empty">No products found</td></tr>':list.map(function(p){var st=p.stock||0;return'<tr><td class="bold" style="font-size:14px">'+p.name+'</td><td class="r bold" style="font-size:15px;'+(st<=0?'color:var(--danger)':st<=5?'color:var(--warning)':'color:var(--accent)')+'">'+st+'</td></tr>'}).join('')+'<tr style="background:var(--bg);font-weight:800"><td>TOTAL PRODUCTS: '+list.length+'</td><td class="r">'+list.reduce(function(s,p){return s+(p.stock||0)},0)+'</td></tr>'}
window.filterSck=function(q){var t=q.trim().toLowerCase();if(!t){renderSck(sckProds);return}renderSck(sckProds.filter(function(p){return(p.name||'').toLowerCase().includes(t)}))}
loadSck();
...
var data={invoiceNo:document.getElementById('salNo').value,date:document.getElementById('salDate').value,customerId:cid,customerName:cust?cust.name:'',salespersonId:spId,salespersonName:sp?sp.name:'',items:items.map(function(x){return{productId:x.pk,productName:x.pn,qty:x.qty,rate:x.rate,amount:x.amt}}),discount:dv,discountType:dt,extra:extra,vat:vv,vatType:vt,ait:av,aitType:at,total:total,paid:paid,method:method,bankName:bankName,chequeNo:chequeNo};
...
await saveByKey(ek,data)}else{await saveItem('sale:',data);for(var ii=0;ii<items.length;ii++){var pr=salProds.find(function(x){return x._key===items[ii].pk});if(pr){pr.stock=Math.max(0,(pr.stock||0)-items[ii].qty);await saveByKey(pr._key,cleanForSave(pr))}}
...
else if(type==='product-sales'){head='<tr><th>Product</th><th class="r">Qty Sold</th><th class="r">Revenue</th><th class="r">COGS</th><th class="r">Profit</th><th class="r">Margin%</th></tr>';var byProd={};sales.forEach(function(s){(s.items||[]).forEach(function(it){var k=it.productId||it.productName;if(!byProd[k])byProd[k]={name:it.productName,qty:0,rev:0,cogs:0};byProd[k].qty+=it.qty;byProd[k].rev+=it.amount;var pr=rptProducts.find(function(p){return p._key===it.productId});byProd[k].cogs+=(pr?pr.purchasePrice||0:0)*it.qty})});var tQ=0,tR=0,tCo=0;body=Object.values(byProd).sort(function(a,b){return b.rev-a.rev}).map(function(p){tQ+=p.qty;tR+=p.rev;tCo+=p.cogs;var margin=p.rev?((p.rev-p.cogs)/p.rev*100).toFixed(1):0;return'<tr><td class="bold">'+p.name+'</td><td class="r">'+p.qty+'</td><td class="r">'+fmt(p.rev)+'</td><td class="r">'+fmt(p.cogs)+'</td><td class="r bold '+(p.rev-p.cogs>=0?'text-success':'text-danger')+'">'+fmt(p.rev-p.cogs)+'</td><td class="r">'+margin+'%</td></tr>'}).join('');footer='<tr style="background:var(--bg);font-weight:800"><td>TOTAL</td><td class="r">'+tQ+'</td><td class="r">'+fmt(tR)+'</td><td class="r">'+fmt(tCo)+'</td><td class="r '+(tR-tCo>=0?'text-success':'text-danger')+'">'+fmt(tR-tCo)+'</td><td class="r">'+(tR?((tR-tCo)/tR*100).toFixed(1):0)+'%</td></tr>'}
else if(type==='customer-sales'){head='<tr><th>Customer</th><th class="r">Invoices</th><th class="r">Sales</th><th class="r">Receipts</th><th class="r">Outstanding</th></tr>';var byCust={};sales.forEach(function(s){var n=s.customerName;if(!byCust[n])byCust[n]={sales:0,paid:0,count:0};byCust[n].sales+=s.total||0;byCust[n].paid+=s.paid||0;byCust[n].count++});rptPayments.filter(function(p){return p.type==='receipt'&&p.status==='done'}).forEach(function(p){if(byCust[p.party])byCust[p.party].paid+=p.amount||0});var tSa=0,tPa=0,tCn=0;body=Object.entries(byCust).sort(function(a,b){return b[1].sales-a[1].sales}).map(function(e){var out=Math.max(0,e[1].sales-e[1].paid);tSa+=e[1].sales;tPa+=e[1].paid;tCn+=e[1].count;return'<tr><td class="bold">'+e[0]+'</td><td class="r">'+e[1].count+'</td><td class="r">'+fmt(e[1].sales)+'</td><td class="r text-success">'+fmt(e[1].paid)+'</td><td class="r '+(out>0?'text-danger bold':'')+'">'+fmt(out)+'</td></tr>'}).join('');footer='<tr style="background:var(--bg);font-weight:800"><td>TOTAL</td><td class="r">'+tCn+'</td><td class="r">'+fmt(tSa)+'</td><td class="r">'+fmt(tPa)+'</td><td class="r text-danger">'+fmt(Math.max(0,tSa-tPa))+'</td></tr>'}
...
else if(type==='customer-outstanding'){head='<tr><th>Customer</th><th>Phone</th><th class="r">Sales</th><th class="r">Paid</th><th class="r">Outstanding</th></tr>';var byCO={};rptParties.filter(function(p){return p.type==='customer'}).forEach(function(c){var cs=rptSales.filter(function(s){return s.customerId===c._key});var totalS=cs.reduce(function(s,x){return s+(x.total||0)},0);var totalP=cs.reduce(function(s,x){return s+(x.paid||0)},0);rptPayments.filter(function(p){return p.party===c.name&&p.type==='receipt'&&p.status==='done'}).forEach(function(p){totalP+=p.amount||0});var out=Math.max(0,totalS-totalP);if(totalS>0)byCO[c.name]={phone:c.phone||'',sales:totalS,paid:totalP,out:out}});var tOS=0,tOP=0,tOO=0;body=Object.entries(byCO).sort(function(a,b){return b[1].out-a[1].out}).map(function(e){tOS+=e[1].sales;tOP+=e[1].paid;tOO+=e[1].out;return'<tr><td class="bold">'+e[0]+'</td><td class="text-muted">'+e[1].phone+'</td><td class="r">'+fmt(e[1].sales)+'</td><td class="r text-success">'+fmt(e[1].paid)+'</td><td class="r '+(e[1].out>0?'text-danger bold':'')+'">'+fmt(e[1].out)+'</td></tr>'}).join('');footer='<tr style="background:var(--bg);font-weight:800"><td colspan="2">TOTAL</td><td class="r">'+fmt(tOS)+'</td><td class="r">'+fmt(tOP)+'</td><td class="r text-danger">'+fmt(tOO)+'</td></tr>'}

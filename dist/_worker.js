var Mt=Object.defineProperty;var Za=a=>{throw TypeError(a)};var At=(a,t,e)=>t in a?Mt(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var g=(a,t,e)=>At(a,typeof t!="symbol"?t+"":t,e),Ja=(a,t,e)=>t.has(a)||Za("Cannot "+e);var o=(a,t,e)=>(Ja(a,t,"read from private field"),e?e.call(a):t.get(a)),b=(a,t,e)=>t.has(a)?Za("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,n)=>(Ja(a,t,"write to private field"),n?n.call(a,e):t.set(a,e),e),x=(a,t,e)=>(Ja(a,t,"access private method"),e);var at=(a,t,e,n)=>({set _(i){m(a,t,i,e)},get _(){return o(a,t,n)}});var tt=(a,t,e)=>(n,i)=>{let r=-1;return s(0);async function s(d){if(d<=r)throw new Error("next() called multiple times");r=d;let c,l=!1,p;if(a[d]?(p=a[d][0][0],n.req.routeIndex=d):p=d===a.length&&i||void 0,p)try{c=await p(n,()=>s(d+1))}catch(u){if(u instanceof Error&&t)n.error=u,c=await t(u,n),l=!0;else throw u}else n.finalized===!1&&e&&(c=await e(n));return c&&(n.finalized===!1||l)&&(n.res=c),n}},Lt=Symbol(),Kt=async(a,t=Object.create(null))=>{const{all:e=!1,dot:n=!1}=t,r=(a instanceof bt?a.raw.headers:a.headers).get("Content-Type");return r!=null&&r.startsWith("multipart/form-data")||r!=null&&r.startsWith("application/x-www-form-urlencoded")?_t(a,{all:e,dot:n}):{}};async function _t(a,t){const e=await a.formData();return e?Ft(e,t):{}}function Ft(a,t){const e=Object.create(null);return a.forEach((n,i)=>{t.all||i.endsWith("[]")?Ot(e,i,n):e[i]=n}),t.dot&&Object.entries(e).forEach(([n,i])=>{n.includes(".")&&(zt(e,n,i),delete e[n])}),e}var Ot=(a,t,e)=>{a[t]!==void 0?Array.isArray(a[t])?a[t].push(e):a[t]=[a[t],e]:t.endsWith("[]")?a[t]=[e]:a[t]=e},zt=(a,t,e)=>{if(/(?:^|\.)__proto__\./.test(t))return;let n=a;const i=t.split(".");i.forEach((r,s)=>{s===i.length-1?n[r]=e:((!n[r]||typeof n[r]!="object"||Array.isArray(n[r])||n[r]instanceof File)&&(n[r]=Object.create(null)),n=n[r])})},ut=a=>{const t=a.split("/");return t[0]===""&&t.shift(),t},Ht=a=>{const{groups:t,path:e}=Gt(a),n=ut(e);return qt(n,t)},Gt=a=>{const t=[];return a=a.replace(/\{[^}]+\}/g,(e,n)=>{const i=`@${n}`;return t.push([i,e]),i}),{groups:t,path:a}},qt=(a,t)=>{for(let e=t.length-1;e>=0;e--){const[n]=t[e];for(let i=a.length-1;i>=0;i--)if(a[i].includes(n)){a[i]=a[i].replace(n,t[e][1]);break}}return a},La={},Jt=(a,t)=>{if(a==="*")return"*";const e=a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(e){const n=`${a}#${t}`;return La[n]||(e[2]?La[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,e[1],new RegExp(`^${e[2]}(?=/${t})`)]:[a,e[1],new RegExp(`^${e[2]}$`)]:La[n]=[a,e[1],!0]),La[n]}return null},$a=(a,t)=>{try{return t(a)}catch{return a.replace(/(?:%[0-9A-Fa-f]{2})+/g,e=>{try{return t(e)}catch{return e}})}},Ut=a=>$a(a,decodeURI),ht=a=>{const t=a.url,e=t.indexOf("/",t.indexOf(":")+4);let n=e;for(;n<t.length;n++){const i=t.charCodeAt(n);if(i===37){const r=t.indexOf("?",n),s=t.indexOf("#",n),d=r===-1?s===-1?void 0:s:s===-1?r:Math.min(r,s),c=t.slice(e,d);return Ut(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(i===63||i===35)break}return t.slice(e,n)},Vt=a=>{const t=ht(a);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},pa=(a,t,...e)=>(e.length&&(t=pa(t,...e)),`${(a==null?void 0:a[0])==="/"?"":"/"}${a}${t==="/"?"":`${(a==null?void 0:a.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),mt=a=>{if(a.charCodeAt(a.length-1)!==63||!a.includes(":"))return null;const t=a.split("/"),e=[];let n="";return t.forEach(i=>{if(i!==""&&!/\:/.test(i))n+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){e.length===0&&n===""?e.push("/"):e.push(n);const r=i.replace("?","");n+="/"+r,e.push(n)}else n+="/"+i}),e.filter((i,r,s)=>s.indexOf(i)===r)},Ua=a=>/[%+]/.test(a)?(a.indexOf("+")!==-1&&(a=a.replace(/\+/g," ")),a.indexOf("%")!==-1?$a(a,vt):a):a,gt=(a,t,e)=>{let n;if(!e&&t&&!/[%+]/.test(t)){let s=a.indexOf("?",8);if(s===-1)return;for(a.startsWith(t,s+1)||(s=a.indexOf(`&${t}`,s+1));s!==-1;){const d=a.charCodeAt(s+t.length+1);if(d===61){const c=s+t.length+2,l=a.indexOf("&",c);return Ua(a.slice(c,l===-1?void 0:l))}else if(d==38||isNaN(d))return"";s=a.indexOf(`&${t}`,s+1)}if(n=/[%+]/.test(a),!n)return}const i={};n??(n=/[%+]/.test(a));let r=a.indexOf("?",8);for(;r!==-1;){const s=a.indexOf("&",r+1);let d=a.indexOf("=",r);d>s&&s!==-1&&(d=-1);let c=a.slice(r+1,d===-1?s===-1?void 0:s:d);if(n&&(c=Ua(c)),r=s,c==="")continue;let l;d===-1?l="":(l=a.slice(d+1,s===-1?void 0:s),n&&(l=Ua(l))),e?(i[c]&&Array.isArray(i[c])||(i[c]=[]),i[c].push(l)):i[c]??(i[c]=l)}return t?i[t]:i},Xt=gt,Qt=(a,t)=>gt(a,t,!0),vt=decodeURIComponent,et=a=>$a(a,vt),ma,j,G,ft,yt,Xa,J,st,bt=(st=class{constructor(a,t="/",e=[[]]){b(this,G);g(this,"raw");b(this,ma);b(this,j);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});b(this,J,a=>{const{bodyCache:t,raw:e}=this,n=t[a];if(n)return n;const i=Object.keys(t)[0];return i?t[i].then(r=>(i==="json"&&(r=JSON.stringify(r)),new Response(r)[a]())):t[a]=e[a]()});this.raw=a,this.path=t,m(this,j,e),m(this,ma,{})}param(a){return a?x(this,G,ft).call(this,a):x(this,G,yt).call(this)}query(a){return Xt(this.url,a)}queries(a){return Qt(this.url,a)}header(a){if(a)return this.raw.headers.get(a)??void 0;const t={};return this.raw.headers.forEach((e,n)=>{t[n]=e}),t}async parseBody(a){return Kt(this,a)}json(){return o(this,J).call(this,"text").then(a=>JSON.parse(a))}text(){return o(this,J).call(this,"text")}arrayBuffer(){return o(this,J).call(this,"arrayBuffer")}blob(){return o(this,J).call(this,"blob")}formData(){return o(this,J).call(this,"formData")}addValidatedData(a,t){o(this,ma)[a]=t}valid(a){return o(this,ma)[a]}get url(){return this.raw.url}get method(){return this.raw.method}get[Lt](){return o(this,j)}get matchedRoutes(){return o(this,j)[0].map(([[,a]])=>a)}get routePath(){return o(this,j)[0].map(([[,a]])=>a)[this.routeIndex].path}},ma=new WeakMap,j=new WeakMap,G=new WeakSet,ft=function(a){const t=o(this,j)[0][this.routeIndex][1][a],e=x(this,G,Xa).call(this,t);return e&&/\%/.test(e)?et(e):e},yt=function(){const a={},t=Object.keys(o(this,j)[0][this.routeIndex][1]);for(const e of t){const n=x(this,G,Xa).call(this,o(this,j)[0][this.routeIndex][1][e]);n!==void 0&&(a[e]=/\%/.test(n)?et(n):n)}return a},Xa=function(a){return o(this,j)[1]?o(this,j)[1][a]:a},J=new WeakMap,st),$t={Stringify:1},xt=async(a,t,e,n,i)=>{typeof a=="object"&&!(a instanceof String)&&(a instanceof Promise||(a=a.toString()),a instanceof Promise&&(a=await a));const r=a.callbacks;return r!=null&&r.length?(i?i[0]+=a:i=[a],Promise.all(r.map(d=>d({phase:t,buffer:i,context:n}))).then(d=>Promise.all(d.filter(Boolean).map(c=>xt(c,t,!1,n,i))).then(()=>i[0]))):Promise.resolve(a)},Yt="text/plain; charset=UTF-8",Va=(a,t)=>({"Content-Type":a,...t}),Ba=(a,t)=>new Response(a,t),Ea,Da,F,ga,O,E,ja,va,ba,aa,Na,Ra,U,ua,ot,Wt=(ot=class{constructor(a,t){b(this,U);b(this,Ea);b(this,Da);g(this,"env",{});b(this,F);g(this,"finalized",!1);g(this,"error");b(this,ga);b(this,O);b(this,E);b(this,ja);b(this,va);b(this,ba);b(this,aa);b(this,Na);b(this,Ra);g(this,"render",(...a)=>(o(this,va)??m(this,va,t=>this.html(t)),o(this,va).call(this,...a)));g(this,"setLayout",a=>m(this,ja,a));g(this,"getLayout",()=>o(this,ja));g(this,"setRenderer",a=>{m(this,va,a)});g(this,"header",(a,t,e)=>{this.finalized&&m(this,E,Ba(o(this,E).body,o(this,E)));const n=o(this,E)?o(this,E).headers:o(this,aa)??m(this,aa,new Headers);t===void 0?n.delete(a):e!=null&&e.append?n.append(a,t):n.set(a,t)});g(this,"status",a=>{m(this,ga,a)});g(this,"set",(a,t)=>{o(this,F)??m(this,F,new Map),o(this,F).set(a,t)});g(this,"get",a=>o(this,F)?o(this,F).get(a):void 0);g(this,"newResponse",(...a)=>x(this,U,ua).call(this,...a));g(this,"body",(a,t,e)=>x(this,U,ua).call(this,a,t,e));g(this,"text",(a,t,e)=>!o(this,aa)&&!o(this,ga)&&!t&&!e&&!this.finalized?new Response(a):x(this,U,ua).call(this,a,t,Va(Yt,e)));g(this,"json",(a,t,e)=>x(this,U,ua).call(this,JSON.stringify(a),t,Va("application/json",e)));g(this,"html",(a,t,e)=>{const n=i=>x(this,U,ua).call(this,i,t,Va("text/html; charset=UTF-8",e));return typeof a=="object"?xt(a,$t.Stringify,!1,{}).then(n):n(a)});g(this,"redirect",(a,t)=>{const e=String(a);return this.header("Location",/[^\x00-\xFF]/.test(e)?encodeURI(e):e),this.newResponse(null,t??302)});g(this,"notFound",()=>(o(this,ba)??m(this,ba,()=>Ba()),o(this,ba).call(this,this)));m(this,Ea,a),t&&(m(this,O,t.executionCtx),this.env=t.env,m(this,ba,t.notFoundHandler),m(this,Ra,t.path),m(this,Na,t.matchResult))}get req(){return o(this,Da)??m(this,Da,new bt(o(this,Ea),o(this,Ra),o(this,Na))),o(this,Da)}get event(){if(o(this,O)&&"respondWith"in o(this,O))return o(this,O);throw Error("This context has no FetchEvent")}get executionCtx(){if(o(this,O))return o(this,O);throw Error("This context has no ExecutionContext")}get res(){return o(this,E)||m(this,E,Ba(null,{headers:o(this,aa)??m(this,aa,new Headers)}))}set res(a){if(o(this,E)&&a){a=Ba(a.body,a);for(const[t,e]of o(this,E).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=o(this,E).headers.getSetCookie();a.headers.delete("set-cookie");for(const i of n)a.headers.append("set-cookie",i)}else a.headers.set(t,e)}m(this,E,a),this.finalized=!0}get var(){return o(this,F)?Object.fromEntries(o(this,F)):{}}},Ea=new WeakMap,Da=new WeakMap,F=new WeakMap,ga=new WeakMap,O=new WeakMap,E=new WeakMap,ja=new WeakMap,va=new WeakMap,ba=new WeakMap,aa=new WeakMap,Na=new WeakMap,Ra=new WeakMap,U=new WeakSet,ua=function(a,t,e){const n=o(this,E)?new Headers(o(this,E).headers):o(this,aa)??new Headers;if(typeof t=="object"&&"headers"in t){const r=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[s,d]of r)s.toLowerCase()==="set-cookie"?n.append(s,d):n.set(s,d)}if(e)for(const[r,s]of Object.entries(e))if(typeof s=="string")n.set(r,s);else{n.delete(r);for(const d of s)n.append(r,d)}const i=typeof t=="number"?t:(t==null?void 0:t.status)??o(this,ga);return Ba(a,{status:i,headers:n})},ot),C="ALL",Zt="all",ae=["get","post","put","delete","options","patch"],kt="Can not add a route since the matcher is already built.",St=class extends Error{},te="__COMPOSED_HANDLER",ee=a=>a.text("404 Not Found",404),nt=(a,t)=>{if("getResponse"in a){const e=a.getResponse();return t.newResponse(e.body,e)}return console.error(a),t.text("Internal Server Error",500)},R,P,wt,M,W,Ka,_a,fa,ne=(fa=class{constructor(t={}){b(this,P);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");b(this,R,"/");g(this,"routes",[]);b(this,M,ee);g(this,"errorHandler",nt);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(m(this,M,t),this));g(this,"fetch",(t,...e)=>x(this,P,_a).call(this,t,e[1],e[0],t.method));g(this,"request",(t,e,n,i)=>t instanceof Request?this.fetch(e?new Request(t,e):t,n,i):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${pa("/",t)}`,e),n,i)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(x(this,P,_a).call(this,t.request,t,void 0,t.request.method))})});[...ae,Zt].forEach(r=>{this[r]=(s,...d)=>(typeof s=="string"?m(this,R,s):x(this,P,W).call(this,r,o(this,R),s),d.forEach(c=>{x(this,P,W).call(this,r,o(this,R),c)}),this)}),this.on=(r,s,...d)=>{for(const c of[s].flat()){m(this,R,c);for(const l of[r].flat())d.map(p=>{x(this,P,W).call(this,l.toUpperCase(),o(this,R),p)})}return this},this.use=(r,...s)=>(typeof r=="string"?m(this,R,r):(m(this,R,"*"),s.unshift(r)),s.forEach(d=>{x(this,P,W).call(this,C,o(this,R),d)}),this);const{strict:n,...i}=t;Object.assign(this,i),this.getPath=n??!0?t.getPath??ht:Vt}route(t,e){const n=this.basePath(t);return e.routes.map(i=>{var s;let r;e.errorHandler===nt?r=i.handler:(r=async(d,c)=>(await tt([],e.errorHandler)(d,()=>i.handler(d,c))).res,r[te]=i.handler),x(s=n,P,W).call(s,i.method,i.path,r)}),this}basePath(t){const e=x(this,P,wt).call(this);return e._basePath=pa(this._basePath,t),e}mount(t,e,n){let i,r;n&&(typeof n=="function"?r=n:(r=n.optionHandler,n.replaceRequest===!1?i=c=>c:i=n.replaceRequest));const s=r?c=>{const l=r(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};i||(i=(()=>{const c=pa(this._basePath,t),l=c==="/"?0:c.length;return p=>{const u=new URL(p.url);return u.pathname=u.pathname.slice(l)||"/",new Request(u,p)}})());const d=async(c,l)=>{const p=await e(i(c.req.raw),...s(c));if(p)return p;await l()};return x(this,P,W).call(this,C,pa(t,"*"),d),this}},R=new WeakMap,P=new WeakSet,wt=function(){const t=new fa({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,m(t,M,o(this,M)),t.routes=this.routes,t},M=new WeakMap,W=function(t,e,n){t=t.toUpperCase(),e=pa(this._basePath,e);const i={basePath:this._basePath,path:e,method:t,handler:n};this.router.add(t,e,[n,i]),this.routes.push(i)},Ka=function(t,e){if(t instanceof Error)return this.errorHandler(t,e);throw t},_a=function(t,e,n,i){if(i==="HEAD")return(async()=>new Response(null,await x(this,P,_a).call(this,t,e,n,"GET")))();const r=this.getPath(t,{env:n}),s=this.router.match(i,r),d=new Wt(t,{path:r,matchResult:s,env:n,executionCtx:e,notFoundHandler:o(this,M)});if(s[0].length===1){let l;try{l=s[0][0][0][0](d,async()=>{d.res=await o(this,M).call(this,d)})}catch(p){return x(this,P,Ka).call(this,p,d)}return l instanceof Promise?l.then(p=>p||(d.finalized?d.res:o(this,M).call(this,d))).catch(p=>x(this,P,Ka).call(this,p,d)):l??o(this,M).call(this,d)}const c=tt(s[0],this.errorHandler,o(this,M));return(async()=>{try{const l=await c(d);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return x(this,P,Ka).call(this,l,d)}})()},fa),Bt=[];function re(a,t){const e=this.buildAllMatchers(),n=((i,r)=>{const s=e[i]||e[C],d=s[2][r];if(d)return d;const c=r.match(s[0]);if(!c)return[[],Bt];const l=c.indexOf("",1);return[s[1][l],c]});return this.match=n,n(a,t)}var Oa="[^/]+",Pa=".*",Ta="(?:|/.*)",ha=Symbol(),ie=new Set(".\\+*[^]$()");function se(a,t){return a.length===1?t.length===1?a<t?-1:1:-1:t.length===1||a===Pa||a===Ta?1:t===Pa||t===Ta?-1:a===Oa?1:t===Oa?-1:a.length===t.length?a<t?-1:1:t.length-a.length}var ta,ea,A,ia,oe=(ia=class{constructor(){b(this,ta);b(this,ea);b(this,A,Object.create(null))}insert(t,e,n,i,r){if(t.length===0){if(o(this,ta)!==void 0)throw ha;if(r)return;m(this,ta,e);return}const[s,...d]=t,c=s==="*"?d.length===0?["","",Pa]:["","",Oa]:s==="/*"?["","",Ta]:s.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const p=c[1];let u=c[2]||Oa;if(p&&c[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ha;if(l=o(this,A)[u],!l){if(Object.keys(o(this,A)).some(f=>f!==Pa&&f!==Ta))throw ha;if(r)return;l=o(this,A)[u]=new ia,p!==""&&m(l,ea,i.varIndex++)}!r&&p!==""&&n.push([p,o(l,ea)])}else if(l=o(this,A)[s],!l){if(Object.keys(o(this,A)).some(p=>p.length>1&&p!==Pa&&p!==Ta))throw ha;if(r)return;l=o(this,A)[s]=new ia}l.insert(d,e,n,i,r)}buildRegExpStr(){const e=Object.keys(o(this,A)).sort(se).map(n=>{const i=o(this,A)[n];return(typeof o(i,ea)=="number"?`(${n})@${o(i,ea)}`:ie.has(n)?`\\${n}`:n)+i.buildRegExpStr()});return typeof o(this,ta)=="number"&&e.unshift(`#${o(this,ta)}`),e.length===0?"":e.length===1?e[0]:"(?:"+e.join("|")+")"}},ta=new WeakMap,ea=new WeakMap,A=new WeakMap,ia),za,Ma,lt,le=(lt=class{constructor(){b(this,za,{varIndex:0});b(this,Ma,new oe)}insert(a,t,e){const n=[],i=[];for(let s=0;;){let d=!1;if(a=a.replace(/\{[^}]+\}/g,c=>{const l=`@\\${s}`;return i[s]=[l,c],s++,d=!0,l}),!d)break}const r=a.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let s=i.length-1;s>=0;s--){const[d]=i[s];for(let c=r.length-1;c>=0;c--)if(r[c].indexOf(d)!==-1){r[c]=r[c].replace(d,i[s][1]);break}}return o(this,Ma).insert(r,t,n,o(this,za),e),n}buildRegExp(){let a=o(this,Ma).buildRegExpStr();if(a==="")return[/^$/,[],[]];let t=0;const e=[],n=[];return a=a.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,r,s)=>r!==void 0?(e[++t]=Number(r),"$()"):(s!==void 0&&(n[Number(s)]=++t),"")),[new RegExp(`^${a}`),e,n]}},za=new WeakMap,Ma=new WeakMap,lt),de=[/^$/,[],Object.create(null)],Fa=Object.create(null);function Ct(a){return Fa[a]??(Fa[a]=new RegExp(a==="*"?"":`^${a.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,e)=>e?`\\${e}`:"(?:|/.*)")}$`))}function ce(){Fa=Object.create(null)}function pe(a){var l;const t=new le,e=[];if(a.length===0)return de;const n=a.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,u],[f,S])=>p?1:f?-1:u.length-S.length),i=Object.create(null);for(let p=0,u=-1,f=n.length;p<f;p++){const[S,w,D]=n[p];S?i[w]=[D.map(([L])=>[L,Object.create(null)]),Bt]:u++;let N;try{N=t.insert(w,u,S)}catch(L){throw L===ha?new St(w):L}S||(e[u]=D.map(([L,B])=>{const K=Object.create(null);for(B-=1;B>=0;B--){const[ka,Ga]=N[B];K[ka]=Ga}return[L,K]}))}const[r,s,d]=t.buildRegExp();for(let p=0,u=e.length;p<u;p++)for(let f=0,S=e[p].length;f<S;f++){const w=(l=e[p][f])==null?void 0:l[1];if(!w)continue;const D=Object.keys(w);for(let N=0,L=D.length;N<L;N++)w[D[N]]=d[w[D[N]]]}const c=[];for(const p in s)c[p]=e[s[p]];return[r,c,i]}function da(a,t){if(a){for(const e of Object.keys(a).sort((n,i)=>i.length-n.length))if(Ct(e).test(t))return[...a[e]]}}var V,X,Ha,Pt,dt,ue=(dt=class{constructor(){b(this,Ha);g(this,"name","RegExpRouter");b(this,V);b(this,X);g(this,"match",re);m(this,V,{[C]:Object.create(null)}),m(this,X,{[C]:Object.create(null)})}add(a,t,e){var d;const n=o(this,V),i=o(this,X);if(!n||!i)throw new Error(kt);n[a]||[n,i].forEach(c=>{c[a]=Object.create(null),Object.keys(c[C]).forEach(l=>{c[a][l]=[...c[C][l]]})}),t==="/*"&&(t="*");const r=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=Ct(t);a===C?Object.keys(n).forEach(l=>{var p;(p=n[l])[t]||(p[t]=da(n[l],t)||da(n[C],t)||[])}):(d=n[a])[t]||(d[t]=da(n[a],t)||da(n[C],t)||[]),Object.keys(n).forEach(l=>{(a===C||a===l)&&Object.keys(n[l]).forEach(p=>{c.test(p)&&n[l][p].push([e,r])})}),Object.keys(i).forEach(l=>{(a===C||a===l)&&Object.keys(i[l]).forEach(p=>c.test(p)&&i[l][p].push([e,r]))});return}const s=mt(t)||[t];for(let c=0,l=s.length;c<l;c++){const p=s[c];Object.keys(i).forEach(u=>{var f;(a===C||a===u)&&((f=i[u])[p]||(f[p]=[...da(n[u],p)||da(n[C],p)||[]]),i[u][p].push([e,r-l+c+1]))})}}buildAllMatchers(){const a=Object.create(null);return Object.keys(o(this,X)).concat(Object.keys(o(this,V))).forEach(t=>{a[t]||(a[t]=x(this,Ha,Pt).call(this,t))}),m(this,V,m(this,X,void 0)),ce(),a}},V=new WeakMap,X=new WeakMap,Ha=new WeakSet,Pt=function(a){const t=[];let e=a===C;return[o(this,V),o(this,X)].forEach(n=>{const i=n[a]?Object.keys(n[a]).map(r=>[r,n[a][r]]):[];i.length!==0?(e||(e=!0),t.push(...i)):a!==C&&t.push(...Object.keys(n[C]).map(r=>[r,n[C][r]]))}),e?pe(t):null},dt),Q,z,ct,he=(ct=class{constructor(a){g(this,"name","SmartRouter");b(this,Q,[]);b(this,z,[]);m(this,Q,a.routers)}add(a,t,e){if(!o(this,z))throw new Error(kt);o(this,z).push([a,t,e])}match(a,t){if(!o(this,z))throw new Error("Fatal error");const e=o(this,Q),n=o(this,z),i=e.length;let r=0,s;for(;r<i;r++){const d=e[r];try{for(let c=0,l=n.length;c<l;c++)d.add(...n[c]);s=d.match(a,t)}catch(c){if(c instanceof St)continue;throw c}this.match=d.match.bind(d),m(this,Q,[d]),m(this,z,void 0);break}if(r===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,s}get activeRouter(){if(o(this,z)||o(this,Q).length!==1)throw new Error("No active router has been determined yet.");return o(this,Q)[0]}},Q=new WeakMap,z=new WeakMap,ct),Ca=Object.create(null),me=a=>{for(const t in a)return!0;return!1},$,I,na,ya,T,H,Z,xa,ge=(xa=class{constructor(t,e,n){b(this,H);b(this,$);b(this,I);b(this,na);b(this,ya,0);b(this,T,Ca);if(m(this,I,n||Object.create(null)),m(this,$,[]),t&&e){const i=Object.create(null);i[t]={handler:e,possibleKeys:[],score:0},m(this,$,[i])}m(this,na,[])}insert(t,e,n){m(this,ya,++at(this,ya)._);let i=this;const r=Ht(e),s=[];for(let d=0,c=r.length;d<c;d++){const l=r[d],p=r[d+1],u=Jt(l,p),f=Array.isArray(u)?u[0]:l;if(f in o(i,I)){i=o(i,I)[f],u&&s.push(u[1]);continue}o(i,I)[f]=new xa,u&&(o(i,na).push(u),s.push(u[1])),i=o(i,I)[f]}return o(i,$).push({[t]:{handler:n,possibleKeys:s.filter((d,c,l)=>l.indexOf(d)===c),score:o(this,ya)}}),i}search(t,e){var p;const n=[];m(this,T,Ca);let r=[this];const s=ut(e),d=[],c=s.length;let l=null;for(let u=0;u<c;u++){const f=s[u],S=u===c-1,w=[];for(let N=0,L=r.length;N<L;N++){const B=r[N],K=o(B,I)[f];K&&(m(K,T,o(B,T)),S?(o(K,I)["*"]&&x(this,H,Z).call(this,n,o(K,I)["*"],t,o(B,T)),x(this,H,Z).call(this,n,K,t,o(B,T))):w.push(K));for(let ka=0,Ga=o(B,na).length;ka<Ga;ka++){const Ya=o(B,na)[ka],q=o(B,T)===Ca?{}:{...o(B,T)};if(Ya==="*"){const oa=o(B,I)["*"];oa&&(x(this,H,Z).call(this,n,oa,t,o(B,T)),m(oa,T,q),w.push(oa));continue}const[Rt,Wa,Sa]=Ya;if(!f&&!(Sa instanceof RegExp))continue;const _=o(B,I)[Rt];if(Sa instanceof RegExp){if(l===null){l=new Array(c);let la=e[0]==="/"?1:0;for(let wa=0;wa<c;wa++)l[wa]=la,la+=s[wa].length+1}const oa=e.substring(l[u]),qa=Sa.exec(oa);if(qa){if(q[Wa]=qa[0],x(this,H,Z).call(this,n,_,t,o(B,T),q),me(o(_,I))){m(_,T,q);const la=((p=qa[0].match(/\//))==null?void 0:p.length)??0;(d[la]||(d[la]=[])).push(_)}continue}}(Sa===!0||Sa.test(f))&&(q[Wa]=f,S?(x(this,H,Z).call(this,n,_,t,q,o(B,T)),o(_,I)["*"]&&x(this,H,Z).call(this,n,o(_,I)["*"],t,q,o(B,T))):(m(_,T,q),w.push(_)))}}const D=d.shift();r=D?w.concat(D):w}return n.length>1&&n.sort((u,f)=>u.score-f.score),[n.map(({handler:u,params:f})=>[u,f])]}},$=new WeakMap,I=new WeakMap,na=new WeakMap,ya=new WeakMap,T=new WeakMap,H=new WeakSet,Z=function(t,e,n,i,r){for(let s=0,d=o(e,$).length;s<d;s++){const c=o(e,$)[s],l=c[n]||c[C],p={};if(l!==void 0&&(l.params=Object.create(null),t.push(l),i!==Ca||r&&r!==Ca))for(let u=0,f=l.possibleKeys.length;u<f;u++){const S=l.possibleKeys[u],w=p[l.score];l.params[S]=r!=null&&r[S]&&!w?r[S]:i[S]??(r==null?void 0:r[S]),p[l.score]=!0}}},xa),ra,pt,ve=(pt=class{constructor(){g(this,"name","TrieRouter");b(this,ra);m(this,ra,new ge)}add(a,t,e){const n=mt(t);if(n){for(let i=0,r=n.length;i<r;i++)o(this,ra).insert(a,n[i],e);return}o(this,ra).insert(a,t,e)}match(a,t){return o(this,ra).search(a,t)}},ra=new WeakMap,pt),Tt=class extends ne{constructor(a={}){super(a),this.router=a.router??new he({routers:[new ue,new ve]})}};const h=new Tt;let It="1234";const Et="4321",Dt="2028-12-31";function Y(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function ca(a){return String(a).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function sa(a,t){if(!a.DATA_STORE)return[];let e;const n=[];do{const s=await a.DATA_STORE.list({prefix:t,cursor:e,limit:1e3});n.push(...s.keys.map(d=>d.name)),e=s.list_complete?void 0:s.cursor}while(e);const i=await Promise.all(n.map(s=>a.DATA_STORE.get(s))),r=[];for(let s=0;s<n.length;s++)if(i[s])try{r.push({_key:n[s],...JSON.parse(i[s])})}catch{}return r}function v(a){return new Response(a,{headers:{"content-type":"text/html;charset=UTF-8","Cache-Control":"no-store, no-cache, must-revalidate, proxy-revalidate",Pragma:"no-cache",Expires:"0"}})}h.post("/login",async a=>{var s;const t=await a.req.formData(),e=t.get("pin"),n=await((s=a.env.DATA_STORE)==null?void 0:s.get("APP_PIN"))||It,i=(t.get("username")||"").trim(),r=await sa(a.env,"user:");if(r.length>0&&i){const d=r.find(c=>c.username===i&&c.password===e&&c.active!==!1);if(d){const c=encodeURIComponent(JSON.stringify({auth:1,userId:d._key,username:d.username,role:d.role,name:d.name}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${c}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return v(Ia("Invalid credentials",r.length>0))}if(e===n){const d=encodeURIComponent(JSON.stringify({auth:1,userId:"admin",username:"admin",role:"admin",name:"Administrator"}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${d}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return v(Ia("Wrong PIN",r.length>0))});h.get("/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"session=; Path=/; HttpOnly; Max-Age=0; SameSite=Strict",Location:"/login","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache","Clear-Site-Data":'"cache"'}}));function y(a){const e=(a.req.header("Cookie")||"").match(/session=([^;]+)/);if(!e)return null;try{return JSON.parse(decodeURIComponent(e[1]))}catch{return null}}h.use("*",async(a,t)=>{const e=new URL(a.req.url).pathname;if(e==="/login"&&a.req.method==="GET"){const l=await sa(a.env,"user:");return v(Ia("",l.length>0))}if(e==="/api/company-settings"&&a.req.method==="GET"){await t();return}if(!(new URL(a.req.url).searchParams.get("master")===Et)){const l=new Date().toISOString().slice(0,10);if(l>Dt)return v(rt());if(a.env.DATA_STORE){const p=await a.env.DATA_STORE.get("APP_LICENSE");if(p&&l>p)return v(rt())}}if(e.startsWith("/sp-portal")){const p=(a.req.header("Cookie")||"").match(/sp_session=([^;]+)/);if(e==="/sp-portal/login"&&a.req.method==="GET"||!p&&e!=="/sp-portal/login")return v(Qa(""));await t();return}const r=y(a);if(!(r!=null&&r.auth)&&e!=="/login")return v(Ia("",!1));const s={admin:[],manager:["/users","/admin"],entry:["/users","/admin","/profit-loss","/balance-sheet","/trial-balance","/stock","/receivable-payable","/salesperson","/expense-ledger","/approvals","/company-settings"],viewer:["/inventory","/parties","/purchases","/sales","/payments","/expenses","/orders","/users","/admin","/salesperson","/approvals","/company-settings"]},d=(r==null?void 0:r.role)||"admin";if((s[d]||[]).includes(e))return v(k(`<div class="card"><div class="empty" style="padding:40px"><h3>Access Denied</h3><p class="text-muted">You don't have permission to access this page.</p><a href="/" class="btn btn-primary" style="margin-top:12px">Go to Dashboard</a></div></div>`,"dashboard",r));await t()});h.get("/api/license-info",async a=>{const e=(a.env.DATA_STORE?await a.env.DATA_STORE.get("APP_LICENSE"):null)||Dt,n=Math.floor((new Date(e).getTime()-Date.now())/864e5);return a.json({expiry:e,days:n,status:n<0?"Expired":"Active"})});h.post("/api/set-license",async a=>{if(new URL(a.req.url).searchParams.get("master")!==Et)return a.json({success:!1,error:"Unauthorized"},403);const e=await a.req.json();return a.env.DATA_STORE?(await a.env.DATA_STORE.put("APP_LICENSE",String((e==null?void 0:e.date)||"")),a.json({success:!0})):a.json({success:!1,error:"KV not configured"},500)});h.post("/api/list",async a=>{const t=await a.req.json();return a.json(await sa(a.env,(t==null?void 0:t.prefix)||""))});const jt=["product:","party:","sale:","purchase:","payment:","expense:","bank:","order:","salesperson:"];h.post("/api/save",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=await a.req.json(),e=(t==null?void 0:t.prefix)||"",n=t==null?void 0:t.id,i=t==null?void 0:t.key,r=(t==null?void 0:t.data)||{},s=(t==null?void 0:t.logAction)||"",d=(t==null?void 0:t.logDetail)||"",c=(t==null?void 0:t.skipApproval)===!0;let l=i;l||(n?l=n.startsWith(e)?n:e+n:l=e+Y());const p=y(a),u=(p==null?void 0:p.role)==="entry",f=!!(i||n),S=jt.some(w=>e&&e===w||l&&l.startsWith(w));if(u&&f&&S&&!c){const w="approval:"+Y(),D=await a.env.DATA_STORE.get(l);return await a.env.DATA_STORE.put(w,JSON.stringify({type:"edit",targetKey:l,prefix:e,newData:r,oldData:D?JSON.parse(D):null,detail:d||"Edit: "+l,requestedBy:(p==null?void 0:p.name)||(p==null?void 0:p.username)||"Unknown",requestedAt:new Date().toISOString(),status:"pending"})),a.json({success:!0,key:l,pending:!0,message:"Your edit has been submitted for approval"})}if(await a.env.DATA_STORE.put(l,JSON.stringify(r)),s){const w="modlog:"+Y();await a.env.DATA_STORE.put(w,JSON.stringify({action:s,detail:d,key:l,prefix:e,user:(p==null?void 0:p.name)||(p==null?void 0:p.username)||"System",timestamp:new Date().toISOString()}))}return a.json({success:!0,key:l})});h.post("/api/get",async a=>{if(!a.env.DATA_STORE)return a.json(null);const{key:t}=await a.req.json(),e=await a.env.DATA_STORE.get(t);return a.json(e?JSON.parse(e):null)});h.post("/api/delete",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=await a.req.json(),e=t==null?void 0:t.key,n=(t==null?void 0:t.logDetail)||"",i=(t==null?void 0:t.skipApproval)===!0;if(!e)return a.json({success:!1,error:"Key is required"},400);const r=y(a),s=(r==null?void 0:r.role)==="entry",d=jt.some(p=>e.startsWith(p));if(s&&d&&!i){const p=await a.env.DATA_STORE.get(e),u="approval:"+Y();return await a.env.DATA_STORE.put(u,JSON.stringify({type:"delete",targetKey:e,prefix:e.split(":")[0]+":",newData:null,oldData:p?JSON.parse(p):null,detail:n||"Delete: "+e,requestedBy:(r==null?void 0:r.name)||(r==null?void 0:r.username)||"Unknown",requestedAt:new Date().toISOString(),status:"pending"})),a.json({success:!0,pending:!0,message:"Your delete request has been submitted for approval"})}const c=await a.env.DATA_STORE.get(e);await a.env.DATA_STORE.delete(e);const l="modlog:"+Y();return await a.env.DATA_STORE.put(l,JSON.stringify({action:"delete",detail:n||"Deleted key: "+e,key:e,oldData:c?c.substring(0,500):"",user:(r==null?void 0:r.name)||(r==null?void 0:r.username)||"System",timestamp:new Date().toISOString()})),a.json({success:!0})});h.post("/api/approval-list",async a=>a.json(await sa(a.env,"approval:")));h.post("/api/approval-action",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=y(a),e=(t==null?void 0:t.role)||"";if(e!=="admin"&&e!=="manager")return a.json({success:!1,error:"Only admin/manager can approve"},403);const{approvalKey:n,action:i}=await a.req.json();if(!n)return a.json({success:!1,error:"Approval key required"},400);const r=await a.env.DATA_STORE.get(n);if(!r)return a.json({success:!1,error:"Approval not found"},404);const s=JSON.parse(r);if(s.status!=="pending")return a.json({success:!1,error:"Already processed"},400);if(i==="approve"){if(s.type==="edit"&&s.targetKey&&s.newData){await a.env.DATA_STORE.put(s.targetKey,JSON.stringify(s.newData));const d="modlog:"+Y();await a.env.DATA_STORE.put(d,JSON.stringify({action:"edit",detail:"Approved edit by "+s.requestedBy+": "+s.detail,key:s.targetKey,prefix:s.prefix,user:(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System",timestamp:new Date().toISOString()}))}else if(s.type==="delete"&&s.targetKey){await a.env.DATA_STORE.delete(s.targetKey);const d="modlog:"+Y();await a.env.DATA_STORE.put(d,JSON.stringify({action:"delete",detail:"Approved delete by "+s.requestedBy+": "+s.detail,key:s.targetKey,prefix:s.prefix,user:(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System",timestamp:new Date().toISOString()}))}s.status="approved"}else s.status="rejected";return s.processedBy=(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System",s.processedAt=new Date().toISOString(),await a.env.DATA_STORE.put(n,JSON.stringify(s)),a.json({success:!0,status:s.status})});h.get("/api/company-settings",async a=>{if(!a.env.DATA_STORE)return a.json({companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"});const t=await a.env.DATA_STORE.get("COMPANY_SETTINGS");return t?a.json(JSON.parse(t)):a.json({companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"})});h.post("/api/company-settings",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=y(a);if((t==null?void 0:t.role)!=="admin")return a.json({success:!1,error:"Only admin can change company settings"},403);const e=await a.req.json();return await a.env.DATA_STORE.put("COMPANY_SETTINGS",JSON.stringify(e)),a.json({success:!0})});h.post("/api/export-all",async a=>{const t=["product:","party:","sale:","purchase:","payment:","expense:","exphead:","expsubhead:","bank:","cb:","user:","order:","salesperson:","creditlimit:","prodgroup:","modlog:","approval:","companysettings:"],e={};for(const n of t)e[n]=await sa(a.env,n);return a.json(e)});h.post("/api/import-all",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=await a.req.json();let e=0;for(const[n,i]of Object.entries(t))if(Array.isArray(i))for(const r of i){const s=r._key||n+Y(),d={...r};delete d._key,await a.env.DATA_STORE.put(s,JSON.stringify(d)),e++}return a.json({success:!0,count:e})});h.post("/api/change-pin",async a=>{var i;const{oldPin:t,newPin:e}=await a.req.json(),n=await((i=a.env.DATA_STORE)==null?void 0:i.get("APP_PIN"))||It;return t!==n?a.json({success:!1,error:"Wrong current PIN"}):!e||e.length<4?a.json({success:!1,error:"PIN must be at least 4 characters"}):(await a.env.DATA_STORE.put("APP_PIN",e),a.json({success:!0}))});h.post("/api/kv-keys",async a=>{const{prefix:t}=await a.req.json();if(!a.env.DATA_STORE)return a.json([]);const e=await a.env.DATA_STORE.list({prefix:t||"",limit:100});return a.json(e.keys.map(n=>n.name))});h.post("/api/kv-get",async a=>{const{key:t}=await a.req.json();if(!a.env.DATA_STORE)return a.json({value:null});const e=await a.env.DATA_STORE.get(t);return a.json({value:e})});h.post("/api/kv-delete",async a=>{const{key:t}=await a.req.json();return a.env.DATA_STORE?(await a.env.DATA_STORE.delete(t),a.json({success:!0})):a.json({success:!1})});h.post("/sp-portal/login",async a=>{const t=await a.req.formData(),e=t.get("code"),n=t.get("pin"),r=(await sa(a.env,"salesperson:")).find(s=>s.code===e&&s.pin===n&&s.active!==!1);if(r){const s=encodeURIComponent(JSON.stringify({spId:r._key,spName:r.name,spCode:r.code}));return new Response(null,{status:302,headers:{"Set-Cookie":`sp_session=${s}; Path=/; HttpOnly; SameSite=Strict`,Location:"/sp-portal"}})}return v(Qa("Invalid credentials"))});h.get("/sp-portal/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"sp_session=; Path=/; HttpOnly; Max-Age=0",Location:"/sp-portal/login"}}));h.get("/",a=>v(k(Se(),"dashboard",y(a))));h.get("/inventory",a=>v(k(we(),"inventory",y(a))));h.get("/stock-check",a=>v(k(Be(),"stockcheck",y(a))));h.get("/parties",a=>v(k(Ce(),"parties",y(a))));h.get("/purchases",a=>v(k(Pe(),"purchases",y(a))));h.get("/sales",a=>v(k(Te(),"sales",y(a))));h.get("/payments",a=>v(k(Ie(),"payments",y(a))));h.get("/expenses",a=>v(k(Ee(),"expenses",y(a))));h.get("/ledger",a=>v(k(De(),"ledger",y(a))));h.get("/expense-ledger",a=>v(k(je(),"expledger",y(a))));h.get("/profit-loss",a=>v(k(Ne(),"profitloss",y(a))));h.get("/balance-sheet",a=>v(k(Re(),"balancesheet",y(a))));h.get("/trial-balance",a=>v(k(Me(),"trialbalance",y(a))));h.get("/stock",a=>v(k(Ae(),"stock",y(a))));h.get("/receivable-payable",a=>v(k(Le(),"recpay",y(a))));h.get("/day-details",a=>v(k(Ke(),"daydetails",y(a))));h.get("/reports",a=>v(k(_e(),"reports",y(a))));h.get("/salesperson",a=>v(k(Fe(),"salesperson",y(a))));h.get("/orders",a=>v(k(Oe(),"orders",y(a))));h.get("/users",a=>v(k(ze(),"users",y(a))));h.get("/admin",a=>v(k(He(),"admin",y(a))));h.get("/mod-log",a=>v(k(Ge(),"modlog",y(a))));h.get("/approvals",a=>v(k(qe(),"approvals",y(a))));h.get("/company-settings",a=>v(k(Je(),"companysettings",y(a))));h.get("/vat-ledger",a=>v(k(be(),"vatledger",y(a))));h.get("/ait-ledger",a=>v(k(fe(),"aitledger",y(a))));h.get("/truck-fare-report",a=>v(k(xe(),"truckfarereport",y(a))));h.get("/truck-fare-settings",a=>v(k(ye(),"truckfaresettings",y(a))));h.get("/sp-portal",a=>v(ke(a)));h.get("/login",async a=>{const t=await sa(a.env,"user:");return v(Ia("",t.length>0))});function be(){return`
...
<\/script></body></html>`}function Se(){var a=new Date().toISOString().slice(0,10),t=a.slice(0,7);return`
...
async function loadTB(){
  ...
  // Cash receipts (manual, non-auto vouchers)
  ...
  var cashForPurchases = purchases.filter(function(p) { return p.method === 'cash'; })
    .reduce(function(s, x) { return s + n(x.paid); }, 0);
  // Cash payments out (manual, non-auto)
...
loadCS();
<\/script>`}const it=new Tt,Ue=Object.assign({"/src/index.tsx":h});let Nt=!1;for(const[,a]of Object.entries(Ue))a&&(it.all("*",t=>{let e;try{e=t.executionCtx}catch{}return a.fetch(t.req.raw,t.env,e)}),it.notFound(t=>{let e;try{e=t.executionCtx}catch{}return a.fetch(t.req.raw,t.env,e)}),Nt=!0);if(!Nt)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{it as default};

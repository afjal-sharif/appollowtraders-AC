...
<\/script></body></html>`}function rr(){var a=new Date().toISOString().slice(0,10),t=a.slice(0,7);return`
...
loadCS();
<\/script>`}const gt=new Lt,Ir=Object.assign({"/src/index.tsx":h});let Zt=!1;for(const[,a]of Object.entries(Ir))a&&(gt.all("*",t=>{let e;try{e=t.executionCtx}catch{}return a.fetch(t.req.raw,t.env,e)}),gt.notFound(t=>{let e;try{e=t.executionCtx}catch{}return a.fetch(t.req.raw,t.env,e)}),Zt=!0);if(!Zt)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{gt as default};

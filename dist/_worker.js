var ee=Object.defineProperty;var dt=a=>{throw TypeError(a)};var re=(a,t,e)=>t in a?ee(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var g=(a,t,e)=>re(a,typeof t!="symbol"?t+"":t,e),Ya=(a,t,e)=>t.has(a)||dt("Cannot "+e);var c=(a,t,e)=>(Ya(a,t,"read from private field"),e?e.call(a):t.get(a)),b=(a,t,e)=>t.has(a)?dt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(Ya(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),B=(a,t,e)=>(Ya(a,t,"access private method"),e);var ct=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return c(a,t,r)}});var pt=(a,t,e)=>(r,i)=>{let n=-1;return s(0);async function s(l){if(l<=n)throw new Error("next() called multiple times");n=l;let o,d=!1,p;if(a[l]?(p=a[l][0][0],r.req.routeIndex=l):p=l===a.length&&i||void 0,p)try{o=await p(r,()=>s(l+1))}catch(u){if(u instanceof Error&&t)r.error=u,o=await t(u,r),d=!0;else throw u}else r.finalized===!1&&e&&(o=await e(r));return o&&(r.finalized===!1||d)&&(r.res=o),r}},ne=Symbol(),ie=async(a,t=Object.create(null))=>{const{all:e=!1,dot:r=!1}=t,n=(a instanceof It?a.raw.headers:a.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?se(a,{all:e,dot:r}):{}};async function se(a,t){const e=await a.formData();return e?oe(e,t):{}}function oe(a,t){const e=Object.create(null);return a.forEach((r,i)=>{t.all||i.endsWith("[]")?le(e,i,r):e[i]=r}),t.dot&&Object.entries(e).forEach(([r,i])=>{r.includes(".")&&(de(e,r,i),delete e[r])}),e}var le=(a,t,e)=>{a[t]!==void 0?Array.isArray(a[t])?a[t].push(e):a[t]=[a[t],e]:t.endsWith("[]")?a[t]=[e]:a[t]=e},de=(a,t,e)=>{if(/(?:^|\.)__proto__\./.test(t))return;let r=a;const i=t.split(".");i.forEach((n,s)=>{s===i.length-1?r[n]=e:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},St=a=>{const t=a.split("/");return t[0]===""&&t.shift(),t},ce=a=>{const{groups:t,path:e}=pe(a),r=St(e);return ue(r,t)},pe=a=>{const t=[];return a=a.replace(/\{[^}]+\}/g,(e,r)=>{const i=`@${r}`;return t.push([i,e]),i}),{groups:t,path:a}},ue=(a,t)=>{for(let e=t.length-1;e>=0;e--){const[r]=t[e];for(let i=a.length-1;i>=0;i--)if(a[i].includes(r)){a[i]=a[i].replace(r,t[e][1]);break}}return a},za={},he=(a,t)=>{if(a==="*")return"*";const e=a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(e){const r=`${a}#${t}`;return za[r]||(e[2]?za[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,e[1],new RegExp(`^${e[2]}(?=/${t})`)]:[a,e[1],new RegExp(`^${e[2]}$`)]:za[r]=[a,e[1],!0]),za[r]}return null},et=(a,t)=>{try{return t(a)}catch{return a.replace(/(?:%[0-9A-Fa-f]{2})+/g,e=>{try{return t(e)}catch{return e}})}},me=a=>et(a,decodeURI),Bt=a=>{const t=a.url,e=t.indexOf("/",t.indexOf(":")+4);let r=e;for(;r<t.length;r++){const i=t.charCodeAt(r);if(i===37){const n=t.indexOf("?",r),s=t.indexOf("#",r),l=n===-1?s===-1?void 0:s:s===-1?n:Math.min(n,s),o=t.slice(e,l);return me(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(i===63||i===35)break}return t.slice(e,r)},ge=a=>{const t=Bt(a);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ua=(a,t,...e)=>(e.length&&(t=ua(t,...e)),`${(a==null?void 0:a[0])==="/"?"":"/"}${a}${t==="/"?"":`${(a==null?void 0:a.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),wt=a=>{if(a.charCodeAt(a.length-1)!==63||!a.includes(":"))return null;const t=a.split("/"),e=[];let r="";return t.forEach(i=>{if(i!==""&&!/\:/.test(i))r+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){e.length===0&&r===""?e.push("/"):e.push(r);const n=i.replace("?","");r+="/"+n,e.push(r)}else r+="/"+i}),e.filter((i,n,s)=>s.indexOf(i)===n)},Wa=a=>/[%+]/.test(a)?(a.indexOf("+")!==-1&&(a=a.replace(/\+/g," ")),a.indexOf("%")!==-1?et(a,Pt):a):a,Ct=(a,t,e)=>{let r;if(!e&&t&&!/[%+]/.test(t)){let s=a.indexOf("?",8);if(s===-1)return;for(a.startsWith(t,s+1)||(s=a.indexOf(`&${t}`,s+1));s!==-1;){const l=a.charCodeAt(s+t.length+1);if(l===61){const o=s+t.length+2,d=a.indexOf("&",o);return Wa(a.slice(o,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";s=a.indexOf(`&${t}`,s+1)}if(r=/[%+]/.test(a),!r)return}const i={};r??(r=/[%+]/.test(a));let n=a.indexOf("?",8);for(;n!==-1;){const s=a.indexOf("&",n+1);let l=a.indexOf("=",n);l>s&&s!==-1&&(l=-1);let o=a.slice(n+1,l===-1?s===-1?void 0:s:l);if(r&&(o=Wa(o)),n=s,o==="")continue;let d;l===-1?d="":(d=a.slice(l+1,s===-1?void 0:s),r&&(d=Wa(d))),e?(i[o]&&Array.isArray(i[o])||(i[o]=[]),i[o].push(d)):i[o]??(i[o]=d)}return t?i[t]:i},ve=Ct,be=(a,t)=>Ct(a,t,!0),Pt=decodeURIComponent,ut=a=>et(a,Pt),ga,R,J,Et,Tt,at,U,vt,It=(vt=class{constructor(a,t="/",e=[[]]){b(this,J);g(this,"raw");b(this,ga);b(this,R);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});b(this,U,a=>{const{bodyCache:t,raw:e}=this,r=t[a];if(r)return r;const i=Object.keys(t)[0];return i?t[i].then(n=>(i==="json"&&(n=JSON.stringify(n)),new Response(n)[a]())):t[a]=e[a]()});this.raw=a,this.path=t,m(this,R,e),m(this,ga,{})}param(a){return a?B(this,J,Et).call(this,a):B(this,J,Tt).call(this)}query(a){return ve(this.url,a)}queries(a){return be(this.url,a)}header(a){if(a)return this.raw.headers.get(a)??void 0;const t={};return this.raw.headers.forEach((e,r)=>{t[r]=e}),t}async parseBody(a){return ie(this,a)}json(){return c(this,U).call(this,"text").then(a=>JSON.parse(a))}text(){return c(this,U).call(this,"text")}arrayBuffer(){return c(this,U).call(this,"arrayBuffer")}blob(){return c(this,U).call(this,"blob")}formData(){return c(this,U).call(this,"formData")}addValidatedData(a,t){c(this,ga)[a]=t}valid(a){return c(this,ga)[a]}get url(){return this.raw.url}get method(){return this.raw.method}get[ne](){return c(this,R)}get matchedRoutes(){return c(this,R)[0].map(([[,a]])=>a)}get routePath(){return c(this,R)[0].map(([[,a]])=>a)[this.routeIndex].path}},ga=new WeakMap,R=new WeakMap,J=new WeakSet,Et=function(a){const t=c(this,R)[0][this.routeIndex][1][a],e=B(this,J,at).call(this,t);return e&&/\%/.test(e)?ut(e):e},Tt=function(){const a={},t=Object.keys(c(this,R)[0][this.routeIndex][1]);for(const e of t){const r=B(this,J,at).call(this,c(this,R)[0][this.routeIndex][1][e]);r!==void 0&&(a[e]=/\%/.test(r)?ut(r):r)}return a},at=function(a){return c(this,R)[1]?c(this,R)[1][a]:a},U=new WeakMap,vt),fe={Stringify:1},Dt=async(a,t,e,r,i)=>{typeof a=="object"&&!(a instanceof String)&&(a instanceof Promise||(a=a.toString()),a instanceof Promise&&(a=await a));const n=a.callbacks;return n!=null&&n.length?(i?i[0]+=a:i=[a],Promise.all(n.map(l=>l({phase:t,buffer:i,context:r}))).then(l=>Promise.all(l.filter(Boolean).map(o=>Dt(o,t,!1,r,i))).then(()=>i[0]))):Promise.resolve(a)},ye="text/plain; charset=UTF-8",Za=(a,t)=>({"Content-Type":a,...t}),Pa=(a,t)=>new Response(a,t),Aa,Ra,z,va,H,N,Ma,ba,fa,aa,_a,La,V,ha,bt,ke=(bt=class{constructor(a,t){b(this,V);b(this,Aa);b(this,Ra);g(this,"env",{});b(this,z);g(this,"finalized",!1);g(this,"error");b(this,va);b(this,H);b(this,N);b(this,Ma);b(this,ba);b(this,fa);b(this,aa);b(this,_a);b(this,La);g(this,"render",(...a)=>(c(this,ba)??m(this,ba,t=>this.html(t)),c(this,ba).call(this,...a)));g(this,"setLayout",a=>m(this,Ma,a));g(this,"getLayout",()=>c(this,Ma));g(this,"setRenderer",a=>{m(this,ba,a)});g(this,"header",(a,t,e)=>{this.finalized&&m(this,N,Pa(c(this,N).body,c(this,N)));const r=c(this,N)?c(this,N).headers:c(this,aa)??m(this,aa,new Headers);t===void 0?r.delete(a):e!=null&&e.append?r.append(a,t):r.set(a,t)});g(this,"status",a=>{m(this,va,a)});g(this,"set",(a,t)=>{c(this,z)??m(this,z,new Map),c(this,z).set(a,t)});g(this,"get",a=>c(this,z)?c(this,z).get(a):void 0);g(this,"newResponse",(...a)=>B(this,V,ha).call(this,...a));g(this,"body",(a,t,e)=>B(this,V,ha).call(this,a,t,e));g(this,"text",(a,t,e)=>!c(this,aa)&&!c(this,va)&&!t&&!e&&!this.finalized?new Response(a):B(this,V,ha).call(this,a,t,Za(ye,e)));g(this,"json",(a,t,e)=>B(this,V,ha).call(this,JSON.stringify(a),t,Za("application/json",e)));g(this,"html",(a,t,e)=>{const r=i=>B(this,V,ha).call(this,i,t,Za("text/html; charset=UTF-8",e));return typeof a=="object"?Dt(a,fe.Stringify,!1,{}).then(r):r(a)});g(this,"redirect",(a,t)=>{const e=String(a);return this.header("Location",/[^\x00-\xFF]/.test(e)?encodeURI(e):e),this.newResponse(null,t??302)});g(this,"notFound",()=>(c(this,fa)??m(this,fa,()=>Pa()),c(this,fa).call(this,this)));m(this,Aa,a),t&&(m(this,H,t.executionCtx),this.env=t.env,m(this,fa,t.notFoundHandler),m(this,La,t.path),m(this,_a,t.matchResult))}get req(){return c(this,Ra)??m(this,Ra,new It(c(this,Aa),c(this,La),c(this,_a))),c(this,Ra)}get event(){if(c(this,H)&&"respondWith"in c(this,H))return c(this,H);throw Error("This context has no FetchEvent")}get executionCtx(){if(c(this,H))return c(this,H);throw Error("This context has no ExecutionContext")}get res(){return c(this,N)||m(this,N,Pa(null,{headers:c(this,aa)??m(this,aa,new Headers)}))}set res(a){if(c(this,N)&&a){a=Pa(a.body,a);for(const[t,e]of c(this,N).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=c(this,N).headers.getSetCookie();a.headers.delete("set-cookie");for(const i of r)a.headers.append("set-cookie",i)}else a.headers.set(t,e)}m(this,N,a),this.finalized=!0}get var(){return c(this,z)?Object.fromEntries(c(this,z)):{}}},Aa=new WeakMap,Ra=new WeakMap,z=new WeakMap,va=new WeakMap,H=new WeakMap,N=new WeakMap,Ma=new WeakMap,ba=new WeakMap,fa=new WeakMap,aa=new WeakMap,_a=new WeakMap,La=new WeakMap,V=new WeakSet,ha=function(a,t,e){const r=c(this,N)?new Headers(c(this,N).headers):c(this,aa)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[s,l]of n)s.toLowerCase()==="set-cookie"?r.append(s,l):r.set(s,l)}if(e)for(const[n,s]of Object.entries(e))if(typeof s=="string")r.set(n,s);else{r.delete(n);for(const l of s)r.append(n,l)}const i=typeof t=="number"?t:(t==null?void 0:t.status)??c(this,va);return Pa(a,{status:i,headers:r})},bt),I="ALL",xe="all",Se=["get","post","put","delete","options","patch"],jt="Can not add a route since the matcher is already built.",Nt=class extends Error{},Be="__COMPOSED_HANDLER",we=a=>a.text("404 Not Found",404),ht=(a,t)=>{if("getResponse"in a){const e=a.getResponse();return t.newResponse(e.body,e)}return console.error(a),t.text("Internal Server Error",500)},M,E,At,_,W,Ha,Ga,ya,Ce=(ya=class{constructor(t={}){b(this,E);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");b(this,M,"/");g(this,"routes",[]);b(this,_,we);g(this,"errorHandler",ht);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(m(this,_,t),this));g(this,"fetch",(t,...e)=>B(this,E,Ga).call(this,t,e[1],e[0],t.method));g(this,"request",(t,e,r,i)=>t instanceof Request?this.fetch(e?new Request(t,e):t,r,i):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ua("/",t)}`,e),r,i)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(B(this,E,Ga).call(this,t.request,t,void 0,t.request.method))})});[...Se,xe].forEach(n=>{this[n]=(s,...l)=>(typeof s=="string"?m(this,M,s):B(this,E,W).call(this,n,c(this,M),s),l.forEach(o=>{B(this,E,W).call(this,n,c(this,M),o)}),this)}),this.on=(n,s,...l)=>{for(const o of[s].flat()){m(this,M,o);for(const d of[n].flat())l.map(p=>{B(this,E,W).call(this,d.toUpperCase(),c(this,M),p)})}return this},this.use=(n,...s)=>(typeof n=="string"?m(this,M,n):(m(this,M,"*"),s.unshift(n)),s.forEach(l=>{B(this,E,W).call(this,I,c(this,M),l)}),this);const{strict:r,...i}=t;Object.assign(this,i),this.getPath=r??!0?t.getPath??Bt:ge}route(t,e){const r=this.basePath(t);return e.routes.map(i=>{var s;let n;e.errorHandler===ht?n=i.handler:(n=async(l,o)=>(await pt([],e.errorHandler)(l,()=>i.handler(l,o))).res,n[Be]=i.handler),B(s=r,E,W).call(s,i.method,i.path,n)}),this}basePath(t){const e=B(this,E,At).call(this);return e._basePath=ua(this._basePath,t),e}mount(t,e,r){let i,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?i=o=>o:i=r.replaceRequest));const s=n?o=>{const d=n(o);return Array.isArray(d)?d:[d]}:o=>{let d;try{d=o.executionCtx}catch{}return[o.env,d]};i||(i=(()=>{const o=ua(this._basePath,t),d=o==="/"?0:o.length;return p=>{const u=new URL(p.url);return u.pathname=u.pathname.slice(d)||"/",new Request(u,p)}})());const l=async(o,d)=>{const p=await e(i(o.req.raw),...s(o));if(p)return p;await d()};return B(this,E,W).call(this,I,ua(t,"*"),l),this}},M=new WeakMap,E=new WeakSet,At=function(){const t=new ya({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,m(t,_,c(this,_)),t.routes=this.routes,t},_=new WeakMap,W=function(t,e,r){t=t.toUpperCase(),e=ua(this._basePath,e);const i={basePath:this._basePath,path:e,method:t,handler:r};this.router.add(t,e,[r,i]),this.routes.push(i)},Ha=function(t,e){if(t instanceof Error)return this.errorHandler(t,e);throw t},Ga=function(t,e,r,i){if(i==="HEAD")return(async()=>new Response(null,await B(this,E,Ga).call(this,t,e,r,"GET")))();const n=this.getPath(t,{env:r}),s=this.router.match(i,n),l=new ke(t,{path:n,matchResult:s,env:r,executionCtx:e,notFoundHandler:c(this,_)});if(s[0].length===1){let d;try{d=s[0][0][0][0](l,async()=>{l.res=await c(this,_).call(this,l)})}catch(p){return B(this,E,Ha).call(this,p,l)}return d instanceof Promise?d.then(p=>p||(l.finalized?l.res:c(this,_).call(this,l))).catch(p=>B(this,E,Ha).call(this,p,l)):d??c(this,_).call(this,l)}const o=pt(s[0],this.errorHandler,c(this,_));return(async()=>{try{const d=await o(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return B(this,E,Ha).call(this,d,l)}})()},ya),Rt=[];function Pe(a,t){const e=this.buildAllMatchers(),r=((i,n)=>{const s=e[i]||e[I],l=s[2][n];if(l)return l;const o=n.match(s[0]);if(!o)return[[],Rt];const d=o.indexOf("",1);return[s[1][d],o]});return this.match=r,r(a,t)}var Ja="[^/]+",Ea=".*",Ta="(?:|/.*)",ma=Symbol(),Ie=new Set(".\\+*[^]$()");function Ee(a,t){return a.length===1?t.length===1?a<t?-1:1:-1:t.length===1||a===Ea||a===Ta?1:t===Ea||t===Ta?-1:a===Ja?1:t===Ja?-1:a.length===t.length?a<t?-1:1:t.length-a.length}var ta,ea,L,ia,Te=(ia=class{constructor(){b(this,ta);b(this,ea);b(this,L,Object.create(null))}insert(t,e,r,i,n){if(t.length===0){if(c(this,ta)!==void 0)throw ma;if(n)return;m(this,ta,e);return}const[s,...l]=t,o=s==="*"?l.length===0?["","",Ea]:["","",Ja]:s==="/*"?["","",Ta]:s.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(o){const p=o[1];let u=o[2]||Ja;if(p&&o[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ma;if(d=c(this,L)[u],!d){if(Object.keys(c(this,L)).some(v=>v!==Ea&&v!==Ta))throw ma;if(n)return;d=c(this,L)[u]=new ia,p!==""&&m(d,ea,i.varIndex++)}!n&&p!==""&&r.push([p,c(d,ea)])}else if(d=c(this,L)[s],!d){if(Object.keys(c(this,L)).some(p=>p.length>1&&p!==Ea&&p!==Ta))throw ma;if(n)return;d=c(this,L)[s]=new ia}d.insert(l,e,r,i,n)}buildRegExpStr(){const e=Object.keys(c(this,L)).sort(Ee).map(r=>{const i=c(this,L)[r];return(typeof c(i,ea)=="number"?`(${r})@${c(i,ea)}`:Ie.has(r)?`\\${r}`:r)+i.buildRegExpStr()});return typeof c(this,ta)=="number"&&e.unshift(`#${c(this,ta)}`),e.length===0?"":e.length===1?e[0]:"(?:"+e.join("|")+")"}},ta=new WeakMap,ea=new WeakMap,L=new WeakMap,ia),Va,Ka,ft,De=(ft=class{constructor(){b(this,Va,{varIndex:0});b(this,Ka,new Te)}insert(a,t,e){const r=[],i=[];for(let s=0;;){let l=!1;if(a=a.replace(/\{[^}]+\}/g,o=>{const d=`@\\${s}`;return i[s]=[d,o],s++,l=!0,d}),!l)break}const n=a.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let s=i.length-1;s>=0;s--){const[l]=i[s];for(let o=n.length-1;o>=0;o--)if(n[o].indexOf(l)!==-1){n[o]=n[o].replace(l,i[s][1]);break}}return c(this,Ka).insert(n,t,r,c(this,Va),e),r}buildRegExp(){let a=c(this,Ka).buildRegExpStr();if(a==="")return[/^$/,[],[]];let t=0;const e=[],r=[];return a=a.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,n,s)=>n!==void 0?(e[++t]=Number(n),"$()"):(s!==void 0&&(r[Number(s)]=++t),"")),[new RegExp(`^${a}`),e,r]}},Va=new WeakMap,Ka=new WeakMap,ft),je=[/^$/,[],Object.create(null)],qa=Object.create(null);function Mt(a){return qa[a]??(qa[a]=new RegExp(a==="*"?"":`^${a.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,e)=>e?`\\${e}`:"(?:|/.*)")}$`))}function Ne(){qa=Object.create(null)}function Ae(a){var d;const t=new De,e=[];if(a.length===0)return je;const r=a.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,u],[v,y])=>p?1:v?-1:u.length-y.length),i=Object.create(null);for(let p=0,u=-1,v=r.length;p<v;p++){const[y,k,C]=r[p];y?i[k]=[C.map(([S])=>[S,Object.create(null)]),Rt]:u++;let D;try{D=t.insert(k,u,y)}catch(S){throw S===ma?new Nt(k):S}y||(e[u]=C.map(([S,P])=>{const A=Object.create(null);for(P-=1;P>=0;P--){const[F,Ba]=D[P];A[F]=Ba}return[S,A]}))}const[n,s,l]=t.buildRegExp();for(let p=0,u=e.length;p<u;p++)for(let v=0,y=e[p].length;v<y;v++){const k=(d=e[p][v])==null?void 0:d[1];if(!k)continue;const C=Object.keys(k);for(let D=0,S=C.length;D<S;D++)k[C[D]]=l[k[C[D]]]}const o=[];for(const p in s)o[p]=e[s[p]];return[n,o,i]}function ca(a,t){if(a){for(const e of Object.keys(a).sort((r,i)=>i.length-r.length))if(Mt(e).test(t))return[...a[e]]}}var Q,X,Qa,_t,yt,Re=(yt=class{constructor(){b(this,Qa);g(this,"name","RegExpRouter");b(this,Q);b(this,X);g(this,"match",Pe);m(this,Q,{[I]:Object.create(null)}),m(this,X,{[I]:Object.create(null)})}add(a,t,e){var l;const r=c(this,Q),i=c(this,X);if(!r||!i)throw new Error(jt);r[a]||[r,i].forEach(o=>{o[a]=Object.create(null),Object.keys(o[I]).forEach(d=>{o[a][d]=[...o[I][d]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=Mt(t);a===I?Object.keys(r).forEach(d=>{var p;(p=r[d])[t]||(p[t]=ca(r[d],t)||ca(r[I],t)||[])}):(l=r[a])[t]||(l[t]=ca(r[a],t)||ca(r[I],t)||[]),Object.keys(r).forEach(d=>{(a===I||a===d)&&Object.keys(r[d]).forEach(p=>{o.test(p)&&r[d][p].push([e,n])})}),Object.keys(i).forEach(d=>{(a===I||a===d)&&Object.keys(i[d]).forEach(p=>o.test(p)&&i[d][p].push([e,n]))});return}const s=wt(t)||[t];for(let o=0,d=s.length;o<d;o++){const p=s[o];Object.keys(i).forEach(u=>{var v;(a===I||a===u)&&((v=i[u])[p]||(v[p]=[...ca(r[u],p)||ca(r[I],p)||[]]),i[u][p].push([e,n-d+o+1]))})}}buildAllMatchers(){const a=Object.create(null);return Object.keys(c(this,X)).concat(Object.keys(c(this,Q))).forEach(t=>{a[t]||(a[t]=B(this,Qa,_t).call(this,t))}),m(this,Q,m(this,X,void 0)),Ne(),a}},Q=new WeakMap,X=new WeakMap,Qa=new WeakSet,_t=function(a){const t=[];let e=a===I;return[c(this,Q),c(this,X)].forEach(r=>{const i=r[a]?Object.keys(r[a]).map(n=>[n,r[a][n]]):[];i.length!==0?(e||(e=!0),t.push(...i)):a!==I&&t.push(...Object.keys(r[I]).map(n=>[n,r[I][n]]))}),e?Ae(t):null},yt),$,G,kt,Me=(kt=class{constructor(a){g(this,"name","SmartRouter");b(this,$,[]);b(this,G,[]);m(this,$,a.routers)}add(a,t,e){if(!c(this,G))throw new Error(jt);c(this,G).push([a,t,e])}match(a,t){if(!c(this,G))throw new Error("Fatal error");const e=c(this,$),r=c(this,G),i=e.length;let n=0,s;for(;n<i;n++){const l=e[n];try{for(let o=0,d=r.length;o<d;o++)l.add(...r[o]);s=l.match(a,t)}catch(o){if(o instanceof Nt)continue;throw o}this.match=l.match.bind(l),m(this,$,[l]),m(this,G,void 0);break}if(n===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,s}get activeRouter(){if(c(this,G)||c(this,$).length!==1)throw new Error("No active router has been determined yet.");return c(this,$)[0]}},$=new WeakMap,G=new WeakMap,kt),Ia=Object.create(null),_e=a=>{for(const t in a)return!0;return!1},Y,j,ra,ka,T,q,Z,xa,Le=(xa=class{constructor(t,e,r){b(this,q);b(this,Y);b(this,j);b(this,ra);b(this,ka,0);b(this,T,Ia);if(m(this,j,r||Object.create(null)),m(this,Y,[]),t&&e){const i=Object.create(null);i[t]={handler:e,possibleKeys:[],score:0},m(this,Y,[i])}m(this,ra,[])}insert(t,e,r){m(this,ka,++ct(this,ka)._);let i=this;const n=ce(e),s=[];for(let l=0,o=n.length;l<o;l++){const d=n[l],p=n[l+1],u=he(d,p),v=Array.isArray(u)?u[0]:d;if(v in c(i,j)){i=c(i,j)[v],u&&s.push(u[1]);continue}c(i,j)[v]=new xa,u&&(c(i,ra).push(u),s.push(u[1])),i=c(i,j)[v]}return c(i,Y).push({[t]:{handler:r,possibleKeys:s.filter((l,o,d)=>d.indexOf(l)===o),score:c(this,ka)}}),i}search(t,e){var p;const r=[];m(this,T,Ia);let n=[this];const s=St(e),l=[],o=s.length;let d=null;for(let u=0;u<o;u++){const v=s[u],y=u===o-1,k=[];for(let D=0,S=n.length;D<S;D++){const P=n[D],A=c(P,j)[v];A&&(m(A,T,c(P,T)),y?(c(A,j)["*"]&&B(this,q,Z).call(this,r,c(A,j)["*"],t,c(P,T)),B(this,q,Z).call(this,r,A,t,c(P,T))):k.push(A));for(let F=0,Ba=c(P,ra).length;F<Ba;F++){const Oa=c(P,ra)[F],K=c(P,T)===Ia?{}:{...c(P,T)};if(Oa==="*"){const la=c(P,j)["*"];la&&(B(this,q,Z).call(this,r,la,t,c(P,T)),m(la,T,K),k.push(la));continue}const[oa,lt,wa]=Oa;if(!v&&!(wa instanceof RegExp))continue;const O=c(P,j)[oa];if(wa instanceof RegExp){if(d===null){d=new Array(o);let da=e[0]==="/"?1:0;for(let Ca=0;Ca<o;Ca++)d[Ca]=da,da+=s[Ca].length+1}const la=e.substring(d[u]),$a=wa.exec(la);if($a){if(K[lt]=$a[0],B(this,q,Z).call(this,r,O,t,c(P,T),K),_e(c(O,j))){m(O,T,K);const da=((p=$a[0].match(/\//))==null?void 0:p.length)??0;(l[da]||(l[da]=[])).push(O)}continue}}(wa===!0||wa.test(v))&&(K[lt]=v,y?(B(this,q,Z).call(this,r,O,t,K,c(P,T)),c(O,j)["*"]&&B(this,q,Z).call(this,r,c(O,j)["*"],t,K,c(P,T))):(m(O,T,K),k.push(O)))}}const C=l.shift();n=C?k.concat(C):k}return r.length>1&&r.sort((u,v)=>u.score-v.score),[r.map(({handler:u,params:v})=>[u,v])]}},Y=new WeakMap,j=new WeakMap,ra=new WeakMap,ka=new WeakMap,T=new WeakMap,q=new WeakSet,Z=function(t,e,r,i,n){for(let s=0,l=c(e,Y).length;s<l;s++){const o=c(e,Y)[s],d=o[r]||o[I],p={};if(d!==void 0&&(d.params=Object.create(null),t.push(d),i!==Ia||n&&n!==Ia))for(let u=0,v=d.possibleKeys.length;u<v;u++){const y=d.possibleKeys[u],k=p[d.score];d.params[y]=n!=null&&n[y]&&!k?n[y]:i[y]??(n==null?void 0:n[y]),p[d.score]=!0}}},xa),na,xt,Ke=(xt=class{constructor(){g(this,"name","TrieRouter");b(this,na);m(this,na,new Le)}add(a,t,e){const r=wt(t);if(r){for(let i=0,n=r.length;i<n;i++)c(this,na).insert(a,r[i],e);return}c(this,na).insert(a,t,e)}match(a,t){return c(this,na).search(a,t)}},na=new WeakMap,xt),Lt=class extends Ce{constructor(a={}){super(a),this.router=a.router??new Me({routers:[new Re,new Ke]})}};const sa={"product:":"products","party:":"parties","sale:":"sales","purchase:":"purchases","payment:":"payments","expense:":"expenses","exphead:":"exp_heads","expsubhead:":"exp_subheads","bank:":"banks","cb:":"cb","user:":"users","order:":"orders","salesperson:":"salespersons","creditlimit:":"credit_limits","prodgroup:":"prod_groups","prodbrand:":"prod_brands","modlog:":"mod_logs","approval:":"approvals","thanafare:":"thana_fares"},rt={sales:"sale_items",purchases:"purchase_items",orders:"order_items"},Kt={products:{purchasePrice:"purchase_price",salePrice:"sale_price",extraData:"extra_data"},parties:{postOffice:"post_office",openingBalance:"opening_balance",creditLimit:"credit_limit",salespersonId:"salesperson_id",salespersonName:"salesperson_name",extraData:"extra_data"},sales:{invoiceNo:"invoice_no",customerId:"customer_id",customerName:"customer_name",salespersonId:"salesperson_id",salespersonName:"salesperson_name",bankName:"bank_name",discountType:"discount_type",vatType:"vat_type",vatAmount:"vat_amount",aitType:"ait_type",aitAmount:"ait_amount",truckFare:"truck_fare",customerThana:"customer_thana",createdBy:"created_by",extraData:"extra_data",cashAmount:"cash_amount",bankAmount:"bank_amount",bankMethod:"bank_method",chequeNo:"cheque_no"},purchases:{purchaseNo:"purchase_no",supplierId:"supplier_id",supplierName:"supplier_name",bankName:"bank_name",vatType:"vat_type",extraData:"extra_data",cashAmount:"cash_amount",bankAmount:"bank_amount",bankMethod:"bank_method",chequeNo:"cheque_no"},payments:{bankName:"bank_name",chequeNo:"cheque_no",fromAcc:"from_acc",toAcc:"to_acc",autoInvoice:"auto_invoice",isTruckFare:"is_truck_fare",billKeys:"bill_keys",extraData:"extra_data",_autoInvoice:"auto_invoice",_isTruckFare:"is_truck_fare"},expenses:{expenseNo:"expense_no",headName:"head_name",subHeadName:"sub_head_name",bankName:"bank_name",isTruckFare:"is_truck_fare",_isTruckFare:"is_truck_fare",extraData:"extra_data"},orders:{orderNo:"order_no",customerId:"customer_id",customerName:"customer_name",spId:"sp_id",spName:"sp_name",spCode:"sp_code",convertedInvoice:"converted_invoice",extraData:"extra_data"},salespersons:{extraData:"extra_data"},banks:{accountNo:"account_no",openingBalance:"opening_balance",extraData:"extra_data"},users:{extraData:"extra_data"},approvals:{targetKey:"target_key",newData:"new_data",oldData:"old_data",requestedBy:"requested_by",requestedAt:"requested_at",processedBy:"processed_by",processedAt:"processed_at",extraData:"extra_data"},mod_logs:{oldData:"old_data",extraData:"extra_data"},exp_heads:{},exp_subheads:{headId:"head_id",headName:"head_name"},credit_limits:{partyId:"party_id",partyName:"party_name",extraData:"extra_data"},thana_fares:{maxFare:"max_fare",extraData:"extra_data"},cb:{openingBalance:"opening_balance",extraData:"extra_data"},prod_groups:{},prod_brands:{}},Ft={sale_items:{saleId:"sale_id",productId:"product_id",productName:"product_name",extraData:"extra_data"},purchase_items:{purchaseId:"purchase_id",productId:"product_id",productName:"product_name",extraData:"extra_data"},order_items:{orderId:"order_id",productKey:"product_key",productName:"product_name",extraData:"extra_data"}},Fe=new Set(["exp_heads","exp_subheads","mod_logs","approvals","credit_limits","cb","sale_items","purchase_items","order_items"]),Ot={mod_logs:"timestamp"};function zt(a){return{products:["id","name","sku","unit",'"group"',"brand","purchase_price","sale_price","stock","extra_data","created_at","updated_at"],parties:["id","name","type","phone","address","division","district","thana","post_office","postcode","opening_balance","credit_limit","salesperson_id","salesperson_name","extra_data","created_at","updated_at"],salespersons:["id","name","code","pin","phone","active","extra_data","created_at","updated_at"],banks:["id","name","account_no","opening_balance","balance","extra_data","created_at","updated_at"],sales:["id","invoice_no","date","customer_id","customer_name","salesperson_id","salesperson_name","method","bank_name","discount","discount_type","extra","vat","vat_type","vat_amount","ait","ait_type","ait_amount","truck_fare","total","paid","note","customer_thana","created_by","extra_data","created_at","updated_at","cash_amount","bank_amount","bank_method","cheque_no"],sale_items:["sale_id","product_id","product_name","qty","rate","amount","extra_data"],purchases:["id","purchase_no","date","supplier_id","supplier_name","method","bank_name","discount","extra","vat","vat_type","total","paid","note","extra_data","created_at","updated_at","cash_amount","bank_amount","bank_method","cheque_no"],purchase_items:["purchase_id","product_id","product_name","qty","rate","amount","extra_data"],payments:["id",'"no"',"date","type","party","method","bank_name","amount","note","cheque_no","status","from_acc","to_acc","auto_invoice","is_truck_fare","bill_keys","extra_data","created_at","updated_at"],expenses:["id","expense_no","date","head_name","sub_head_name","method","bank_name","amount","description","is_truck_fare","extra_data","created_at","updated_at"],exp_heads:["id","name","created_at"],exp_subheads:["id","name","head_id","head_name","created_at"],orders:["id","order_no","date","customer_id","customer_name","sp_id","sp_name","sp_code","total","status","converted_invoice","note","extra_data","created_at","updated_at"],order_items:["order_id","product_key","product_name","qty","rate","amount","extra_data"],users:["id","username","password","name","role","active","extra_data","created_at","updated_at"],approvals:["id","type","target_key","prefix","new_data","old_data","detail","requested_by","requested_at","status","processed_by","processed_at","extra_data","created_at"],mod_logs:["id","action","detail","key","prefix","old_data",'"user"',"timestamp","extra_data"],credit_limits:["id","party_id","party_name","amount","extra_data","created_at"],thana_fares:["id","thana","district","division","max_fare","extra_data","created_at","updated_at"],cb:["id","opening_balance","extra_data","created_at"],prod_groups:["id","name","created_at","updated_at"],prod_brands:["id","name","created_at","updated_at"]}[a]||[]}function nt(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function Oe(a,t){const e=Kt[a];return e&&e[t]?e[t]:t}function ze(a,t){const e=Ft[a];return e&&e[t]?e[t]:t}function He(a,t){const r=zt(a).map(s=>s.replace(/"/g,"")),i={},n={};for(const[s,l]of Object.entries(t)){if(s==="_key"||s==="_items")continue;const o=Oe(a,s);r.includes(o)?typeof l=="object"&&l!==null?i[o]=JSON.stringify(l):i[o]=l:n[s]=l}if(Object.keys(n).length>0){let s={};if(i.extra_data&&typeof i.extra_data=="string")try{s=JSON.parse(i.extra_data)}catch{}i.extra_data=JSON.stringify({...s,...n})}return i}function Ge(a,t,e){const i=zt(a).map(l=>l.replace(/"/g,"")),n={},s={};a==="sale_items"?n.sale_id=e:a==="purchase_items"?n.purchase_id=e:a==="order_items"&&(n.order_id=e);for(const[l,o]of Object.entries(t)){if(l==="_key")continue;const d=ze(a,l);i.includes(d)?typeof o=="object"&&o!==null?n[d]=JSON.stringify(o):n[d]=o:s[l]=o}return Object.keys(s).length>0&&(n.extra_data=JSON.stringify(s)),n}function Ht(a,t,e){const r=t.id,i={_key:e+r},n={},s=Kt[a]||{};for(const[l,o]of Object.entries(s))n[o]=l;for(const[l,o]of Object.entries(t)){if(l==="id"||l==="created_at"||l==="updated_at")continue;const d=n[l]||l;if(l==="extra_data"&&typeof o=="string"&&o!=="{}"){try{const p=JSON.parse(o);Object.assign(i,p)}catch{}continue}if(l==="bill_keys"&&typeof o=="string"){try{i[d]=JSON.parse(o)}catch{i[d]=o}continue}if(l==="new_data"||l==="old_data"){if(typeof o=="string")try{i[d]=JSON.parse(o)}catch{i[d]=o}else i[d]=o;continue}i[d]=o}return i}function qe(a){const t=Ft[a]||{},e={};for(const[r,i]of Object.entries(t))e[i]=r;return e}function Gt(a,t){const e=t?qe(t):{};return a.map(r=>{const i={};for(const[n,s]of Object.entries(r)){if(n==="id"||n==="extra_data"||n==="sale_id"||n==="purchase_id"||n==="order_id")continue;const l=e[n]||n;i[l]=s}if(r.extra_data&&typeof r.extra_data=="string"&&r.extra_data!=="{}")try{Object.assign(i,JSON.parse(r.extra_data))}catch{}return i})}async function qt(a,t){const e=sa[t];if(!e)return[];const r=Ot[e]||"created_at",i=a.prepare(`SELECT * FROM ${e} ORDER BY ${r} DESC`),{results:n}=await i.all(),s=n.map(o=>Ht(e,o,t)),l=rt[e];if(l&&n.length>0){const o=n.map(k=>k.id),d=o.map(()=>"?").join(","),p=l==="sale_items"?"sale_id":l==="purchase_items"?"purchase_id":"order_id",u=a.prepare(`SELECT * FROM ${l} WHERE ${p} IN (${d})`).bind(...o),{results:v}=await u.all(),y={};for(const k of v){const C=k[p];y[C]||(y[C]=[]),y[C].push(k)}for(const k of s){const D=k._key.replace(t,""),S=y[D]||[];S.length>0&&(k.items=Gt(S,l))}}return s}async function Da(a,t){const e=t.indexOf(":");if(e===-1)return null;const r=t.substring(0,e+1),i=t.substring(e+1),n=sa[r];if(!n)return null;const l=await a.prepare(`SELECT * FROM ${n} WHERE id = ?`).bind(i).first();if(!l)return null;const o=Ht(n,l,r),d=rt[n];if(d){const p=d==="sale_items"?"sale_id":d==="purchase_items"?"purchase_id":"order_id",u=a.prepare(`SELECT * FROM ${d} WHERE ${p} = ?`).bind(i),{results:v}=await u.all();v.length>0&&(o.items=Gt(v,d))}return delete o._key,o}async function it(a,t,e,r){const i=sa[t];if(!i)throw new Error(`Unknown prefix: ${t}`);let n;r?n=r.startsWith(t)?r.substring(t.length):r:n=nt();const s=new Date().toISOString(),l=He(i,e);l.id=n,Fe.has(i)||(l.updated_at=s),r||(i==="mod_logs"?l.timestamp||(l.timestamp=s):l.created_at=s);const o=Object.keys(l),d=o.map(S=>S==="group"?'"group"':S==="no"?'"no"':S==="user"?'"user"':S),p=o.map(()=>"?").join(", "),u=o.filter(S=>S!=="id"&&S!=="created_at").map(S=>{const P=S==="group"?'"group"':S==="no"?'"no"':S==="user"?'"user"':S;return`${P} = excluded.${P}`}).join(", "),v=`INSERT INTO ${i} (${d.join(", ")}) VALUES (${p})
    ON CONFLICT(id) DO UPDATE SET ${u}`,y=o.map(S=>l[S]??null),k=[a.prepare(v).bind(...y)],C=rt[i],D=e.items||e._items;if(C&&Array.isArray(D)){const S=C==="sale_items"?"sale_id":C==="purchase_items"?"purchase_id":"order_id";k.push(a.prepare(`DELETE FROM ${C} WHERE ${S} = ?`).bind(n));for(const P of D){const A=Ge(C,P,n),F=Object.keys(A),Ba=F.map(oa=>oa==="no"?'"no"':oa),Oa=F.map(()=>"?").join(", "),K=F.map(oa=>A[oa]??null);k.push(a.prepare(`INSERT INTO ${C} (${Ba.join(", ")}) VALUES (${Oa})`).bind(...K))}}return await a.batch(k),t+n}async function st(a,t){const e=t.indexOf(":");if(e===-1)return;const r=t.substring(0,e+1),i=t.substring(e+1),n=sa[r];n&&await a.prepare(`DELETE FROM ${n} WHERE id = ?`).bind(i).run()}async function Ua(a,t,e,r,i,n,s){const l=nt(),o=new Date().toISOString();await a.prepare('INSERT INTO mod_logs (id, action, detail, key, prefix, old_data, "user", timestamp) VALUES (?, ?, ?, ?, ?, ?, ?, ?)').bind(l,t,e,r,i,s||"",n,o).run()}async function Jt(a,t,e,r,i,n,s,l){const o=nt(),d=new Date().toISOString();return await a.prepare("INSERT INTO approvals (id, type, target_key, prefix, new_data, old_data, detail, requested_by, requested_at, status, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending', ?)").bind(o,t,e,r,JSON.stringify(i),JSON.stringify(n),s,l,d,d).run(),"approval:"+o}async function Je(a,t,e,r){const i=t.startsWith("approval:")?t.substring(9):t,n=await a.prepare("SELECT * FROM approvals WHERE id = ?").bind(i).first();if(!n)return{success:!1,error:"Approval not found"};if(n.status!=="pending")return{success:!1,error:"Already processed"};const s=new Date().toISOString(),l=e==="approve"?"approved":"rejected";if(e==="approve"){const o=n.target_key,d=n.prefix,p=n.type,u=n.requested_by;if(p==="edit"&&n.new_data){const v=typeof n.new_data=="string"?JSON.parse(n.new_data):n.new_data;await it(a,d,v,o),await Ua(a,"edit",`Approved edit by ${u}: ${n.detail}`,o,d,r)}else p==="delete"&&(await st(a,o),await Ua(a,"delete",`Approved delete by ${u}: ${n.detail}`,o,d,r))}return await a.prepare("UPDATE approvals SET status = ?, processed_by = ?, processed_at = ? WHERE id = ?").bind(l,r,s,i).run(),{success:!0,status:l}}async function Ue(a){const t={};for(const[e]of Object.entries(sa))t[e]=await qt(a,e);return t}async function Ve(a,t){let e=0;for(const[r,i]of Object.entries(t))if(!(!Array.isArray(i)||!sa[r]))for(const s of i){const l=s._key,o={...s};delete o._key,await it(a,r,o,l),e++}return e}async function Qe(a,t,e=100){const r=sa[t];if(!r)return[];const i=Ot[r]||"created_at",{results:n}=await a.prepare(`SELECT id FROM ${r} ORDER BY ${i} DESC LIMIT ?`).bind(e).all();return n.map(s=>t+s.id)}const Xe={"product:":300,"party:":300,"prodgroup:":600,"prodbrand:":600,"salesperson:":300,"bank:":300,"exphead:":600,"expsubhead:":600,"thanafare:":600,"creditlimit:":300,"cb:":300,"user:":120,"sale:":60,"purchase:":60,"payment:":60,"expense:":60,"order:":60,"modlog:":120,"approval:":30},Xa="cache:",$e=2*1024*1024;async function Ye(a,t){if(!a)return null;try{const e=Xa+t,r=await a.get(e);return r?JSON.parse(r):null}catch{return null}}async function We(a,t,e){if(a)try{const r=JSON.stringify(e);if(r.length>$e)return;const i=Xe[t]||60;await a.put(Xa+t,r,{expirationTtl:i})}catch{}}async function ja(a,...t){if(a)try{await Promise.all(t.map(e=>a.delete(Xa+e)))}catch{}}async function Ut(a){if(a)try{let t;const e=[];do{const r=await a.list({prefix:Xa,cursor:t,limit:1e3});e.push(...r.keys.map(i=>i.name)),t=r.list_complete?void 0:r.cursor}while(t);await Promise.all(e.map(r=>a.delete(r)))}catch{}}async function Vt(a){return a?a.get("APP_LICENSE"):null}async function Ze(a,t){a&&await a.put("APP_LICENSE",t)}async function Qt(a){return a?a.get("APP_PIN"):null}async function ar(a,t){a&&await a.put("APP_PIN",t)}async function Xt(a){if(!a)return null;const t=await a.get("COMPANY_SETTINGS");if(!t)return null;try{return JSON.parse(t)}catch{return null}}async function $t(a,t){a&&await a.put("COMPANY_SETTINGS",JSON.stringify(t))}async function tr(a,t,e){const r=await Ye(a,e);if(r!==null)return r;const i=await t(e);return await We(a,e,i),i}function ot(a){return{"sale:":["sale:","product:"],"purchase:":["purchase:","product:"],"payment:":["payment:"],"expense:":["expense:"],"order:":["order:"],"product:":["product:"],"party:":["party:"]}[a]||[a]}const h=new Lt;let Yt="1234";const Wt="4321",Zt="2028-12-31";function er(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function pa(a){return String(a).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function Sa(a,t){return a.DB?tr(a.DATA_STORE,e=>qt(a.DB,e),t):[]}function f(a){return new Response(a,{headers:{"content-type":"text/html;charset=UTF-8","Cache-Control":"no-store, no-cache, must-revalidate, proxy-revalidate",Pragma:"no-cache",Expires:"0"}})}h.post("/login",async a=>{const t=await a.req.formData(),e=t.get("pin"),r=await Qt(a.env.DATA_STORE)||Yt,i=(t.get("username")||"").trim(),n=await Sa(a.env,"user:");if(n.length>0&&i){const s=n.find(l=>l.username===i&&l.password===e&&l.active!==!1);if(s){const l=encodeURIComponent(JSON.stringify({auth:1,userId:s._key,username:s.username,role:s.role,name:s.name}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${l}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Na("Invalid credentials",n.length>0))}if(e===r){const s=encodeURIComponent(JSON.stringify({auth:1,userId:"admin",username:"admin",role:"admin",name:"Administrator"}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${s}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Na("Wrong PIN",n.length>0))});h.get("/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"session=; Path=/; HttpOnly; Max-Age=0; SameSite=Strict",Location:"/login","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache","Clear-Site-Data":'"cache"'}}));function x(a){const e=(a.req.header("Cookie")||"").match(/session=([^;]+)/);if(!e)return null;try{return JSON.parse(decodeURIComponent(e[1]))}catch{return null}}h.use("*",async(a,t)=>{const e=new URL(a.req.url).pathname;if(e==="/login"&&a.req.method==="GET"){const d=await Sa(a.env,"user:");return f(Na("",d.length>0))}if(e==="/api/company-settings"&&a.req.method==="GET"){await t();return}if(!(new URL(a.req.url).searchParams.get("master")===Wt)){const d=new Date().toISOString().slice(0,10);if(d>Zt)return f(mt());{const p=await Vt(a.env.DATA_STORE);if(p&&d>p)return f(mt())}}if(e.startsWith("/sp-portal")){const p=(a.req.header("Cookie")||"").match(/sp_session=([^;]+)/);if(e==="/sp-portal/login"&&a.req.method==="GET"||!p&&e!=="/sp-portal/login")return f(tt(""));await t();return}const n=x(a);if(!(n!=null&&n.auth)&&e!=="/login")return f(Na("",!1));const s={admin:[],manager:["/users","/admin"],entry:["/users","/admin","/profit-loss","/balance-sheet","/trial-balance","/stock","/receivable-payable","/salesperson","/expense-ledger","/approvals","/company-settings"],viewer:["/inventory","/parties","/purchases","/sales","/payments","/expenses","/orders","/users","/admin","/salesperson","/approvals","/company-settings"]},l=(n==null?void 0:n.role)||"admin";if((s[l]||[]).includes(e))return f(w(`<div class="card"><div class="empty" style="padding:40px"><h3>Access Denied</h3><p class="text-muted">You don't have permission to access this page.</p><a href="/" class="btn btn-primary" style="margin-top:12px">Go to Dashboard</a></div></div>`,"dashboard",n));await t()});h.get("/api/license-info",async a=>{const e=await Vt(a.env.DATA_STORE)||Zt,r=Math.floor((new Date(e).getTime()-Date.now())/864e5);return a.json({expiry:e,days:r,status:r<0?"Expired":"Active"})});h.post("/api/set-license",async a=>{if(new URL(a.req.url).searchParams.get("master")!==Wt)return a.json({success:!1,error:"Unauthorized"},403);const e=await a.req.json();return await Ze(a.env.DATA_STORE,String((e==null?void 0:e.date)||"")),a.json({success:!0})});h.post("/api/list",async a=>{const t=await a.req.json();return a.json(await Sa(a.env,(t==null?void 0:t.prefix)||""))});const ae=["product:","party:","sale:","purchase:","payment:","expense:","bank:","order:","salesperson:"];h.post("/api/save",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json();let e=(t==null?void 0:t.prefix)||"";const r=t==null?void 0:t.id,i=t==null?void 0:t.key,n=(t==null?void 0:t.data)||{},s=(t==null?void 0:t.logAction)||"",l=(t==null?void 0:t.logDetail)||"",o=(t==null?void 0:t.skipApproval)===!0;let d=i;d||(r?d=r.startsWith(e)?r:e+r:d=e+er()),!e&&d&&d.includes(":")&&(e=d.substring(0,d.indexOf(":")+1));const p=x(a),u=(p==null?void 0:p.role)==="entry",v=!!(i||r),y=ae.some(C=>e&&e===C||d&&d.startsWith(C));if(u&&v&&y&&!o){const C=await Da(a.env.DB,d);return await Jt(a.env.DB,"edit",d,e,n,C,l||"Edit: "+d,(p==null?void 0:p.name)||(p==null?void 0:p.username)||"Unknown"),await ja(a.env.DATA_STORE,"approval:"),a.json({success:!0,key:d,pending:!0,message:"Your edit has been submitted for approval"})}const k=await it(a.env.DB,e,n,d);return s&&await Ua(a.env.DB,s,l,k,e,(p==null?void 0:p.name)||(p==null?void 0:p.username)||"System"),await ja(a.env.DATA_STORE,...ot(e)),a.json({success:!0,key:k})});h.post("/api/get",async a=>{if(!a.env.DB)return a.json(null);const{key:t}=await a.req.json(),e=await Da(a.env.DB,t);return a.json(e)});h.post("/api/delete",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json(),e=t==null?void 0:t.key,r=(t==null?void 0:t.logDetail)||"",i=(t==null?void 0:t.skipApproval)===!0;if(!e)return a.json({success:!1,error:"Key is required"},400);const n=e.split(":")[0]+":",s=x(a),l=(s==null?void 0:s.role)==="entry",o=ae.some(p=>e.startsWith(p));if(l&&o&&!i){const p=await Da(a.env.DB,e);return await Jt(a.env.DB,"delete",e,n,null,p,r||"Delete: "+e,(s==null?void 0:s.name)||(s==null?void 0:s.username)||"Unknown"),await ja(a.env.DATA_STORE,"approval:"),a.json({success:!0,pending:!0,message:"Your delete request has been submitted for approval"})}const d=await Da(a.env.DB,e);return await st(a.env.DB,e),await Ua(a.env.DB,"delete",r||"Deleted key: "+e,e,n,(s==null?void 0:s.name)||(s==null?void 0:s.username)||"System",d?JSON.stringify(d).substring(0,500):""),await ja(a.env.DATA_STORE,...ot(n)),a.json({success:!0})});h.post("/api/approval-list",async a=>a.json(await Sa(a.env,"approval:")));h.post("/api/approval-action",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=x(a),e=(t==null?void 0:t.role)||"";if(e!=="admin"&&e!=="manager")return a.json({success:!1,error:"Only admin/manager can approve"},403);const{approvalKey:r,action:i}=await a.req.json();if(!r)return a.json({success:!1,error:"Approval key required"},400);const n=await Je(a.env.DB,r,i,(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System");return n.success?(await Ut(a.env.DATA_STORE),a.json({success:!0,status:n.status})):a.json(n,400)});h.get("/api/company-settings",async a=>{const t={companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"},e=await Xt(a.env.DATA_STORE);return a.json(e||t)});h.post("/api/company-settings",async a=>{const t=x(a);if((t==null?void 0:t.role)!=="admin")return a.json({success:!1,error:"Only admin can change company settings"},403);const e=await a.req.json();return await $t(a.env.DATA_STORE,e),a.json({success:!0})});h.post("/api/export-all",async a=>{if(!a.env.DB)return a.json({});const t=await Ue(a.env.DB),e=await Xt(a.env.DATA_STORE);return e&&(t["companysettings:"]=[e]),a.json(t)});h.post("/api/import-all",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json();t["companysettings:"]&&Array.isArray(t["companysettings:"])&&t["companysettings:"].length>0&&(await $t(a.env.DATA_STORE,t["companysettings:"][0]),delete t["companysettings:"]);const e=await Ve(a.env.DB,t);return await Ut(a.env.DATA_STORE),a.json({success:!0,count:e})});h.post("/api/change-pin",async a=>{const{oldPin:t,newPin:e}=await a.req.json(),r=await Qt(a.env.DATA_STORE)||Yt;return t!==r?a.json({success:!1,error:"Wrong current PIN"}):!e||e.length<4?a.json({success:!1,error:"PIN must be at least 4 characters"}):(await ar(a.env.DATA_STORE,e),a.json({success:!0}))});h.post("/api/kv-keys",async a=>{if(!a.env.DB)return a.json([]);const{prefix:t}=await a.req.json();return a.json(await Qe(a.env.DB,t||"",100))});h.post("/api/kv-get",async a=>{if(!a.env.DB)return a.json({value:null});const{key:t}=await a.req.json(),e=await Da(a.env.DB,t);return a.json({value:e?JSON.stringify(e):null})});h.post("/api/kv-delete",async a=>{if(!a.env.DB)return a.json({success:!1});const{key:t}=await a.req.json();await st(a.env.DB,t);const e=t.split(":")[0]+":";return await ja(a.env.DATA_STORE,...ot(e)),a.json({success:!0})});h.post("/sp-portal/login",async a=>{const t=await a.req.formData(),e=t.get("code"),r=t.get("pin"),n=(await Sa(a.env,"salesperson:")).find(s=>s.code===e&&s.pin===r&&s.active!==!1);if(n){const s=encodeURIComponent(JSON.stringify({spId:n._key,spName:n.name,spCode:n.code}));return new Response(null,{status:302,headers:{"Set-Cookie":`sp_session=${s}; Path=/; HttpOnly; SameSite=Strict`,Location:"/sp-portal"}})}return f(tt("Invalid credentials"))});h.get("/sp-portal/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"sp_session=; Path=/; HttpOnly; Max-Age=0",Location:"/sp-portal/login"}}));h.get("/",a=>f(w(sr(),"dashboard",x(a))));h.get("/inventory",a=>f(w(or(),"inventory",x(a))));h.get("/stock-check",a=>f(w(lr(),"stockcheck",x(a))));h.get("/parties",a=>f(w(dr(),"parties",x(a))));h.get("/purchases",a=>f(w(cr(),"purchases",x(a))));h.get("/sales",a=>f(w(pr(),"sales",x(a))));h.get("/payments",a=>f(w(ur(),"payments",x(a))));h.get("/expenses",a=>f(w(hr(),"expenses",x(a))));h.get("/ledger",a=>f(w(mr(),"ledger",x(a))));h.get("/expense-ledger",a=>f(w(gr(),"expledger",x(a))));h.get("/profit-loss",a=>f(w(vr(),"profitloss",x(a))));h.get("/balance-sheet",a=>f(w(br(),"balancesheet",x(a))));h.get("/trial-balance",a=>f(w(fr(),"trialbalance",x(a))));h.get("/stock",a=>f(w(yr(),"stock",x(a))));h.get("/receivable-payable",a=>f(w(kr(),"recpay",x(a))));h.get("/day-details",a=>f(w(xr(),"daydetails",x(a))));h.get("/reports",a=>f(w(Sr(),"reports",x(a))));h.get("/salesperson",a=>f(w(Br(),"salesperson",x(a))));h.get("/orders",a=>f(w(wr(),"orders",x(a))));h.get("/users",a=>f(w(Cr(),"users",x(a))));h.get("/admin",a=>f(w(Pr(),"admin",x(a))));h.get("/mod-log",a=>f(w(Ir(),"modlog",x(a))));h.get("/approvals",a=>f(w(Er(),"approvals",x(a))));h.get("/company-settings",a=>f(w(Tr(),"companysettings",x(a))));h.get("/truck-fare-report",a=>f(w(nr(),"truckfarereport",x(a))));h.get("/truck-fare-settings",a=>f(w(rr(),"truckfaresettings",x(a))));h.get("/sp-portal",a=>f(ir(a)));h.get("/login",async a=>{const t=await Sa(a.env,"user:");return f(Na("",t.length>0))});function rr(){return`
...
function renderTF(list){var l=list||_tfList;document.getElementById('tfBody').innerHTML=!l.length?'<tr><td colspan="5" class="empty">No thana fares configured</td></tr>':l.sort(function(a,b){return(a.thana||'').localeCompare(b.thana)}).map(function(t){return'<tr><td class="bold">'+t.thana+'</td><td class="text-muted">'+(t.district||'')+'</td><td class="text-muted">'+(t.division||'')+'</td><td class="r bold">'+fmt(t.maxFare||0)+'</td><td class="r"><button class="btn btn-outline btn-xs" onclick="editTF(&#39;'+t._key+'&#39;)">Edit</button> <button class="btn btn-danger btn-xs" onclick="delTF(&#39;'+t._key+'&#39;)">Del</button></td></tr>'}).join('')}
...
window.methodBadge=function(m,s){if(m==='split'&&s){return'<span class="badge badge-cash">Cash '+fmt(s.cashAmount||0)+'</span> <span class="badge badge-bank">Bank '+fmt(s.bankAmount||0)+'</span>'}var cls=m==='cash'?'badge-cash':m==='cheque'?'badge-warning':m==='credit'?'badge-danger':'badge-bank';return'<span class="badge '+cls+'">'+fmtMethod(m)+'</span>';};
...
window.buildPurchaseInvoice=function(p){
  ...
  // Build payment method display lines for purchase invoice
  var purPayHtml='';
  if((p.cashAmount||0)>0){purPayHtml+='<div style="display:flex;justify-content:space-between;color:#059669;font-size:11px"><span>&nbsp;&nbsp;Cash:</span><span>'+fmt(p.cashAmount)+'</span></div>'}
  if((p.bankAmount||0)>0){purPayHtml+='<div style="display:flex;justify-content:space-between;color:#2563eb;font-size:11px"><span>&nbsp;&nbsp;'+fmtMethod(p.bankMethod||p.method)+(p.bankName?' ('+p.bankName+')':'')+':</span><span>'+fmt(p.bankAmount)+'</span></div>'}
  if(!purPayHtml&&(p.paid||0)>0&&p.method&&p.method!=='credit'){purPayHtml='<div style="display:flex;justify-content:space-between;color:#059669;font-size:11px"><span>&nbsp;&nbsp;'+fmtMethod(p.method)+(p.bankName?' ('+p.bankName+')':'')+':</span><span>'+fmt(p.paid)+'</span></div>'}
  return '<div style="max-width:700px;margin:0 auto">'+getCompanyHeader()+'<div style="display:flex;justify-content:space-between;border-bottom:2px solid #333;padding-bottom:10px;margin-bottom:12px"><div><h2 style="margin:0;font-size:18px">PURCHASE INVOICE</h2><b>No:</b> '+p.purchaseNo+'</div><div style="text-align:right"><b>Date:</b> '+p.date+'<br><b>Supplier:</b> '+p.supplierName+'</div></div><table class="tbl"><thead><tr style="background:#f3f3f3"><th>#</th><th>Item</th><th class="r">Qty</th><th class="r">Rate</th><th class="r">Amount</th></tr></thead><tbody>'+(p.items||[]).map(function(it,i){return'<tr><td>'+(i+1)+'</td><td>'+it.productName+'</td><td class="r">'+it.qty+'</td><td class="r">'+fmt(it.rate)+'</td><td class="r">'+fmt(it.amount)+'</td></tr>';}).join('')+'</tbody></table><div style="display:flex;justify-content:flex-end;margin-top:12px"><div style="width:260px;line-height:1.8;font-size:12px"><div style="display:flex;justify-content:space-between"><span>Subtotal:</span><span>'+fmt(sub)+'</span></div><div style="display:flex;justify-content:space-between;color:#dc2626"><span>Discount:</span><span>-'+fmt(p.discount||0)+'</span></div><div style="display:flex;justify-content:space-between"><span>Extra:</span><span>+'+fmt(p.extra||0)+'</span></div><div style="display:flex;justify-content:space-between"><span>VAT:</span><span>+'+fmt(vatAmt)+'</span></div><div style="display:flex;justify-content:space-between;font-weight:800;font-size:14px;border-top:2px solid #333;margin-top:4px;padding-top:4px"><span>Total:</span><span>'+fmt(p.total)+'</span></div><div style="display:flex;justify-content:space-between;color:#059669"><span>Paid:</span><span>'+fmt(p.paid)+'</span></div>'+purPayHtml+'<div style="display:flex;justify-content:space-between;border-top:1px dashed #666"><span>Balance:</span><span>'+fmt((p.total||0)-(p.paid||0))+'</span></div></div></div></div>';
};
...
<div class="app">
  <aside class="sidebar" id="sidebar">
    ...
    <nav>${o}<div class="nav-group" style="margin-top:12px">Portal</div><a href="/sp-portal" target="_blank"><span class="nav-icon material-symbols-outlined">storefront</span>SP Portal</a><div class="nav-group"></div><a href="/logout" style="opacity:.6"><span class="nav-icon material-symbols-outlined">logout</span>Logout</a></nav>
    <div class="sidebar-footer">BizManager v3.0 | ${i} (${r})</div>
  </aside>
...
<\/script>
</body></html>`}function Na(a,t=!1){return`<!doctype html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,viewport-fit=cover">
...
<\/script>
</body></html>`}function mt(){return`<!doctype html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>License Expired</title><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">${Fa()}</head><body><div class="login-page"><div class="login-card"><h2>License Expired</h2><div class="sub">Please renew.</div></div></div></body></html>`}function tt(a){return`<!doctype html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no,viewport-fit=cover"><meta name="theme-color" content="#1e1b4b"><meta name="apple-mobile-web-app-capable" content="yes"><title>SP Portal</title><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">${Fa()}</head><body><div class="login-page"><form class="login-card" method="POST" action="/sp-portal/login"><h2>Salesperson Portal</h2><div class="sub">Enter code and PIN</div>${a?`<div class="err">${a}</div>`:""}<input name="code" placeholder="Code" style="text-align:center" required><input type="password" name="pin" placeholder="PIN" style="text-align:center" required><button type="submit" class="btn btn-primary">Login</button><div style="margin-top:12px"><a href="/login" style="font-size:11px;color:var(--muted)">Admin Login</a></div></form></div></body></html>`}function ir(a){const e=(a.req.header("Cookie")||"").match(/sp_session=([^;]+)/);let r={};if(e)try{r=JSON.parse(decodeURIComponent(e[1]))}catch{}const i=r.spId||"",n=r.spName||"Salesperson",s=r.spCode||"";return`<!doctype html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no,viewport-fit=cover">
...
<div><h2><span class="material-symbols-outlined" style="font-size:20px;vertical-align:middle;margin-right:4px">storefront</span>SP Portal</h2><div class="sp-user">Welcome, <b>${pa(n)}</b> (${pa(s)})</div></div>
...
<\/script></body></html>`}function sr(){var a=new Date().toISOString().slice(0,10),t=a.slice(0,7);return`
...
function renderPa(li){var l=li||aP.filter(function(p){return p.type===pT});document.getElementById('paBody').innerHTML=!l.length?'<tr><td colspan="8" class="empty">None</td></tr>':l.map(function(p){var ob=p.openingBalance||0;return'<tr><td class="bold">'+p.name+'</td><td class="text-muted">'+(p.phone||'')+'</td><td class="text-muted">'+(p.thana||p.district||'')+'</td><td>'+(p.salespersonName?'<span class="badge badge-info">'+p.salespersonName+'</span>':'-')+'</td><td class="r text-muted">'+(ob?fmt(Math.abs(ob))+(ob>0?' Dr':' Cr'):'--')+'</td><td class="r">'+(p.creditLimit?fmt(p.creditLimit):'--')+'</td><td class="r bold '+((p.balance||0)>0?'text-danger':'text-success')+'">'+fmt(Math.abs(p.balance||0))+((p.balance||0)>0?' Dr':p.balance<0?' Cr':'')+'</td><td class="r"><button class="btn btn-outline btn-sm" onclick="editPa(&#39;'+p._key+'&#39;)">Edit</button></td></tr>'}).join('')}
...
<div class="collapsible-toggle" onclick="this.classList.toggle('open');document.getElementById('purChargesBody').classList.toggle('open')" style="margin-top:12px;cursor:pointer;display:flex;align-items:center;justify-content:space-between;padding:8px 12px;background:var(--bg);border-radius:8px;border:1px solid var(--border)"><div style="display:flex;align-items:center;gap:6px;font-weight:600;font-size:12px;color:var(--primary)"><span class="material-symbols-outlined" style="font-size:16px">tune</span> Discount, VAT & Extra Charges <span id="purChargesSummary" style="font-size:11px;color:var(--muted);font-weight:400"></span></div><span class="material-symbols-outlined" style="font-size:18px;transition:transform 0.2s;color:var(--muted)" id="purChargesArrow">expand_more</span></div>
<div id="purChargesBody" style="display:none;padding:4px 0">
<div class="form-row" style="margin-top:8px"><div><label>Discount</label><input type="number" id="purDisc" value="0" oninput="calcPur()"></div><div><label>Extra Charges</label><input type="number" id="purExtra" value="0" oninput="calcPur()"></div></div>
<div class="form-row"><div><label>VAT/Tax</label><div style="display:flex;gap:4px"><input type="number" id="purVat" value="0" oninput="calcPur()"><select id="purVatType" onchange="calcPur()" style="width:80px"><option value="amount">Amt</option><option value="percent">%</option></select></div></div></div>
</div>
...
window.togglePurBank=function(){var m=document.getElementById('purMethod').value;document.getElementById('purChequeDiv').classList.toggle('hidden',m!=='cheque')};
window.purSplitSync=function(){var ca=+document.getElementById('purCashAmt').value||0;var ba=+document.getElementById('purBankAmt').value||0;document.getElementById('purPaid').value=ca+ba;document.getElementById('purBankMethodDiv').classList.toggle('hidden',ba<=0);document.getElementById('purBankRow').classList.toggle('hidden',ba<=0)};
...
renderPur(purs)}
function renderPur(l){l.sort(function(a,b){return(b.date||'').localeCompare(a.date)});document.getElementById('purBody').innerHTML=!l.length?'<tr><td colspan="7" class="empty">No purchases</td></tr>':l.map(function(p){var due=(p.total||0)-(p.paid||0);return'<tr><td>'+p.date+'</td><td><span class="doc-link" onclick="previewDoc(&#39;purchase&#39;,&#39;'+p._key+'&#39;)">'+p.purchaseNo+'</span></td><td>'+p.supplierName+'</td><td class="r bold">'+fmt(p.total)+'</td><td class="r text-success">'+fmt(p.paid)+'</td><td class="r '+(due>0?'text-danger':'')+'">'+fmt(due)+'</td><td class="r"><button class="btn btn-outline btn-xs" onclick="editPur(&#39;'+p._key+'&#39;)">Edit</button> <button class="btn btn-danger btn-xs" onclick="delPur(&#39;'+p._key+'&#39;)">Del</button></td></tr>'}).join('')}
window.openPurchase=function(){document.getElementById('purEK').value='';document.getElementById('purNo').value=txnNo('PUR');document.getElementById('purDate').value=todayISO();document.getElementById('purSupplier').value='';document.getElementById('purDisc').value=0;document.getElementById('purExtra').value=0;document.getElementById('purVat').value=0;document.getElementById('purPaid').value=0;document.getElementById('purCashAmt').value=0;document.getElementById('purBankAmt').value=0;document.getElementById('purMethod').value='';document.getElementById('purTitle').textContent='New Purchase';var pcTgl=document.getElementById('purChargesBody');if(pcTgl){pcTgl.classList.remove('open');pcTgl.previousElementSibling.classList.remove('open')}togglePurBank();window._purItems=[{pk:'',pn:'',qty:1,rate:0,amt:0}];renderPurItems();openModal('purModal')}
window._purItems=[];
...
if(ek){
  ...
  var oldPurBankAmt=oldPur?(oldPur.bankAmount||0):0;if(!oldPurBankAmt&&oldPur&&oldPur.paid>0&&oldPur.method!=='cash'&&oldPur.method!=='credit')oldPurBankAmt=oldPur.paid;if(oldPurBankAmt>0&&oldPur&&oldPur.bankName){var oldBank=purBanks.find(function(b){return b.name===oldPur.bankName});if(oldBank){oldBank.balance=(oldBank.balance||0)+oldPurBankAmt;await saveByKey(oldBank._key,cleanForSave(oldBank))}}
  // Apply new bank balance
  if(purBankAmt>0&&bankName){var bk=purBanks.find(function(b){return b.name===bankName});if(bk){bk.balance=(bk.balance||0)-purBankAmt;await saveByKey(bk._key,cleanForSave(bk))}}
  // Delete old auto-created payment vouchers if exist
  if(oldPur&&oldPur._autoPayKey){try{await api('/api/delete',{key:oldPur._autoPayKey,skipApproval:true})}catch(e){}}
  if(oldPur&&oldPur._autoPayBankKey){try{await api('/api/delete',{key:oldPur._autoPayBankKey,skipApproval:true})}catch(e){}}
  // Create new auto payment voucher if paid > 0
  if(purCashAmt>0){var payVchC={type:'payment',no:txnNo('PAY'),date:data.date,party:sup?sup.name:'',amount:purCashAmt,method:'cash',bankName:'',chequeNo:'',note:'Auto: Purchase '+data.purchaseNo+' (Cash)',status:'done',_autoInvoice:data.purchaseNo};var pvrC=await api('/api/save',{prefix:'payment:',data:payVchC,skipApproval:true});data._autoPayKey=pvrC.key||''}
  if(purBankAmt>0){var payVchB={type:'payment',no:txnNo('PAY'),date:data.date,party:sup?sup.name:'',amount:purBankAmt,method:bankMethod,bankName:bankName,chequeNo:chequeNo,note:'Auto: Purchase '+data.purchaseNo+' (Bank)',status:'done',_autoInvoice:data.purchaseNo};var pvrB=await api('/api/save',{prefix:'payment:',data:payVchB,skipApproval:true});data._autoPayBankKey=pvrB.key||''}
  ...
  if(purBankAmt>0&&bankName){var bk2=purBanks.find(function(b){return b.name===bankName});if(bk2){bk2.balance=(bk2.balance||0)-purBankAmt;await saveByKey(bk2._key,cleanForSave(bk2))}}
  // Auto-create payment voucher if paid > 0
  if(purCashAmt>0&&saveRes&&saveRes.key){var payVchC2={type:'payment',no:txnNo('PAY'),date:data.date,party:sup?sup.name:'',amount:purCashAmt,method:'cash',bankName:'',chequeNo:'',note:'Auto: Purchase '+data.purchaseNo+' (Cash)',status:'done',_autoInvoice:data.purchaseNo};var pvrC2=await api('/api/save',{prefix:'payment:',data:payVchC2,skipApproval:true});data._autoPayKey=pvrC2.key||'';await api('/api/save',{key:saveRes.key,data:data,skipApproval:true})}
  if(purBankAmt>0&&saveRes&&saveRes.key){var payVchB2={type:'payment',no:txnNo('PAY'),date:data.date,party:sup?sup.name:'',amount:purBankAmt,method:bankMethod,bankName:bankName,chequeNo:chequeNo,note:'Auto: Purchase '+data.purchaseNo+' (Bank)',status:'done',_autoInvoice:data.purchaseNo};var pvrB2=await api('/api/save',{prefix:'payment:',data:payVchB2,skipApproval:true});data._autoPayBankKey=pvrB2.key||'';await api('/api/save',{key:saveRes.key,data:data,skipApproval:true})}
}
...
if(p){
  ...
  var delPurBankAmt=p.bankAmount||0;if(!delPurBankAmt&&p.paid>0&&p.method!=='cash'&&p.method!=='credit')delPurBankAmt=p.paid;if(delPurBankAmt>0&&p.bankName){var bk=purBanks.find(function(b){return b.name===p.bankName});if(bk){bk.balance=(bk.balance||0)+delPurBankAmt;await saveByKey(bk._key,cleanForSave(bk))}}
  // Delete auto-created payment voucher
  if(p._autoPayKey){try{await api('/api/delete',{key:p._autoPayKey,skipApproval:true})}catch(e){}}
  if(p._autoPayBankKey){try{await api('/api/delete',{key:p._autoPayBankKey,skipApproval:true})}catch(e){}}
}
...
<div class="form-row"><div><label>Customer</label><div class="sr-wrap"><input id="salCustSearch" placeholder="Type to search customer..." oninput="salFilterCust()" onfocus="salShowCustList()" autocomplete="off" style="width:100%"><input type="hidden" id="salCust"><div class="sr-list" id="salCustList" style="max-height:200px"></div></div></div><div><label>Salesperson</label><select id="salSP"><option value="">None</option></select></div></div>
...
<div class="collapsible-toggle" onclick="this.classList.toggle('open');document.getElementById('salChargesBody').classList.toggle('open')" style="margin-top:12px;cursor:pointer;display:flex;align-items:center;justify-content:space-between;padding:8px 12px;background:var(--bg);border-radius:8px;border:1px solid var(--border)"><div style="display:flex;align-items:center;gap:6px;font-weight:600;font-size:12px;color:var(--primary)"><span class="material-symbols-outlined" style="font-size:16px">tune</span> Discount, VAT, AIT & Extra Charges <span id="salChargesSummary" style="font-size:11px;color:var(--muted);font-weight:400"></span></div><span class="material-symbols-outlined" style="font-size:18px;transition:transform 0.2s;color:var(--muted)" id="salChargesArrow">expand_more</span></div>
<div id="salChargesBody" style="display:none;padding:4px 0">
<div class="form-row" style="margin-top:8px"><div><label>Discount</label><div style="display:flex;gap:4px"><input type="number" id="salDisc" value="0" oninput="calcSal()"><select id="salDiscType" onchange="calcSal()" style="width:80px"><option value="amount">Amt</option><option value="percent">%</option></select></div></div><div><label>Extra Charges</label><input type="number" id="salExtra" value="0" oninput="calcSal()"></div></div>
...
window.salFilterCust=function(){var q=(document.getElementById('salCustSearch').value||'').toLowerCase();var list=document.getElementById('salCustList');if(!q){list.innerHTML=customers.map(function(c){return'<div class="sr-item" onmousedown="salPickCust(&#39;'+c._key+'&#39;,&#39;'+c.name.replace(/'/g,"")+'&#39;)">'+c.name+'</div>'}).join('');list.classList.add('open');return}var fl=customers.filter(function(c){return c.name.toLowerCase().includes(q)||(c.phone||'').includes(q)||(c.address||'').toLowerCase().includes(q)});list.innerHTML=fl.length?fl.map(function(c){return'<div class="sr-item" onmousedown="salPickCust(&#39;'+c._key+'&#39;,&#39;'+c.name.replace(/'/g,"")+'&#39;)">'+c.name+(c.phone?' <span style="font-size:10px;color:var(--muted)">'+c.phone+'</span>':'')+'</div>'}).join(''):'<div class="sr-item" style="color:var(--muted)">No match</div>';list.classList.add('open')};
window.salShowCustList=function(){salFilterCust()};
window.salPickCust=function(key,name){document.getElementById('salCust').value=key;document.getElementById('salCustSearch').value=name;document.getElementById('salCustList').classList.remove('open');onSalCustChange()};
document.addEventListener('click',function(e){var wrap=document.getElementById('salCustList');if(wrap&&!e.target.closest('.sr-wrap')){wrap.classList.remove('open')}});
...
// salCust is now hidden input, no need to populate select
window._salCustList=customers;
...
function renderSal(l){l.sort(function(a,b){return(b.date||'').localeCompare(a.date)});document.getElementById('salBody').innerHTML=!l.length?'<tr><td colspan="9" class="empty">No sales</td></tr>':l.map(function(s){var due=(s.total||0)-(s.paid||0);return'<tr><td>'+s.date+'</td><td><span class="doc-link" onclick="previewDoc(&#39;sale&#39;,&#39;'+s._key+'&#39;)">'+s.invoiceNo+'</span></td><td>'+s.customerName+'</td><td class="text-muted">'+(s.salespersonName||'-')+'</td><td class="r bold">'+fmt(s.total)+'</td><td class="r text-success">'+fmt(s.paid)+'</td><td class="r '+(due>0?'text-danger':'')+'">'+fmt(due)+'</td><td class="r text-muted">'+(s.truckFare?(s.fareExceeded?'<span style="color:var(--danger)" title="Exceeded max '+fmt(s.fareMaxForThana||0)+' for '+(s.customerThana||'')+'">'+fmt(s.truckFare)+' ⚠</span>':fmt(s.truckFare)):'')+'</td><td class="r"><button class="btn btn-outline btn-xs" onclick="editSal(&#39;'+s._key+'&#39;)">Edit</button> <button class="btn btn-danger btn-xs" onclick="delSal(&#39;'+s._key+'&#39;)">Del</button></td></tr>'}).join('')}
window._salItems=[];
window.openSale=function(){document.getElementById('salEK').value='';document.getElementById('salNo').value=txnNo('INV');document.getElementById('salDate').value=todayISO();document.getElementById('salCust').value='';document.getElementById('salCustSearch').value='';document.getElementById('salSP').value='';document.getElementById('salDisc').value=0;document.getElementById('salExtra').value=0;document.getElementById('salVat').value=0;document.getElementById('salAit').value=0;document.getElementById('salPaid').value=0;document.getElementById('salNote').value='';document.getElementById('salTruckFare').value=0;document.getElementById('salCashAmt').value=0;document.getElementById('salBankAmt').value=0;document.getElementById('salMethod').value='bank_transfer';var creditChk=document.getElementById('salCreditChk');if(creditChk)creditChk.checked=false;document.getElementById('salBankDiv').classList.add('hidden');document.getElementById('salCreditDiv').classList.remove('hidden');document.getElementById('creditWarn').classList.add('hidden');var scTgl=document.getElementById('salChargesBody');if(scTgl){scTgl.classList.remove('open');scTgl.previousElementSibling.classList.remove('open')}toggleSalBank();window._salItems=[{pk:'',pn:'',qty:1,rate:0,amt:0}];renderSalItems();openModal('salModal')}
...
var cParts=[];if(discAmt>0)cParts.push('Disc: '+fmt(discAmt));if(extra>0)cParts.push('Extra: '+fmt(extra));if(vatAmt>0)cParts.push('VAT: '+fmt(vatAmt));if(aitAmt>0)cParts.push('AIT: '+fmt(aitAmt));var cSumEl=document.getElementById('salChargesSummary');if(cSumEl)cSumEl.textContent=cParts.length?'('+cParts.join(' | ')+')':'';
...
if(ek){
  ...
  // Reverse old bank balance (support split payments)
  if(oldSal&&(oldSal.bankAmount||0)>0&&oldSal.bankName){var oldBk=salBanks.find(function(b){return b.name===oldSal.bankName});if(oldBk){oldBk.balance=(oldBk.balance||0)-(oldSal.bankAmount||0);await saveByKey(oldBk._key,cleanForSave(oldBk))}}
  else if(oldSal&&oldSal.paid>0&&oldSal.method!=='cash'&&oldSal.method!=='credit'&&oldSal.bankName){var oldBk2=salBanks.find(function(b){return b.name===oldSal.bankName});if(oldBk2){oldBk2.balance=(oldBk2.balance||0)-(oldSal.paid||0);await saveByKey(oldBk2._key,cleanForSave(oldBk2))}}
  // Apply new bank balance
  if(bankAmt>0&&bankName){var nbk=salBanks.find(function(b){return b.name===bankName});if(nbk){nbk.balance=(nbk.balance||0)+bankAmt;await saveByKey(nbk._key,cleanForSave(nbk))}}
  ...
  if(oldSal&&oldSal._autoRcvBankKey){try{await api('/api/delete',{key:oldSal._autoRcvBankKey,skipApproval:true})}catch(e){}}
  // Create auto receipt vouchers for each payment method (split)
  if(cashAmt>0){var rcvCash={type:'receipt',no:txnNo('RCV'),date:data.date,party:cust?cust.name:'',amount:cashAmt,method:'cash',bankName:'',chequeNo:'',note:'Auto: Sale '+data.invoiceNo+' (Cash)',status:'done',_autoInvoice:data.invoiceNo};var rvrC=await api('/api/save',{prefix:'payment:',data:rcvCash,skipApproval:true});data._autoRcvKey=rvrC.key||''}
  if(bankAmt>0){var rcvBank={type:'receipt',no:txnNo('RCV'),date:data.date,party:cust?cust.name:'',amount:bankAmt,method:bankMethod,bankName:bankName,chequeNo:chequeNo,note:'Auto: Sale '+data.invoiceNo+' (Bank)',status:'done',_autoInvoice:data.invoiceNo};var rvrB=await api('/api/save',{prefix:'payment:',data:rcvBank,skipApproval:true});data._autoRcvBankKey=rvrB.key||''}
  ...
  if(bankAmt>0&&bankName){var bk2=salBanks.find(function(b){return b.name===bankName});if(bk2){bk2.balance=(bk2.balance||0)+bankAmt;await saveByKey(bk2._key,cleanForSave(bk2))}}
  // Auto-create receipt vouchers for each payment method (split)
  if(cashAmt>0&&saveRes&&saveRes.key){var rcvCash2={type:'receipt',no:txnNo('RCV'),date:data.date,party:cust?cust.name:'',amount:cashAmt,method:'cash',bankName:'',chequeNo:'',note:'Auto: Sale '+data.invoiceNo+' (Cash)',status:'done',_autoInvoice:data.invoiceNo};var rvrC2=await api('/api/save',{prefix:'payment:',data:rcvCash2,skipApproval:true});data._autoRcvKey=rvrC2.key||'';await api('/api/save',{key:saveRes.key,data:data,skipApproval:true})}
  if(bankAmt>0&&saveRes&&saveRes.key){var rcvBank2={type:'receipt',no:txnNo('RCV'),date:data.date,party:cust?cust.name:'',amount:bankAmt,method:bankMethod,bankName:bankName,chequeNo:chequeNo,note:'Auto: Sale '+data.invoiceNo+' (Bank)',status:'done',_autoInvoice:data.invoiceNo};var rvrB2=await api('/api/save',{prefix:'payment:',data:rcvBank2,skipApproval:true});data._autoRcvBankKey=rvrB2.key||'';await api('/api/save',{key:saveRes.key,data:data,skipApproval:true})}
...
if(s){
  ...
  // Reverse bank balance (support split payments)
  var delBankAmt=s.bankAmount||0;if(!delBankAmt&&s.paid>0&&s.method!=='cash'&&s.method!=='credit')delBankAmt=s.paid;
  if(delBankAmt>0&&s.bankName){var bk=salBanks.find(function(b){return b.name===s.bankName});if(bk){bk.balance=(bk.balance||0)-delBankAmt;await saveByKey(bk._key,cleanForSave(bk))}}
  // Delete auto-created receipt vouchers (both cash and bank)
  if(s._autoRcvKey){try{await api('/api/delete',{key:s._autoRcvKey,skipApproval:true})}catch(e){}}
  if(s._autoRcvBankKey){try{await api('/api/delete',{key:s._autoRcvBankKey,skipApproval:true})}catch(e){}}
...
c.innerHTML='<div style="margin:12px 0"><button class="btn btn-primary" onclick="openPayModal(&#39;'+payTab+'&#39;)"><span class="material-symbols-outlined" style="font-size:16px">add</span> New '+(payTab==='receipt'?'Receipt':'Payment')+'</button></div><div class="card" style="padding:0"><div class="table-wrap"><table class="tbl" id="payTbl"><thead><tr><th>Date</th><th>No</th><th>Party</th><th>Method</th><th class="r">Amount</th><th>Note</th><th class="r">Act</th></tr></thead><tbody>'+(fl.length?fl.map(function(p){return'<tr><td>'+p.date+'</td><td><span class="doc-link" onclick="previewDoc(&#39;'+p.type+'&#39;,&#39;'+p._key+'&#39;)">'+p.no+'</span></td><td>'+p.party+'</td><td>'+methodBadge(p.method)+'</td><td class="r bold">'+fmt(p.amount)+'</td><td class="text-muted">'+(p.note||'')+'</td><td class="r"><button class="btn btn-outline btn-xs" onclick="editPay(&#39;'+p._key+'&#39;)">Edit</button> <button class="btn btn-danger btn-xs" onclick="delPay(&#39;'+p._key+'&#39;)">Del</button></td></tr>'}).join(''):'<tr><td colspan="7" class="empty">None</td></tr>')+'</tbody></table></div></div>'}
...
if(ek){
  ...
  // Reverse old bill-wise payment effects on sale.paid / purchase.paid AND method info
  if(oldPay&&oldPay.billKeys&&oldPay.billKeys.length){var revRem=oldPay.amount||0;for(var ri=0;ri<oldPay.billKeys.length&&revRem>0;ri++){var rkey=oldPay.billKeys[ri];if(oldPay.type==='receipt'){var rSale=paySales.find(function(x){return x._key===rkey});if(rSale){var ra=Math.min(revRem,rSale.paid||0);rSale.paid=Math.max(0,(rSale.paid||0)-ra);
  if(oldPay.method==='cash'){rSale.cashAmount=Math.max(0,(rSale.cashAmount||0)-ra)}else{rSale.bankAmount=Math.max(0,(rSale.bankAmount||0)-ra)}
  if((rSale.cashAmount||0)>0&&(rSale.bankAmount||0)>0){rSale.method='split'}else if((rSale.cashAmount||0)>0){rSale.method='cash'}else if((rSale.bankAmount||0)>0){rSale.method=rSale.bankMethod||'bank_transfer'}else if((rSale.paid||0)<=0){rSale.method='credit';rSale.cashAmount=0;rSale.bankAmount=0}
  revRem-=ra;await saveByKey(rkey,cleanForSave(rSale))}}else{var rPur=payPurchases.find(function(x){return x._key===rkey});if(rPur){var ra2=Math.min(revRem,rPur.paid||0);rPur.paid=Math.max(0,(rPur.paid||0)-ra2);
  if(oldPay.method==='cash'){rPur.cashAmount=Math.max(0,(rPur.cashAmount||0)-ra2)}else{rPur.bankAmount=Math.max(0,(rPur.bankAmount||0)-ra2)}
  if((rPur.cashAmount||0)>0&&(rPur.bankAmount||0)>0){rPur.method='split'}else if((rPur.cashAmount||0)>0){rPur.method='cash'}else if((rPur.bankAmount||0)>0){rPur.method=rPur.bankMethod||'bank_transfer'}else if((rPur.paid||0)<=0){rPur.method='credit';rPur.cashAmount=0;rPur.bankAmount=0}
  revRem-=ra2;await saveByKey(rkey,cleanForSave(rPur))}}}}
  // Preserve billKeys from old payment for re-application
  data.billKeys=oldPay?oldPay.billKeys||[]:[];
  ...
  // Re-apply new payment amount and method info to the same bills
  if(data.billKeys&&data.billKeys.length){var editRem=amt;for(var ei=0;ei<data.billKeys.length&&editRem>0;ei++){var ekey=data.billKeys[ei];if(type==='receipt'){var eSale=paySales.find(function(x){return x._key===ekey});if(eSale){var eDue=(eSale.total||0)-(eSale.paid||0);var eApply=Math.min(editRem,eDue);eSale.paid=(eSale.paid||0)+eApply;editRem-=eApply;
  if(data.method==='cash'){eSale.cashAmount=(eSale.cashAmount||0)+eApply;eSale.method=(eSale.bankAmount||0)>0?'split':'cash'}else{eSale.bankAmount=(eSale.bankAmount||0)+eApply;eSale.bankMethod=data.method;eSale.bankName=data.bankName||eSale.bankName||'';if(data.method==='cheque')eSale.chequeNo=data.chequeNo||eSale.chequeNo||'';eSale.method=(eSale.cashAmount||0)>0?'split':data.method}
  await saveByKey(ekey,cleanForSave(eSale))}}else{var ePur=payPurchases.find(function(x){return x._key===ekey});if(ePur){var eDue2=(ePur.total||0)-(ePur.paid||0);var eApply2=Math.min(editRem,eDue2);ePur.paid=(ePur.paid||0)+eApply2;editRem-=eApply2;
  if(data.method==='cash'){ePur.cashAmount=(ePur.cashAmount||0)+eApply2;ePur.method=(ePur.bankAmount||0)>0?'split':'cash'}else{ePur.bankAmount=(ePur.bankAmount||0)+eApply2;ePur.bankMethod=data.method;ePur.bankName=data.bankName||ePur.bankName||'';if(data.method==='cheque')ePur.chequeNo=data.chequeNo||ePur.chequeNo||'';ePur.method=(ePur.cashAmount||0)>0?'split':data.method}
  await saveByKey(ekey,cleanForSave(ePur))}}}}
...
if(bills.length){var remaining=amt;for(var i=0;i<bills.length&&remaining>0;i++){var bk=bills[i];if(type==='receipt'){var sale=paySales.find(function(x){return x._key===bk});if(sale){var due=(sale.total||0)-(sale.paid||0);var apply=Math.min(remaining,due);sale.paid=(sale.paid||0)+apply;remaining-=apply;
if(data.method==='cash'){sale.cashAmount=(sale.cashAmount||0)+apply;sale.method=(sale.bankAmount||0)>0?'split':'cash'}else{sale.bankAmount=(sale.bankAmount||0)+apply;sale.bankMethod=data.method;sale.bankName=data.bankName||sale.bankName||'';if(data.method==='cheque')sale.chequeNo=data.chequeNo||sale.chequeNo||'';sale.method=(sale.cashAmount||0)>0?'split':data.method}
await saveByKey(bk,cleanForSave(sale))}}else{var pur=payPurchases.find(function(x){return x._key===bk});if(pur){var due2=(pur.total||0)-(pur.paid||0);var apply2=Math.min(remaining,due2);pur.paid=(pur.paid||0)+apply2;remaining-=apply2;
if(data.method==='cash'){pur.cashAmount=(pur.cashAmount||0)+apply2;pur.method=(pur.bankAmount||0)>0?'split':'cash'}else{pur.bankAmount=(pur.bankAmount||0)+apply2;pur.bankMethod=data.method;pur.bankName=data.bankName||pur.bankName||'';if(data.method==='cheque')pur.chequeNo=data.chequeNo||pur.chequeNo||'';pur.method=(pur.cashAmount||0)>0?'split':data.method}
...
if(p.method==='cash'){sale.cashAmount=Math.max(0,(sale.cashAmount||0)-revAmt)}else{sale.bankAmount=Math.max(0,(sale.bankAmount||0)-revAmt)}
if((sale.cashAmount||0)>0&&(sale.bankAmount||0)>0){sale.method='split'}else if((sale.cashAmount||0)>0){sale.method='cash'}else if((sale.bankAmount||0)>0){sale.method=sale.bankMethod||'bank_transfer'}else if((sale.paid||0)<=0){sale.method='credit';sale.cashAmount=0;sale.bankAmount=0}
remaining-=revAmt;await saveByKey(bkey,cleanForSave(sale))}}else{var pur=payPurchases.find(function(x){return x._key===bkey});if(pur){var revAmt2=Math.min(remaining,pur.paid||0);pur.paid=Math.max(0,(pur.paid||0)-revAmt2);
if(p.method==='cash'){pur.cashAmount=Math.max(0,(pur.cashAmount||0)-revAmt2)}else{pur.bankAmount=Math.max(0,(pur.bankAmount||0)-revAmt2)}
if((pur.cashAmount||0)>0&&(pur.bankAmount||0)>0){pur.method='split'}else if((pur.cashAmount||0)>0){pur.method='cash'}else if((pur.bankAmount||0)>0){pur.method=pur.bankMethod||'bank_transfer'}else if((pur.paid||0)<=0){pur.method='credit';pur.cashAmount=0;pur.bankAmount=0}
remaining-=revAmt2;await saveByKey(bkey,cleanForSave(pur))}}}}
...
window.renderBankLedger=function(){
  ...
  paySales.filter(function(s){return s.bankName===bankName&&(s.method==='split'?(s.bankAmount||0)>0:(s.method!=='cash'&&s.method!=='credit'&&(s.paid||0)>0))}).forEach(function(s){var bAmt=s.method==='split'?(s.bankAmount||0):(s.paid||0);entries.push({date:s.date,desc:'Sale payment - '+s.customerName,ref:s.invoiceNo||'',debit:bAmt,credit:0})});
...
<div class="form-row" style="margin-bottom:14px"><div style="flex:2"><label>Party</label><div class="sr-wrap"><input id="ledPartySearch" placeholder="Type to search party..." oninput="ledFilterParties()" onfocus="ledShowPartyList()" autocomplete="off" style="width:100%"><input type="hidden" id="ledParty"><div class="sr-list" id="ledPartyList" style="max-height:240px"></div></div></div><div><label>Type</label><select id="ledTypeFilter" onchange="ledFilterParties()" style="font-size:12px"><option value="">All</option><option value="customer">Customer</option><option value="supplier">Supplier</option></select></div><div><label>Date Range</label><div style="display:flex;gap:4px"><input type="date" id="ledFrom" onchange="renderLedger()"><input type="date" id="ledTo" onchange="renderLedger()"></div></div></div>
<style>.sr-wrap{position:relative}.sr-list{display:none;position:absolute;top:100%;left:0;right:0;max-height:180px;overflow-y:auto;background:var(--card);border:1px solid var(--border);border-radius:6px;z-index:100;box-shadow:0 4px 12px rgba(0,0,0,.15)}.sr-list.active{display:block}.sr-list div{padding:6px 10px;cursor:pointer;font-size:12px;border-bottom:1px solid var(--border)}.sr-list div:hover,.sr-list div.hl{background:var(--accent-light);color:var(--accent)}</style>
...
ledFilterParties()}
window.ledFilterParties=function(){var q=(document.getElementById('ledPartySearch').value||'').trim().toLowerCase();var tf=document.getElementById('ledTypeFilter')?document.getElementById('ledTypeFilter').value:'';var fl=ledParties.filter(function(p){return(!tf||p.type===tf)&&(!q||(p.name||'').toLowerCase().includes(q)||(p.phone||'').includes(q)||(p.thana||'').toLowerCase().includes(q))});var el=document.getElementById('ledPartyList');el.innerHTML=fl.slice(0,60).map(function(p){return'<div onclick="ledSelectParty(&#39;'+p._key+'&#39;,&#39;'+(p.name||'').replace(/'/g,'')+'&#39;)">['+p.type.charAt(0).toUpperCase()+'] '+p.name+(p.phone?' <span class=text-muted>('+p.phone+')</span>':'')+'</div>'}).join('');el.classList.add('active')}
window.ledShowPartyList=function(){var el=document.getElementById('ledPartyList');if(!el.innerHTML)ledFilterParties();el.classList.add('active')}
window.ledSelectParty=function(key,name){document.getElementById('ledPartySearch').value=name;document.getElementById('ledParty').value=key;document.getElementById('ledPartyList').classList.remove('active');renderLedger()}
document.addEventListener('click',function(e){if(!e.target.closest('.sr-wrap'))document.querySelectorAll('.sr-list').forEach(function(x){x.classList.remove('active')})})
...
document.getElementById('ledBody').innerHTML=!entries.length?'<tr><td colspan="6" class="empty">No entries</td></tr>':entries.map(function(e){var rowClass='led-'+e.type.toLowerCase();var badgeClass=e.type==='Sale'?'badge-info':e.type==='Purchase'?'badge-warning':e.type==='Receipt'?'badge-success':e.type==='Truck Fare IN'?'badge-success':e.type==='Truck Fare OUT'?'badge-danger':e.type==='Opening'?'badge-cash':'badge-cash';return'<tr class="'+rowClass+'"><td>'+e.date+'</td><td>'+(e.docKey?'<span class="doc-link" onclick="previewDoc(&#39;'+e.docType+'&#39;,&#39;'+e.docKey+'&#39;)">'+e.doc+'</span>':e.doc)+'</td><td><span class="badge '+badgeClass+'">'+e.type+'</span></td><td class="r '+(e.debit?'text-danger':'')+'">'+fmt(e.debit)+'</td><td class="r '+(e.credit?'text-success':'')+'">'+fmt(e.credit)+'</td><td class="r bold '+(e.balance>0?'text-danger':'text-success')+'">'+fmt(Math.abs(e.balance))+' '+(e.balance>0?'Dr':'Cr')+'</td></tr>'}).join('')+'<tr style="background:var(--bg);font-weight:800;border-top:2px solid var(--border-dark)"><td colspan="3">TOTAL ('+entries.length+' entries)</td><td class="r text-danger">'+fmt(totalDr)+'</td><td class="r text-success">'+fmt(totalCr)+'</td><td class="r bold '+(bal>0?'text-danger':'text-success')+'">'+fmt(Math.abs(bal))+' '+(bal>0?'Dr':'Cr')+'</td></tr>'}
loadLedger();
<\/script>`}function gr(){return`
...
async function loadTB(){
  ...
  var cashFromSales = sales.reduce(function(s, x) { if(x.method === 'split') return s + n(x.cashAmount); else if(x.method === 'cash') return s + n(x.paid); return s; }, 0);
...
document.getElementById('rpVatBody').innerHTML=!rows.length?'<tr><td colspan="6" class="empty">No VAT transactions</td></tr>':rows.map(function(r){return'<tr><td>'+r.date+'</td><td><span class="doc-link" onclick="previewDoc(&#39;sale&#39;,&#39;'+r.key+'&#39;)">'+r.inv+'</span></td><td>'+r.cust+'</td><td class="r">'+fmt(r.saleTotal)+'</td><td class="r bold text-info">'+fmt(r.vatAmt)+'</td><td class="r bold">'+fmt(r.bal)+'</td></tr>'}).join('')+'<tr style="background:var(--bg);font-weight:800"><td colspan="4">TOTAL</td><td class="r">'+fmt(total)+'</td><td class="r">'+fmt(bal)+'</td></tr>'};
// === AIT LEDGER IN R/P ===
...
document.getElementById('rpAitBody').innerHTML=!rows.length?'<tr><td colspan="6" class="empty">No AIT transactions</td></tr>':rows.map(function(r){return'<tr><td>'+r.date+'</td><td><span class="doc-link" onclick="previewDoc(&#39;sale&#39;,&#39;'+r.key+'&#39;)">'+r.inv+'</span></td><td>'+r.cust+'</td><td class="r">'+fmt(r.saleTotal)+'</td><td class="r bold text-info">'+fmt(r.aitAmt)+'</td><td class="r bold">'+fmt(r.bal)+'</td></tr>'}).join('')+'<tr style="background:var(--bg);font-weight:800"><td colspan="4">TOTAL</td><td class="r">'+fmt(total)+'</td><td class="r">'+fmt(bal)+'</td></tr>'};
loadRP();
<\/script>`}function xr(){return`
...
var cashPurchases=dp.filter(function(p){return (p.method==='cash'||p.method==='split')&&(p.cashAmount>0||(p.method==='cash'&&(p.paid||0)>0))});
var bankPurchases=dp.filter(function(p){return (p.method==='split'&&(p.bankAmount||0)>0)||(p.method&&p.method!=='cash'&&p.method!=='credit'&&p.method!=='split'&&(p.paid||0)>0)});
var cashExpenses=de.filter(function(e){return e.method==='cash'});
var bankExpenses=de.filter(function(e){return e.method!=='cash'});

var html='';
// Sales section
html+='<div class="card"><div class="section-title">Sales ('+ds.length+')</div>'+(ds.length?'<table class="tbl"><thead><tr><th>Invoice</th><th>Customer</th><th>Method</th><th class="r">Total</th><th class="r">Paid</th></tr></thead><tbody>'+ds.map(function(s){return'<tr><td><span class="doc-link" onclick="previewDoc(&#39;sale&#39;,&#39;'+s._key+'&#39;)">'+s.invoiceNo+'</span></td><td>'+s.customerName+'</td><td>'+methodBadge(s.method,s)+'</td><td class="r bold">'+fmt(s.total)+'</td><td class="r text-success">'+fmt(s.paid)+'</td></tr>'}).join('')+'<tr style="background:var(--bg);font-weight:800"><td colspan="3">Total</td><td class="r">'+fmt(totalSales)+'</td><td class="r">'+fmt(ds.reduce(function(s,x){return s+(x.paid||0)},0))+'</td></tr></tbody></table>':'<div class="empty">No sales</div>')+'</div>';
// Purchases section
html+='<div class="card"><div class="section-title">Purchases ('+dp.length+')</div>'+(dp.length?'<table class="tbl"><thead><tr><th>#</th><th>Supplier</th><th>Method</th><th class="r">Total</th><th class="r">Paid</th></tr></thead><tbody>'+dp.map(function(p){return'<tr><td><span class="doc-link" onclick="previewDoc(&#39;purchase&#39;,&#39;'+p._key+'&#39;)">'+p.purchaseNo+'</span></td><td>'+p.supplierName+'</td><td>'+methodBadge(p.method,p)+'</td><td class="r bold">'+fmt(p.total)+'</td><td class="r text-success">'+fmt(p.paid)+'</td></tr>'}).join('')+'<tr style="background:var(--bg);font-weight:800"><td colspan="3">Total</td><td class="r">'+fmt(totalPurchases)+'</td><td class="r">'+fmt(dp.reduce(function(s,x){return s+(x.paid||0)},0))+'</td></tr></tbody></table>':'<div class="empty">No purchases</div>')+'</div>';
// CASH section
var cashItems=[];
cashSales.forEach(function(s){var cAmt=s.method==='split'?(s.cashAmount||0):(s.paid||0);if(cAmt>0)cashItems.push({desc:'Sale: '+s.invoiceNo+' - '+s.customerName,amt:cAmt,type:'in'})});
cashRecTxn.forEach(function(r){cashItems.push({desc:'Receipt: '+r.no+' - '+r.party+(r.billKeys&&r.billKeys.length?' (Inv)':''),amt:r.amount||0,type:'in'})});
cashPurchases.forEach(function(p){var cAmt=p.method==='split'?(p.cashAmount||0):(p.paid||0);if(cAmt>0)cashItems.push({desc:'Purchase: '+p.purchaseNo+' - '+p.supplierName,amt:cAmt,type:'out'})});
cashPayTxn.forEach(function(p){cashItems.push({desc:'Payment: '+p.no+' - '+p.party+(p.billKeys&&p.billKeys.length?' (Inv)':''),amt:p.amount||0,type:'out'})});
...
// BANK section
var bankItems=[];
bankSales.forEach(function(s){var bAmt=s.method==='split'?(s.bankAmount||0):(s.paid||0);if(bAmt>0)bankItems.push({desc:'Sale: '+s.invoiceNo+' - '+s.customerName+(s.bankName?' ['+s.bankName+']':''),amt:bAmt,type:'in'})});
bankRecTxn.forEach(function(r){bankItems.push({desc:'Receipt: '+r.no+' - '+r.party+(r.billKeys&&r.billKeys.length?' (Inv)':'')+(r.bankName?' ['+r.bankName+']':''),amt:r.amount||0,type:'in'})});
bankPurchases.forEach(function(p){var bAmt=p.method==='split'?(p.bankAmount||0):(p.paid||0);if(bAmt>0)bankItems.push({desc:'Purchase: '+p.purchaseNo+' - '+p.supplierName+(p.bankName?' ['+p.bankName+']':''),amt:bAmt,type:'out'})});
bankPayTxn.forEach(function(p){bankItems.push({desc:'Payment: '+p.no+' - '+p.party+(p.billKeys&&p.billKeys.length?' (Inv)':'')+(p.bankName?' ['+p.bankName+']':''),amt:p.amount||0,type:'out'})});
...
// Transfer bank-in/out (Cash→Bank = Bank In, Bank→Cash = Bank Out)
dr.filter(function(r){return r.type==='transfer'&&r.fromAcc==='Cash'&&r.toAcc&&r.toAcc!=='Cash'}).forEach(function(r){bankItems.push({desc:'Transfer In from Cash ['+r.toAcc+']',amt:r.amount||0,type:'in'})});
dr.filter(function(r){return r.type==='transfer'&&r.toAcc==='Cash'&&r.fromAcc&&r.fromAcc!=='Cash'}).forEach(function(r){bankItems.push({desc:'Transfer Out to Cash ['+r.fromAcc+']',amt:r.amount||0,type:'out'})});
...
// Expenses section
html+='<div class="card"><div class="section-title">Expenses ('+de.length+')</div>'+(de.length?'<table class="tbl"><thead><tr><th>No</th><th>Head</th><th>Method</th><th class="r">Amount</th></tr></thead><tbody>'+de.map(function(e){return'<tr><td><span class="doc-link" onclick="previewDoc(&#39;expense&#39;,&#39;'+e._key+'&#39;)">'+(e.expenseNo||'')+'</span></td><td>'+e.headName+'</td><td>'+methodBadge(e.method)+'</td><td class="r bold">'+fmt(e.amount)+'</td></tr>'}).join('')+'<tr style="background:var(--bg);font-weight:800"><td colspan="3">Total Expenses</td><td class="r">'+fmt(totalExpenses)+'</td></tr></tbody></table>':'<div class="empty">None</div>')+'</div>';
document.getElementById('daySections').innerHTML=html}
loadDay();
<\/script>`}function Sr(){return`
...
<option value="brand-customer-sales">Brand-wise Customer Sales</option>
...
window.toggleRptFilters=function(){var type=document.getElementById('rptType').value;var showGroup=['product-sales','product-purchases','date-sales','gross-profit','customer-invoice-detail','customer-sales','brand-customer-sales','group-sales-summary','brand-sales-summary'].includes(type);document.getElementById('rptGroupFilter').style.display=showGroup?'grid':'none'}
...
html+='<tr><td><span class="doc-link" onclick="previewDoc(&#39;sale&#39;,&#39;'+s._key+'&#39;)">'+s.invoiceNo+'</span></td><td class="text-muted">'+( s.note||'-')+'</td><td>'+s.customerName+'</td><td class="text-muted">'+(s.createdBy||'-')+'</td><td class="r">'+fmt(sub)+'</td><td class="r text-danger">'+fmt(discAmt)+'</td><td class="r">'+fmt(s.extra||0)+'</td><td class="r">'+fmt(vatAmt)+'</td><td class="r bold">'+fmt(s.total)+'</td><td>'+methodBadge(s.method)+'</td></tr>'});
...
html+='<tr><td><span class="doc-link" onclick="previewDoc(&#39;sale&#39;,&#39;'+r.key+'&#39;)">'+r.inv+'</span></td><td>'+r.cust+'</td><td class="text-muted">-</td><td class="text-muted">'+r.date+'</td><td class="r">'+r.qty+'</td><td class="r">'+fmt(r.rate)+'</td><td class="r bold">'+fmt(r.amt)+'</td></tr>'});
gQ+=pQ;gA+=pA;
...
html+='<tr><td><span class="doc-link" onclick="previewDoc(&#39;sale&#39;,&#39;'+s._key+'&#39;)">'+s.invoiceNo+'</span></td><td>'+it.productName+'</td><td class="r">'+it.qty+'</td><td class="r">'+fmt(it.rate)+'</td><td class="r text-danger">'+fmt(discPerItem)+'</td><td class="r">'+fmt(Math.max(0,netRate))+'</td><td class="r bold">'+fmt(it.amount)+'</td></tr>'})});
gA2+=cData.totalAmt;
...
html+='<tr><td><span class="doc-link" onclick="previewDoc(&#39;purchase&#39;,&#39;'+p._key+'&#39;)">'+p.purchaseNo+'</span></td><td class="text-muted">-</td><td>'+p.supplierName+'</td><td>'+methodBadge(p.method)+'</td><td class="r text-danger">'+fmt(p.discount||0)+'</td><td class="r">'+fmt(p.extra||0)+'</td><td class="r">'+fmt(vatAmt)+'</td><td class="r bold">'+fmt(p.total)+'</td><td>'+methodBadge(p.method)+'</td></tr>'});
gDPA+=dA;
...
html+='<tr><td><span class="doc-link" onclick="previewDoc(&#39;purchase&#39;,&#39;'+p._key+'&#39;)">'+p.purchaseNo+'</span></td><td>'+it.productName+'</td><td class="r">'+it.qty+'</td><td class="r">'+fmt(it.rate)+'</td><td class="r bold">'+fmt(it.amount)+'</td></tr>'})});
gSPA+=sData.total;
...
html+='<tr><td><span class="doc-link" onclick="previewDoc(&#39;purchase&#39;,&#39;'+r.key+'&#39;)">'+r.inv+'</span></td><td>'+r.date+'</td><td>'+r.sup+'</td><td class="r">'+r.qty+'</td><td class="text-muted">'+r.unit+'</td><td class="r">'+fmt(r.rate)+'</td><td class="r bold">'+fmt(r.amt)+'</td></tr>'});
gPPA+=pA;
...
body=invRows.map(function(r){return'<tr><td class="bold">'+r.cust+'</td><td><span class="doc-link" onclick="previewDoc(&#39;sale&#39;,&#39;'+r.key+'&#39;)">'+r.inv+'</span></td><td>'+r.date+'</td><td class="r">'+fmt(r.total)+'</td><td class="r text-success">'+fmt(r.invPaid)+'</td><td class="r text-info">'+fmt(r.rcptPaid)+'</td><td class="r '+(r.bal>0?'text-danger bold':'')+'">'+fmt(r.bal)+'</td></tr>'}).join('');
...
// ===== BRAND-WISE CUSTOMER SALES =====
else if(type==='brand-customer-sales'){
head='<tr><th>Brand</th><th>Customer</th><th class="r">Qty</th><th class="r">Revenue</th><th class="r">Avg Rate</th></tr>';
var byBC={};sales.forEach(function(s){(s.items||[]).forEach(function(it){var pr=rptProducts.find(function(p){return p._key===it.productId});var br=pr?pr.brand||'No Brand':'No Brand';var cn=s.customerName||'Unknown';var k=br+'|||'+cn;if(!byBC[k])byBC[k]={brand:br,cust:cn,qty:0,rev:0};byBC[k].qty+=it.qty||0;byBC[k].rev+=it.amount||0})});
var brandGroups={};Object.values(byBC).forEach(function(r){if(!brandGroups[r.brand])brandGroups[r.brand]={rows:[],totalQty:0,totalRev:0};brandGroups[r.brand].rows.push(r);brandGroups[r.brand].totalQty+=r.qty;brandGroups[r.brand].totalRev+=r.rev});
var gBCQ=0,gBCR=0;
body=Object.entries(brandGroups).sort(function(a,b){return b[1].totalRev-a[1].totalRev}).map(function(e){var brand=e[0],bg=e[1];gBCQ+=bg.totalQty;gBCR+=bg.totalRev;
var html='<tr style="'+ss+'"><td colspan="5" style="font-size:13px">'+brand+' <span class="text-muted">('+bg.rows.length+' customers)</span></td></tr>';
bg.rows.sort(function(a,b){return b.rev-a.rev}).forEach(function(r){html+='<tr><td></td><td class="bold">'+r.cust+'</td><td class="r">'+r.qty+'</td><td class="r bold">'+fmt(r.rev)+'</td><td class="r text-muted">'+fmt(r.qty?r.rev/r.qty:0)+'</td></tr>'});
html+='<tr style="'+ss+';border-top:1px solid var(--border-dark)"><td colspan="2" class="r bold">Brand Total</td><td class="r bold">'+bg.totalQty+'</td><td class="r bold">'+fmt(bg.totalRev)+'</td><td class="r">'+fmt(bg.totalQty?bg.totalRev/bg.totalQty:0)+'</td></tr>';
return html}).join('');
body+='<tr style="'+gs+';border-top:3px solid #333"><td colspan="2" class="r bold" style="font-size:13px">Grand Total</td><td class="r bold">'+gBCQ+'</td><td class="r bold" style="font-size:14px">'+fmt(gBCR)+'</td><td class="r">'+fmt(gBCQ?gBCR/gBCQ:0)+'</td></tr>'}
// ===== GROUP-WISE SALES SUMMARY =====
else if(type==='group-sales-summary'){
head='<tr><th>Group</th><th class="r">Products Sold</th><th class="r">Total Qty</th><th class="r">Revenue</th><th class="r">Avg Rate</th></tr>';
var byGrp={};sales.forEach(function(s){(s.items||[]).forEach(function(it){var pr=rptProducts.find(function(p){return p._key===it.productId});var gr=pr?pr.group||'No Group':'No Group';if(!byGrp[gr])byGrp[gr]={prods:{},qty:0,rev:0};byGrp[gr].prods[it.productId||it.productName]=1;byGrp[gr].qty+=it.qty||0;byGrp[gr].rev+=it.amount||0})});
var gGQ=0,gGR=0;
body=Object.entries(byGrp).sort(function(a,b){return b[1].rev-a[1].rev}).map(function(e){gGQ+=e[1].qty;gGR+=e[1].rev;return'<tr><td class="bold">'+e[0]+'</td><td class="r">'+Object.keys(e[1].prods).length+'</td><td class="r">'+e[1].qty+'</td><td class="r bold">'+fmt(e[1].rev)+'</td><td class="r text-muted">'+fmt(e[1].qty?e[1].rev/e[1].qty:0)+'</td></tr>'}).join('');
body+='<tr style="'+gs+';border-top:3px solid #333"><td class="bold" style="font-size:13px">Grand Total</td><td></td><td class="r bold">'+gGQ+'</td><td class="r bold" style="font-size:14px">'+fmt(gGR)+'</td><td class="r">'+fmt(gGQ?gGR/gGQ:0)+'</td></tr>'}
// ===== BRAND-WISE SALES SUMMARY =====
else if(type==='brand-sales-summary'){
head='<tr><th>Brand</th><th class="r">Products Sold</th><th class="r">Total Qty</th><th class="r">Revenue</th><th class="r">Avg Rate</th></tr>';
var byBrd={};sales.forEach(function(s){(s.items||[]).forEach(function(it){var pr=rptProducts.find(function(p){return p._key===it.productId});var br=pr?pr.brand||'No Brand':'No Brand';if(!byBrd[br])byBrd[br]={prods:{},qty:0,rev:0};byBrd[br].prods[it.productId||it.productName]=1;byBrd[br].qty+=it.qty||0;byBrd[br].rev+=it.amount||0})});
var gBQ=0,gBR=0;
body=Object.entries(byBrd).sort(function(a,b){return b[1].rev-a[1].rev}).map(function(e){gBQ+=e[1].qty;gBR+=e[1].rev;return'<tr><td class="bold">'+e[0]+'</td><td class="r">'+Object.keys(e[1].prods).length+'</td><td class="r">'+e[1].qty+'</td><td class="r bold">'+fmt(e[1].rev)+'</td><td class="r text-muted">'+fmt(e[1].qty?e[1].rev/e[1].qty:0)+'</td></tr>'}).join('');
body+='<tr style="'+gs+';border-top:3px solid #333"><td class="bold" style="font-size:13px">Grand Total</td><td></td><td class="r bold">'+gBQ+'</td><td class="r bold" style="font-size:14px">'+fmt(gBR)+'</td><td class="r">'+fmt(gBQ?gBR/gBQ:0)+'</td></tr>'}
...
html+='<div class="form-row" style="margin-bottom:14px"><div><div style="font-size:10px;color:var(--muted);text-transform:uppercase;font-weight:700">Salesperson</div><div style="font-weight:600">'+(o.spName||'-')+'</div></div>'+(o.convertedInvoice?'<div><div style="font-size:10px;color:var(--muted);text-transform:uppercase;font-weight:700">Converted Invoice</div><div style="font-weight:600;color:var(--primary)"><span class="doc-link" onclick="previewDoc(&#39;sale&#39;,findSaleKeyByInvoice(&#39;'+o.convertedInvoice+'&#39;));event.stopPropagation()" style="cursor:pointer;text-decoration:underline">'+o.convertedInvoice+'</span></div></div>':'')+'</div>';
...
var acts='';if(o.status==='pending'){acts='<button class="btn btn-success" onclick="approveOrd(&#39;'+o._key+'&#39;);closeModal(&#39;ordDetailModal&#39;)">Approve</button> <button class="btn btn-danger" onclick="denyOrd(&#39;'+o._key+'&#39;);closeModal(&#39;ordDetailModal&#39;)">Deny</button>'}
if(o.status==='approved'){acts='<button class="btn btn-primary" onclick="convertOrd(&#39;'+o._key+'&#39;);closeModal(&#39;ordDetailModal&#39;)">Convert to Invoice</button>'}
...
var sub=items.reduce(function(s,x){return s+(x.amount||0)},0);
var saleData={invoiceNo:txnNo('INV'),date:todayISO(),customerId:o.customerId||'',customerName:o.customerName,salespersonId:o.spId||'',salespersonName:o.spName||'',createdBy:window.SESSION?.name||window.SESSION?.username||'Admin',items:items,discount:0,discountType:'amount',extra:0,vat:0,vatType:'amount',ait:0,aitType:'amount',vatAmount:0,aitAmount:0,total:sub,paid:0,method:'credit',cashAmount:0,bankAmount:0,bankMethod:'',bankName:'',chequeNo:'',note:'From Order: '+o.orderNo,truckFare:0,customerThana:'',fareExceeded:false,fareMaxForThana:0,_orderKey:k};
var saveRes=await saveItem('sale:',saleData,null,'create','Created sale from order: '+o.orderNo+' -> '+saleData.invoiceNo);
...
o.status='converted';o.convertedInvoice=saleData.invoiceNo;await saveByKey(k,cleanForSave(o));invalidateCache('order:');invalidateCache('sale:');invalidateCache('product:');invalidateCache('payment:');invalidateCache('bank:');showToast('Invoice created: '+saleData.invoiceNo+'. Stock deducted.','success');loadOrd()}
...
function renderAppr(){
  ...
  document.getElementById('apprBody').innerHTML=!fl.length?'<tr><td colspan="7" class="empty">No approval requests</td></tr>':fl.map(function(a){
    ...
    var acts='';
    if(a.status==='pending'){acts='<button class="btn btn-success btn-xs" onclick="approveAppr(&#39;'+a._key+'&#39;)">Approve</button> <button class="btn btn-danger btn-xs" onclick="rejectAppr(&#39;'+a._key+'&#39;)">Reject</button> ';}
    acts+='<button class="btn btn-outline btn-xs" onclick="viewApprDetail(&#39;'+a._key+'&#39;)">View</button>';
...
window.viewApprDetail=function(k){
  ...
  var actHtml='';
  if(a.status==='pending'){actHtml='<button class="btn btn-success" onclick="approveAppr(&#39;'+a._key+'&#39;);closeModal(&#39;apprDetailModal&#39;)">Approve</button><button class="btn btn-danger" onclick="rejectAppr(&#39;'+a._key+'&#39;);closeModal(&#39;apprDetailModal&#39;)">Reject</button>';}
  document.getElementById('apprDetailActions').innerHTML=actHtml;
  openModal('apprDetailModal');
};
loadAppr();
<\/script>`}function Tr(){return`
...
loadCS();
<\/script>`}const gt=new Lt,Dr=Object.assign({"/src/index.tsx":h});let te=!1;for(const[,a]of Object.entries(Dr))a&&(gt.all("*",t=>{let e;try{e=t.executionCtx}catch{}return a.fetch(t.req.raw,t.env,e)}),gt.notFound(t=>{let e;try{e=t.executionCtx}catch{}return a.fetch(t.req.raw,t.env,e)}),te=!0);if(!te)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{gt as default};

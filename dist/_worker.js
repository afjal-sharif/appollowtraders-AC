var te=Object.defineProperty;var dt=a=>{throw TypeError(a)};var ee=(a,t,e)=>t in a?te(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var g=(a,t,e)=>ee(a,typeof t!="symbol"?t+"":t,e),Wa=(a,t,e)=>t.has(a)||dt("Cannot "+e);var c=(a,t,e)=>(Wa(a,t,"read from private field"),e?e.call(a):t.get(a)),b=(a,t,e)=>t.has(a)?dt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(Wa(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),S=(a,t,e)=>(Wa(a,t,"access private method"),e);var ct=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return c(a,t,r)}});var pt=(a,t,e)=>(r,i)=>{let n=-1;return s(0);async function s(o){if(o<=n)throw new Error("next() called multiple times");n=o;let l,d=!1,p;if(a[o]?(p=a[o][0][0],r.req.routeIndex=o):p=o===a.length&&i||void 0,p)try{l=await p(r,()=>s(o+1))}catch(u){if(u instanceof Error&&t)r.error=u,l=await t(u,r),d=!0;else throw u}else r.finalized===!1&&e&&(l=await e(r));return l&&(r.finalized===!1||d)&&(r.res=l),r}},re=Symbol(),ne=async(a,t=Object.create(null))=>{const{all:e=!1,dot:r=!1}=t,n=(a instanceof It?a.raw.headers:a.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?ie(a,{all:e,dot:r}):{}};async function ie(a,t){const e=await a.formData();return e?se(e,t):{}}function se(a,t){const e=Object.create(null);return a.forEach((r,i)=>{t.all||i.endsWith("[]")?oe(e,i,r):e[i]=r}),t.dot&&Object.entries(e).forEach(([r,i])=>{r.includes(".")&&(le(e,r,i),delete e[r])}),e}var oe=(a,t,e)=>{a[t]!==void 0?Array.isArray(a[t])?a[t].push(e):a[t]=[a[t],e]:t.endsWith("[]")?a[t]=[e]:a[t]=e},le=(a,t,e)=>{if(/(?:^|\.)__proto__\./.test(t))return;let r=a;const i=t.split(".");i.forEach((n,s)=>{s===i.length-1?r[n]=e:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},St=a=>{const t=a.split("/");return t[0]===""&&t.shift(),t},de=a=>{const{groups:t,path:e}=ce(a),r=St(e);return pe(r,t)},ce=a=>{const t=[];return a=a.replace(/\{[^}]+\}/g,(e,r)=>{const i=`@${r}`;return t.push([i,e]),i}),{groups:t,path:a}},pe=(a,t)=>{for(let e=t.length-1;e>=0;e--){const[r]=t[e];for(let i=a.length-1;i>=0;i--)if(a[i].includes(r)){a[i]=a[i].replace(r,t[e][1]);break}}return a},za={},ue=(a,t)=>{if(a==="*")return"*";const e=a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(e){const r=`${a}#${t}`;return za[r]||(e[2]?za[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,e[1],new RegExp(`^${e[2]}(?=/${t})`)]:[a,e[1],new RegExp(`^${e[2]}$`)]:za[r]=[a,e[1],!0]),za[r]}return null},rt=(a,t)=>{try{return t(a)}catch{return a.replace(/(?:%[0-9A-Fa-f]{2})+/g,e=>{try{return t(e)}catch{return e}})}},he=a=>rt(a,decodeURI),wt=a=>{const t=a.url,e=t.indexOf("/",t.indexOf(":")+4);let r=e;for(;r<t.length;r++){const i=t.charCodeAt(r);if(i===37){const n=t.indexOf("?",r),s=t.indexOf("#",r),o=n===-1?s===-1?void 0:s:s===-1?n:Math.min(n,s),l=t.slice(e,o);return he(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(i===63||i===35)break}return t.slice(e,r)},me=a=>{const t=wt(a);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ha=(a,t,...e)=>(e.length&&(t=ha(t,...e)),`${(a==null?void 0:a[0])==="/"?"":"/"}${a}${t==="/"?"":`${(a==null?void 0:a.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Bt=a=>{if(a.charCodeAt(a.length-1)!==63||!a.includes(":"))return null;const t=a.split("/"),e=[];let r="";return t.forEach(i=>{if(i!==""&&!/\:/.test(i))r+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){e.length===0&&r===""?e.push("/"):e.push(r);const n=i.replace("?","");r+="/"+n,e.push(r)}else r+="/"+i}),e.filter((i,n,s)=>s.indexOf(i)===n)},Za=a=>/[%+]/.test(a)?(a.indexOf("+")!==-1&&(a=a.replace(/\+/g," ")),a.indexOf("%")!==-1?rt(a,Pt):a):a,Ct=(a,t,e)=>{let r;if(!e&&t&&!/[%+]/.test(t)){let s=a.indexOf("?",8);if(s===-1)return;for(a.startsWith(t,s+1)||(s=a.indexOf(`&${t}`,s+1));s!==-1;){const o=a.charCodeAt(s+t.length+1);if(o===61){const l=s+t.length+2,d=a.indexOf("&",l);return Za(a.slice(l,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";s=a.indexOf(`&${t}`,s+1)}if(r=/[%+]/.test(a),!r)return}const i={};r??(r=/[%+]/.test(a));let n=a.indexOf("?",8);for(;n!==-1;){const s=a.indexOf("&",n+1);let o=a.indexOf("=",n);o>s&&s!==-1&&(o=-1);let l=a.slice(n+1,o===-1?s===-1?void 0:s:o);if(r&&(l=Za(l)),n=s,l==="")continue;let d;o===-1?d="":(d=a.slice(o+1,s===-1?void 0:s),r&&(d=Za(d))),e?(i[l]&&Array.isArray(i[l])||(i[l]=[]),i[l].push(d)):i[l]??(i[l]=d)}return t?i[t]:i},ge=Ct,ve=(a,t)=>Ct(a,t,!0),Pt=decodeURIComponent,ut=a=>rt(a,Pt),va,M,q,Et,Tt,tt,U,vt,It=(vt=class{constructor(a,t="/",e=[[]]){b(this,q);g(this,"raw");b(this,va);b(this,M);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});b(this,U,a=>{const{bodyCache:t,raw:e}=this,r=t[a];if(r)return r;const i=Object.keys(t)[0];return i?t[i].then(n=>(i==="json"&&(n=JSON.stringify(n)),new Response(n)[a]())):t[a]=e[a]()});this.raw=a,this.path=t,m(this,M,e),m(this,va,{})}param(a){return a?S(this,q,Et).call(this,a):S(this,q,Tt).call(this)}query(a){return ge(this.url,a)}queries(a){return ve(this.url,a)}header(a){if(a)return this.raw.headers.get(a)??void 0;const t={};return this.raw.headers.forEach((e,r)=>{t[r]=e}),t}async parseBody(a){return ne(this,a)}json(){return c(this,U).call(this,"text").then(a=>JSON.parse(a))}text(){return c(this,U).call(this,"text")}arrayBuffer(){return c(this,U).call(this,"arrayBuffer")}blob(){return c(this,U).call(this,"blob")}formData(){return c(this,U).call(this,"formData")}addValidatedData(a,t){c(this,va)[a]=t}valid(a){return c(this,va)[a]}get url(){return this.raw.url}get method(){return this.raw.method}get[re](){return c(this,M)}get matchedRoutes(){return c(this,M)[0].map(([[,a]])=>a)}get routePath(){return c(this,M)[0].map(([[,a]])=>a)[this.routeIndex].path}},va=new WeakMap,M=new WeakMap,q=new WeakSet,Et=function(a){const t=c(this,M)[0][this.routeIndex][1][a],e=S(this,q,tt).call(this,t);return e&&/\%/.test(e)?ut(e):e},Tt=function(){const a={},t=Object.keys(c(this,M)[0][this.routeIndex][1]);for(const e of t){const r=S(this,q,tt).call(this,c(this,M)[0][this.routeIndex][1][e]);r!==void 0&&(a[e]=/\%/.test(r)?ut(r):r)}return a},tt=function(a){return c(this,M)[1]?c(this,M)[1][a]:a},U=new WeakMap,vt),be={Stringify:1},Dt=async(a,t,e,r,i)=>{typeof a=="object"&&!(a instanceof String)&&(a instanceof Promise||(a=a.toString()),a instanceof Promise&&(a=await a));const n=a.callbacks;return n!=null&&n.length?(i?i[0]+=a:i=[a],Promise.all(n.map(o=>o({phase:t,buffer:i,context:r}))).then(o=>Promise.all(o.filter(Boolean).map(l=>Dt(l,t,!1,r,i))).then(()=>i[0]))):Promise.resolve(a)},fe="text/plain; charset=UTF-8",at=(a,t)=>({"Content-Type":a,...t}),Pa=(a,t)=>new Response(a,t),Ra,Ma,O,ba,z,N,Aa,fa,ya,ea,_a,La,V,ma,bt,ye=(bt=class{constructor(a,t){b(this,V);b(this,Ra);b(this,Ma);g(this,"env",{});b(this,O);g(this,"finalized",!1);g(this,"error");b(this,ba);b(this,z);b(this,N);b(this,Aa);b(this,fa);b(this,ya);b(this,ea);b(this,_a);b(this,La);g(this,"render",(...a)=>(c(this,fa)??m(this,fa,t=>this.html(t)),c(this,fa).call(this,...a)));g(this,"setLayout",a=>m(this,Aa,a));g(this,"getLayout",()=>c(this,Aa));g(this,"setRenderer",a=>{m(this,fa,a)});g(this,"header",(a,t,e)=>{this.finalized&&m(this,N,Pa(c(this,N).body,c(this,N)));const r=c(this,N)?c(this,N).headers:c(this,ea)??m(this,ea,new Headers);t===void 0?r.delete(a):e!=null&&e.append?r.append(a,t):r.set(a,t)});g(this,"status",a=>{m(this,ba,a)});g(this,"set",(a,t)=>{c(this,O)??m(this,O,new Map),c(this,O).set(a,t)});g(this,"get",a=>c(this,O)?c(this,O).get(a):void 0);g(this,"newResponse",(...a)=>S(this,V,ma).call(this,...a));g(this,"body",(a,t,e)=>S(this,V,ma).call(this,a,t,e));g(this,"text",(a,t,e)=>!c(this,ea)&&!c(this,ba)&&!t&&!e&&!this.finalized?new Response(a):S(this,V,ma).call(this,a,t,at(fe,e)));g(this,"json",(a,t,e)=>S(this,V,ma).call(this,JSON.stringify(a),t,at("application/json",e)));g(this,"html",(a,t,e)=>{const r=i=>S(this,V,ma).call(this,i,t,at("text/html; charset=UTF-8",e));return typeof a=="object"?Dt(a,be.Stringify,!1,{}).then(r):r(a)});g(this,"redirect",(a,t)=>{const e=String(a);return this.header("Location",/[^\x00-\xFF]/.test(e)?encodeURI(e):e),this.newResponse(null,t??302)});g(this,"notFound",()=>(c(this,ya)??m(this,ya,()=>Pa()),c(this,ya).call(this,this)));m(this,Ra,a),t&&(m(this,z,t.executionCtx),this.env=t.env,m(this,ya,t.notFoundHandler),m(this,La,t.path),m(this,_a,t.matchResult))}get req(){return c(this,Ma)??m(this,Ma,new It(c(this,Ra),c(this,La),c(this,_a))),c(this,Ma)}get event(){if(c(this,z)&&"respondWith"in c(this,z))return c(this,z);throw Error("This context has no FetchEvent")}get executionCtx(){if(c(this,z))return c(this,z);throw Error("This context has no ExecutionContext")}get res(){return c(this,N)||m(this,N,Pa(null,{headers:c(this,ea)??m(this,ea,new Headers)}))}set res(a){if(c(this,N)&&a){a=Pa(a.body,a);for(const[t,e]of c(this,N).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=c(this,N).headers.getSetCookie();a.headers.delete("set-cookie");for(const i of r)a.headers.append("set-cookie",i)}else a.headers.set(t,e)}m(this,N,a),this.finalized=!0}get var(){return c(this,O)?Object.fromEntries(c(this,O)):{}}},Ra=new WeakMap,Ma=new WeakMap,O=new WeakMap,ba=new WeakMap,z=new WeakMap,N=new WeakMap,Aa=new WeakMap,fa=new WeakMap,ya=new WeakMap,ea=new WeakMap,_a=new WeakMap,La=new WeakMap,V=new WeakSet,ma=function(a,t,e){const r=c(this,N)?new Headers(c(this,N).headers):c(this,ea)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[s,o]of n)s.toLowerCase()==="set-cookie"?r.append(s,o):r.set(s,o)}if(e)for(const[n,s]of Object.entries(e))if(typeof s=="string")r.set(n,s);else{r.delete(n);for(const o of s)r.append(n,o)}const i=typeof t=="number"?t:(t==null?void 0:t.status)??c(this,ba);return Pa(a,{status:i,headers:r})},bt),I="ALL",xe="all",ke=["get","post","put","delete","options","patch"],jt="Can not add a route since the matcher is already built.",Nt=class extends Error{},Se="__COMPOSED_HANDLER",we=a=>a.text("404 Not Found",404),ht=(a,t)=>{if("getResponse"in a){const e=a.getResponse();return t.newResponse(e.body,e)}return console.error(a),t.text("Internal Server Error",500)},A,E,Rt,_,aa,Ha,Ga,xa,Be=(xa=class{constructor(t={}){b(this,E);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");b(this,A,"/");g(this,"routes",[]);b(this,_,we);g(this,"errorHandler",ht);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(m(this,_,t),this));g(this,"fetch",(t,...e)=>S(this,E,Ga).call(this,t,e[1],e[0],t.method));g(this,"request",(t,e,r,i)=>t instanceof Request?this.fetch(e?new Request(t,e):t,r,i):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ha("/",t)}`,e),r,i)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(S(this,E,Ga).call(this,t.request,t,void 0,t.request.method))})});[...ke,xe].forEach(n=>{this[n]=(s,...o)=>(typeof s=="string"?m(this,A,s):S(this,E,aa).call(this,n,c(this,A),s),o.forEach(l=>{S(this,E,aa).call(this,n,c(this,A),l)}),this)}),this.on=(n,s,...o)=>{for(const l of[s].flat()){m(this,A,l);for(const d of[n].flat())o.map(p=>{S(this,E,aa).call(this,d.toUpperCase(),c(this,A),p)})}return this},this.use=(n,...s)=>(typeof n=="string"?m(this,A,n):(m(this,A,"*"),s.unshift(n)),s.forEach(o=>{S(this,E,aa).call(this,I,c(this,A),o)}),this);const{strict:r,...i}=t;Object.assign(this,i),this.getPath=r??!0?t.getPath??wt:me}route(t,e){const r=this.basePath(t);return e.routes.map(i=>{var s;let n;e.errorHandler===ht?n=i.handler:(n=async(o,l)=>(await pt([],e.errorHandler)(o,()=>i.handler(o,l))).res,n[Se]=i.handler),S(s=r,E,aa).call(s,i.method,i.path,n)}),this}basePath(t){const e=S(this,E,Rt).call(this);return e._basePath=ha(this._basePath,t),e}mount(t,e,r){let i,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?i=l=>l:i=r.replaceRequest));const s=n?l=>{const d=n(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};i||(i=(()=>{const l=ha(this._basePath,t),d=l==="/"?0:l.length;return p=>{const u=new URL(p.url);return u.pathname=u.pathname.slice(d)||"/",new Request(u,p)}})());const o=async(l,d)=>{const p=await e(i(l.req.raw),...s(l));if(p)return p;await d()};return S(this,E,aa).call(this,I,ha(t,"*"),o),this}},A=new WeakMap,E=new WeakSet,Rt=function(){const t=new xa({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,m(t,_,c(this,_)),t.routes=this.routes,t},_=new WeakMap,aa=function(t,e,r){t=t.toUpperCase(),e=ha(this._basePath,e);const i={basePath:this._basePath,path:e,method:t,handler:r};this.router.add(t,e,[r,i]),this.routes.push(i)},Ha=function(t,e){if(t instanceof Error)return this.errorHandler(t,e);throw t},Ga=function(t,e,r,i){if(i==="HEAD")return(async()=>new Response(null,await S(this,E,Ga).call(this,t,e,r,"GET")))();const n=this.getPath(t,{env:r}),s=this.router.match(i,n),o=new ye(t,{path:n,matchResult:s,env:r,executionCtx:e,notFoundHandler:c(this,_)});if(s[0].length===1){let d;try{d=s[0][0][0][0](o,async()=>{o.res=await c(this,_).call(this,o)})}catch(p){return S(this,E,Ha).call(this,p,o)}return d instanceof Promise?d.then(p=>p||(o.finalized?o.res:c(this,_).call(this,o))).catch(p=>S(this,E,Ha).call(this,p,o)):d??c(this,_).call(this,o)}const l=pt(s[0],this.errorHandler,c(this,_));return(async()=>{try{const d=await l(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return S(this,E,Ha).call(this,d,o)}})()},xa),Mt=[];function Ce(a,t){const e=this.buildAllMatchers(),r=((i,n)=>{const s=e[i]||e[I],o=s[2][n];if(o)return o;const l=n.match(s[0]);if(!l)return[[],Mt];const d=l.indexOf("",1);return[s[1][d],l]});return this.match=r,r(a,t)}var Ja="[^/]+",Ea=".*",Ta="(?:|/.*)",ga=Symbol(),Pe=new Set(".\\+*[^]$()");function Ie(a,t){return a.length===1?t.length===1?a<t?-1:1:-1:t.length===1||a===Ea||a===Ta?1:t===Ea||t===Ta?-1:a===Ja?1:t===Ja?-1:a.length===t.length?a<t?-1:1:t.length-a.length}var ra,na,L,oa,Ee=(oa=class{constructor(){b(this,ra);b(this,na);b(this,L,Object.create(null))}insert(t,e,r,i,n){if(t.length===0){if(c(this,ra)!==void 0)throw ga;if(n)return;m(this,ra,e);return}const[s,...o]=t,l=s==="*"?o.length===0?["","",Ea]:["","",Ja]:s==="/*"?["","",Ta]:s.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const p=l[1];let u=l[2]||Ja;if(p&&l[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ga;if(d=c(this,L)[u],!d){if(Object.keys(c(this,L)).some(v=>v!==Ea&&v!==Ta))throw ga;if(n)return;d=c(this,L)[u]=new oa,p!==""&&m(d,na,i.varIndex++)}!n&&p!==""&&r.push([p,c(d,na)])}else if(d=c(this,L)[s],!d){if(Object.keys(c(this,L)).some(p=>p.length>1&&p!==Ea&&p!==Ta))throw ga;if(n)return;d=c(this,L)[s]=new oa}d.insert(o,e,r,i,n)}buildRegExpStr(){const e=Object.keys(c(this,L)).sort(Ie).map(r=>{const i=c(this,L)[r];return(typeof c(i,na)=="number"?`(${r})@${c(i,na)}`:Pe.has(r)?`\\${r}`:r)+i.buildRegExpStr()});return typeof c(this,ra)=="number"&&e.unshift(`#${c(this,ra)}`),e.length===0?"":e.length===1?e[0]:"(?:"+e.join("|")+")"}},ra=new WeakMap,na=new WeakMap,L=new WeakMap,oa),Va,Ka,ft,Te=(ft=class{constructor(){b(this,Va,{varIndex:0});b(this,Ka,new Ee)}insert(a,t,e){const r=[],i=[];for(let s=0;;){let o=!1;if(a=a.replace(/\{[^}]+\}/g,l=>{const d=`@\\${s}`;return i[s]=[d,l],s++,o=!0,d}),!o)break}const n=a.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let s=i.length-1;s>=0;s--){const[o]=i[s];for(let l=n.length-1;l>=0;l--)if(n[l].indexOf(o)!==-1){n[l]=n[l].replace(o,i[s][1]);break}}return c(this,Ka).insert(n,t,r,c(this,Va),e),r}buildRegExp(){let a=c(this,Ka).buildRegExpStr();if(a==="")return[/^$/,[],[]];let t=0;const e=[],r=[];return a=a.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,n,s)=>n!==void 0?(e[++t]=Number(n),"$()"):(s!==void 0&&(r[Number(s)]=++t),"")),[new RegExp(`^${a}`),e,r]}},Va=new WeakMap,Ka=new WeakMap,ft),De=[/^$/,[],Object.create(null)],qa=Object.create(null);function At(a){return qa[a]??(qa[a]=new RegExp(a==="*"?"":`^${a.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,e)=>e?`\\${e}`:"(?:|/.*)")}$`))}function je(){qa=Object.create(null)}function Ne(a){var d;const t=new Te,e=[];if(a.length===0)return De;const r=a.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,u],[v,x])=>p?1:v?-1:u.length-x.length),i=Object.create(null);for(let p=0,u=-1,v=r.length;p<v;p++){const[x,w,C]=r[p];x?i[w]=[C.map(([D])=>[D,Object.create(null)]),Mt]:u++;let P;try{P=t.insert(w,u,x)}catch(D){throw D===ga?new Nt(w):D}x||(e[u]=C.map(([D,y])=>{const R=Object.create(null);for(y-=1;y>=0;y--){const[J,W]=P[y];R[J]=W}return[D,R]}))}const[n,s,o]=t.buildRegExp();for(let p=0,u=e.length;p<u;p++)for(let v=0,x=e[p].length;v<x;v++){const w=(d=e[p][v])==null?void 0:d[1];if(!w)continue;const C=Object.keys(w);for(let P=0,D=C.length;P<D;P++)w[C[P]]=o[w[C[P]]]}const l=[];for(const p in s)l[p]=e[s[p]];return[n,l,i]}function pa(a,t){if(a){for(const e of Object.keys(a).sort((r,i)=>i.length-r.length))if(At(e).test(t))return[...a[e]]}}var Q,X,Qa,_t,yt,Re=(yt=class{constructor(){b(this,Qa);g(this,"name","RegExpRouter");b(this,Q);b(this,X);g(this,"match",Ce);m(this,Q,{[I]:Object.create(null)}),m(this,X,{[I]:Object.create(null)})}add(a,t,e){var o;const r=c(this,Q),i=c(this,X);if(!r||!i)throw new Error(jt);r[a]||[r,i].forEach(l=>{l[a]=Object.create(null),Object.keys(l[I]).forEach(d=>{l[a][d]=[...l[I][d]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=At(t);a===I?Object.keys(r).forEach(d=>{var p;(p=r[d])[t]||(p[t]=pa(r[d],t)||pa(r[I],t)||[])}):(o=r[a])[t]||(o[t]=pa(r[a],t)||pa(r[I],t)||[]),Object.keys(r).forEach(d=>{(a===I||a===d)&&Object.keys(r[d]).forEach(p=>{l.test(p)&&r[d][p].push([e,n])})}),Object.keys(i).forEach(d=>{(a===I||a===d)&&Object.keys(i[d]).forEach(p=>l.test(p)&&i[d][p].push([e,n]))});return}const s=Bt(t)||[t];for(let l=0,d=s.length;l<d;l++){const p=s[l];Object.keys(i).forEach(u=>{var v;(a===I||a===u)&&((v=i[u])[p]||(v[p]=[...pa(r[u],p)||pa(r[I],p)||[]]),i[u][p].push([e,n-d+l+1]))})}}buildAllMatchers(){const a=Object.create(null);return Object.keys(c(this,X)).concat(Object.keys(c(this,Q))).forEach(t=>{a[t]||(a[t]=S(this,Qa,_t).call(this,t))}),m(this,Q,m(this,X,void 0)),je(),a}},Q=new WeakMap,X=new WeakMap,Qa=new WeakSet,_t=function(a){const t=[];let e=a===I;return[c(this,Q),c(this,X)].forEach(r=>{const i=r[a]?Object.keys(r[a]).map(n=>[n,r[a][n]]):[];i.length!==0?(e||(e=!0),t.push(...i)):a!==I&&t.push(...Object.keys(r[I]).map(n=>[n,r[I][n]]))}),e?Ne(t):null},yt),$,H,xt,Me=(xt=class{constructor(a){g(this,"name","SmartRouter");b(this,$,[]);b(this,H,[]);m(this,$,a.routers)}add(a,t,e){if(!c(this,H))throw new Error(jt);c(this,H).push([a,t,e])}match(a,t){if(!c(this,H))throw new Error("Fatal error");const e=c(this,$),r=c(this,H),i=e.length;let n=0,s;for(;n<i;n++){const o=e[n];try{for(let l=0,d=r.length;l<d;l++)o.add(...r[l]);s=o.match(a,t)}catch(l){if(l instanceof Nt)continue;throw l}this.match=o.match.bind(o),m(this,$,[o]),m(this,H,void 0);break}if(n===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,s}get activeRouter(){if(c(this,H)||c(this,$).length!==1)throw new Error("No active router has been determined yet.");return c(this,$)[0]}},$=new WeakMap,H=new WeakMap,xt),Ia=Object.create(null),Ae=a=>{for(const t in a)return!0;return!1},Y,j,ia,ka,T,G,ta,Sa,_e=(Sa=class{constructor(t,e,r){b(this,G);b(this,Y);b(this,j);b(this,ia);b(this,ka,0);b(this,T,Ia);if(m(this,j,r||Object.create(null)),m(this,Y,[]),t&&e){const i=Object.create(null);i[t]={handler:e,possibleKeys:[],score:0},m(this,Y,[i])}m(this,ia,[])}insert(t,e,r){m(this,ka,++ct(this,ka)._);let i=this;const n=de(e),s=[];for(let o=0,l=n.length;o<l;o++){const d=n[o],p=n[o+1],u=ue(d,p),v=Array.isArray(u)?u[0]:d;if(v in c(i,j)){i=c(i,j)[v],u&&s.push(u[1]);continue}c(i,j)[v]=new Sa,u&&(c(i,ia).push(u),s.push(u[1])),i=c(i,j)[v]}return c(i,Y).push({[t]:{handler:r,possibleKeys:s.filter((o,l,d)=>d.indexOf(o)===l),score:c(this,ka)}}),i}search(t,e){var p;const r=[];m(this,T,Ia);let n=[this];const s=St(e),o=[],l=s.length;let d=null;for(let u=0;u<l;u++){const v=s[u],x=u===l-1,w=[];for(let P=0,D=n.length;P<D;P++){const y=n[P],R=c(y,j)[v];R&&(m(R,T,c(y,T)),x?(c(R,j)["*"]&&S(this,G,ta).call(this,r,c(R,j)["*"],t,c(y,T)),S(this,G,ta).call(this,r,R,t,c(y,T))):w.push(R));for(let J=0,W=c(y,ia).length;J<W;J++){const Oa=c(y,ia)[J],K=c(y,T)===Ia?{}:{...c(y,T)};if(Oa==="*"){const da=c(y,j)["*"];da&&(S(this,G,ta).call(this,r,da,t,c(y,T)),m(da,T,K),w.push(da));continue}const[$a,Z,Ba]=Oa;if(!v&&!(Ba instanceof RegExp))continue;const F=c(y,j)[$a];if(Ba instanceof RegExp){if(d===null){d=new Array(l);let ca=e[0]==="/"?1:0;for(let Ca=0;Ca<l;Ca++)d[Ca]=ca,ca+=s[Ca].length+1}const da=e.substring(d[u]),Ya=Ba.exec(da);if(Ya){if(K[Z]=Ya[0],S(this,G,ta).call(this,r,F,t,c(y,T),K),Ae(c(F,j))){m(F,T,K);const ca=((p=Ya[0].match(/\//))==null?void 0:p.length)??0;(o[ca]||(o[ca]=[])).push(F)}continue}}(Ba===!0||Ba.test(v))&&(K[Z]=v,x?(S(this,G,ta).call(this,r,F,t,K,c(y,T)),c(F,j)["*"]&&S(this,G,ta).call(this,r,c(F,j)["*"],t,K,c(y,T))):(m(F,T,K),w.push(F)))}}const C=o.shift();n=C?w.concat(C):w}return r.length>1&&r.sort((u,v)=>u.score-v.score),[r.map(({handler:u,params:v})=>[u,v])]}},Y=new WeakMap,j=new WeakMap,ia=new WeakMap,ka=new WeakMap,T=new WeakMap,G=new WeakSet,ta=function(t,e,r,i,n){for(let s=0,o=c(e,Y).length;s<o;s++){const l=c(e,Y)[s],d=l[r]||l[I],p={};if(d!==void 0&&(d.params=Object.create(null),t.push(d),i!==Ia||n&&n!==Ia))for(let u=0,v=d.possibleKeys.length;u<v;u++){const x=d.possibleKeys[u],w=p[d.score];d.params[x]=n!=null&&n[x]&&!w?n[x]:i[x]??(n==null?void 0:n[x]),p[d.score]=!0}}},Sa),sa,kt,Le=(kt=class{constructor(){g(this,"name","TrieRouter");b(this,sa);m(this,sa,new _e)}add(a,t,e){const r=Bt(t);if(r){for(let i=0,n=r.length;i<n;i++)c(this,sa).insert(a,r[i],e);return}c(this,sa).insert(a,t,e)}match(a,t){return c(this,sa).search(a,t)}},sa=new WeakMap,kt),Lt=class extends Be{constructor(a={}){super(a),this.router=a.router??new Me({routers:[new Re,new Le]})}};const la={"product:":"products","party:":"parties","sale:":"sales","purchase:":"purchases","payment:":"payments","expense:":"expenses","exphead:":"exp_heads","expsubhead:":"exp_subheads","bank:":"banks","cb:":"cb","user:":"users","order:":"orders","salesperson:":"salespersons","creditlimit:":"credit_limits","prodgroup:":"prod_groups","prodbrand:":"prod_brands","modlog:":"mod_logs","approval:":"approvals","thanafare:":"thana_fares"},nt={sales:"sale_items",purchases:"purchase_items",orders:"order_items"},Kt={products:{purchasePrice:"purchase_price",salePrice:"sale_price",extraData:"extra_data"},parties:{postOffice:"post_office",openingBalance:"opening_balance",creditLimit:"credit_limit",salespersonId:"salesperson_id",salespersonName:"salesperson_name",extraData:"extra_data"},sales:{invoiceNo:"invoice_no",customerId:"customer_id",customerName:"customer_name",salespersonId:"salesperson_id",salespersonName:"salesperson_name",bankName:"bank_name",discountType:"discount_type",vatType:"vat_type",vatAmount:"vat_amount",aitType:"ait_type",aitAmount:"ait_amount",truckFare:"truck_fare",customerThana:"customer_thana",createdBy:"created_by",extraData:"extra_data"},purchases:{purchaseNo:"purchase_no",supplierId:"supplier_id",supplierName:"supplier_name",bankName:"bank_name",vatType:"vat_type",extraData:"extra_data"},payments:{bankName:"bank_name",chequeNo:"cheque_no",fromAcc:"from_acc",toAcc:"to_acc",autoInvoice:"auto_invoice",isTruckFare:"is_truck_fare",billKeys:"bill_keys",extraData:"extra_data",_autoInvoice:"auto_invoice",_isTruckFare:"is_truck_fare"},expenses:{expenseNo:"expense_no",headName:"head_name",subHeadName:"sub_head_name",bankName:"bank_name",isTruckFare:"is_truck_fare",_isTruckFare:"is_truck_fare",extraData:"extra_data"},orders:{orderNo:"order_no",customerId:"customer_id",customerName:"customer_name",spId:"sp_id",spName:"sp_name",spCode:"sp_code",convertedInvoice:"converted_invoice",extraData:"extra_data"},salespersons:{extraData:"extra_data"},banks:{accountNo:"account_no",openingBalance:"opening_balance",extraData:"extra_data"},users:{extraData:"extra_data"},approvals:{targetKey:"target_key",newData:"new_data",oldData:"old_data",requestedBy:"requested_by",requestedAt:"requested_at",processedBy:"processed_by",processedAt:"processed_at",extraData:"extra_data"},mod_logs:{oldData:"old_data",extraData:"extra_data"},exp_heads:{},exp_subheads:{headId:"head_id",headName:"head_name"},credit_limits:{partyId:"party_id",partyName:"party_name",extraData:"extra_data"},thana_fares:{maxFare:"max_fare",extraData:"extra_data"},cb:{openingBalance:"opening_balance",extraData:"extra_data"},prod_groups:{},prod_brands:{}},Ft={sale_items:{saleId:"sale_id",productId:"product_id",productName:"product_name",extraData:"extra_data"},purchase_items:{purchaseId:"purchase_id",productId:"product_id",productName:"product_name",extraData:"extra_data"},order_items:{orderId:"order_id",productKey:"product_key",productName:"product_name",extraData:"extra_data"}};function Ot(a){return{products:["id","name","sku","unit",'"group"',"brand","purchase_price","sale_price","stock","extra_data","created_at","updated_at"],parties:["id","name","type","phone","address","division","district","thana","post_office","postcode","opening_balance","credit_limit","salesperson_id","salesperson_name","extra_data","created_at","updated_at"],salespersons:["id","name","code","pin","phone","active","extra_data","created_at","updated_at"],banks:["id","name","account_no","opening_balance","balance","extra_data","created_at","updated_at"],sales:["id","invoice_no","date","customer_id","customer_name","salesperson_id","salesperson_name","method","bank_name","discount","discount_type","extra","vat","vat_type","vat_amount","ait","ait_type","ait_amount","truck_fare","total","paid","note","customer_thana","created_by","extra_data","created_at","updated_at"],sale_items:["sale_id","product_id","product_name","qty","rate","amount","extra_data"],purchases:["id","purchase_no","date","supplier_id","supplier_name","method","bank_name","discount","extra","vat","vat_type","total","paid","note","extra_data","created_at","updated_at"],purchase_items:["purchase_id","product_id","product_name","qty","rate","amount","extra_data"],payments:["id",'"no"',"date","type","party","method","bank_name","amount","note","cheque_no","status","from_acc","to_acc","auto_invoice","is_truck_fare","bill_keys","extra_data","created_at","updated_at"],expenses:["id","expense_no","date","head_name","sub_head_name","method","bank_name","amount","description","is_truck_fare","extra_data","created_at","updated_at"],exp_heads:["id","name","created_at"],exp_subheads:["id","name","head_id","head_name","created_at"],orders:["id","order_no","date","customer_id","customer_name","sp_id","sp_name","sp_code","total","status","converted_invoice","note","extra_data","created_at","updated_at"],order_items:["order_id","product_key","product_name","qty","rate","amount","extra_data"],users:["id","username","password","name","role","active","extra_data","created_at","updated_at"],approvals:["id","type","target_key","prefix","new_data","old_data","detail","requested_by","requested_at","status","processed_by","processed_at","extra_data","created_at"],mod_logs:["id","action","detail","key","prefix","old_data",'"user"',"timestamp","extra_data"],credit_limits:["id","party_id","party_name","amount","extra_data","created_at"],thana_fares:["id","thana","district","division","max_fare","extra_data","created_at","updated_at"],cb:["id","opening_balance","extra_data","created_at"],prod_groups:["id","name","created_at","updated_at"],prod_brands:["id","name","created_at","updated_at"]}[a]||[]}function it(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function Ke(a,t){const e=Kt[a];return e&&e[t]?e[t]:t}function Fe(a,t){const e=Ft[a];return e&&e[t]?e[t]:t}function Oe(a,t){const r=Ot(a).map(s=>s.replace(/"/g,"")),i={},n={};for(const[s,o]of Object.entries(t)){if(s==="_key"||s==="_items")continue;const l=Ke(a,s);r.includes(l)?typeof o=="object"&&o!==null?i[l]=JSON.stringify(o):i[l]=o:n[s]=o}if(Object.keys(n).length>0){let s={};if(i.extra_data&&typeof i.extra_data=="string")try{s=JSON.parse(i.extra_data)}catch{}i.extra_data=JSON.stringify({...s,...n})}return i}function ze(a,t,e){const i=Ot(a).map(o=>o.replace(/"/g,"")),n={},s={};a==="sale_items"?n.sale_id=e:a==="purchase_items"?n.purchase_id=e:a==="order_items"&&(n.order_id=e);for(const[o,l]of Object.entries(t)){if(o==="_key")continue;const d=Fe(a,o);i.includes(d)?typeof l=="object"&&l!==null?n[d]=JSON.stringify(l):n[d]=l:s[o]=l}return Object.keys(s).length>0&&(n.extra_data=JSON.stringify(s)),n}function zt(a,t,e){const r=t.id,i={_key:e+r},n={},s=Kt[a]||{};for(const[o,l]of Object.entries(s))n[l]=o;for(const[o,l]of Object.entries(t)){if(o==="id"||o==="created_at"||o==="updated_at")continue;const d=n[o]||o;if(o==="extra_data"&&typeof l=="string"&&l!=="{}"){try{const p=JSON.parse(l);Object.assign(i,p)}catch{}continue}if(o==="bill_keys"&&typeof l=="string"){try{i[d]=JSON.parse(l)}catch{i[d]=l}continue}if(o==="new_data"||o==="old_data"){if(typeof l=="string")try{i[d]=JSON.parse(l)}catch{i[d]=l}else i[d]=l;continue}i[d]=l}return i}function He(a){const t=Ft[a]||{},e={};for(const[r,i]of Object.entries(t))e[i]=r;return e}function Ht(a,t){const e=t?He(t):{};return a.map(r=>{const i={};for(const[n,s]of Object.entries(r)){if(n==="id"||n==="extra_data"||n==="sale_id"||n==="purchase_id"||n==="order_id")continue;const o=e[n]||n;i[o]=s}if(r.extra_data&&typeof r.extra_data=="string"&&r.extra_data!=="{}")try{Object.assign(i,JSON.parse(r.extra_data))}catch{}return i})}async function Gt(a,t){const e=la[t];if(!e)return[];const r=e==="mod_logs"?"timestamp":"created_at",i=a.prepare(`SELECT * FROM ${e} ORDER BY ${r} DESC`),{results:n}=await i.all(),s=n.map(l=>zt(e,l,t)),o=nt[e];if(o&&n.length>0){const l=n.map(w=>w.id),d=l.map(()=>"?").join(","),p=o==="sale_items"?"sale_id":o==="purchase_items"?"purchase_id":"order_id",u=a.prepare(`SELECT * FROM ${o} WHERE ${p} IN (${d})`).bind(...l),{results:v}=await u.all(),x={};for(const w of v){const C=w[p];x[C]||(x[C]=[]),x[C].push(w)}for(const w of s){const P=w._key.replace(t,""),D=x[P]||[];D.length>0&&(w.items=Ht(D,o))}}return s}async function Da(a,t){const e=t.indexOf(":");if(e===-1)return null;const r=t.substring(0,e+1),i=t.substring(e+1),n=la[r];if(!n)return null;const o=await a.prepare(`SELECT * FROM ${n} WHERE id = ?`).bind(i).first();if(!o)return null;const l=zt(n,o,r),d=nt[n];if(d){const p=d==="sale_items"?"sale_id":d==="purchase_items"?"purchase_id":"order_id",u=a.prepare(`SELECT * FROM ${d} WHERE ${p} = ?`).bind(i),{results:v}=await u.all();v.length>0&&(l.items=Ht(v,d))}return delete l._key,l}async function st(a,t,e,r){const i=la[t];if(!i)throw new Error(`Unknown prefix: ${t}`);let n;r?n=r.startsWith(t)?r.substring(t.length):r:n=it();const s=new Date().toISOString(),o=Oe(i,e);o.id=n,["products","parties","salespersons","banks","sales","purchases","payments","expenses","orders","users","thana_fares","prod_groups","prod_brands"].includes(i)&&(o.updated_at=s),r||(i==="mod_logs"?o.timestamp=o.timestamp||s:o.created_at=s);const d=Object.keys(o),p=d.map(y=>y==="group"?'"group"':y==="no"?'"no"':y==="user"?'"user"':y),u=d.map(()=>"?").join(", "),v=d.filter(y=>y!=="id"&&y!=="created_at").map(y=>{const R=y==="group"?'"group"':y==="no"?'"no"':y==="user"?'"user"':y;return`${R} = excluded.${R}`}).join(", "),x=`INSERT INTO ${i} (${p.join(", ")}) VALUES (${u})
    ON CONFLICT(id) DO UPDATE SET ${v}`,w=d.map(y=>o[y]??null),C=[a.prepare(x).bind(...w)],P=nt[i],D=e.items||e._items;if(P&&Array.isArray(D)){const y=P==="sale_items"?"sale_id":P==="purchase_items"?"purchase_id":"order_id";C.push(a.prepare(`DELETE FROM ${P} WHERE ${y} = ?`).bind(n));for(const R of D){const J=ze(P,R,n),W=Object.keys(J),Oa=W.map(Z=>Z==="no"?'"no"':Z),K=W.map(()=>"?").join(", "),$a=W.map(Z=>J[Z]??null);C.push(a.prepare(`INSERT INTO ${P} (${Oa.join(", ")}) VALUES (${K})`).bind(...$a))}}return await a.batch(C),t+n}async function ot(a,t){const e=t.indexOf(":");if(e===-1)return;const r=t.substring(0,e+1),i=t.substring(e+1),n=la[r];n&&await a.prepare(`DELETE FROM ${n} WHERE id = ?`).bind(i).run()}async function Ua(a,t,e,r,i,n,s){const o=it(),l=new Date().toISOString();await a.prepare('INSERT INTO mod_logs (id, action, detail, key, prefix, old_data, "user", timestamp) VALUES (?, ?, ?, ?, ?, ?, ?, ?)').bind(o,t,e,r,i,s||"",n,l).run()}async function qt(a,t,e,r,i,n,s,o){const l=it(),d=new Date().toISOString();return await a.prepare("INSERT INTO approvals (id, type, target_key, prefix, new_data, old_data, detail, requested_by, requested_at, status, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending', ?)").bind(l,t,e,r,JSON.stringify(i),JSON.stringify(n),s,o,d,d).run(),"approval:"+l}async function Ge(a,t,e,r){const i=t.startsWith("approval:")?t.substring(9):t,n=await a.prepare("SELECT * FROM approvals WHERE id = ?").bind(i).first();if(!n)return{success:!1,error:"Approval not found"};if(n.status!=="pending")return{success:!1,error:"Already processed"};const s=new Date().toISOString(),o=e==="approve"?"approved":"rejected";if(e==="approve"){const l=n.target_key,d=n.prefix,p=n.type,u=n.requested_by;if(p==="edit"&&n.new_data){const v=typeof n.new_data=="string"?JSON.parse(n.new_data):n.new_data;await st(a,d,v,l),await Ua(a,"edit",`Approved edit by ${u}: ${n.detail}`,l,d,r)}else p==="delete"&&(await ot(a,l),await Ua(a,"delete",`Approved delete by ${u}: ${n.detail}`,l,d,r))}return await a.prepare("UPDATE approvals SET status = ?, processed_by = ?, processed_at = ? WHERE id = ?").bind(o,r,s,i).run(),{success:!0,status:o}}async function qe(a){const t={};for(const[e]of Object.entries(la))t[e]=await Gt(a,e);return t}async function Je(a,t){let e=0;for(const[r,i]of Object.entries(t))if(!(!Array.isArray(i)||!la[r]))for(const s of i){const o=s._key,l={...s};delete l._key,await st(a,r,l,o),e++}return e}async function Ue(a,t,e=100){const r=la[t];if(!r)return[];const i=r==="mod_logs"?"timestamp":"created_at",{results:n}=await a.prepare(`SELECT id FROM ${r} ORDER BY ${i} DESC LIMIT ?`).bind(e).all();return n.map(s=>t+s.id)}const Ve={"product:":300,"party:":300,"prodgroup:":600,"prodbrand:":600,"salesperson:":300,"bank:":300,"exphead:":600,"expsubhead:":600,"thanafare:":600,"creditlimit:":300,"cb:":300,"user:":120,"sale:":60,"purchase:":60,"payment:":60,"expense:":60,"order:":60,"modlog:":120,"approval:":30},Xa="cache:",Qe=2*1024*1024;async function Xe(a,t){if(!a)return null;try{const e=Xa+t,r=await a.get(e);return r?JSON.parse(r):null}catch{return null}}async function $e(a,t,e){if(a)try{const r=JSON.stringify(e);if(r.length>Qe)return;const i=Ve[t]||60;await a.put(Xa+t,r,{expirationTtl:i})}catch{}}async function ja(a,...t){if(a)try{await Promise.all(t.map(e=>a.delete(Xa+e)))}catch{}}async function Jt(a){if(a)try{let t;const e=[];do{const r=await a.list({prefix:Xa,cursor:t,limit:1e3});e.push(...r.keys.map(i=>i.name)),t=r.list_complete?void 0:r.cursor}while(t);await Promise.all(e.map(r=>a.delete(r)))}catch{}}async function Ut(a){return a?a.get("APP_LICENSE"):null}async function Ye(a,t){a&&await a.put("APP_LICENSE",t)}async function Vt(a){return a?a.get("APP_PIN"):null}async function We(a,t){a&&await a.put("APP_PIN",t)}async function Qt(a){if(!a)return null;const t=await a.get("COMPANY_SETTINGS");if(!t)return null;try{return JSON.parse(t)}catch{return null}}async function Xt(a,t){a&&await a.put("COMPANY_SETTINGS",JSON.stringify(t))}async function Ze(a,t,e){const r=await Xe(a,e);if(r!==null)return r;const i=await t(e);return await $e(a,e,i),i}function lt(a){return{"sale:":["sale:","product:"],"purchase:":["purchase:","product:"],"payment:":["payment:"],"expense:":["expense:"],"order:":["order:"],"product:":["product:"],"party:":["party:"]}[a]||[a]}const h=new Lt;let $t="1234";const Yt="4321",Wt="2028-12-31";function ar(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function ua(a){return String(a).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function wa(a,t){return a.DB?Ze(a.DATA_STORE,e=>Gt(a.DB,e),t):[]}function f(a){return new Response(a,{headers:{"content-type":"text/html;charset=UTF-8","Cache-Control":"no-store, no-cache, must-revalidate, proxy-revalidate",Pragma:"no-cache",Expires:"0"}})}h.post("/login",async a=>{const t=await a.req.formData(),e=t.get("pin"),r=await Vt(a.env.DATA_STORE)||$t,i=(t.get("username")||"").trim(),n=await wa(a.env,"user:");if(n.length>0&&i){const s=n.find(o=>o.username===i&&o.password===e&&o.active!==!1);if(s){const o=encodeURIComponent(JSON.stringify({auth:1,userId:s._key,username:s.username,role:s.role,name:s.name}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${o}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Na("Invalid credentials",n.length>0))}if(e===r){const s=encodeURIComponent(JSON.stringify({auth:1,userId:"admin",username:"admin",role:"admin",name:"Administrator"}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${s}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return f(Na("Wrong PIN",n.length>0))});h.get("/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"session=; Path=/; HttpOnly; Max-Age=0; SameSite=Strict",Location:"/login","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache","Clear-Site-Data":'"cache"'}}));function k(a){const e=(a.req.header("Cookie")||"").match(/session=([^;]+)/);if(!e)return null;try{return JSON.parse(decodeURIComponent(e[1]))}catch{return null}}h.use("*",async(a,t)=>{const e=new URL(a.req.url).pathname;if(e==="/login"&&a.req.method==="GET"){const d=await wa(a.env,"user:");return f(Na("",d.length>0))}if(e==="/api/company-settings"&&a.req.method==="GET"){await t();return}if(!(new URL(a.req.url).searchParams.get("master")===Yt)){const d=new Date().toISOString().slice(0,10);if(d>Wt)return f(mt());{const p=await Ut(a.env.DATA_STORE);if(p&&d>p)return f(mt())}}if(e.startsWith("/sp-portal")){const p=(a.req.header("Cookie")||"").match(/sp_session=([^;]+)/);if(e==="/sp-portal/login"&&a.req.method==="GET"||!p&&e!=="/sp-portal/login")return f(et(""));await t();return}const n=k(a);if(!(n!=null&&n.auth)&&e!=="/login")return f(Na("",!1));const s={admin:[],manager:["/users","/admin"],entry:["/users","/admin","/profit-loss","/balance-sheet","/trial-balance","/stock","/receivable-payable","/salesperson","/expense-ledger","/approvals","/company-settings"],viewer:["/inventory","/parties","/purchases","/sales","/payments","/expenses","/orders","/users","/admin","/salesperson","/approvals","/company-settings"]},o=(n==null?void 0:n.role)||"admin";if((s[o]||[]).includes(e))return f(B(`<div class="card"><div class="empty" style="padding:40px"><h3>Access Denied</h3><p class="text-muted">You don't have permission to access this page.</p><a href="/" class="btn btn-primary" style="margin-top:12px">Go to Dashboard</a></div></div>`,"dashboard",n));await t()});h.get("/api/license-info",async a=>{const e=await Ut(a.env.DATA_STORE)||Wt,r=Math.floor((new Date(e).getTime()-Date.now())/864e5);return a.json({expiry:e,days:r,status:r<0?"Expired":"Active"})});h.post("/api/set-license",async a=>{if(new URL(a.req.url).searchParams.get("master")!==Yt)return a.json({success:!1,error:"Unauthorized"},403);const e=await a.req.json();return await Ye(a.env.DATA_STORE,String((e==null?void 0:e.date)||"")),a.json({success:!0})});h.post("/api/list",async a=>{const t=await a.req.json();return a.json(await wa(a.env,(t==null?void 0:t.prefix)||""))});const Zt=["product:","party:","sale:","purchase:","payment:","expense:","bank:","order:","salesperson:"];h.post("/api/save",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json();let e=(t==null?void 0:t.prefix)||"";const r=t==null?void 0:t.id,i=t==null?void 0:t.key,n=(t==null?void 0:t.data)||{},s=(t==null?void 0:t.logAction)||"",o=(t==null?void 0:t.logDetail)||"",l=(t==null?void 0:t.skipApproval)===!0;let d=i;d||(r?d=r.startsWith(e)?r:e+r:d=e+ar()),!e&&d&&d.includes(":")&&(e=d.substring(0,d.indexOf(":")+1));const p=k(a),u=(p==null?void 0:p.role)==="entry",v=!!(i||r),x=Zt.some(C=>e&&e===C||d&&d.startsWith(C));if(u&&v&&x&&!l){const C=await Da(a.env.DB,d);return await qt(a.env.DB,"edit",d,e,n,C,o||"Edit: "+d,(p==null?void 0:p.name)||(p==null?void 0:p.username)||"Unknown"),await ja(a.env.DATA_STORE,"approval:"),a.json({success:!0,key:d,pending:!0,message:"Your edit has been submitted for approval"})}const w=await st(a.env.DB,e,n,d);return s&&await Ua(a.env.DB,s,o,w,e,(p==null?void 0:p.name)||(p==null?void 0:p.username)||"System"),await ja(a.env.DATA_STORE,...lt(e)),a.json({success:!0,key:w})});h.post("/api/get",async a=>{if(!a.env.DB)return a.json(null);const{key:t}=await a.req.json(),e=await Da(a.env.DB,t);return a.json(e)});h.post("/api/delete",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json(),e=t==null?void 0:t.key,r=(t==null?void 0:t.logDetail)||"",i=(t==null?void 0:t.skipApproval)===!0;if(!e)return a.json({success:!1,error:"Key is required"},400);const n=e.split(":")[0]+":",s=k(a),o=(s==null?void 0:s.role)==="entry",l=Zt.some(p=>e.startsWith(p));if(o&&l&&!i){const p=await Da(a.env.DB,e);return await qt(a.env.DB,"delete",e,n,null,p,r||"Delete: "+e,(s==null?void 0:s.name)||(s==null?void 0:s.username)||"Unknown"),await ja(a.env.DATA_STORE,"approval:"),a.json({success:!0,pending:!0,message:"Your delete request has been submitted for approval"})}const d=await Da(a.env.DB,e);return await ot(a.env.DB,e),await Ua(a.env.DB,"delete",r||"Deleted key: "+e,e,n,(s==null?void 0:s.name)||(s==null?void 0:s.username)||"System",d?JSON.stringify(d).substring(0,500):""),await ja(a.env.DATA_STORE,...lt(n)),a.json({success:!0})});h.post("/api/approval-list",async a=>a.json(await wa(a.env,"approval:")));h.post("/api/approval-action",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=k(a),e=(t==null?void 0:t.role)||"";if(e!=="admin"&&e!=="manager")return a.json({success:!1,error:"Only admin/manager can approve"},403);const{approvalKey:r,action:i}=await a.req.json();if(!r)return a.json({success:!1,error:"Approval key required"},400);const n=await Ge(a.env.DB,r,i,(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System");return n.success?(await Jt(a.env.DATA_STORE),a.json({success:!0,status:n.status})):a.json(n,400)});h.get("/api/company-settings",async a=>{const t={companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"},e=await Qt(a.env.DATA_STORE);return a.json(e||t)});h.post("/api/company-settings",async a=>{const t=k(a);if((t==null?void 0:t.role)!=="admin")return a.json({success:!1,error:"Only admin can change company settings"},403);const e=await a.req.json();return await Xt(a.env.DATA_STORE,e),a.json({success:!0})});h.post("/api/export-all",async a=>{if(!a.env.DB)return a.json({});const t=await qe(a.env.DB),e=await Qt(a.env.DATA_STORE);return e&&(t["companysettings:"]=[e]),a.json(t)});h.post("/api/import-all",async a=>{if(!a.env.DB)return a.json({success:!1,error:"D1 not configured"},500);const t=await a.req.json();t["companysettings:"]&&Array.isArray(t["companysettings:"])&&t["companysettings:"].length>0&&(await Xt(a.env.DATA_STORE,t["companysettings:"][0]),delete t["companysettings:"]);const e=await Je(a.env.DB,t);return await Jt(a.env.DATA_STORE),a.json({success:!0,count:e})});h.post("/api/change-pin",async a=>{const{oldPin:t,newPin:e}=await a.req.json(),r=await Vt(a.env.DATA_STORE)||$t;return t!==r?a.json({success:!1,error:"Wrong current PIN"}):!e||e.length<4?a.json({success:!1,error:"PIN must be at least 4 characters"}):(await We(a.env.DATA_STORE,e),a.json({success:!0}))});h.post("/api/kv-keys",async a=>{if(!a.env.DB)return a.json([]);const{prefix:t}=await a.req.json();return a.json(await Ue(a.env.DB,t||"",100))});h.post("/api/kv-get",async a=>{if(!a.env.DB)return a.json({value:null});const{key:t}=await a.req.json(),e=await Da(a.env.DB,t);return a.json({value:e?JSON.stringify(e):null})});h.post("/api/kv-delete",async a=>{if(!a.env.DB)return a.json({success:!1});const{key:t}=await a.req.json();await ot(a.env.DB,t);const e=t.split(":")[0]+":";return await ja(a.env.DATA_STORE,...lt(e)),a.json({success:!0})});h.post("/sp-portal/login",async a=>{const t=await a.req.formData(),e=t.get("code"),r=t.get("pin"),n=(await wa(a.env,"salesperson:")).find(s=>s.code===e&&s.pin===r&&s.active!==!1);if(n){const s=encodeURIComponent(JSON.stringify({spId:n._key,spName:n.name,spCode:n.code}));return new Response(null,{status:302,headers:{"Set-Cookie":`sp_session=${s}; Path=/; HttpOnly; SameSite=Strict`,Location:"/sp-portal"}})}return f(et("Invalid credentials"))});h.get("/sp-portal/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"sp_session=; Path=/; HttpOnly; Max-Age=0",Location:"/sp-portal/login"}}));h.get("/",a=>f(B(nr(),"dashboard",k(a))));h.get("/inventory",a=>f(B(ir(),"inventory",k(a))));h.get("/stock-check",a=>f(B(sr(),"stockcheck",k(a))));h.get("/parties",a=>f(B(or(),"parties",k(a))));h.get("/purchases",a=>f(B(lr(),"purchases",k(a))));h.get("/sales",a=>f(B(dr(),"sales",k(a))));h.get("/payments",a=>f(B(cr(),"payments",k(a))));h.get("/expenses",a=>f(B(pr(),"expenses",k(a))));h.get("/ledger",a=>f(B(ur(),"ledger",k(a))));h.get("/expense-ledger",a=>f(B(hr(),"expledger",k(a))));h.get("/profit-loss",a=>f(B(mr(),"profitloss",k(a))));h.get("/balance-sheet",a=>f(B(gr(),"balancesheet",k(a))));h.get("/trial-balance",a=>f(B(vr(),"trialbalance",k(a))));h.get("/stock",a=>f(B(br(),"stock",k(a))));h.get("/receivable-payable",a=>f(B(fr(),"recpay",k(a))));h.get("/day-details",a=>f(B(yr(),"daydetails",k(a))));h.get("/reports",a=>f(B(xr(),"reports",k(a))));h.get("/salesperson",a=>f(B(kr(),"salesperson",k(a))));h.get("/orders",a=>f(B(Sr(),"orders",k(a))));h.get("/users",a=>f(B(wr(),"users",k(a))));h.get("/admin",a=>f(B(Br(),"admin",k(a))));h.get("/mod-log",a=>f(B(Cr(),"modlog",k(a))));h.get("/approvals",a=>f(B(Pr(),"approvals",k(a))));h.get("/company-settings",a=>f(B(Ir(),"companysettings",k(a))));h.get("/truck-fare-report",a=>f(B(er(),"truckfarereport",k(a))));h.get("/truck-fare-settings",a=>f(B(tr(),"truckfaresettings",k(a))));h.get("/sp-portal",a=>f(rr(a)));h.get("/login",async a=>{const t=await wa(a.env,"user:");return f(Na("",t.length>0))});function tr(){return`
...
<div class="app">
  <aside class="sidebar" id="sidebar">
    ...
    <nav>${l}<div class="nav-group" style="margin-top:12px">Portal</div><a href="/sp-portal" target="_blank"><span class="nav-icon material-symbols-outlined">storefront</span>SP Portal</a><div class="nav-group"></div><a href="/logout" style="opacity:.6"><span class="nav-icon material-symbols-outlined">logout</span>Logout</a></nav>
...
<div><h2><span class="material-symbols-outlined" style="font-size:20px;vertical-align:middle;margin-right:4px">storefront</span>SP Portal</h2><div class="sp-user">Welcome, <b>${ua(n)}</b> (${ua(s)})</div></div>
...
<\/script></body></html>`}function nr(){var a=new Date().toISOString().slice(0,10),t=a.slice(0,7);return`
...
var method=document.getElementById('purMethod').value;var purNeedsBank=method==='bank_transfer'||method==='cheque'||method==='credit_card'||method==='mobile_payment';var bankName=purNeedsBank?(document.getElementById('purBank').value||''):'';var chequeNo=method==='cheque'?(document.getElementById('purCheque')?document.getElementById('purCheque').value:''):'';
...
var salNeedsBank=method==='bank_transfer'||method==='cheque'||method==='credit_card'||method==='mobile_payment';var bankName=salNeedsBank?(document.getElementById('salBank').value||''):'';var chequeNo=method==='cheque'?(document.getElementById('salCheque')?document.getElementById('salCheque').value:''):'';
...
var dayCashIn=ds.filter(function(s){return s.method==='cash'&&(s.paid||0)>0}).reduce(function(s,x){return s+(x.paid||0)},0)+dr.filter(function(r){return r.type==='receipt'&&r.method==='cash'&&(!r._autoInvoice||r._isTruckFare)&&!(r.billKeys&&r.billKeys.length)}).reduce(function(s,x){return s+(x.amount||0)},0);
var dayCashOut=dp.filter(function(p){return p.method==='cash'&&(p.paid||0)>0}).reduce(function(s,x){return s+(x.paid||0)},0)+dr.filter(function(r){return r.type==='payment'&&r.method==='cash'&&(!r._autoInvoice||r._isTruckFare)&&!(r.billKeys&&r.billKeys.length)}).reduce(function(s,x){return s+(x.amount||0)},0)+de.filter(function(e){return e.method==='cash'}).reduce(function(s,x){return s+(x.amount||0)},0);
...
var cihSalesCash=allSalesUpTo.filter(function(s){return s.method==='cash'&&(s.paid||0)>0}).reduce(function(s,x){return s+(x.paid||0)},0);
...
var cihPurCash=allPurUpTo.filter(function(p){return p.method==='cash'&&(p.paid||0)>0}).reduce(function(s,x){return s+(x.paid||0)},0);
...
var dayBankIn=ds.filter(function(s){return s.method&&s.method!=='cash'&&s.method!=='credit'&&(s.paid||0)>0}).reduce(function(s,x){return s+(x.paid||0)},0)+dr.filter(function(r){return r.type==='receipt'&&r.method!=='cash'&&(!r._autoInvoice||r._isTruckFare)&&!(r.billKeys&&r.billKeys.length)}).reduce(function(s,x){return s+(x.amount||0)},0);
var dayBankOut=dp.filter(function(p){return p.method&&p.method!=='cash'&&p.method!=='credit'&&(p.paid||0)>0}).reduce(function(s,x){return s+(x.paid||0)},0)+dr.filter(function(r){return r.type==='payment'&&r.method!=='cash'&&(!r._autoInvoice||r._isTruckFare)&&!(r.billKeys&&r.billKeys.length)}).reduce(function(s,x){return s+(x.amount||0)},0)+de.filter(function(e){return e.method&&e.method!=='cash'}).reduce(function(s,x){return s+(x.amount||0)},0);
...
var cashSales=ds.filter(function(s){return s.method==='cash'&&(s.paid||0)>0});
var bankSales=ds.filter(function(s){return s.method&&s.method!=='cash'&&s.method!=='credit'&&(s.paid||0)>0});
var creditSales=ds.filter(function(s){return s.method==='credit'});
var cashPurchases=dp.filter(function(p){return p.method==='cash'&&(p.paid||0)>0});
var bankPurchases=dp.filter(function(p){return p.method&&p.method!=='cash'&&p.method!=='credit'&&(p.paid||0)>0});
...
loadCS();
<\/script>`}const gt=new Lt,Er=Object.assign({"/src/index.tsx":h});let ae=!1;for(const[,a]of Object.entries(Er))a&&(gt.all("*",t=>{let e;try{e=t.executionCtx}catch{}return a.fetch(t.req.raw,t.env,e)}),gt.notFound(t=>{let e;try{e=t.executionCtx}catch{}return a.fetch(t.req.raw,t.env,e)}),ae=!0);if(!ae)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{gt as default};

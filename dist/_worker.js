var Mt=Object.defineProperty;var Za=a=>{throw TypeError(a)};var At=(a,t,e)=>t in a?Mt(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var g=(a,t,e)=>At(a,typeof t!="symbol"?t+"":t,e),Ja=(a,t,e)=>t.has(a)||Za("Cannot "+e);var o=(a,t,e)=>(Ja(a,t,"read from private field"),e?e.call(a):t.get(a)),v=(a,t,e)=>t.has(a)?Za("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(Ja(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),k=(a,t,e)=>(Ja(a,t,"access private method"),e);var at=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return o(a,t,r)}});var tt=(a,t,e)=>(r,i)=>{let n=-1;return s(0);async function s(d){if(d<=n)throw new Error("next() called multiple times");n=d;let p,l=!1,c;if(a[d]?(c=a[d][0][0],r.req.routeIndex=d):c=d===a.length&&i||void 0,c)try{p=await c(r,()=>s(d+1))}catch(u){if(u instanceof Error&&t)r.error=u,p=await t(u,r),l=!0;else throw u}else r.finalized===!1&&e&&(p=await e(r));return p&&(r.finalized===!1||l)&&(r.res=p),r}},Kt=Symbol(),Lt=async(a,t=Object.create(null))=>{const{all:e=!1,dot:r=!1}=t,n=(a instanceof bt?a.raw.headers:a.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?_t(a,{all:e,dot:r}):{}};async function _t(a,t){const e=await a.formData();return e?Ft(e,t):{}}function Ft(a,t){const e=Object.create(null);return a.forEach((r,i)=>{t.all||i.endsWith("[]")?Ot(e,i,r):e[i]=r}),t.dot&&Object.entries(e).forEach(([r,i])=>{r.includes(".")&&(zt(e,r,i),delete e[r])}),e}var Ot=(a,t,e)=>{a[t]!==void 0?Array.isArray(a[t])?a[t].push(e):a[t]=[a[t],e]:t.endsWith("[]")?a[t]=[e]:a[t]=e},zt=(a,t,e)=>{if(/(?:^|\.)__proto__\./.test(t))return;let r=a;const i=t.split(".");i.forEach((n,s)=>{s===i.length-1?r[n]=e:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},ut=a=>{const t=a.split("/");return t[0]===""&&t.shift(),t},Ht=a=>{const{groups:t,path:e}=Gt(a),r=ut(e);return qt(r,t)},Gt=a=>{const t=[];return a=a.replace(/\{[^}]+\}/g,(e,r)=>{const i=`@${r}`;return t.push([i,e]),i}),{groups:t,path:a}},qt=(a,t)=>{for(let e=t.length-1;e>=0;e--){const[r]=t[e];for(let i=a.length-1;i>=0;i--)if(a[i].includes(r)){a[i]=a[i].replace(r,t[e][1]);break}}return a},Ka={},Jt=(a,t)=>{if(a==="*")return"*";const e=a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(e){const r=`${a}#${t}`;return Ka[r]||(e[2]?Ka[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,e[1],new RegExp(`^${e[2]}(?=/${t})`)]:[a,e[1],new RegExp(`^${e[2]}$`)]:Ka[r]=[a,e[1],!0]),Ka[r]}return null},$a=(a,t)=>{try{return t(a)}catch{return a.replace(/(?:%[0-9A-Fa-f]{2})+/g,e=>{try{return t(e)}catch{return e}})}},Ut=a=>$a(a,decodeURI),ht=a=>{const t=a.url,e=t.indexOf("/",t.indexOf(":")+4);let r=e;for(;r<t.length;r++){const i=t.charCodeAt(r);if(i===37){const n=t.indexOf("?",r),s=t.indexOf("#",r),d=n===-1?s===-1?void 0:s:s===-1?n:Math.min(n,s),p=t.slice(e,d);return Ut(p.includes("%25")?p.replace(/%25/g,"%2525"):p)}else if(i===63||i===35)break}return t.slice(e,r)},Vt=a=>{const t=ht(a);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ca=(a,t,...e)=>(e.length&&(t=ca(t,...e)),`${(a==null?void 0:a[0])==="/"?"":"/"}${a}${t==="/"?"":`${(a==null?void 0:a.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),mt=a=>{if(a.charCodeAt(a.length-1)!==63||!a.includes(":"))return null;const t=a.split("/"),e=[];let r="";return t.forEach(i=>{if(i!==""&&!/\:/.test(i))r+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){e.length===0&&r===""?e.push("/"):e.push(r);const n=i.replace("?","");r+="/"+n,e.push(r)}else r+="/"+i}),e.filter((i,n,s)=>s.indexOf(i)===n)},Ua=a=>/[%+]/.test(a)?(a.indexOf("+")!==-1&&(a=a.replace(/\+/g," ")),a.indexOf("%")!==-1?$a(a,vt):a):a,gt=(a,t,e)=>{let r;if(!e&&t&&!/[%+]/.test(t)){let s=a.indexOf("?",8);if(s===-1)return;for(a.startsWith(t,s+1)||(s=a.indexOf(`&${t}`,s+1));s!==-1;){const d=a.charCodeAt(s+t.length+1);if(d===61){const p=s+t.length+2,l=a.indexOf("&",p);return Ua(a.slice(p,l===-1?void 0:l))}else if(d==38||isNaN(d))return"";s=a.indexOf(`&${t}`,s+1)}if(r=/[%+]/.test(a),!r)return}const i={};r??(r=/[%+]/.test(a));let n=a.indexOf("?",8);for(;n!==-1;){const s=a.indexOf("&",n+1);let d=a.indexOf("=",n);d>s&&s!==-1&&(d=-1);let p=a.slice(n+1,d===-1?s===-1?void 0:s:d);if(r&&(p=Ua(p)),n=s,p==="")continue;let l;d===-1?l="":(l=a.slice(d+1,s===-1?void 0:s),r&&(l=Ua(l))),e?(i[p]&&Array.isArray(i[p])||(i[p]=[]),i[p].push(l)):i[p]??(i[p]=l)}return t?i[t]:i},Xt=gt,Qt=(a,t)=>gt(a,t,!0),vt=decodeURIComponent,et=a=>$a(a,vt),ma,j,G,yt,ft,Xa,J,st,bt=(st=class{constructor(a,t="/",e=[[]]){v(this,G);g(this,"raw");v(this,ma);v(this,j);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});v(this,J,a=>{const{bodyCache:t,raw:e}=this,r=t[a];if(r)return r;const i=Object.keys(t)[0];return i?t[i].then(n=>(i==="json"&&(n=JSON.stringify(n)),new Response(n)[a]())):t[a]=e[a]()});this.raw=a,this.path=t,m(this,j,e),m(this,ma,{})}param(a){return a?k(this,G,yt).call(this,a):k(this,G,ft).call(this)}query(a){return Xt(this.url,a)}queries(a){return Qt(this.url,a)}header(a){if(a)return this.raw.headers.get(a)??void 0;const t={};return this.raw.headers.forEach((e,r)=>{t[r]=e}),t}async parseBody(a){return Lt(this,a)}json(){return o(this,J).call(this,"text").then(a=>JSON.parse(a))}text(){return o(this,J).call(this,"text")}arrayBuffer(){return o(this,J).call(this,"arrayBuffer")}blob(){return o(this,J).call(this,"blob")}formData(){return o(this,J).call(this,"formData")}addValidatedData(a,t){o(this,ma)[a]=t}valid(a){return o(this,ma)[a]}get url(){return this.raw.url}get method(){return this.raw.method}get[Kt](){return o(this,j)}get matchedRoutes(){return o(this,j)[0].map(([[,a]])=>a)}get routePath(){return o(this,j)[0].map(([[,a]])=>a)[this.routeIndex].path}},ma=new WeakMap,j=new WeakMap,G=new WeakSet,yt=function(a){const t=o(this,j)[0][this.routeIndex][1][a],e=k(this,G,Xa).call(this,t);return e&&/\%/.test(e)?et(e):e},ft=function(){const a={},t=Object.keys(o(this,j)[0][this.routeIndex][1]);for(const e of t){const r=k(this,G,Xa).call(this,o(this,j)[0][this.routeIndex][1][e]);r!==void 0&&(a[e]=/\%/.test(r)?et(r):r)}return a},Xa=function(a){return o(this,j)[1]?o(this,j)[1][a]:a},J=new WeakMap,st),$t={Stringify:1},kt=async(a,t,e,r,i)=>{typeof a=="object"&&!(a instanceof String)&&(a instanceof Promise||(a=a.toString()),a instanceof Promise&&(a=await a));const n=a.callbacks;return n!=null&&n.length?(i?i[0]+=a:i=[a],Promise.all(n.map(d=>d({phase:t,buffer:i,context:r}))).then(d=>Promise.all(d.filter(Boolean).map(p=>kt(p,t,!1,r,i))).then(()=>i[0]))):Promise.resolve(a)},Yt="text/plain; charset=UTF-8",Va=(a,t)=>({"Content-Type":a,...t}),Ba=(a,t)=>new Response(a,t),Ta,Ea,F,ga,O,T,ja,va,ba,aa,Na,Ra,U,ua,ot,Wt=(ot=class{constructor(a,t){v(this,U);v(this,Ta);v(this,Ea);g(this,"env",{});v(this,F);g(this,"finalized",!1);g(this,"error");v(this,ga);v(this,O);v(this,T);v(this,ja);v(this,va);v(this,ba);v(this,aa);v(this,Na);v(this,Ra);g(this,"render",(...a)=>(o(this,va)??m(this,va,t=>this.html(t)),o(this,va).call(this,...a)));g(this,"setLayout",a=>m(this,ja,a));g(this,"getLayout",()=>o(this,ja));g(this,"setRenderer",a=>{m(this,va,a)});g(this,"header",(a,t,e)=>{this.finalized&&m(this,T,Ba(o(this,T).body,o(this,T)));const r=o(this,T)?o(this,T).headers:o(this,aa)??m(this,aa,new Headers);t===void 0?r.delete(a):e!=null&&e.append?r.append(a,t):r.set(a,t)});g(this,"status",a=>{m(this,ga,a)});g(this,"set",(a,t)=>{o(this,F)??m(this,F,new Map),o(this,F).set(a,t)});g(this,"get",a=>o(this,F)?o(this,F).get(a):void 0);g(this,"newResponse",(...a)=>k(this,U,ua).call(this,...a));g(this,"body",(a,t,e)=>k(this,U,ua).call(this,a,t,e));g(this,"text",(a,t,e)=>!o(this,aa)&&!o(this,ga)&&!t&&!e&&!this.finalized?new Response(a):k(this,U,ua).call(this,a,t,Va(Yt,e)));g(this,"json",(a,t,e)=>k(this,U,ua).call(this,JSON.stringify(a),t,Va("application/json",e)));g(this,"html",(a,t,e)=>{const r=i=>k(this,U,ua).call(this,i,t,Va("text/html; charset=UTF-8",e));return typeof a=="object"?kt(a,$t.Stringify,!1,{}).then(r):r(a)});g(this,"redirect",(a,t)=>{const e=String(a);return this.header("Location",/[^\x00-\xFF]/.test(e)?encodeURI(e):e),this.newResponse(null,t??302)});g(this,"notFound",()=>(o(this,ba)??m(this,ba,()=>Ba()),o(this,ba).call(this,this)));m(this,Ta,a),t&&(m(this,O,t.executionCtx),this.env=t.env,m(this,ba,t.notFoundHandler),m(this,Ra,t.path),m(this,Na,t.matchResult))}get req(){return o(this,Ea)??m(this,Ea,new bt(o(this,Ta),o(this,Ra),o(this,Na))),o(this,Ea)}get event(){if(o(this,O)&&"respondWith"in o(this,O))return o(this,O);throw Error("This context has no FetchEvent")}get executionCtx(){if(o(this,O))return o(this,O);throw Error("This context has no ExecutionContext")}get res(){return o(this,T)||m(this,T,Ba(null,{headers:o(this,aa)??m(this,aa,new Headers)}))}set res(a){if(o(this,T)&&a){a=Ba(a.body,a);for(const[t,e]of o(this,T).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=o(this,T).headers.getSetCookie();a.headers.delete("set-cookie");for(const i of r)a.headers.append("set-cookie",i)}else a.headers.set(t,e)}m(this,T,a),this.finalized=!0}get var(){return o(this,F)?Object.fromEntries(o(this,F)):{}}},Ta=new WeakMap,Ea=new WeakMap,F=new WeakMap,ga=new WeakMap,O=new WeakMap,T=new WeakMap,ja=new WeakMap,va=new WeakMap,ba=new WeakMap,aa=new WeakMap,Na=new WeakMap,Ra=new WeakMap,U=new WeakSet,ua=function(a,t,e){const r=o(this,T)?new Headers(o(this,T).headers):o(this,aa)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[s,d]of n)s.toLowerCase()==="set-cookie"?r.append(s,d):r.set(s,d)}if(e)for(const[n,s]of Object.entries(e))if(typeof s=="string")r.set(n,s);else{r.delete(n);for(const d of s)r.append(n,d)}const i=typeof t=="number"?t:(t==null?void 0:t.status)??o(this,ga);return Ba(a,{status:i,headers:r})},ot),C="ALL",Zt="all",ae=["get","post","put","delete","options","patch"],xt="Can not add a route since the matcher is already built.",St=class extends Error{},te="__COMPOSED_HANDLER",ee=a=>a.text("404 Not Found",404),rt=(a,t)=>{if("getResponse"in a){const e=a.getResponse();return t.newResponse(e.body,e)}return console.error(a),t.text("Internal Server Error",500)},R,P,wt,M,W,La,_a,ya,re=(ya=class{constructor(t={}){v(this,P);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");v(this,R,"/");g(this,"routes",[]);v(this,M,ee);g(this,"errorHandler",rt);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(m(this,M,t),this));g(this,"fetch",(t,...e)=>k(this,P,_a).call(this,t,e[1],e[0],t.method));g(this,"request",(t,e,r,i)=>t instanceof Request?this.fetch(e?new Request(t,e):t,r,i):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ca("/",t)}`,e),r,i)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(k(this,P,_a).call(this,t.request,t,void 0,t.request.method))})});[...ae,Zt].forEach(n=>{this[n]=(s,...d)=>(typeof s=="string"?m(this,R,s):k(this,P,W).call(this,n,o(this,R),s),d.forEach(p=>{k(this,P,W).call(this,n,o(this,R),p)}),this)}),this.on=(n,s,...d)=>{for(const p of[s].flat()){m(this,R,p);for(const l of[n].flat())d.map(c=>{k(this,P,W).call(this,l.toUpperCase(),o(this,R),c)})}return this},this.use=(n,...s)=>(typeof n=="string"?m(this,R,n):(m(this,R,"*"),s.unshift(n)),s.forEach(d=>{k(this,P,W).call(this,C,o(this,R),d)}),this);const{strict:r,...i}=t;Object.assign(this,i),this.getPath=r??!0?t.getPath??ht:Vt}route(t,e){const r=this.basePath(t);return e.routes.map(i=>{var s;let n;e.errorHandler===rt?n=i.handler:(n=async(d,p)=>(await tt([],e.errorHandler)(d,()=>i.handler(d,p))).res,n[te]=i.handler),k(s=r,P,W).call(s,i.method,i.path,n)}),this}basePath(t){const e=k(this,P,wt).call(this);return e._basePath=ca(this._basePath,t),e}mount(t,e,r){let i,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?i=p=>p:i=r.replaceRequest));const s=n?p=>{const l=n(p);return Array.isArray(l)?l:[l]}:p=>{let l;try{l=p.executionCtx}catch{}return[p.env,l]};i||(i=(()=>{const p=ca(this._basePath,t),l=p==="/"?0:p.length;return c=>{const u=new URL(c.url);return u.pathname=u.pathname.slice(l)||"/",new Request(u,c)}})());const d=async(p,l)=>{const c=await e(i(p.req.raw),...s(p));if(c)return c;await l()};return k(this,P,W).call(this,C,ca(t,"*"),d),this}},R=new WeakMap,P=new WeakSet,wt=function(){const t=new ya({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,m(t,M,o(this,M)),t.routes=this.routes,t},M=new WeakMap,W=function(t,e,r){t=t.toUpperCase(),e=ca(this._basePath,e);const i={basePath:this._basePath,path:e,method:t,handler:r};this.router.add(t,e,[r,i]),this.routes.push(i)},La=function(t,e){if(t instanceof Error)return this.errorHandler(t,e);throw t},_a=function(t,e,r,i){if(i==="HEAD")return(async()=>new Response(null,await k(this,P,_a).call(this,t,e,r,"GET")))();const n=this.getPath(t,{env:r}),s=this.router.match(i,n),d=new Wt(t,{path:n,matchResult:s,env:r,executionCtx:e,notFoundHandler:o(this,M)});if(s[0].length===1){let l;try{l=s[0][0][0][0](d,async()=>{d.res=await o(this,M).call(this,d)})}catch(c){return k(this,P,La).call(this,c,d)}return l instanceof Promise?l.then(c=>c||(d.finalized?d.res:o(this,M).call(this,d))).catch(c=>k(this,P,La).call(this,c,d)):l??o(this,M).call(this,d)}const p=tt(s[0],this.errorHandler,o(this,M));return(async()=>{try{const l=await p(d);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return k(this,P,La).call(this,l,d)}})()},ya),Bt=[];function ne(a,t){const e=this.buildAllMatchers(),r=((i,n)=>{const s=e[i]||e[C],d=s[2][n];if(d)return d;const p=n.match(s[0]);if(!p)return[[],Bt];const l=p.indexOf("",1);return[s[1][l],p]});return this.match=r,r(a,t)}var Oa="[^/]+",Pa=".*",Ia="(?:|/.*)",ha=Symbol(),ie=new Set(".\\+*[^]$()");function se(a,t){return a.length===1?t.length===1?a<t?-1:1:-1:t.length===1||a===Pa||a===Ia?1:t===Pa||t===Ia?-1:a===Oa?1:t===Oa?-1:a.length===t.length?a<t?-1:1:t.length-a.length}var ta,ea,A,ia,oe=(ia=class{constructor(){v(this,ta);v(this,ea);v(this,A,Object.create(null))}insert(t,e,r,i,n){if(t.length===0){if(o(this,ta)!==void 0)throw ha;if(n)return;m(this,ta,e);return}const[s,...d]=t,p=s==="*"?d.length===0?["","",Pa]:["","",Oa]:s==="/*"?["","",Ia]:s.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(p){const c=p[1];let u=p[2]||Oa;if(c&&p[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ha;if(l=o(this,A)[u],!l){if(Object.keys(o(this,A)).some(y=>y!==Pa&&y!==Ia))throw ha;if(n)return;l=o(this,A)[u]=new ia,c!==""&&m(l,ea,i.varIndex++)}!n&&c!==""&&r.push([c,o(l,ea)])}else if(l=o(this,A)[s],!l){if(Object.keys(o(this,A)).some(c=>c.length>1&&c!==Pa&&c!==Ia))throw ha;if(n)return;l=o(this,A)[s]=new ia}l.insert(d,e,r,i,n)}buildRegExpStr(){const e=Object.keys(o(this,A)).sort(se).map(r=>{const i=o(this,A)[r];return(typeof o(i,ea)=="number"?`(${r})@${o(i,ea)}`:ie.has(r)?`\\${r}`:r)+i.buildRegExpStr()});return typeof o(this,ta)=="number"&&e.unshift(`#${o(this,ta)}`),e.length===0?"":e.length===1?e[0]:"(?:"+e.join("|")+")"}},ta=new WeakMap,ea=new WeakMap,A=new WeakMap,ia),za,Ma,lt,le=(lt=class{constructor(){v(this,za,{varIndex:0});v(this,Ma,new oe)}insert(a,t,e){const r=[],i=[];for(let s=0;;){let d=!1;if(a=a.replace(/\{[^}]+\}/g,p=>{const l=`@\\${s}`;return i[s]=[l,p],s++,d=!0,l}),!d)break}const n=a.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let s=i.length-1;s>=0;s--){const[d]=i[s];for(let p=n.length-1;p>=0;p--)if(n[p].indexOf(d)!==-1){n[p]=n[p].replace(d,i[s][1]);break}}return o(this,Ma).insert(n,t,r,o(this,za),e),r}buildRegExp(){let a=o(this,Ma).buildRegExpStr();if(a==="")return[/^$/,[],[]];let t=0;const e=[],r=[];return a=a.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,n,s)=>n!==void 0?(e[++t]=Number(n),"$()"):(s!==void 0&&(r[Number(s)]=++t),"")),[new RegExp(`^${a}`),e,r]}},za=new WeakMap,Ma=new WeakMap,lt),de=[/^$/,[],Object.create(null)],Fa=Object.create(null);function Ct(a){return Fa[a]??(Fa[a]=new RegExp(a==="*"?"":`^${a.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,e)=>e?`\\${e}`:"(?:|/.*)")}$`))}function pe(){Fa=Object.create(null)}function ce(a){var l;const t=new le,e=[];if(a.length===0)return de;const r=a.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,u],[y,S])=>c?1:y?-1:u.length-S.length),i=Object.create(null);for(let c=0,u=-1,y=r.length;c<y;c++){const[S,w,E]=r[c];S?i[w]=[E.map(([K])=>[K,Object.create(null)]),Bt]:u++;let N;try{N=t.insert(w,u,S)}catch(K){throw K===ha?new St(w):K}S||(e[u]=E.map(([K,B])=>{const L=Object.create(null);for(B-=1;B>=0;B--){const[xa,Ga]=N[B];L[xa]=Ga}return[K,L]}))}const[n,s,d]=t.buildRegExp();for(let c=0,u=e.length;c<u;c++)for(let y=0,S=e[c].length;y<S;y++){const w=(l=e[c][y])==null?void 0:l[1];if(!w)continue;const E=Object.keys(w);for(let N=0,K=E.length;N<K;N++)w[E[N]]=d[w[E[N]]]}const p=[];for(const c in s)p[c]=e[s[c]];return[n,p,i]}function da(a,t){if(a){for(const e of Object.keys(a).sort((r,i)=>i.length-r.length))if(Ct(e).test(t))return[...a[e]]}}var V,X,Ha,Pt,dt,ue=(dt=class{constructor(){v(this,Ha);g(this,"name","RegExpRouter");v(this,V);v(this,X);g(this,"match",ne);m(this,V,{[C]:Object.create(null)}),m(this,X,{[C]:Object.create(null)})}add(a,t,e){var d;const r=o(this,V),i=o(this,X);if(!r||!i)throw new Error(xt);r[a]||[r,i].forEach(p=>{p[a]=Object.create(null),Object.keys(p[C]).forEach(l=>{p[a][l]=[...p[C][l]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const p=Ct(t);a===C?Object.keys(r).forEach(l=>{var c;(c=r[l])[t]||(c[t]=da(r[l],t)||da(r[C],t)||[])}):(d=r[a])[t]||(d[t]=da(r[a],t)||da(r[C],t)||[]),Object.keys(r).forEach(l=>{(a===C||a===l)&&Object.keys(r[l]).forEach(c=>{p.test(c)&&r[l][c].push([e,n])})}),Object.keys(i).forEach(l=>{(a===C||a===l)&&Object.keys(i[l]).forEach(c=>p.test(c)&&i[l][c].push([e,n]))});return}const s=mt(t)||[t];for(let p=0,l=s.length;p<l;p++){const c=s[p];Object.keys(i).forEach(u=>{var y;(a===C||a===u)&&((y=i[u])[c]||(y[c]=[...da(r[u],c)||da(r[C],c)||[]]),i[u][c].push([e,n-l+p+1]))})}}buildAllMatchers(){const a=Object.create(null);return Object.keys(o(this,X)).concat(Object.keys(o(this,V))).forEach(t=>{a[t]||(a[t]=k(this,Ha,Pt).call(this,t))}),m(this,V,m(this,X,void 0)),pe(),a}},V=new WeakMap,X=new WeakMap,Ha=new WeakSet,Pt=function(a){const t=[];let e=a===C;return[o(this,V),o(this,X)].forEach(r=>{const i=r[a]?Object.keys(r[a]).map(n=>[n,r[a][n]]):[];i.length!==0?(e||(e=!0),t.push(...i)):a!==C&&t.push(...Object.keys(r[C]).map(n=>[n,r[C][n]]))}),e?ce(t):null},dt),Q,z,pt,he=(pt=class{constructor(a){g(this,"name","SmartRouter");v(this,Q,[]);v(this,z,[]);m(this,Q,a.routers)}add(a,t,e){if(!o(this,z))throw new Error(xt);o(this,z).push([a,t,e])}match(a,t){if(!o(this,z))throw new Error("Fatal error");const e=o(this,Q),r=o(this,z),i=e.length;let n=0,s;for(;n<i;n++){const d=e[n];try{for(let p=0,l=r.length;p<l;p++)d.add(...r[p]);s=d.match(a,t)}catch(p){if(p instanceof St)continue;throw p}this.match=d.match.bind(d),m(this,Q,[d]),m(this,z,void 0);break}if(n===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,s}get activeRouter(){if(o(this,z)||o(this,Q).length!==1)throw new Error("No active router has been determined yet.");return o(this,Q)[0]}},Q=new WeakMap,z=new WeakMap,pt),Ca=Object.create(null),me=a=>{for(const t in a)return!0;return!1},$,D,ra,fa,I,H,Z,ka,ge=(ka=class{constructor(t,e,r){v(this,H);v(this,$);v(this,D);v(this,ra);v(this,fa,0);v(this,I,Ca);if(m(this,D,r||Object.create(null)),m(this,$,[]),t&&e){const i=Object.create(null);i[t]={handler:e,possibleKeys:[],score:0},m(this,$,[i])}m(this,ra,[])}insert(t,e,r){m(this,fa,++at(this,fa)._);let i=this;const n=Ht(e),s=[];for(let d=0,p=n.length;d<p;d++){const l=n[d],c=n[d+1],u=Jt(l,c),y=Array.isArray(u)?u[0]:l;if(y in o(i,D)){i=o(i,D)[y],u&&s.push(u[1]);continue}o(i,D)[y]=new ka,u&&(o(i,ra).push(u),s.push(u[1])),i=o(i,D)[y]}return o(i,$).push({[t]:{handler:r,possibleKeys:s.filter((d,p,l)=>l.indexOf(d)===p),score:o(this,fa)}}),i}search(t,e){var c;const r=[];m(this,I,Ca);let n=[this];const s=ut(e),d=[],p=s.length;let l=null;for(let u=0;u<p;u++){const y=s[u],S=u===p-1,w=[];for(let N=0,K=n.length;N<K;N++){const B=n[N],L=o(B,D)[y];L&&(m(L,I,o(B,I)),S?(o(L,D)["*"]&&k(this,H,Z).call(this,r,o(L,D)["*"],t,o(B,I)),k(this,H,Z).call(this,r,L,t,o(B,I))):w.push(L));for(let xa=0,Ga=o(B,ra).length;xa<Ga;xa++){const Ya=o(B,ra)[xa],q=o(B,I)===Ca?{}:{...o(B,I)};if(Ya==="*"){const oa=o(B,D)["*"];oa&&(k(this,H,Z).call(this,r,oa,t,o(B,I)),m(oa,I,q),w.push(oa));continue}const[Rt,Wa,Sa]=Ya;if(!y&&!(Sa instanceof RegExp))continue;const _=o(B,D)[Rt];if(Sa instanceof RegExp){if(l===null){l=new Array(p);let la=e[0]==="/"?1:0;for(let wa=0;wa<p;wa++)l[wa]=la,la+=s[wa].length+1}const oa=e.substring(l[u]),qa=Sa.exec(oa);if(qa){if(q[Wa]=qa[0],k(this,H,Z).call(this,r,_,t,o(B,I),q),me(o(_,D))){m(_,I,q);const la=((c=qa[0].match(/\//))==null?void 0:c.length)??0;(d[la]||(d[la]=[])).push(_)}continue}}(Sa===!0||Sa.test(y))&&(q[Wa]=y,S?(k(this,H,Z).call(this,r,_,t,q,o(B,I)),o(_,D)["*"]&&k(this,H,Z).call(this,r,o(_,D)["*"],t,q,o(B,I))):(m(_,I,q),w.push(_)))}}const E=d.shift();n=E?w.concat(E):w}return r.length>1&&r.sort((u,y)=>u.score-y.score),[r.map(({handler:u,params:y})=>[u,y])]}},$=new WeakMap,D=new WeakMap,ra=new WeakMap,fa=new WeakMap,I=new WeakMap,H=new WeakSet,Z=function(t,e,r,i,n){for(let s=0,d=o(e,$).length;s<d;s++){const p=o(e,$)[s],l=p[r]||p[C],c={};if(l!==void 0&&(l.params=Object.create(null),t.push(l),i!==Ca||n&&n!==Ca))for(let u=0,y=l.possibleKeys.length;u<y;u++){const S=l.possibleKeys[u],w=c[l.score];l.params[S]=n!=null&&n[S]&&!w?n[S]:i[S]??(n==null?void 0:n[S]),c[l.score]=!0}}},ka),na,ct,ve=(ct=class{constructor(){g(this,"name","TrieRouter");v(this,na);m(this,na,new ge)}add(a,t,e){const r=mt(t);if(r){for(let i=0,n=r.length;i<n;i++)o(this,na).insert(a,r[i],e);return}o(this,na).insert(a,t,e)}match(a,t){return o(this,na).search(a,t)}},na=new WeakMap,ct),It=class extends re{constructor(a={}){super(a),this.router=a.router??new he({routers:[new ue,new ve]})}};const h=new It;let Dt="1234";const Tt="4321",Et="2028-12-31";function Y(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function pa(a){return String(a).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async function sa(a,t){if(!a.DATA_STORE)return[];let e;const r=[];do{const s=await a.DATA_STORE.list({prefix:t,cursor:e,limit:1e3});r.push(...s.keys.map(d=>d.name)),e=s.list_complete?void 0:s.cursor}while(e);const i=await Promise.all(r.map(s=>a.DATA_STORE.get(s))),n=[];for(let s=0;s<r.length;s++)if(i[s])try{n.push({_key:r[s],...JSON.parse(i[s])})}catch{}return n}function b(a){return new Response(a,{headers:{"content-type":"text/html;charset=UTF-8","Cache-Control":"no-store, no-cache, must-revalidate, proxy-revalidate",Pragma:"no-cache",Expires:"0"}})}h.post("/login",async a=>{var s;const t=await a.req.formData(),e=t.get("pin"),r=await((s=a.env.DATA_STORE)==null?void 0:s.get("APP_PIN"))||Dt,i=(t.get("username")||"").trim(),n=await sa(a.env,"user:");if(n.length>0&&i){const d=n.find(p=>p.username===i&&p.password===e&&p.active!==!1);if(d){const p=encodeURIComponent(JSON.stringify({auth:1,userId:d._key,username:d.username,role:d.role,name:d.name}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${p}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return b(Da("Invalid credentials",n.length>0))}if(e===r){const d=encodeURIComponent(JSON.stringify({auth:1,userId:"admin",username:"admin",role:"admin",name:"Administrator"}));return new Response(null,{status:302,headers:{"Set-Cookie":`session=${d}; Path=/; HttpOnly; SameSite=Strict; Max-Age=86400`,Location:"/","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache"}})}return b(Da("Wrong PIN",n.length>0))});h.get("/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"session=; Path=/; HttpOnly; Max-Age=0; SameSite=Strict",Location:"/login","Cache-Control":"no-store, no-cache, must-revalidate",Pragma:"no-cache","Clear-Site-Data":'"cache"'}}));function f(a){const e=(a.req.header("Cookie")||"").match(/session=([^;]+)/);if(!e)return null;try{return JSON.parse(decodeURIComponent(e[1]))}catch{return null}}h.use("*",async(a,t)=>{const e=new URL(a.req.url).pathname;if(e==="/login"&&a.req.method==="GET"){const l=await sa(a.env,"user:");return b(Da("",l.length>0))}if(e==="/api/company-settings"&&a.req.method==="GET"){await t();return}if(!(new URL(a.req.url).searchParams.get("master")===Tt)){const l=new Date().toISOString().slice(0,10);if(l>Et)return b(nt());if(a.env.DATA_STORE){const c=await a.env.DATA_STORE.get("APP_LICENSE");if(c&&l>c)return b(nt())}}if(e.startsWith("/sp-portal")){const c=(a.req.header("Cookie")||"").match(/sp_session=([^;]+)/);if(e==="/sp-portal/login"&&a.req.method==="GET"||!c&&e!=="/sp-portal/login")return b(Qa(""));await t();return}const n=f(a);if(!(n!=null&&n.auth)&&e!=="/login")return b(Da("",!1));const s={admin:[],manager:["/users","/admin"],entry:["/users","/admin","/profit-loss","/balance-sheet","/trial-balance","/stock","/receivable-payable","/salesperson","/expense-ledger","/approvals","/company-settings"],viewer:["/inventory","/parties","/purchases","/sales","/payments","/expenses","/orders","/users","/admin","/salesperson","/approvals","/company-settings"]},d=(n==null?void 0:n.role)||"admin";if((s[d]||[]).includes(e))return b(x(`<div class="card"><div class="empty" style="padding:40px"><h3>Access Denied</h3><p class="text-muted">You don't have permission to access this page.</p><a href="/" class="btn btn-primary" style="margin-top:12px">Go to Dashboard</a></div></div>`,"dashboard",n));await t()});h.get("/api/license-info",async a=>{const e=(a.env.DATA_STORE?await a.env.DATA_STORE.get("APP_LICENSE"):null)||Et,r=Math.floor((new Date(e).getTime()-Date.now())/864e5);return a.json({expiry:e,days:r,status:r<0?"Expired":"Active"})});h.post("/api/set-license",async a=>{if(new URL(a.req.url).searchParams.get("master")!==Tt)return a.json({success:!1,error:"Unauthorized"},403);const e=await a.req.json();return a.env.DATA_STORE?(await a.env.DATA_STORE.put("APP_LICENSE",String((e==null?void 0:e.date)||"")),a.json({success:!0})):a.json({success:!1,error:"KV not configured"},500)});h.post("/api/list",async a=>{const t=await a.req.json();return a.json(await sa(a.env,(t==null?void 0:t.prefix)||""))});const jt=["product:","party:","sale:","purchase:","payment:","expense:","bank:","order:","salesperson:"];h.post("/api/save",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=await a.req.json(),e=(t==null?void 0:t.prefix)||"",r=t==null?void 0:t.id,i=t==null?void 0:t.key,n=(t==null?void 0:t.data)||{},s=(t==null?void 0:t.logAction)||"",d=(t==null?void 0:t.logDetail)||"",p=(t==null?void 0:t.skipApproval)===!0;let l=i;l||(r?l=r.startsWith(e)?r:e+r:l=e+Y());const c=f(a),u=(c==null?void 0:c.role)==="entry",y=!!(i||r),S=jt.some(w=>e&&e===w||l&&l.startsWith(w));if(u&&y&&S&&!p){const w="approval:"+Y(),E=await a.env.DATA_STORE.get(l);return await a.env.DATA_STORE.put(w,JSON.stringify({type:"edit",targetKey:l,prefix:e,newData:n,oldData:E?JSON.parse(E):null,detail:d||"Edit: "+l,requestedBy:(c==null?void 0:c.name)||(c==null?void 0:c.username)||"Unknown",requestedAt:new Date().toISOString(),status:"pending"})),a.json({success:!0,key:l,pending:!0,message:"Your edit has been submitted for approval"})}if(await a.env.DATA_STORE.put(l,JSON.stringify(n)),s){const w="modlog:"+Y();await a.env.DATA_STORE.put(w,JSON.stringify({action:s,detail:d,key:l,prefix:e,user:(c==null?void 0:c.name)||(c==null?void 0:c.username)||"System",timestamp:new Date().toISOString()}))}return a.json({success:!0,key:l})});h.post("/api/get",async a=>{if(!a.env.DATA_STORE)return a.json(null);const{key:t}=await a.req.json(),e=await a.env.DATA_STORE.get(t);return a.json(e?JSON.parse(e):null)});h.post("/api/delete",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=await a.req.json(),e=t==null?void 0:t.key,r=(t==null?void 0:t.logDetail)||"",i=(t==null?void 0:t.skipApproval)===!0;if(!e)return a.json({success:!1,error:"Key is required"},400);const n=f(a),s=(n==null?void 0:n.role)==="entry",d=jt.some(c=>e.startsWith(c));if(s&&d&&!i){const c=await a.env.DATA_STORE.get(e),u="approval:"+Y();return await a.env.DATA_STORE.put(u,JSON.stringify({type:"delete",targetKey:e,prefix:e.split(":")[0]+":",newData:null,oldData:c?JSON.parse(c):null,detail:r||"Delete: "+e,requestedBy:(n==null?void 0:n.name)||(n==null?void 0:n.username)||"Unknown",requestedAt:new Date().toISOString(),status:"pending"})),a.json({success:!0,pending:!0,message:"Your delete request has been submitted for approval"})}const p=await a.env.DATA_STORE.get(e);await a.env.DATA_STORE.delete(e);const l="modlog:"+Y();return await a.env.DATA_STORE.put(l,JSON.stringify({action:"delete",detail:r||"Deleted key: "+e,key:e,oldData:p?p.substring(0,500):"",user:(n==null?void 0:n.name)||(n==null?void 0:n.username)||"System",timestamp:new Date().toISOString()})),a.json({success:!0})});h.post("/api/approval-list",async a=>a.json(await sa(a.env,"approval:")));h.post("/api/approval-action",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=f(a),e=(t==null?void 0:t.role)||"";if(e!=="admin"&&e!=="manager")return a.json({success:!1,error:"Only admin/manager can approve"},403);const{approvalKey:r,action:i}=await a.req.json();if(!r)return a.json({success:!1,error:"Approval key required"},400);const n=await a.env.DATA_STORE.get(r);if(!n)return a.json({success:!1,error:"Approval not found"},404);const s=JSON.parse(n);if(s.status!=="pending")return a.json({success:!1,error:"Already processed"},400);if(i==="approve"){if(s.type==="edit"&&s.targetKey&&s.newData){await a.env.DATA_STORE.put(s.targetKey,JSON.stringify(s.newData));const d="modlog:"+Y();await a.env.DATA_STORE.put(d,JSON.stringify({action:"edit",detail:"Approved edit by "+s.requestedBy+": "+s.detail,key:s.targetKey,prefix:s.prefix,user:(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System",timestamp:new Date().toISOString()}))}else if(s.type==="delete"&&s.targetKey){await a.env.DATA_STORE.delete(s.targetKey);const d="modlog:"+Y();await a.env.DATA_STORE.put(d,JSON.stringify({action:"delete",detail:"Approved delete by "+s.requestedBy+": "+s.detail,key:s.targetKey,prefix:s.prefix,user:(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System",timestamp:new Date().toISOString()}))}s.status="approved"}else s.status="rejected";return s.processedBy=(t==null?void 0:t.name)||(t==null?void 0:t.username)||"System",s.processedAt=new Date().toISOString(),await a.env.DATA_STORE.put(r,JSON.stringify(s)),a.json({success:!0,status:s.status})});h.get("/api/company-settings",async a=>{if(!a.env.DATA_STORE)return a.json({companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"});const t=await a.env.DATA_STORE.get("COMPANY_SETTINGS");return t?a.json(JSON.parse(t)):a.json({companyName:"My Company",companyAddress:"",companyPhone:"",companyEmail:"",companyWebsite:"",companyTagline:"",companyTIN:"",primaryColor:"#4f46e5",sidebarColor:"#1e1b4b"})});h.post("/api/company-settings",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=f(a);if((t==null?void 0:t.role)!=="admin")return a.json({success:!1,error:"Only admin can change company settings"},403);const e=await a.req.json();return await a.env.DATA_STORE.put("COMPANY_SETTINGS",JSON.stringify(e)),a.json({success:!0})});h.post("/api/export-all",async a=>{const t=["product:","party:","sale:","purchase:","payment:","expense:","exphead:","expsubhead:","bank:","cb:","user:","order:","salesperson:","creditlimit:","prodgroup:","modlog:","approval:","companysettings:"],e={};for(const r of t)e[r]=await sa(a.env,r);return a.json(e)});h.post("/api/import-all",async a=>{if(!a.env.DATA_STORE)return a.json({success:!1,error:"KV not configured"},500);const t=await a.req.json();let e=0;for(const[r,i]of Object.entries(t))if(Array.isArray(i))for(const n of i){const s=n._key||r+Y(),d={...n};delete d._key,await a.env.DATA_STORE.put(s,JSON.stringify(d)),e++}return a.json({success:!0,count:e})});h.post("/api/change-pin",async a=>{var i;const{oldPin:t,newPin:e}=await a.req.json(),r=await((i=a.env.DATA_STORE)==null?void 0:i.get("APP_PIN"))||Dt;return t!==r?a.json({success:!1,error:"Wrong current PIN"}):!e||e.length<4?a.json({success:!1,error:"PIN must be at least 4 characters"}):(await a.env.DATA_STORE.put("APP_PIN",e),a.json({success:!0}))});h.post("/api/kv-keys",async a=>{const{prefix:t}=await a.req.json();if(!a.env.DATA_STORE)return a.json([]);const e=await a.env.DATA_STORE.list({prefix:t||"",limit:100});return a.json(e.keys.map(r=>r.name))});h.post("/api/kv-get",async a=>{const{key:t}=await a.req.json();if(!a.env.DATA_STORE)return a.json({value:null});const e=await a.env.DATA_STORE.get(t);return a.json({value:e})});h.post("/api/kv-delete",async a=>{const{key:t}=await a.req.json();return a.env.DATA_STORE?(await a.env.DATA_STORE.delete(t),a.json({success:!0})):a.json({success:!1})});h.post("/sp-portal/login",async a=>{const t=await a.req.formData(),e=t.get("code"),r=t.get("pin"),n=(await sa(a.env,"salesperson:")).find(s=>s.code===e&&s.pin===r&&s.active!==!1);if(n){const s=encodeURIComponent(JSON.stringify({spId:n._key,spName:n.name,spCode:n.code}));return new Response(null,{status:302,headers:{"Set-Cookie":`sp_session=${s}; Path=/; HttpOnly; SameSite=Strict`,Location:"/sp-portal"}})}return b(Qa("Invalid credentials"))});h.get("/sp-portal/logout",()=>new Response(null,{status:302,headers:{"Set-Cookie":"sp_session=; Path=/; HttpOnly; Max-Age=0",Location:"/sp-portal/login"}}));h.get("/",a=>b(x(ke(),"dashboard",f(a))));h.get("/inventory",a=>b(x(xe(),"inventory",f(a))));h.get("/stock-check",a=>b(x(Se(),"stockcheck",f(a))));h.get("/parties",a=>b(x(we(),"parties",f(a))));h.get("/purchases",a=>b(x(Be(),"purchases",f(a))));h.get("/sales",a=>b(x(Ce(),"sales",f(a))));h.get("/payments",a=>b(x(Pe(),"payments",f(a))));h.get("/expenses",a=>b(x(Ie(),"expenses",f(a))));h.get("/ledger",a=>b(x(De(),"ledger",f(a))));h.get("/expense-ledger",a=>b(x(Te(),"expledger",f(a))));h.get("/profit-loss",a=>b(x(Ee(),"profitloss",f(a))));h.get("/balance-sheet",a=>b(x(je(),"balancesheet",f(a))));h.get("/trial-balance",a=>b(x(Ne(),"trialbalance",f(a))));h.get("/stock",a=>b(x(Re(),"stock",f(a))));h.get("/receivable-payable",a=>b(x(Me(),"recpay",f(a))));h.get("/day-details",a=>b(x(Ae(),"daydetails",f(a))));h.get("/reports",a=>b(x(Ke(),"reports",f(a))));h.get("/salesperson",a=>b(x(Le(),"salesperson",f(a))));h.get("/orders",a=>b(x(_e(),"orders",f(a))));h.get("/users",a=>b(x(Fe(),"users",f(a))));h.get("/admin",a=>b(x(Oe(),"admin",f(a))));h.get("/mod-log",a=>b(x(ze(),"modlog",f(a))));h.get("/approvals",a=>b(x(He(),"approvals",f(a))));h.get("/company-settings",a=>b(x(Ge(),"companysettings",f(a))));h.get("/truck-fare-report",a=>b(x(ye(),"truckfarereport",f(a))));h.get("/truck-fare-settings",a=>b(x(be(),"truckfaresettings",f(a))));h.get("/sp-portal",a=>b(fe(a)));h.get("/login",async a=>{const t=await sa(a.env,"user:");return b(Da("",t.length>0))});function be(){return`
...
<div class="app">
  <aside class="sidebar" id="sidebar">
    ...
    <nav>${p}<div class="nav-group" style="margin-top:12px">Portal</div><a href="/sp-portal" target="_blank"><span class="nav-icon material-symbols-outlined">storefront</span>SP Portal</a><div class="nav-group"></div><a href="/logout" style="opacity:.6"><span class="nav-icon material-symbols-outlined">logout</span>Logout</a></nav>
...
<\/script>
</body></html>`}function Da(a,t=!1){return`<!doctype html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,viewport-fit=cover">

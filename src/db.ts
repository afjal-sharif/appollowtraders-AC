...
const FIELD_MAP: Record<string, Record<string, string>> = {
  ...
  sales: {
    ...
    cashAmount: 'cash_amount', bankAmount: 'bank_amount', bankMethod: 'bank_method',
    chequeNo: 'cheque_no',
  },
  purchases: {
...
function getTableColumns(table: string): string[] {
  const schemas: Record<string, string[]> = {
    ...
    sales: ['id', 'invoice_no', 'date', 'customer_id', 'customer_name', 'salesperson_id', 'salesperson_name', 'method', 'bank_name', 'discount', 'discount_type', 'extra', 'vat', 'vat_type', 'vat_amount', 'ait', 'ait_type', 'ait_amount', 'truck_fare', 'total', 'paid', 'note', 'customer_thana', 'created_by', 'extra_data', 'created_at', 'updated_at', 'cash_amount', 'bank_amount', 'bank_method', 'cheque_no'],
    sale_items: ['sale_id', 'product_id', 'product_name', 'qty', 'rate', 'amount', 'extra_data'],
    purchases: ['id', 'purchase_no', 'date', 'supplier_id', 'supplier_name', 'method', 'bank_name', 'discount', 'extra', 'vat', 'vat_type', 'total', 'paid', 'note', 'extra_data', 'created_at', 'updated_at', 'cash_amount', 'bank_amount', 'bank_method', 'cheque_no'],
